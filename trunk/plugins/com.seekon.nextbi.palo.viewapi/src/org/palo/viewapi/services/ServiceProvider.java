...
/*     */   }
/*     */ 
/*     */   public static final boolean hasPermission(Right right, Class<? extends Service> forService, AuthUser user)
/*     */   {
/* 190 */     if (isAdmin(user)) {
/* 191 */       return true;
/*     */     }
...
/*     */ 
/*     */   protected abstract AdministrationService getAdminService(AuthUser paramAuthUser);
/*     */ 
/*     */   protected abstract ReportService getReportServiceFor(AuthUser paramAuthUser);
/*     */ 
/*     */   protected abstract ViewService getViewServiceFor(AuthUser paramAuthUser);
/*     */ 
/*     */   protected abstract FolderService getFolderServiceFor(AuthUser paramAuthUser);
/*     */ 
/*     */   protected abstract void init(DbConnection paramDbConnection, boolean paramBoolean)
/*     */     throws SQLException;
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.services.ServiceProvider
