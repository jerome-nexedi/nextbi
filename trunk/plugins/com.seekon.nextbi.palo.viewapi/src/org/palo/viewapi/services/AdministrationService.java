...
public abstract interface AdministrationService extends Service
{
  ...
  public abstract User createUser(String paramString1, String paramString2, String paramString3, String paramString4)
  ...
  public abstract void delete(Group paramGroup)
    throws OperationFailedException;

  public abstract void save(Group paramGroup)
    throws OperationFailedException;
  ...
  public abstract PaloConnection createConnection(String paramString1, String paramString2, String paramString3, int paramInt)
    throws OperationFailedException;
  ...
  public abstract void setDescription(String paramString, PaloConnection paramPaloConnection);
  ...
  public abstract void setService(String paramString, PaloConnection paramPaloConnection);
  ...
  public abstract Account createAccount(String paramString1, String paramString2, User paramUser, PaloConnection paramPaloConnection)
    throws OperationFailedException;

  public abstract void delete(Account paramAccount)
    throws OperationFailedException;

  public abstract void save(Account paramAccount)
    throws OperationFailedException;

  public abstract void setConnection(PaloConnection paramPaloConnection, Account paramAccount);
 ...
 * Qualified Name:     org.palo.viewapi.services.AdministrationService
