...
/*     */ 
/*     */   public TrafficLightData(double[] minVals, double[] maxVals, ColorDescriptor[] backgroundColors, ColorDescriptor[] foregroundColors, FontDescriptor[] fontDatas)
/*     */   {
...
/*     */ 
/* 108 */     for (double d : minVals) this.minValues.add(Double.valueOf(d));
/* 109 */     for (double d : maxVals) this.maxValues.add(Double.valueOf(d));
...
/* 129 */     int counter = 0;
/*     */     Double d;
/* 130 */     for (Iterator localIterator = this.minValues.iterator(); localIterator.hasNext(); result[(counter++)] = d.doubleValue()) d = (Double)localIterator.next();
/* 131 */     return result;
/*     */   }
/*     */ 
...
/* 140 */     int counter = 0;
/*     */     Double d;
/* 141 */     for (Iterator localIterator = this.maxValues.iterator(); localIterator.hasNext(); result[(counter++)] = d.doubleValue()) d = (Double)localIterator.next();
/* 142 */     return result;
/*     */   }
/*     */ 
/*     */   public ColorDescriptor[] getForegroundColors()
/*     */   {
/* 150 */     return (ColorDescriptor[])this.foregroundColors.toArray(new ColorDescriptor[0]);
/*     */   }
/*     */ 
/*     */   public ColorDescriptor[] getBackgroundColors()
/*     */   {
/* 158 */     return (ColorDescriptor[])this.backgroundColors.toArray(new ColorDescriptor[0]);
/*     */   }
/*     */ 
...
/*     */   {
/* 193 */     ColorDescriptor rgb = (ColorDescriptor)this.foregroundColors.get(index);
/* 194 */     if (rgb == null) {
...
/*     */   {
/* 206 */     ColorDescriptor rgb = (ColorDescriptor)this.backgroundColors.get(index);
/* 207 */     if (rgb == null) {
...
/* 227 */     int i = 0; for (int n = this.minValues.size(); i < n; ++i) {
/* 228 */       if ((((Double)this.minValues.get(i)).doubleValue() <= value) && (((Double)this.maxValues.get(i)).doubleValue() >= value)) {
/* 229 */         return i;
/*     */       }
/*     */     }
/* 232 */     return -1;
 ...
 * Qualified Name:     org.palo.viewapi.uimodels.formats.TrafficLightData
