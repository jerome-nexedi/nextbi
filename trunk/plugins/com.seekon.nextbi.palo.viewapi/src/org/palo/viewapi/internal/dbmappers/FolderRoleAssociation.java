...
/*     */ {
/*  65 */   private static final String TABLE = DbService.getQuery("FoldersRolesAssociation.tableName");
/*  66 */   private static final String COLUMNS = DbService.getQuery("FoldersRolesAssociation.columns");
/*  67 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("FoldersRolesAssociation.createTable", new String[] { TABLE });
/*  68 */   private static final String INSERT_STMT = DbService.getQuery("FoldersRolesAssociation.insert", new String[] { TABLE });
/*  69 */   private static final String FIND_BY_FOLDER_STMT = DbService.getQuery("FoldersRolesAssociation.findByFolder", new String[] { COLUMNS, TABLE });
/*  70 */   private static final String FIND_BY_ROLE_STMT = DbService.getQuery("FoldersRolesAssociation.findByRole", new String[] { COLUMNS, TABLE });
/*  71 */   private static final String UPDATE_STMT = DbService.getQuery("FoldersRolesAssociation.update", new String[] { TABLE });
/*  72 */   private static final String DELETE_STMT = DbService.getQuery("FoldersRolesAssociation.delete", new String[] { TABLE });
/*  73 */   private static final String DELETE_ROLE_STMT = DbService.getQuery("FoldersRolesAssociation.deleteRole", new String[] { TABLE });
/*  74 */   private static final String DELETE_FOLDER_STMT = DbService.getQuery("FoldersRolesAssociation.deleteFolder", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.FolderRoleAssociation
