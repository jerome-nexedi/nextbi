...
/*  71 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("Views.createTable", new String[] { TABLE });
/*  72 */   private static final String FIND_BY_ID_STMT = DbService.getQuery("Views.findById", new String[] { COLUMNS, TABLE });
/*  73 */   private static final String FIND_BY_OWNER_STMT = DbService.getQuery("Views.findByOwner", new String[] { COLUMNS, TABLE });
/*  74 */   private static final String FIND_BY_NAME_STMT = DbService.getQuery("Views.findByName", new String[] { COLUMNS, TABLE });
/*  75 */   private static final String FIND_BY_ACCOUNT_STMT = DbService.getQuery("Views.findByAccount", new String[] { COLUMNS, TABLE });
/*  76 */   private static final String FIND_BY_NAME_CUBE_ACCOUNT_STMT = DbService.getQuery("Views.findByNameCubeAccount", new String[] { COLUMNS, TABLE });
/*  77 */   private static final String FIND_ALL_STMT = DbService.getQuery("Views.findAll", new String[] { COLUMNS, TABLE });
/*     */ 
/*  79 */   private static final String INSERT_STMT = DbService.getQuery("Views.insert", new String[] { TABLE });
/*  80 */   private static final String UPDATE_STMT = DbService.getQuery("Views.update", new String[] { TABLE });
/*  81 */   private static final String DELETE_STMT = DbService.getQuery("Views.delete", new String[] { TABLE });
/*     */ 
...
/*     */ 
/* 237 */     IUserManagement usrMgmt = MapperRegistry.getInstance().getUserManagement();
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.ViewMapper
