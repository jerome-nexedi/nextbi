...
{
  public abstract List<String> getUsers(Group paramGroup)
    throws SQLException;

  public abstract List<String> getUsers(String paramString)
    throws SQLException;

  public abstract List<String> getGroups(User paramUser)
    throws SQLException;
 ...
 * Qualified Name:     org.palo.viewapi.internal.IUserGroupManagement
