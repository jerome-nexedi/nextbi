...
/*     */{
  ...
  /*     */
  /*     */public ServerConnectionPool(IConnectionFactory factory, String host,
    String service, String login, String password, int capacity, String provider) {
  ...
  /*     */{
    ...
    /*     */{
      /* 82 */Connection nativeConnection = this.factory.createConnection(
        this.host, this.service, this.login, this.password, this.provider);
      /* 83 */ConnectionWrapper conn = new ConnectionWrapper(nativeConnection,
        index);
      /* 84 */return conn;
      /*     */}
    /*     */}
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.ServerConnectionPool JD-Core
 * Version: 0.5.4
 */