...
{
  public abstract List<String> getReports(View paramView)
    throws SQLException;

  public abstract List<String> getViews(Report paramReport)
    throws SQLException;
 ...
 * Qualified Name:     org.palo.viewapi.internal.IReportViewManagement
