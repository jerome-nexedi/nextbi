...
/*     */ {
/*  59 */   private static final String TABLE = DbService.getQuery("GroupsRolesAssociation.tableName");
/*  60 */   private static final String COLUMNS = DbService.getQuery("GroupsRolesAssociation.columns");
/*  61 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("GroupsRolesAssociation.createTable", new String[] { TABLE });
/*  62 */   private static final String INSERT_STMT = DbService.getQuery("GroupsRolesAssociation.insert", new String[] { TABLE });
/*  63 */   private static final String FIND_BY_GROUP_STMT = DbService.getQuery("GroupsRolesAssociation.findByGroup", new String[] { COLUMNS, TABLE });
/*  64 */   private static final String FIND_BY_ROLE_STMT = DbService.getQuery("GroupsRolesAssociation.findByRole", new String[] { COLUMNS, TABLE });
/*  65 */   private static final String UPDATE_STMT = DbService.getQuery("GroupsRolesAssociation.update", new String[] { TABLE });
/*  66 */   private static final String DELETE_STMT = DbService.getQuery("GroupsRolesAssociation.delete", new String[] { TABLE });
/*  67 */   private static final String DELETE_GROUP_STMT = DbService.getQuery("GroupsRolesAssociation.deleteGroup", new String[] { TABLE });
/*  68 */   private static final String DELETE_ROLE_STMT = DbService.getQuery("GroupsRolesAssociation.deleteRole", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.GroupRoleAssociation
