...
/*     */ {
/*  67 */   private static final String TABLE = DbService.getQuery("Folders.tableName");
/*  68 */   private static final String COLUMNS = DbService.getQuery("Folders.columns");
/*  69 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("Folders.createTable", new String[] { TABLE });
/*  70 */   private static final String FIND_BY_ID_STMT = DbService.getQuery("Folders.findById", new String[] { COLUMNS, TABLE });
/*  71 */   private static final String FIND_BY_OWNER_STMT = DbService.getQuery("Folders.findByOwner", new String[] { COLUMNS, TABLE });
/*  72 */   private static final String FIND_BY_CONNECTION_STMT = DbService.getQuery("Folders.findByConnection", new String[] { COLUMNS, TABLE });
/*  73 */   private static final String INSERT_STMT = DbService.getQuery("Folders.insert", new String[] { TABLE });
/*  74 */   private static final String UPDATE_STMT = DbService.getQuery("Folders.update", new String[] { TABLE });
/*  75 */   private static final String DELETE_STMT = DbService.getQuery("Folders.delete", new String[] { TABLE });
...
/*     */   {
/* 236 */     AbstractExplorerTreeNode.Builder folderBuilder = new AbstractExplorerTreeNode.Builder(id);
/* 237 */     folderBuilder.name(result.getString(2));
/*     */ 
/* 239 */     IUserManagement usrMgmt = MapperRegistry.getInstance().getUserManagement();
...
/* 311 */     throw new IllegalArgumentException("This method is not supported for folders.");
/*     */   }
/*     */ }

/* Location:           E:\workspace\eclipse\opensourceBI\bicp\com.seekon.bicp.palo\lib\paloviewapi.jar
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.FolderMapper
