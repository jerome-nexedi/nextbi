...
{
  public abstract List<String> getGroups(Role paramRole)
    throws SQLException;

  public abstract List<String> getGroups(String paramString)
    throws SQLException;

  public abstract List<String> getRoles(Group paramGroup)
    throws SQLException;
 ...
 * Qualified Name:     org.palo.viewapi.internal.IGroupRoleManagement
