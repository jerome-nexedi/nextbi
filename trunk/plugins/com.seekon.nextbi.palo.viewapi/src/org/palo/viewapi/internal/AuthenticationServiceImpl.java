...
/* 124 */     IUserManagement usrManager = MapperRegistry.getInstance().getUserManagement();
/* 125 */     IUserRoleManagement urManager = MapperRegistry.getInstance().getUserRoleAssociation();
/* 126 */     IRoleManagement roleManager = MapperRegistry.getInstance().getRoleManagement();
/*     */ 
...
/* 141 */       if (user == null) continue;
/*     */       try {
/* 143 */         AuthUser authUser = authenticateHash(user.getLoginName(), user.getPassword());
/* 144 */         if (authUser == null) break label169;
/* 145 */         return authUser;
/*     */       }
 ...
 * Qualified Name:     org.palo.viewapi.internal.AuthenticationServiceImpl
