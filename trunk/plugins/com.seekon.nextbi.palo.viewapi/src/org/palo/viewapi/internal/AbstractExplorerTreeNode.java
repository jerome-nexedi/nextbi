...
/*     */   {
/* 227 */     return (ExplorerTreeNode[])this.children.toArray(new ExplorerTreeNode[0]);
/*     */   }
/*     */ 
...
/* 265 */     int i = 0; for (int n = this.children.size(); i < n; ++i) {
...
/*     */         }
/*     */       }
/* 453 */       AbstractExplorerTreeNode node = (AbstractExplorerTreeNode)findNode((ExplorerTreeNode)roots.get(user), this.id);
/* 454 */       if (node == null) {
/*     */         try {
/* 456 */           roots.put(user, FolderModel.getInstance().loadPure(user));
/* 457 */           node = (AbstractExplorerTreeNode)findNode((ExplorerTreeNode)roots.get(user), this.id);
/*     */         } catch (PaloIOException e) {
...
/* 462 */       if (node == null) {
/* 463 */         if (this.type == 2)
/* 464 */           node = new StaticFolder((ExplorerTreeNode)roots.get(user), this.id, this.name);
/* 465 */         else if (this.type == 3) {
/* 466 */           node = new FolderElement((ExplorerTreeNode)roots.get(user), this.id, this.name);
/*     */         }
/*     */       }
/* 469 */       if (node != null) {
 ...
 * Qualified Name:     org.palo.viewapi.internal.AbstractExplorerTreeNode
