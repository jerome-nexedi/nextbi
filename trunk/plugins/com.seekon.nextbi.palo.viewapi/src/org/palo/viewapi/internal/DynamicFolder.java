...
/*     */ 
/*     */   public static DynamicFolder internalCreate(ExplorerTreeNode parent, Hierarchy sourceHierarchy, Subset2 sourceSubset, String id, String name)
/*     */   {
/* 182 */     return new DynamicFolder(parent, sourceHierarchy, sourceSubset, id, name);
/*     */   }
/*     */ 
/*     */   private DynamicFolder(ExplorerTreeNode parent, Hierarchy sourceHierarchy, Subset2 sourceSubset, String id, String name)
/*     */   {
/* 198 */     super(id, true);
/* 199 */     this.name = name;
...
/*     */   }
/*     */ 
/*     */   public DynamicFolder(ExplorerTreeNode parent, Hierarchy sourceHierarchy, Subset2 sourceSubset)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public DynamicFolder(ExplorerTreeNode parent, Hierarchy sourceHierarchy, Subset2 sourceSubset, String name)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public void setPossibleValuesFor(String parameterName, Object[] possibleValues)
/*     */   {
...
/*     */   {
/* 432 */     if ((parameterName.equals("Hierarchy")) && (parameterValue instanceof Hierarchy))
/* 433 */       this.sourceHierarchy = ((Hierarchy)parameterValue);
/* 434 */     else if ((parameterName.equals("Subset")) && (parameterValue instanceof Subset2)) {
...
/* 503 */       return (ExplorerTreeNode[])this.children.toArray(new ExplorerTreeNode[0]);
/*     */     ElementNode[] elems;
...
/* 513 */       return (ExplorerTreeNode[])this.children.toArray(new ExplorerTreeNode[0]);
/*     */     }
/*     */ 
...
/* 521 */         String newId = kid.getId() + "_" + e.getElement().getId() + elementPathName;
...
/*     */           else
/* 532 */             n = new DynamicFolder(newId, newName, this, (DynamicFolder)kid);
/*     */         }
...
/* 756 */       Connection con = this.sourceHierarchy.getDimension().getDatabase().getConnection();
/* 757 */       result.append(tag("connectionServer", con.getServer()));
/* 758 */       result.append(tag("connectionService", con.getService()));
/* 759 */       result.append(tag("databaseId", this.sourceHierarchy.getDimension().getDatabase().getId()));
/* 760 */       result.append(tag("dimensionId", this.sourceHierarchy.getDimension().getId()));
/* 761 */       result.append(tag("hierarchyId", this.sourceHierarchy.getId()));
/*     */     }
/* 763 */     if (this.sourceSubset != null) {
/* 764 */       result.append("subset=\"");
/* 765 */       result.append(this.sourceSubset.getDimHierarchy().getDimension().getId());
/* 766 */       result.append("@_@");
 ...
 * Qualified Name:     org.palo.viewapi.internal.DynamicFolder
