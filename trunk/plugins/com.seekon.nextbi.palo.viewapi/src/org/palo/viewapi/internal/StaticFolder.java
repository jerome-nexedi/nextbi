...
/*     */ 
/*     */   public static StaticFolder internalCreate(ExplorerTreeNode parent, String id, String name)
/*     */   {
...
/* 152 */         this.children.add(new FolderElement(kid.getId(), kid.getName(), parent, (FolderElement)kid));
/*     */       else {
/* 154 */         this.children.add(new DynamicFolder(kid.getId(), kid.getName(), parent, (DynamicFolder)kid));
/*     */       }
/*     */     }
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.StaticFolder
