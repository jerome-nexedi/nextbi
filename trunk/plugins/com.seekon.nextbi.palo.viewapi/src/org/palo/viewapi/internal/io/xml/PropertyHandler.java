...
/*  70 */         throw new PaloAPIException("PropertyHandler: no property id defined!");
/*     */       }
/*     */ 
/*  73 */       String value = attributes.getValue("value");
/*  74 */       if (value == null) {
/*  75 */         throw new PaloAPIException("PropertyHandler: no property value specified!");
/*     */       }
/*     */ 
/*  79 */       this.property = this.view.addProperty(id, value);
/*  80 */       this.parentProperties.push(this.property);
/*  81 */     } else if ((path.startsWith("/view/property")) && (path.endsWith("property"))) {
...
/*  88 */         throw new PaloAPIException("PropertyHandler: no property id defined!");
/*     */       }
/*     */ 
/*  91 */       String value = attributes.getValue("value");
/*  92 */       if (value == null) {
/*  93 */         throw new PaloAPIException("PropertyHandler: no property value specified!");
/*     */       }
/*     */ 
...
/* 117 */     xml.append(" value=\"" + XMLUtil.printQuoted(property.getValue().toString()) + "\">\r\n");
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.xml.PropertyHandler
