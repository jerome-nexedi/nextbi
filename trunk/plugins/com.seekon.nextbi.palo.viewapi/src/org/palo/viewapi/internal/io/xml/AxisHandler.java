...
/* 102 */     } else if ((path.equals("/view/axis/property")) && (this.axis != null)) {
...
/*     */       }
/* 109 */     } else if ((path.equals("/view/axis/axis_hierarchy")) && (this.axisHierarchy == null))
/*     */     {
...
/* 155 */     } else if (path.startsWith("/view/axis/axis_hierarchy/localfilter/element")) {
...
/* 183 */       Subset2 subset = 
/* 184 */         this.axisHierarchy.getHierarchy().getDimension().getSubsetHandler().getSubset(value, 1);
/* 185 */       if (subset == null) {
/* 186 */         this.axisHierarchy.setSubsetMissing(value);
/*     */       }
/*     */ 
/* 191 */       this.axisHierarchy.setSubset(subset);
/* 192 */     } else if (path.equals("/view/axis/axis_hierarchy/selected_elements")) {
...
/*     */       }
/* 205 */     } else if (path.startsWith("/view/axis/axis_hierarchy/localfilter/element")) {
...
/*     */   }
/*     */ 
/*     */   private static final void writeAxisHierarchy(StringBuffer xml, AxisHierarchy axisHierarchy)
/*     */   {
...
/* 317 */           xml.append(prop.getId()); xml.append("\"");
/* 318 */           xml.append(" value=\""); xml.append(attr.getId());
/* 319 */           xml.append("\"/>\r\n");
/*     */         }
/*     */       } else {
...
/* 325 */         xml.append(prop.getId()); xml.append("\"");
/* 326 */         xml.append(" value=\""); xml.append(propValue);
/* 327 */         xml.append("\"/>\r\n");
/*     */       }
/*     */     }
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.xml.AxisHandler
