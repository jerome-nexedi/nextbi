...
/*     */       } catch (Exception e) {
/* 110 */         throw new PaloAPIException("FormatHandler: invalid traffic light parameters!");
/*     */       }
...
/*     */       } catch (Exception e) {
/* 128 */         throw new PaloAPIException("FormatHandler: invalid border parameters!");
/*     */       }
...
/* 139 */           new FormatRangeInfo(this.view.getCube().getDimensions(), levels, false));
/*     */       }
/* 141 */       if (coords != null)
/* 142 */         this.format.addRange(
/* 143 */           new FormatRangeInfo(this.view.getCube().getDimensions(), coords, true));
/*     */     }
/*     */   }
/*     */ 
...
/* 189 */       xml.append(getColorXML("backgroundColor", format.getBackgroundColor()));
/*     */     }
...
/* 195 */       xml.append("  fontData=\"" + XMLUtil.printQuoted(format.getFontData().toString()) + "\"\r\n");
/*     */     }
/* 197 */     if ((format.getNumberFormat() != null) && (format.getNumberFormat().length() != 0)) {
/* 198 */       xml.append("  numberFormat=\"" + XMLUtil.printQuoted(format.getNumberFormat()) + "\"\r\n");
/*     */     }
/* 200 */     xml.append(">\r\n");
...
/* 207 */       int i = 0; for (n = traffic.getSize(); i < n; ++i) {
...
/* 250 */       return "";
/*     */     }
/* 252 */     int i = 0; for (int n = borders.length; i < n; ++i) {
...
/* 268 */     trafficXML.append("min=\"" + XMLUtil.printQuoted(new StringBuilder().append(data.getMinValueAt(i)).toString()) + "\"\r\n");
/* 269 */     trafficXML.append("                max=\"" + XMLUtil.printQuoted(new StringBuilder().append(data.getMaxValueAt(i)).toString()) + "\"\r\n");
/* 270 */     trafficXML.append(getColorXML("              backgroundColor", data.getBackgroundColorAt(i)));
/* 271 */     trafficXML.append(getColorXML("              fontColor", data.getForegroundColorAt(i)));
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.xml.FormatHandler
