...
public final class HandlerRegistry {
  ...
  private void updateServletArray() {
    ...
    ServletHandler[] tmp = allServletHandlerList
      .toArray(new ServletHandler[allServletHandlerList.size()]);
    Arrays.sort(tmp);
    this.servlets = tmp;
  }
  ...
  private void updateFilterArray() {
    ...
    FilterHandler[] tmp = allFilterHandlerList
      .toArray(new FilterHandler[allFilterHandlerList.size()]);
    Arrays.sort(tmp);
    this.filters = tmp;
  }
}
