...
public class XMLADimensionLoader extends DimensionLoader
{
  ...
  public XMLADimensionLoader(DbConnection paramDbConnection, XMLAClient paramXMLAClient, DatabaseInfo paramDatabaseInfo)
  {
  ...
  public String[] getAllDimensionIds()
  {
    if (this.allIds == null)
    {
      ...
      String[] arrayOfString1 = ((XMLAConnection)this.paloConnection).getCubeLoader(this.database).getAllCubeIds();
      for (String str : arrayOfString1)
      {
        if (!this.dimensionIds.containsKey(str))
        {
          XMLADimensionRequestor localXMLADimensionRequestor = new XMLADimensionRequestor((XMLACubeInfo)((XMLAConnection)this.paloConnection).getCubeLoader(this.database).load(str), (XMLAConnection)this.paloConnection);
          ...
          XMLADimensionInfo[] arrayOfXMLADimensionInfo1 = localXMLADimensionRequestor.requestDimensions(this.xmlaClient);
  ...
  public String[] getAllDimensionIdsForCube(CubeInfo paramCubeInfo)
  {
    ...
    {
      XMLADimensionRequestor localXMLADimensionRequestor = new XMLADimensionRequestor((XMLACubeInfo)paramCubeInfo, (XMLAConnection)this.paloConnection);
      localXMLADimensionRequestor.setCatalogNameRestriction(this.database.getId());
      ...
      for (XMLADimensionInfo localXMLADimensionInfo : arrayOfXMLADimensionInfo1)
        localArrayList.add(localXMLADimensionInfo.getId());
      this.dimensionIds.put(paramCubeInfo.getId(), localArrayList.toArray(new String[0]));
    }
 ...
 * Qualified Name:     com.tensegrity.palo.xmla.loader.XMLADimensionLoader
