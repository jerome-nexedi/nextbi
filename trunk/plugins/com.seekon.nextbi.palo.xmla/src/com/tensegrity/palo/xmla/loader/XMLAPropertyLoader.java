...
public class XMLAPropertyLoader extends PropertyLoader
{
  ...
  public String[] getAllPropertyIds()
  {
    ...
    if (this.paloObject == null)
      arrayOfString1 = ((XMLAConnection)this.paloConnection).getAllKnownPropertyIds();
    else if (this.paloObject instanceof XMLAPaloInfo)
      arrayOfString1 = ((XMLAPaloInfo)this.paloObject).getAllKnownPropertyIds(this.paloConnection);
  ...
  public PropertyInfo load(String paramString)
  {
    ...
    if (localObject == null)
    {
      if (this.paloObject == null)
        ...
        localObject = ((XMLAPaloInfo)this.paloObject).getProperty(this.paloConnection, paramString);
 ...
 * Qualified Name:     com.tensegrity.palo.xmla.loader.XMLAPropertyLoader
