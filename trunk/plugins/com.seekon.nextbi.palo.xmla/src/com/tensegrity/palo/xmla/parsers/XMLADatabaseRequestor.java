...
public class XMLADatabaseRequestor extends AbstractXMLARequestor
{
  ...
  public boolean requestDatabases(XMLAClient paramXMLAClient)
  {
    ...
    try
    {
      ...
      if ((this.restrictionName != null) && (this.restrictionName.trim().length() != 0))
        localXMLARestrictions.setCatalog(this.restrictionName);
      Document localDocument = paramXMLAClient.getCatalogList(localXMLARestrictions, localXMLAProperties);
  ...
  protected void parseResult(HashMap<String, String> paramHashMap, String paramString, XMLAClient paramXMLAClient)
  {
    ...
    XMLADatabaseInfo localXMLADatabaseInfo = new XMLADatabaseInfo(this.connection, str);
