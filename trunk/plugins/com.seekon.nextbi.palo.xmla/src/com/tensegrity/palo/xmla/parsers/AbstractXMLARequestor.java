...
public abstract class AbstractXMLARequestor
{
  ...
  protected void parseXMLANodeList(NodeList paramNodeList, String paramString, XMLAClient paramXMLAClient)
  {
      ...
      for (int k = 0; k < localNodeList.getLength(); ++k)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localNode.getNodeName().equals(str1))
          {
            ...
            if (str2.length() == 0)
              continue;
            localLinkedHashMap.put(str1, XMLAClient.getTextFromDOMElement(localNode));
          }
        }
      }
  ...
  protected abstract void parseResult(HashMap<String, String> paramHashMap, String paramString, XMLAClient paramXMLAClient);
}
