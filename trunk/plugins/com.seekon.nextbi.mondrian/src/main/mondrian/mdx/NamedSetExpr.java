/*
// $Id: //open/mondrian/src/main/mondrian/mdx/NamedSetExpr.java#18 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/mdx/NamedSetExpr.java#18 $
 * @since Sep 26, 2005
 */
public class NamedSetExpr extends ExpBase implements Exp {
	...
	public Calc accept(ExpCompiler compiler) {
		...
		return new AbstractIterCalc(this, new Calc[] {/*
																									 * todo: compile
																									 * namedSet.getExp()
																									 */}) {
