/*
// $Id: //open/mondrian/src/main/mondrian/mdx/ResolvedFunCall.java#13 $
 ...
 * which has been validated and resolved to a {@link FunDef function definition}
 * .
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/mdx/ResolvedFunCall.java#13 $
 * @since Jan 6, 2006
 */
public final class ResolvedFunCall extends ExpBase implements FunCall {
	...
	public Exp accept(Validator validator) {
		...
		FunUtil.resolveFunArgs(validator, funDef, args, newArgs, getFunName(),
				getSyntax());
