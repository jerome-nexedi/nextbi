...
public interface Dialect {
	 ...
	 * 
	 * <p>
	 * For example, for MySQL, {@code toUpper("foo.bar")} returns
	 * {@code "UPPER(foo.bar)"}.
	 * </p>
	 * 
	 * @param expr
	 ...
	 * 
	 * <p>
	 * For example, {@code caseWhenElse("b", "1", "0")} returns
	 * {@code "case when b then 1 else 0 end"} on Oracle, {@code "Iif(b, 1, 0)"}
	 * on Access.
	 * 
	 * @param cond
	 ...
	 * <p>
	 * For example, in the default dialect,
	 * <code>quoteStringLiteral(buf, "1969-03-17")</code> appends
	 * <code>DATE '1969-03-17'</code>.
	 * 
	 * @param buf
	 *          Buffer to append to
	 * @param value
	 ...
	 * <p>
	 * For example, in the default dialect,
	 * <code>quoteStringLiteral(buf, "12:34:56")</code> appends
	 * <code>TIME '12:34:56'</code>.
	 * 
	 * @param buf
	 *          Buffer to append to
	 * @param value
	 ...
	 * <p>
	 * For example, in the default dialect,
	 * <code>quoteStringLiteral(buf, "1969-03-17 12:34:56")</code> appends
	 * <code>TIMESTAMP '1969-03-17 12:34:56'</code>.
	 * 
	 * @param buf
	 *          Buffer to append to
	 * @param value
	 ...
	 * 
	 * <blockquote><code>SELECT COUNT(DISTINCT x, y) FROM t</code>
	 * </blockquote>
	 * 
	 ...
	 * the {@code emps} table, and therefore all columns are dependent on it. For
	 * a given value of {@code empno}, {@code first_name || ' ' || last_name} has
	 * a unique value.
	 * 
	 * <p>
	...
	enum Datatype {
		 ...
		 *          Value
		 */
		public abstract void quoteValue(StringBuilder buf, Dialect dialect,
				String value);
