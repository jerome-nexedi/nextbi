...
public class Scripts {
	...
	private static <T> T create(ScriptDefinition script, Class<T> iface,
			String script2) {
	...
	public static PropertyFormatter propertyFormatter(ScriptDefinition script) {
		return create(script, PropertyFormatter.class,
				simple(script, "formatProperty(member,propertyName,propertyValue)"));
	}
	...
	public static MemberFormatter memberFormatter(ScriptDefinition script) {
		return create(script, MemberFormatter.class,
	...
	public static CellFormatter cellFormatter(ScriptDefinition script) {
		return create(script, CellFormatter.class,
	...
	public static DataSourceResolver dataSourceResolver(ScriptDefinition script) {
		return create(script, DataSourceResolver.class,
	...
	public static DynamicSchemaProcessor dynamicSchemaProcessor(
			ScriptDefinition script) {
		return create(script, DynamicSchemaProcessor.class,
	...
	public static UserDefinedFunction userDefinedFunction(
			ScriptDefinition script, String name) {
		final String code;
		switch (script.language) {
		case JAVASCRIPT:
