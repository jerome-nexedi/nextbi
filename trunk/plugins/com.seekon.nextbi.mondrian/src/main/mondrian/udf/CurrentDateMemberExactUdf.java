/*
// $Id: //open/mondrian/src/main/mondrian/udf/CurrentDateMemberExactUdf.java#7 $
 ...
 * </code> </blockquote>
 * 
 * The function returns the member from the specified hierarchy that matches the
 * current date, to the granularity specified by the &lt;FormatString&gt;.
 * 
 * The format string conforms to the format string implemented by {@link Format}
 * .
 * 
 * @author Zelaine Fong
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/udf/CurrentDateMemberExactUdf.
 *          java#7 $
 */
