/*
// $Id: //open/mondrian/src/main/mondrian/olap/LevelType.java#15 $
...
public enum LevelType {
	...
	/**
	 * Indicates that a level refers to years. It must be used in a dimension
	 * whose type is {@link DimensionType#TimeDimension}.
	 */
	TimeYears,
	...
	/**
	 * Indicates that a level refers to months. It must be used in a dimension
	 * whose type is {@link DimensionType#TimeDimension}.
	 */
	TimeMonths,

	/**
	 * Indicates that a level refers to weeks. It must be used in a dimension
	 * whose type is {@link DimensionType#TimeDimension}.
	 */
	TimeWeeks,
	 ...
	 * type is {@link DimensionType#TimeDimension}.
	 */
	TimeDays,

	/**
	 * Indicates that a level refers to hours. It must be used in a dimension
	 * whose type is {@link DimensionType#TimeDimension}.
	 */
	TimeHours,
	 ...
	 * dimension whose type is {@link DimensionType#TimeDimension}.
	 */
	TimeUndefined,
