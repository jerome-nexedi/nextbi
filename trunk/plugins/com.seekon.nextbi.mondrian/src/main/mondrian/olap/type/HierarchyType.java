/*
// $Id: //open/mondrian/src/main/mondrian/olap/type/HierarchyType.java#15 $
 ...
 * @since Feb 17, 2005
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/type/HierarchyType.java#15 $
 */
public class HierarchyType implements Type {
   ...
   * @param hierarchy
   *          Hierarchy that values of this type must belong to, null if the
  ...
  public boolean isInstance(Object value) {
    return value instanceof Hierarchy
      && (hierarchy == null || value.equals(hierarchy))
      && (dimension == null || ((Hierarchy) value).getDimension().equals(dimension));
  }
