/*
// $Id: //open/mondrian/src/main/mondrian/olap/Cell.java#21 $
 ...
 * @author jhyde
 * @since 6 August, 2001
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Cell.java#21 $
 */
public interface Cell {
	 ...
	 * {@link Throwable};</li>
	 * <li>otherwise, the type of this value depends upon the type of measure:
	 * possible types include {@link java.math.BigDecimal}, {@link Double},
	 * {@link Integer} and {@link String}.</li>
	 * </ul>
	 * 
	 * @post return != null
	 ...
	 * format strings, see {@link mondrian.util.Format}.
	 */
	...
	/**
	 * Returns a SQL query that, when executed, returns drill through data for
	 * this Cell.
	 * 
	 * <p>
	 * If the parameter {@code extendedContext} is true, then the query will
	 * include all the levels (i.e. columns) of non-constraining members (i.e.
	 * members which are at the "All" level).
	 * 
	 * <p>
	 * If the parameter {@code extendedContext} is false, the query will exclude
	...
	/**
	 * Returns true if drill through is possible for this Cell. Returns false if
	 * the Cell is based on a calculated measure.
	 * 
	 ...
	 * <ul>
	 * 
	 * <li>If the dimension appears on one of the visible axes, the context member
	 * is simply the member on the current row or column.
	 * 
	 * <li>If the dimension appears in the slicer, the context member is the
	 * member of that dimension in the slier.
	 * 
	 * <li>Otherwise, the context member is the default member of that dimension
	 ...
	 */
	void setValue(Scenario scenario, Object newValue,
