/*
// $Id: //open/mondrian/src/main/mondrian/olap/MatchType.java#7 $
...
/**
 * <code>MatchType</code> enumerates the allowable match modes when searching
 * for a member based on its unique name.
 * 
 * @author Zelaine Fong
