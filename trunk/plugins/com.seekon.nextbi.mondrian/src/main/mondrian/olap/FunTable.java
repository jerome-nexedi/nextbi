/*
// $Id: //open/mondrian/src/main/mondrian/olap/FunTable.java#17 $
 ...
 * {@link Syntax} and set of arguments, to a function definition ({@link FunDef}
 * ).
 */
public interface FunTable {
	...
	/**
	 * Returns whether a string is a property-style (postfix) operator. This is
	 * used during parsing to disambiguate functions from unquoted member names.
	 */
	...
	/**
	 * This method is called from the constructor, to define the set of functions
	 * and reserved words recognized.
	 * 
	 * <p>
	 * The implementing class calls {@link Builder} methods to declare functions
	 * and reserved words.
	 * 
	 * <p>
	 * Derived class can override this method to add more functions. It must call
	 * the base method.
	 * 
	 * @param builder
	 *          Builder
	...
	/**
	 * Builder that assists with the construction of a function table by providing
	 * callbacks to define functions.
	 * 
	 * <p>
	 * An implementation of {@link mondrian.olap.FunTable} must register all of
	 * its functions and operators by making callbacks during its
	...
	public interface Builder {
		...
		/**
		 * Defines a function info that is not matchd by an actual function. The
		 * function will be implemented via implicit conversions, but we still want
		 * the function info to appear in the metadata.
		 * 
		 * @param funInfo
		 *          Function info
		 */
