 ...
 * {@link mondrian.mdx.UnresolvedFunCall unresolved function call}. The
 * validator converts it to a {@link mondrian.mdx.ResolvedFunCall resolved
 * function call}, which has a {@link FunDef function definition} and extra type
 * information.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/FunCall.java#23 $
 * @since Jan 6, 2006
 */
