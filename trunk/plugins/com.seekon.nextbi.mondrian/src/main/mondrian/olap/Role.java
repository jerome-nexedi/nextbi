/*
// $Id: //open/mondrian/src/main/mondrian/olap/Role.java#25 $
 ...
 * executed for the duration of the connection will b.
 * 
 * <p>
 ...
 * @author jhyde
 * @since Oct 5, 2002
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Role.java#25 $
 */
public interface Role {
	 ...
	 * 
	 * @pre schema != null
	 * @post return == Access.ALL || return == Access.NONE || return ==
	...
	public interface HierarchyAccess {
		...
		/**
		 * Returns the policy by which cell values are calculated if not all of a
		 * member's children are visible.
		 * 
		...
		/**
		 * Returns <code>true</code> if at least one of the descendants of the given
		 * Member is inaccessible to this Role.
		 * 
		 * <p>
		 * Descendants which are inaccessible because they are below the bottom
		 * level are ignored.
		 * 
		 * @param member
		 *          Member
	 ...
	 * 
	 * @pre hierarchy != null
	 * @post return == Access.NONE || return == Access.ALL || return ==
	 *       Access.CUSTOM
	 */
