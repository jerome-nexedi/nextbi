...
public class Walker implements Enumeration {
	...
	public int getOrdinal() {
		...
		// have changed it.
		return currentFrame.parent == null ? 0 : arrayFind(
				currentFrame.parent.children, currentFrame.node);
	}
		...
		Region usa = new Region("USA", new Region[] {
				new Region("CA", new Region[] {
						new Region("San Francisco", new Region[] {
								new Region("WesternAddition", new Region[] { new Region(
										"Haight", null) }), new Region("Soma", null) }),
