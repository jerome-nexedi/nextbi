/*
// $Id: //open/mondrian/src/main/mondrian/olap/Exp.java#20 $
 ...
 * @author jhyde
 * @since 1.0
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Exp.java#20 $
 */
public interface Exp {
  ...
  /**
   * Accepts a visitor to this Exp. The implementation should generally
   * dispatches to the {@link MdxVisitor#visit} method appropriate to the type
   * of expression.
   * 
   * @param visitor
   *          Visitor
