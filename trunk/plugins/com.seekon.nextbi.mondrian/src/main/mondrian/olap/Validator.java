/*
// $Id: //open/mondrian/src/main/mondrian/olap/Validator.java#11 $
 ...
 * 
 * <p>
 * An expression calls {@link #validate} on each of its children, which in turn
 * calls {@link Exp#accept}.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Validator.java#11 $
 */
public interface Validator {
	 ...
	 * @param scalar
	 *          Whether the context requires that the expression is evaluated to a
	 *          value, as opposed to a tuple
	 */
	 ...
	 *          parameter type
	 * @param conversions
	 *          List of conversions performed; method adds an element for each
	 *          non-trivial conversion (for example, converting a member to a
	 *          level).
	 * @return Whether we can convert an argument to a parameter type
	 */
	boolean canConvert(int ordinal, Exp fromExp, int to,
	 ...
	 */
	Parameter createOrLookupParam(boolean definition, String name, Type type,
	 ...
	 * 
	 * <p>
	 * The schema reader is initially in the context of the query's cube, and
	 * during a traversal it may change if named sets are introduced using the
	 * 'expr AS alias' construct.
	 * 
