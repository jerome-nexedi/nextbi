/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/UnionFunDef.java#9 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/UnionFunDef.java#9 $
 * @since Mar 23, 2006
 */
class UnionFunDef extends FunDefBase {
  ...
  static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
    "Union", "Union(<Set1>, <Set2>[, ALL])",
    "Returns the union of two sets, optionally retaining duplicates.", new String[] {
      "fxxx", "fxxxy" }, UnionFunDef.class, ReservedWords);
