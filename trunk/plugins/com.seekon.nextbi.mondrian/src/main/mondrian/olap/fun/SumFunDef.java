...
class SumFunDef extends AbstractAggregateFunDef {
  static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver("Sum",
    "Sum(<Set>[, <Numeric Expression>])",
    "Returns the sum of a numeric expression evaluated over a set.", new String[] {
      "fnx", "fnxn" }, SumFunDef.class);
  ...
  protected Calc genIterCalc(final ResolvedFunCall call, final IterCalc iterCalc,
    final Calc calc) {
  ...
  protected Calc genListCalc(final ResolvedFunCall call, final ListCalc listCalc,
    final Calc calc) {
