/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/ToggleDrillStateFunDef.java#7 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/ToggleDrillStateFunDef
 *          .java#7 $
 * @since Mar 23, 2006
 */
class ToggleDrillStateFunDef extends FunDefBase {
	...
	static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
			...
			new String[] { "fxxx", "fxxxy" }, ToggleDrillStateFunDef.class,
			ReservedWords);
	...
	public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
		if (call.getArgCount() > 2) {
			throw MondrianResource.instance().ToggleDrillStateRecursiveNotSupported
					.ex();
		}
	...
	TupleList toggleDrillStateTuples(Evaluator evaluator, TupleList v0,
			TupleList list1) {
