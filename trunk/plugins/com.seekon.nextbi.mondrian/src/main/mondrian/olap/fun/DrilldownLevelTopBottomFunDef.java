...
class DrilldownLevelTopBottomFunDef extends FunDefBase {
	...
	public Calc compileCall(final ResolvedFunCall call, ExpCompiler compiler) {
		...
		final LevelCalc levelCalc = call.getArgCount() > 2
				&& call.getArg(2).getCategory() != Category.Empty ? compiler
				.compileLevel(call.getArg(2)) : null;
		final Calc orderCalc = call.getArgCount() > 3 ? compiler.compileScalar(
				call.getArg(3), true) : new ValueCalc(new DummyExp(new ScalarType()));
