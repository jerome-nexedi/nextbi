/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/CacheFunDef.java#13 $
 ...
 * @author jhyde
 * @since 2005/8/14
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/CacheFunDef.java#13
 *          $
 */
public class CacheFunDef extends FunDefBase {
	...
	CacheFunDef(String name, String signature, String description, Syntax syntax,
			int category, Type type) {
		super(name, signature, description, syntax, category,
				new int[] { category });
		Util.discard(type);
	}
	...
	public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
		...
		final ExpCacheDescriptor cacheDescriptor = new ExpCacheDescriptor(exp,
				compiler);
	...
	public static class CacheFunResolver extends ResolverBase {
		...
		public FunDef resolve(Exp[] args, Validator validator,
			...
			return new CacheFunDef(NAME, SIGNATURE, DESCRIPTION, SYNTAX, category,
					type);
		}
