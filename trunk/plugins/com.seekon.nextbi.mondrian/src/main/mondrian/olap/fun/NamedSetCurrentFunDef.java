/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/NamedSetCurrentFunDef.java#5 $
...
/**
 * Definition of the <code>&lt;Named Set&gt;.Current</code> MDX builtin
 * function.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/NamedSetCurrentFunDef
 *          .java#5 $
 * @since Oct 19, 2008
 */
public class NamedSetCurrentFunDef extends FunDefBase {
	...
	private NamedSetCurrentFunDef() {
		super("Current", "Returns the current member or tuple of a named set.",
				"ptx");
	}
