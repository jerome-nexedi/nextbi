/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/HierarchizeFunDef.java#11 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/HierarchizeFunDef.java#11
 *          $
 * @since Mar 23, 2006
 */
class HierarchizeFunDef extends FunDefBase {
	...
	static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
			...
			"Orders the members of a set in a hierarchy.", new String[] { "fxx",
					"fxxy" }, HierarchizeFunDef.class, prePost);
