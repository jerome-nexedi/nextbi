...
class TopBottomCountFunDef extends FunDefBase {
  ...
  public Calc compileCall(final ResolvedFunCall call, ExpCompiler compiler) {
    ...
    final Calc orderCalc = call.getArgCount() > 2 ? compiler.compileScalar(call
      .getArg(2), true) : null;
    ...
    return new AbstractListCalc(call,
      ...
      private TupleList partiallySortList(Evaluator evaluator, TupleList list,
        ...
        case 1:
          final List<Member> members = partiallySortMembers(evaluator.push(), list
            .slice(0), orderCalc, n, top);
          evaluator.restore(savepoint);
          return new UnaryTupleList(members);
        default:
          final List<List<Member>> tuples = partiallySortTuples(evaluator.push(),
            list, orderCalc, n, top);
          evaluator.restore(savepoint);
