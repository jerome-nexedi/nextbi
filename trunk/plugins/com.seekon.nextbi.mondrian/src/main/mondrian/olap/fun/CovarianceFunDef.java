/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/CovarianceFunDef.java#9 $
...
/**
 * Definition of the <code>Covariance</code> and <code>CovarianceN</code> MDX
 * functions.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/CovarianceFunDef.java#9 $
 * @since Mar 23, 2006
 */
class CovarianceFunDef extends FunDefBase {
	static final ReflectiveMultiResolver CovarianceResolver = new ReflectiveMultiResolver(
			...
			new String[] { "fnxn", "fnxnn" }, CovarianceFunDef.class);
	...
	public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
		...
		final Calc calc2 = call.getArgCount() > 2 ? compiler.compileScalar(
				call.getArg(2), true) : new ValueCalc(call);
		return new AbstractDoubleCalc(call, new Calc[] { listCalc, calc1, calc2 }) {
			public double evaluateDouble(Evaluator evaluator) {
				...
				final double covariance = (Double) covariance(evaluator, memberList,
						calc1, calc2, biased);
