/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/ParenthesesFunDef.java#14 $
 ...
 * @since 3 March, 2002
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/ParenthesesFunDef.java#14
 *          $
 */
public class ParenthesesFunDef extends FunDefBase {
	...
	public ParenthesesFunDef(int argType) {
		super("()", "(<Expression>)",
				...
				Syntax.Parentheses, argType, new int[] { argType });
