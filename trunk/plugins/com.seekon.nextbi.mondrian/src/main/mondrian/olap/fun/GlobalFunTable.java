/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/GlobalFunTable.java#13 $
 ...
 * @author Gang Chen
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/GlobalFunTable.java#13 $
 */
public class GlobalFunTable extends FunTableImpl {
  ...
  public void defineFunctions(Builder builder) {
    ...
    for (Class<UserDefinedFunction> udfClass : lookupUdfImplClasses()) {
      defineUdf(builder, new UdfResolver.ClassUdfFactory(udfClass, null));
    }
  }

  private List<Class<UserDefinedFunction>> lookupUdfImplClasses() {
    final ServiceDiscovery<UserDefinedFunction> serviceDiscovery = ServiceDiscovery
      .forClass(UserDefinedFunction.class);
   ...
   *          Factory for UDF
   */
  private void defineUdf(Builder builder, UdfResolver.UdfFactory udfFactory) {
