/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jDriver.java#8 $
 ...
 * 
 * <p>
 * Then create a connection using a URL with the prefix "jdbc:mondrian:". For
 * example,
 * 
 ...
 * &nbsp;&nbsp;connection.unwrap(OlapConnection.class);</code> </blockquote>
 * 
 * <p>
 * Note how we use the {@link Connection#unwrap(Class)} method to down-cast the
 ...
 * 
 * <p>
 * Mondrian has a sole catalog, called "LOCALDB". You will get an error if you
 * attempt to use {@link java.sql.Connection#setCatalog(String)} to set it to
 * anything else.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jDriver.java#8
 *          $
 * @since May 22, 2007
 */
