/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/Factory.java#6 $
...
/**
 * Instantiates classes to implement the olap4j API against the Mondrian OLAP
 * engine.
 * 
 * <p>
 * There are implementations for JDBC 3.0 (which occurs in JDK 1.5) and JDBC 4.0
 * (which occurs in JDK 1.6).
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap4j/Factory.java#6 $
 * @since Jun 14, 2007
 */
interface Factory {
	/**
	 ...
	 *           on error
	 */
	Connection newConnection(MondrianOlap4jDriver driver, String url,
