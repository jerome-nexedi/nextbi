/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/FactoryJdbc4Impl.java#8 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap4j/FactoryJdbc4Impl.java#8 $
 * @since Jun 14, 2007
 */
class FactoryJdbc4Impl implements Factory {
	...
	private static class EmptyResultSetJdbc4 extends EmptyResultSet {
		EmptyResultSetJdbc4(MondrianOlap4jConnection olap4jConnection,
				List<String> headerList, List<List<Object>> rowList) {
	...
	private static class MondrianOlap4jConnectionJdbc4 extends
			MondrianOlap4jConnection implements OlapConnection {
		MondrianOlap4jConnectionJdbc4(Factory factory, MondrianOlap4jDriver driver,
	...
	private static class MondrianOlap4jCellSetJdbc4 extends MondrianOlap4jCellSet {
		public MondrianOlap4jCellSetJdbc4(MondrianOlap4jStatement olap4jStatement) {
	...
	private static class MondrianOlap4jPreparedStatementJdbc4 extends
	...
	private static class MondrianOlap4jDatabaseMetaDataJdbc4 extends
