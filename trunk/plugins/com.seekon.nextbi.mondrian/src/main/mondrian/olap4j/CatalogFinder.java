/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/CatalogFinder.java#2 $
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/olap4j/CatalogFinder.java#2 $
 * @author jhyde
 * @since 2010/11/12
 */
public interface CatalogFinder {
	 ...
	 * 
	 * @param connection
	 *          Connection to mondrian we want the catalog children.
	 * @return List of catalogs
	 */
	List<String> getCatalogNames(RolapConnection connection);

	/**
	 * Returns a list of (schema name, schema) pairs in a catalog of a particular
	 * name.
	 * 
	 * <p>
	 * The name of the schema may not be the same as the value returned by
	 * {@link mondrian.rolap.RolapSchema#getName()}. In fact, a given schema may
	 * occur multiple times in the same catalog with different names.
	 * 
	 * <p>
