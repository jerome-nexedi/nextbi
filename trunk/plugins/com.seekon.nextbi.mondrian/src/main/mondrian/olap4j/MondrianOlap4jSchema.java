...
/**
 * Implementation of {@link org.olap4j.metadata.Schema} for the Mondrian OLAP
 * engine.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jSchema.java#7
 *          $
 * @since May 24, 2007
 */
class MondrianOlap4jSchema implements Schema, Named {
	 ...
	 * 
	 * <p>
	 * The name of the schema is not necessarily the same as schema.getName(). If
	 * schema was loaded in a datasources.xml file, the name it was given there
	 * (in the &lt;Catalog&gt; element) trumps the name in the catalog.xml file.
	 * 
	 * @param olap4jCatalog
	 *          Catalog containing schema
	 * @param schemaName
	 *          Name of schema
	 * @param schema
	 *          Mondrian schema
	 */
	MondrianOlap4jSchema(MondrianOlap4jCatalog olap4jCatalog, String schemaName,
	...
	public NamedList<Cube> getCubes() throws OlapException {
		NamedList<MondrianOlap4jCube> list = new NamedListImpl<MondrianOlap4jCube>();
		final MondrianOlap4jConnection olap4jConnection = olap4jCatalog.olap4jDatabaseMetaData.olap4jConnection;
		for (mondrian.olap.Cube cube : olap4jConnection.getMondrianConnection()
	...
	public NamedList<Dimension> getSharedDimensions() throws OlapException {
		final MondrianOlap4jConnection olap4jConnection = olap4jCatalog.olap4jDatabaseMetaData.olap4jConnection;
		final SortedSet<MondrianOlap4jDimension> dimensions = new TreeSet<MondrianOlap4jDimension>(
				new Comparator<MondrianOlap4jDimension>() {
					public int compare(MondrianOlap4jDimension o1,
	...
	/**
	 * Shorthand for catalog.database.connection.getLocale(). Not part of the
	 * olap4j api; do not make public.
	 * 
