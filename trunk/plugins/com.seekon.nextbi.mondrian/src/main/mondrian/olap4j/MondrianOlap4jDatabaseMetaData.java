...
abstract class MondrianOlap4jDatabaseMetaData implements OlapDatabaseMetaData {
	...
	private ResultSet getMetadata(String methodName, Object... patternValues)
		...
		XmlaUtil.MetadataRowset rowset = XmlaUtil.getMetadataRowset(
				olap4jConnection, methodName, restrictionMap);
	...
	public ResultSet getSchemas() throws OlapException {
		...
		for (Catalog catalog : Util.sort(olap4jConnection.getOlapCatalogs(),
			...
			for (Schema schema : Util.sort(catalog.getSchemas(), SCHEMA_COMP)) {
				rowList
						.add(Arrays.<Object> asList(schema.getName(), catalog.getName()));
			}
		}
		return olap4jConnection.factory.newFixedResultSet(olap4jConnection,
				headerList, rowList);
	...
	public <T> T unwrap(Class<T> iface) throws SQLException {
		...
		throw olap4jConnection.helper.createException("does not implement '"
				+ iface + "'");
	}
	...
	public ResultSet getActions(String catalog, String schemaPattern,
		...
		return getMetadata("MDSCHEMA_ACTIONS", "SCHEMA_NAME",
	...
	public ResultSet getProperties(String catalog, String schemaPattern,
			...
			String memberUniqueName, String propertyNamePattern) throws OlapException {
		return getMetadata("MDSCHEMA_PROPERTIES", "CATALOG_NAME", catalog,
				...
				dimensionUniqueName, "HIERARCHY_UNIQUE_NAME", hierarchyUniqueName,
				"LEVEL_UNIQUE_NAME", levelUniqueName, "MEMBER_UNIQUE_NAME",
				memberUniqueName, "PROPERTY_NAME", wildcard(propertyNamePattern));
	}
	...
	public ResultSet getCubes(String catalog, String schemaPattern,
		...
		return getMetadata("MDSCHEMA_CUBES", "CATALOG_NAME", catalog,
				"SCHEMA_NAME", wildcard(schemaPattern), "CUBE_NAME",
				wildcard(cubeNamePattern));
	}
	...
	public ResultSet getHierarchies(String catalog, String schemaPattern,
		...
		return getMetadata("MDSCHEMA_HIERARCHIES", "CATALOG_NAME", catalog,
				"SCHEMA_NAME", wildcard(schemaPattern), "CUBE_NAME",
				wildcard(cubeNamePattern), "DIMENSION_UNIQUE_NAME",
				dimensionUniqueName, "HIERARCHY_NAME", wildcard(hierarchyNamePattern));
	}
	...
	public ResultSet getMeasures(String catalog, String schemaPattern,
		...
		return getMetadata("MDSCHEMA_MEASURES", "CATALOG_NAME", catalog,
				"SCHEMA_NAME", wildcard(schemaPattern), "CUBE_NAME",
				wildcard(cubeNamePattern), "MEASURE_NAME",
				wildcard(measureNamePattern), "MEASURE_UNIQUE_NAME", measureUniqueName);
	}

	public ResultSet getMembers(String catalog, String schemaPattern,
			String cubeNamePattern, String dimensionUniqueName,
			String hierarchyUniqueName, String levelUniqueName,
			String memberUniqueName, Set<Member.TreeOp> treeOps) throws OlapException {
		String treeOpString;
		if (treeOps != null) {
		...
		return getMetadata("MDSCHEMA_MEMBERS", "CATALOG_NAME", catalog,
				"SCHEMA_NAME", wildcard(schemaPattern), "CUBE_NAME",
				wildcard(cubeNamePattern), "DIMENSION_UNIQUE_NAME",
				dimensionUniqueName, "HIERARCHY_UNIQUE_NAME", hierarchyUniqueName,
				"LEVEL_UNIQUE_NAME", levelUniqueName, "MEMBER_UNIQUE_NAME",
				memberUniqueName, "TREE_OP", treeOpString);
	}

	public ResultSet getLevels(String catalog, String schemaPattern,
			String cubeNamePattern, String dimensionUniqueName,
			String hierarchyUniqueName, String levelNamePattern) throws OlapException {
		return getMetadata("MDSCHEMA_LEVELS", "CATALOG_NAME", catalog,
				"SCHEMA_NAME", wildcard(schemaPattern), "CUBE_NAME",
				wildcard(cubeNamePattern), "DIMENSION_UNIQUE_NAME",
				dimensionUniqueName, "HIERARCHY_UNIQUE_NAME", hierarchyUniqueName,
