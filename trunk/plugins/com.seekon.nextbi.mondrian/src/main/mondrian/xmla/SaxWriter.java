/*
// $Id: //open/mondrian/src/main/mondrian/xmla/SaxWriter.java#7 $
 ...
 * @author Gang Chen
 * @since 27 April, 2003
 * @version $Id: //open/mondrian/src/main/mondrian/xmla/SaxWriter.java#7 $
 */
public interface SaxWriter {
	...
	/**
	 * Sends a piece of text verbatim through the writer. It must be a piece of
	 * well-formed XML.
	 */
