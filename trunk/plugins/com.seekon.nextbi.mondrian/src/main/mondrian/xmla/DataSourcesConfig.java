...
/**
 * This is the XML model for XMLA DataSources Configuration. Revision is $Id:
 * //open/mondrian/src/main/mondrian/xmla/DataSourcesConfig.xml#6 $
 * <p>
 * This class was generated from XOM model 'datasourcesconfig' on Sun Apr 22
 * 18:24:21 CST 2012
 */
public class DataSourcesConfig {
	...
	public static String[] _elements = { "DataSources", "DataSource",
			"DataSourceName", "DataSourceDescription", "URL", "DataSourceInfo",
			"ProviderName", "ProviderType", "AuthenticationMode", "Definition",
			"Catalogs", "Catalog" };
	...
	public static class DataSources extends org.eigenbase.xom.ElementDef {
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayElementArrayDiff("dataSources", dataSources,
					_cother.dataSources, _out, _indent + 1);
			return _diff;
		}
	}
	...
	public static class DataSource extends org.eigenbase.xom.ElementDef {
		...
		/**
		 * ConnectString of Mondrian (minus the catalog entry). Required, but
		 * catalog may override.
		 */
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "catalogs", (org.eigenbase.xom.ElementDef) catalogs,
					_indent + 1);
		}
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayStringDiff("name", name, _cother.name, _out,
					_indent + 1);
			_diff = _diff
					&& displayStringDiff("description", description, _cother.description,
							_out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("url", url, _cother.url, _out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("dataSourceInfo", dataSourceInfo,
							_cother.dataSourceInfo, _out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("providerName", providerName,
							_cother.providerName, _out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("providerType", providerType,
							_cother.providerType, _out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("authenticationMode", authenticationMode,
							_cother.authenticationMode, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("catalogs", catalogs, _cother.catalogs, _out,
							_indent + 1);
			return _diff;
		}
	...
	public static class Catalogs extends org.eigenbase.xom.ElementDef {
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayElementArrayDiff("catalogs", catalogs,
					_cother.catalogs, _out, _indent + 1);
			return _diff;
		}
	}
	...
	public static class Catalog extends org.eigenbase.xom.ElementDef {
		...
		/**
		 * ConnectString of Mondrian (minus the catalog entry). This entry is
		 * optional; if present, it overrides the DataSourceInfo within the
		 * DataSource.
		 */
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayStringDiff("dataSourceInfo", dataSourceInfo,
							_cother.dataSourceInfo, _out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("definition", definition, _cother.definition,
							_out, _indent + 1);
			return _diff;
		}
	}
