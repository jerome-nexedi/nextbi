...
public class DataSourcesConfig {
  ...
  public static String[] _elements = { "DataSources", "DataSource",
    ...
    "ProviderName", "ProviderType", "AuthenticationMode", "Definition", "Catalogs",
    "Catalog" };
  ...
  public static class DataSource extends org.eigenbase.xom.ElementDef {
    ...
    public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
      ...
      boolean _diff = displayStringDiff("name", name, _cother.name, _out,
        _indent + 1);
      _diff = _diff
        && displayStringDiff("description", description, _cother.description, _out,
          _indent + 1);
      ...
      _diff = _diff
        && displayStringDiff("providerName", providerName, _cother.providerName,
          _out, _indent + 1);
      _diff = _diff
        && displayStringDiff("providerType", providerType, _cother.providerType,
          _out, _indent + 1);
      _diff = _diff
  ...
  public static class Catalog extends org.eigenbase.xom.ElementDef {
    ...
    public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
      _out.beginTag("Catalog", new org.eigenbase.xom.XMLAttrVector().add("name",
        name));
      displayXMLString(_out, "DataSourceInfo", dataSourceInfo);
    ...
    public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
      ...
      _diff = _diff
        && displayStringDiff("dataSourceInfo", dataSourceInfo,
          _cother.dataSourceInfo, _out, _indent + 1);
      _diff = _diff
        && displayStringDiff("definition", definition, _cother.definition, _out,
          _indent + 1);
      return _diff;
    }
  }
