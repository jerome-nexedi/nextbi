/*
// $Id: //open/mondrian/src/main/mondrian/xmla/XmlaException.java#8 $
 ...
 * corresponds to the SOAP Fault faultcode and the faultstring to the SOAP Fault
 * faultstring.
 * 
 * @author <a>Richard M. Emberson</a>
 * @version $Id: //open/mondrian/src/main/mondrian/xmla/XmlaException.java#8 $
 */
public class XmlaException extends MondrianException {
	...
	public static String formatFaultCode(String faultCode, String code) {
		return formatFaultCode(XmlaConstants.SOAP_PREFIX, faultCode, code);
	}

	public static String formatFaultCode(String nsPrefix, String faultCode,
			String code) {
