/*
// $Id: //open/mondrian/src/main/mondrian/util/SpatialValueTree.java#3 $
 ...
 * 
 * <p>
 * You can think of a SpatialValueTree as a multi dimensional list where
 ...
 * 
 * <p>
 * When evaluating a region, if a dimension is omitted form a region, this means
 * that the region doesn't overlap the dimension at all. It is not the same as
 * covering all the values of the dimension axis.
 * 
 * <p>
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/util/SpatialValueTree.java#3
 *          $
 * @param <K>
