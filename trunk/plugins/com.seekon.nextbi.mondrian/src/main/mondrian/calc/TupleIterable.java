/*
// $Id: //open/mondrian/src/main/mondrian/calc/TupleIterable.java#1 $
 ...
 * 
 * <p>
 * If efficiency is important, call {@link #tupleCursor()} rather than
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/calc/TupleIterable.java#1 $
 * @author jhyde
 */
public interface TupleIterable extends Iterable<List<Member>> {
   ...
   * 
   * <p>
   * Always has the same effect as calling {@link #iterator()}.
   * 
   * @see #tupleCursor()
   * 
   ...
   * {@link #tupleIterator()}. Because {@link TupleCursor} is a simpler API to
   * implement than {@link TupleIterator}, in some cases the implementation may
   * be more efficient.
   * 
   * @return cursor over the tuples returned by this iterable
   */
   ...
   * 
   * <p>
   * If this {@code TupleIterable} happens to be a {@link TupleList}, the method
   * is overridden to return a {@link List}&lt;{@link Member}&gt;.
   * 
   * @param column
