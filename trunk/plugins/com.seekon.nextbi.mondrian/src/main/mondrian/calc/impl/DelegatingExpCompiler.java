/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/DelegatingExpCompiler.java#14 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/DelegatingExpCompiler
 *          .java#14 $
 * @since Jan 2, 2006
 */
public class DelegatingExpCompiler implements ExpCompiler {
	 ...
	 * @param calc
	 *          Calculator created by compiler
	 * @param mutable
	...
	/**
	 * Wrapping an expression ensures that when it is visited, it calls back to
	 * this compiler rather than our parent (wrapped) compiler.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * If we didn't do this, the decorator would get forgotten at the first level
	 * of recursion. It's not pretty, and I thought about other ways of combining
	 * Visitor + Decorator. For instance, I tried replacing
	 * {@link #afterCompile(mondrian.olap.Exp, mondrian.calc.Calc, boolean)} with
	 * a callback (Strategy), but the exit points in ExpCompiler not clear because
