/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/AbstractTupleCalc.java#4 $
 ...
 * {@link #evaluateTuple(mondrian.olap.Evaluator)} method, and the
 * {@link #evaluate(mondrian.olap.Evaluator)} method will call it.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/AbstractTupleCalc.java#4
 *          $
 * @since Sep 27, 2005
 */
