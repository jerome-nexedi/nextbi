/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/AbstractDoubleCalc.java#4 $
 ...
 * {@link #evaluateDouble(mondrian.olap.Evaluator)} method, and the
 * {@link #evaluate(mondrian.olap.Evaluator)} method will call it.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/AbstractDoubleCalc.java
 *          #4 $
 * @since Sep 27, 2005
 */
public abstract class AbstractDoubleCalc extends AbstractCalc implements
		DoubleCalc {
	/**
