/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/AbstractStringCalc.java#4 $
 ...
 * {@link #evaluateString(mondrian.olap.Evaluator)} method, and the
 * {@link #evaluate(mondrian.olap.Evaluator)} method will call it.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/AbstractStringCalc.java
 *          #4 $
 * @since Sep 26, 2005
 */
