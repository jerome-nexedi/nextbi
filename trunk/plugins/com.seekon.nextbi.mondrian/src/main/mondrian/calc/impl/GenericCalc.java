/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/GenericCalc.java#16 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/calc/impl/GenericCalc.java#16
 *          $
 * @since Sep 26, 2005
 */
public abstract class GenericCalc extends AbstractCalc implements TupleCalc,
  ...
  public static double numberToDouble(Number number) {
    return number == null ? FunUtil.DoubleNull : number.doubleValue();
  }
  ...
  private enum TypeEnum {
    NULL, BOOLEAN, STRING, NUMERIC, DATETIME, MEMBER, LEVEL, HIERARCHY, DIMENSION
  }
}
