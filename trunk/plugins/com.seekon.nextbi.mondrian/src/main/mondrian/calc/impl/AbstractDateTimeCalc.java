/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/AbstractDateTimeCalc.java#3 $
 ...
 * {@link #evaluateDateTime(mondrian.olap.Evaluator)} method, and the
 * {@link #evaluate(mondrian.olap.Evaluator)} method will call it.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/AbstractDateTimeCalc
 *          .java#3 $
 * @since Sep 26, 2005
 */
