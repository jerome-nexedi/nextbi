/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/ArrayTupleList.java#2 $
 ...
 * 
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/ArrayTupleList.java#2 $
 * @author jhyde
 */
public class ArrayTupleList extends AbstractEndToEndTupleList {
	...
	public boolean addAll(int index, Collection<? extends List<Member>> c) {
		...
		int n = index * arity;
		System.arraycopy(objectData, n, objectData, n + size1 * arity, size * arity
				- n);
