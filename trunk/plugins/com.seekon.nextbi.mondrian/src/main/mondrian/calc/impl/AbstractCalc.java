/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/AbstractCalc.java#18 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/AbstractCalc.java#18 $
 * @since Sep 27, 2005
 */
public abstract class AbstractCalc implements Calc {
	 ...
	 * 
	 * <p>
	 * The default implementation tries to extract a name from a function call, if
	 * any, then prints the last part of the class name.
	 */
	 ...
	 * 
	 * <p>
	 * Examples: lastSegment("com.acme.Foo") = "Foo"
	 * lastSegment("com.acme.Foo$Bar") = "Bar" lastSegment("com.acme.Foo$1") = "1"
	 * 
	 * @param clazz
	 *          Class
	...
	/**
	 * Returns true if calc[0] depends on dimension, else false if calc[0] returns
	 * dimension, else true if any of the other calcs depend on dimension.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * The default implementation returns name, class, type, resultStyle. A
	 * subclass must call super, but may add other arguments.
	 * 
	 * @param arguments
	...
	public static Evaluator simplifyEvaluator(Calc calc, Evaluator evaluator) {
		...
		final List<RolapHierarchy> hierarchies = ((RolapEvaluator) evaluator)
		...
		for (RolapHierarchy hierarchy : hierarchies) {
			...
			final Member unconstrainedMember = member.getHierarchy()
					.getDefaultMember();
