...
/**
 * <code>RolapCubeUsages</code> This provides us with the base cubes that a
 * virtual cube uses and specifies if unrelated dimensions to measures from
 * these cubes should be ignored.
 * 
 * @author ajoglekar
 * @since Nov 22 2007
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/RolapCubeUsages.java#6
 *          $
 */
