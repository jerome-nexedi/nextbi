/*
 // $Id: //open/mondrian/src/main/mondrian/rolap/RolapDimension.java#40 $
 ...
 * 
 * <p>
 * Furthermore, since members are created by a {@link MemberReader}which belongs
 * to the {@link RolapHierarchy}, you will the members will be the same too. For
 * example, if you query <code>[Product].[Beer]</code> from the
 * <code>Sales</code> and <code>Warehouse</code> cubes, you will get the same
 * {@link RolapMember}object. ({@link RolapSchema#mapSharedHierarchyToReader}
 * holds the mapping. I don't know whether it's still necessary.)
 * 
 * @author jhyde
 * @since 10 August, 2001
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/RolapDimension.java#40
 *          $
 */
