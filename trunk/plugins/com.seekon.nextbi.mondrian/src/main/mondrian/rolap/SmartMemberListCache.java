/*
// $Id: //open/mondrian/src/main/mondrian/rolap/SmartMemberListCache.java#10 $
 ...
 * 
 * <p>
 * The first set, <em>all</em> customers are computed, in the second only those,
 * who have bought Product#1 in Store#14. We want to put both results into the
 * cache. Then the key for the cache entry is the Level that the members belong
 * to <em>plus</em> the costraint that restricted the amount of members fetched.
 * For Level.Members the key consists of the Level and the cacheKey of the
 ...
 * @since Nov 21, 2005
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/SmartMemberListCache.java#10
 *          $
 */
