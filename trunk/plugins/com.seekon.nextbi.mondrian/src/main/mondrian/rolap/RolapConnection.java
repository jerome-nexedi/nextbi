...
public class RolapConnection extends ConnectionBase {
  ...
  RolapConnection(MondrianServer server, Util.PropertyList connectInfo,
    ...
    String provider = connectInfo.get(RolapConnectionProperties.Provider.name(),
      "mondrian");
  ...
  static DataSource createDataSource(DataSource dataSource,
    ...
    if (dataSource != null) {
      ...
      final boolean poolNeeded = connectInfo.get(
        RolapConnectionProperties.PoolNeeded.name(), "false").equalsIgnoreCase(
        "true");
      ...
      if (poolNeeded) {
        dataSource = RolapConnectionPool.instance().getDataSourcePoolingDataSource(
      ...
      throw Util.newInternal("Connect string '" + connectInfo.toString()
        + "' must contain either '" + RolapConnectionProperties.Jdbc + "' or '"
  ...
  public Result execute(final Execution execution) {
    return RolapResultShepherd.shepherdExecution(execution, new Callable<Result>() {
  ...
  private static class DriverManagerDataSource implements DataSource {
    ...
    public Connection getConnection() throws SQLException {
      return new org.apache.commons.dbcp.DelegatingConnection(java.sql.DriverManager
        .getConnection(jdbcConnectString, jdbcProperties));
    }

    public Connection getConnection(String username, String password)
      throws SQLException {
      if (jdbcProperties == null) {
        return java.sql.DriverManager.getConnection(jdbcConnectString, username,
          password);
      } else {
