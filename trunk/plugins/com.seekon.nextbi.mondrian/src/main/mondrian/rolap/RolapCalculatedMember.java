/*
// $Id: //open/mondrian/src/main/mondrian/rolap/RolapCalculatedMember.java#34 $
...
/**
 * A <code>RolapCalculatedMember</code> is a member based upon a {@link Formula}
 * .
 * 
 * <p>
 ...
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/RolapCalculatedMember.java
 *          #34 $
 */
public class RolapCalculatedMember extends RolapMemberBase {
	 ...
	 *          Formula
	 */
	RolapCalculatedMember(RolapMember parentMember, RolapLevel level,
	...
	public Object getPropertyValue(String propertyName, boolean matchCase) {
		if (Util.equal(propertyName, Property.FORMULA.name, matchCase)) {
			return formula;
		} else if (Util.equal(propertyName, Property.CHILDREN_CARDINALITY.name,
				matchCase)) {
	...
	public boolean isCalculatedInQuery() {
		final String memberScope = (String) getPropertyValue(Property.MEMBER_SCOPE.name);
