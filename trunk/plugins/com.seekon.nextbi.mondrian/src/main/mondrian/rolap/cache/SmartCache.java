 ...
 * 
 * <p>
 * This interface implements the {@link Iterable}. The {@link #iterator()}
 * method returns an iterator over all entries in the cache. The iterator is
 * mutable.
 * 
 * @author av
 * @since Nov 21, 2005
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/cache/SmartCache.java#8
 *          $
 */
