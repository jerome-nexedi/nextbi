/*
// $Id: //open/mondrian/src/main/mondrian/rolap/RolapTupleCalculation.java#4 $
...
/**
 * Implementation of {@link mondrian.rolap.RolapCalculation} that changes one or
 * more dimensions, then evaluates a given calculation.
 * 
 * <p>
 * It is used to implement sets in slicers, in particular sets of tuples in the
 * slicer.
 * 
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/RolapTupleCalculation.java#4
 *          $
 * @author jhyde
 * @since May 15, 2009
 */
