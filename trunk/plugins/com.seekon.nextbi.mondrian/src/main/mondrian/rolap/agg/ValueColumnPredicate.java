/*
// $Id: //open/mondrian/src/main/mondrian/rolap/agg/ValueColumnPredicate.java#10 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/agg/ValueColumnPredicate
 *          .java#10 $
 * @since Nov 2, 2006
 */
public class ValueColumnPredicate extends AbstractColumnPredicate implements
  Comparable {
  ...
  public int compareTo(Object o) {
    ...
    int columnBitKeyComp = getConstrainedColumnBitKey().compareTo(
  ...
  public void toInListSql(SqlQuery sqlQuery, StringBuilder buf) {
    sqlQuery.getDialect().quote(buf, value, getConstrainedColumn().getDatatype());
  }
}
