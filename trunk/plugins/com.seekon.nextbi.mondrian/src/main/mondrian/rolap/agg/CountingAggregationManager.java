/*
// $Id: //open/mondrian/src/main/mondrian/rolap/agg/CountingAggregationManager.java#4 $
...
/**
 * This class adds to {@link AggregationManager} counters for aggregation cache
 * hit and miss. It should only be used for testing purpose due to potential
 * performance regression by the introduction of synchronized blocks.
 * 
 * @author Khanh Vu
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/agg/CountingAggregationManager
 *          .java#4 $
 */
