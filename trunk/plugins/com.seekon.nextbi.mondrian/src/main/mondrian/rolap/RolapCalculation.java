/*
// $Id: //open/mondrian/src/main/mondrian/rolap/RolapCalculation.java#4 $
...
/**
 * Entry in the evaluation context that indicates a calculation that needs to be
 * performed before we get to the atomic stored cells.
 * 
 * <p>
 * Most of the time it's just members that are calculated, but calculated tuples
 * arise when the slicer is a set of tuples.
 * 
 * <p>
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/RolapCalculation.java#4
 *          $
 * @author jhyde
 * @since May 15, 2009
 */
