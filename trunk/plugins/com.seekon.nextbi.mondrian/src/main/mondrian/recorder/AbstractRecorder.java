/*
// $Id: //open/mondrian/src/main/mondrian/recorder/AbstractRecorder.java#12 $
 ...
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/recorder/AbstractRecorder.java#12
 *          $
 */
public abstract class AbstractRecorder implements MessageRecorder {
   ...
   */
  public static void logMessage(final String context, final String msg,
    final MsgType msgType, final org.apache.log4j.Logger logger) {
    ...
    case ERROR:
      ...
      break;
    default:
      logger.warn("Unknown message type enum \"" + msgType + "\" for message: "
        + buf.toString());
    }
  }
  ...
  public void throwRTException() throws RecorderException {
    if (hasErrors()) {
      final String errorMsg = MondrianResource.instance().ForceMessageRecorderError
        .str(getContext(), errorMsgCount);
  ...
  public void reportError(final String msg, final Object info)
    ...
    if (errorMsgCount >= errorMsgLimit) {
      final String errorMsg = MondrianResource.instance().TooManyMessageRecorderErrors
        .str(getContext(), errorMsgCount);
      throw new RecorderException(errorMsg);
    }
  }
   ...
   * @param info
   *          the information Object which might be null.
   * @param msgType
   *          one of the message type enum values
   */
  protected abstract void recordMessage(String msg, Object info, MsgType msgType);
}
