 ...
 * 
 * <p>
 * Every function defined in {@link Vba} must have a test here. In addition,
 * there should be MDX tests (usually in {@link mondrian.olap.fun.FunctionTest})
 * if handling of argument types, result types, operator overloading, exception
 * handling or null handling are non-trivial.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/olap/fun/vba/VbaTest.java#14 $
 * @since Dec 31, 2007
 */
public class VbaTest extends TestCase {
  ...
  private static final boolean isPST = timeZoneName.equals("America/Los_Angeles")
  ...
  private void assertMessage(RuntimeException e, final String expected) {
    ...
    assertTrue("expected message to contain '" + expected + "', got '" + message
  ...
  public void testCDate() throws ParseException {
    ...
    // CInt rounds to the nearest even number
    try {
      assertEquals(DateFormat.getDateInstance().parse("Jan 12, 1952"), Vba
        .cDate("Jan 12, 1952"));
      assertEquals(DateFormat.getDateInstance().parse("October 19, 1962"), Vba
        .cDate("October 19, 1962"));
      assertEquals(DateFormat.getTimeInstance().parse("4:35:47 PM"), Vba
        .cDate("4:35:47 PM"));
      assertEquals(DateFormat.getDateTimeInstance().parse(
        "October 19, 1962 4:35:47 PM"), Vba.cDate("October 19, 1962 4:35:47 PM"));
  ...
  public void testDateAdd() {
    ...
    final Date sampleDatePlusTwoPointFiveYears = Vba.dateAdd("yyyy", 2.5,
      SAMPLE_DATE);
    if (isPST) {
      ...
      assertTrue("Got " + dateString, dateString.equals("2010/10/24 06:40:45")
  ...
  public void testInStr() {
    ...
    assertEquals(32, Vba.inStr(16, "the quick brown fox jumps over the lazy dog",
      "the"));
    assertEquals(0, Vba.inStr(16, "the quick brown fox jumps over the lazy dog",
      "cat"));
    assertEquals(0, Vba.inStr(1, "the quick brown fox jumps over the lazy dog",
      "cat"));
  ...
  public void testMid() {
    ...
    if (Bug.Ssas2005Compatible) {
      ...
      try {
        ...
        assertMessage(e, "Invalid parameter. Start parameter of Mid function must "
          + "be positive");
      }
      // Start<0 illegal
      try {
    ...
    if (Bug.Ssas2005Compatible) {
      ...
      try {
        ...
        assertMessage(e, "Invalid parameter. Length parameter of Mid function must "
          + "be non-negative");
      }
    }
  }
