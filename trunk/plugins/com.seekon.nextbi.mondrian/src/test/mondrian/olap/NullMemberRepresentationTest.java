/*
// $Id: //open/mondrian/testsrc/main/mondrian/olap/NullMemberRepresentationTest.java#10 $
...
/**
 * <code>NullMemberRepresentationTest</code> tests the null member custom
 * representation feature supported via
 * {@link mondrian.olap.MondrianProperties#NullMemberRepresentation} property.
 * 
 * @author ajogleka
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/olap/NullMemberRepresentationTest
 *          .java#10 $
 */
public class NullMemberRepresentationTest extends FoodMartTestCase {
  ...
  public void testItemMemberWithCustomNullMemberRepresentation() throws IOException {
    assertExprReturns("[Time].[1997].Children.Item(6).UniqueName", "[Time].["
      + getNullMemberRepresentation() + "]");
    assertExprReturns("[Time].[1997].Children.Item(-1).UniqueName", "[Time].["
      + getNullMemberRepresentation() + "]");
  }

  public void testNullMemberWithCustomRepresentation() throws IOException {
    assertExprReturns("[Gender].[All Gender].Parent.UniqueName", "[Gender].["
      + getNullMemberRepresentation() + "]");
