/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/comp/ResultComparatorTest.java#18 $
 ...
 * 
 * <p>
 * The file consists of an MDX statement and the expected result. The executes
 * the MDX statement and fails if the actual result does not match the expected
 * result.
 * 
 * <p>
 * Here is a typical XML file: <blockquote>&lt;mdbTest&gt;<br/>
 * &lt;mdxQuery&gt;<br/>
 ...
 * &lt;member&gt;[Product].[All Products]&lt;/member&gt;<br/>
 * &lt;member&gt;[Store].[All Stores]&lt;/member&gt;<br/>
 * &lt;member&gt;[Store Size in SQFT].[All Store Size in SQFTs]&lt;/member&gt;<br/>
 * &lt;member&gt;[Store Type].[All Store Types]&lt;/member&gt;<br/>
 * &lt;member&gt;[Promotions].[All Promotions]&lt;/member&gt;<br/>
 * &lt;member&gt;[Education Level].[All Education Levels]&lt;/member&gt;<br/>
 * &lt;member&gt;[Marital Status].[All Marital Status]&lt;/member&gt;<br/>
 * &lt;member&gt;[Yearly Income].[All Yearly Incomes]&lt;/member&gt;<br/>
 * &lt;member&gt;[Promotion Media].[All Media]&lt;/member&gt;<br/>
 ...
 * &lt;tuples&gt;<br/>
 * &lt;tuple&gt;<br/>
 * &lt;member&gt;[Customers].[Hierarchy Name]&lt;/member&gt;<br/>
 * &lt;/tuple&gt;<br/>
 * &lt;/tuples&gt;<br/>
 * &lt;/columns&gt;<br/>
 * &lt;data&gt;<br/>
...
public class ResultComparatorTest extends FoodMartTestCase {
  ...
  protected void runTest() throws Exception {
    ...
    Element expectedResult = (Element) doc.getElementsByTagName("dataResult")
      .item(0);
  ...
  public static TestSuite suite() {
    ...
    final Pattern pattern = filePattern == null ? null : Pattern
      .compile(filePattern);
    final String directory = fileDirectory == null ? "testsrc" + File.separatorChar
      + "queryFiles" : fileDirectory;
