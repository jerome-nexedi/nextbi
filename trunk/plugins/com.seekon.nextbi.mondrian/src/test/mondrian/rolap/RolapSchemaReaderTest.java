/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/RolapSchemaReaderTest.java#21 $
 ...
 * 
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/rolap/RolapSchemaReaderTest
 *          .java#21 $
 */
public class RolapSchemaReaderTest extends FoodMartTestCase {
  ...
  public void testGetCubesWithNoHrCubes() {
    String[] expectedCubes = new String[] { "Sales", "Warehouse",
      "Warehouse and Sales", "Store", "Sales Ragged", "Sales 2" };
  ...
  public void testGetCubesWithNoRole() {
    String[] expectedCubes = new String[] { "Sales", "Warehouse",
      "Warehouse and Sales", "Store", "Sales Ragged", "Sales 2", "HR" };
   ...
   * <p>
   * Test case for bug <a
   * href="http://jira.pentaho.com/browse/MONDRIAN-691">MONDRIAN-691,
  ...
  public void testGetCubeDimensions() {
    ...
    final String timeTime = TestContext.hierarchyName("Time", "Time");
    final TestContext testContext = TestContext.instance().create(
      ...
      "<Role name=\"REG1\">\n" + "  <SchemaGrant access=\"none\">\n"
        ...
        + "      <HierarchyGrant hierarchy=\"" + timeTime + "\" access=\"none\"/>\n"
        + "      <HierarchyGrant hierarchy=\"" + timeWeekly
        + "\" access=\"all\"/>\n" + "    </CubeGrant>\n" + "  </SchemaGrant>\n"
        + "</Role>").withRole("REG1");
    ...
    try {
      ...
      final Map<String, Dimension> dimensions = new HashMap<String, Dimension>();
