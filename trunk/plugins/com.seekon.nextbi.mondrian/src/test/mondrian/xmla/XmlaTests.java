/*
// $Id: //open/mondrian/testsrc/main/mondrian/xmla/XmlaTests.java#8 $
 ...
 * @since Jul 12 2007
 * @version $Id: //open/mondrian/testsrc/main/mondrian/xmla/XmlaTests.java#8 $
 */
...
public class XmlaTests extends FoodMartTestCase {
  ...
  public void testXmlaHandlerValueInfo() throws Exception {
    ...
    doXmlaHandlerValueInfo(dataType, inputValue, valueType, value, isDecimal);
    doXmlaHandlerValueInfo(null, inputValue, valueType, value, isDecimal);
    ...
    isDecimal = false;
    doXmlaHandlerValueInfo(dataType, inputValue, valueType, value, isDecimal);
    valueType = (Util.Retrowoven) ? XmlaHandler.XSD_DOUBLE : XmlaHandler.XSD_DECIMAL;
    value = (Util.Retrowoven) ? Double.valueOf("-9.223372036854776E18") : inputValue;
    isDecimal = true;
    doXmlaHandlerValueInfo(null, inputValue, valueType, value, isDecimal);
    ...
    /*
     * does not work - BigDecimal converts double 4.9E-323 to
     * 4.940656458412465E-323 // MIN_VALUE = 4.9e-324 // slightly larger
     * dataType = "Numeric"; inputValue = new BigDecimal("4.9e-323");
     * //MathContext.DECIMAL32); //MathContext.DECIMAL64); valueType =
     * XmlaHandler.XSD_DOUBLE; value = Double.valueOf("4.9e-323");
     * System.out.println("    value=" +value); isDecimal = true;
     * doXmlaHandlerValueInfo(dataType, inputValue, valueType, value,
     * isDecimal);
     */
  ...
  protected void doXmlaHandlerValueInfo(final String dataType,
    final Object inputValue, final String valueType, final Object value,
    final boolean isDecimal) throws Exception {
