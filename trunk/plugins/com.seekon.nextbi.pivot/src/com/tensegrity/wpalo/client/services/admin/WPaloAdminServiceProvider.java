...
/**
 * <code>WPaloAdminServiceProvider</code> TODO DOCUMENT ME
 * 
 * @version $Id: WPaloAdminServiceProvider.java,v 1.14 2010/01/13 08:02:41
 *          PhilippBouillon Exp $
 **/
public class WPaloAdminServiceProvider implements WPaloAdminServiceAsync {
  ...
  public final void getAccounts(String sessionId, XUser user,
    AsyncCallback<XAccount[]> callback) {
    proxy.getAccounts(sessionId, user, callback);
  }

  public final void getConnections(String sessionId, XUser user,
    AsyncCallback<XConnection[]> callback) {
    proxy.getConnections(sessionId, user, callback);
  }

  public final void getGroups(String sessionId, XUser user,
    AsyncCallback<XGroup[]> callback) {
  ...
  public final void getRoles(String sessionId, XUser user,
    AsyncCallback<XRole[]> callback) {
  ...
  public final void delete(String sessionId, XObject obj,
    AsyncCallback<Void> callback) {
    proxy.delete(sessionId, obj, callback);
  }

  public final void saveXObject(String sessionId, XObject obj,
    AsyncCallback<XObject> callback) {
  ...
  public void hasAccount(String sessionId, XConnection con,
    AsyncCallback<Boolean> callback) {
