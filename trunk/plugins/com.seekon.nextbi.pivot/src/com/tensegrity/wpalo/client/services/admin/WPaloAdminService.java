...
public interface WPaloAdminService extends RemoteService {
  ...
  public XGroup[] getGroups(String sessionId, XUser user)
  ...
  public XAccount[] getAccounts(String sessionId, XUser user)
    throws SessionExpiredException;

  public XAccount[] listAccounts(String sessionId, XUser user)
    throws SessionExpiredException;

  public XConnection[] getConnections(String sessionId, XUser user)
    throws SessionExpiredException;

  public void delete(String sessionId, XObject xOb)
    throws DbOperationFailedException, SessionExpiredException;

  public String[] mayDelete(String sessionId, XObject xObj)
    throws SessionExpiredException;

  public XObject saveXObject(String sessionId, XObject xObj)
    throws DbOperationFailedException, SessionExpiredException;

  public Boolean[] hasRoles(String sessionId, XUser user, String[] roles)
    throws SessionExpiredException;
  ...
  public XDatabase[] getDatabases(String sessionId, XConnection con)
    throws SessionExpiredException, DbOperationFailedException;

  public XCube[] getCubes(String sessionId, XConnection con, XDatabase db)
    throws SessionExpiredException;
}
