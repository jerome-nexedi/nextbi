...
/**
 * <code>ViewBrowserController</code> TODO DOCUMENT ME
 * 
 * @version $Id: ViewBrowserController.java,v 1.20 2010/02/12 13:49:50
 *          PhilippBouillon Exp $
 **/
public class ViewBrowserController extends Controller {
  ...
  public ViewBrowserController() {
    ...
    registerEventTypes(WPaloEvent.INIT, WPaloEvent.LOGOUT,
      WPaloEvent.EXPANDED_VIEWBROWSER_SECTION, WPaloEvent.EDIT_VIEWBROWSER_VIEW,
      WPaloEvent.SHOW_VIEWBROWSER_VIEW, WPaloEvent.DELETED_VIEWBROWSER_VIEW,
      WPaloEvent.RENAMED_VIEWBROWSER_VIEW, WPaloEvent.WILL_DELETE_VIEWBROWSER_VIEW,
      WPaloEvent.DELETED_ITEM, WPaloEvent.VIEW_LOADED);
  }
  ...
  private final void loadNextView() {
    if (!viewsToLoad.isEmpty()) {
      ...
      DisplayFlags.setDisplayFlagsFor(xView,
        ((Workbench) Registry.get(Workbench.ID)).getUser(), xView.getDisplayFlags(),
        null);
