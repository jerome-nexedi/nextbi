...
/**
 * <code>AdminController</code> TODO DOCUMENT ME
 * 
 * @version $Id: AdminController.java,v 1.20 2010/02/12 13:49:50 PhilippBouillon
 *          Exp $
 **/
public class AdminController extends Controller implements WPaloEvent {
  ...
  public AdminController() {
    ...
    registerEventTypes(SELECTED_GROUPS, SELECTED_ROLES, SELECTED_USERS,
      EDIT_GROUP_ITEM, EDIT_ROLE_ITEM, EDIT_USER_ITEM, EXPANDED_ADMIN_SECTION,
      ADD_GROUP_ITEM, ADD_ROLE_ITEM, ADD_USER_ITEM, SAVED_USER_ITEM,
      SAVED_GROUP_ITEM, SAVED_ROLE_ITEM, DELETED_ITEM);
  }
