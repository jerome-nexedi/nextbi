...
/**
 * <code>ConnectionEditor</code> TODO DOCUMENT ME
 * 
 * @version $Id: ConnectionEditor.java,v 1.21 2010/04/15 09:55:22
 *          PhilippBouillon Exp $
 **/
public class ConnectionEditor extends AbstractTabEditor {
  ...
  public final EditorTab[] getEditorTabs() {
    return new EditorTab[] { new ConnectionPropertiesTab(this),
...
class ConnectionServerTab extends EditorTab {
  ...
  private final ContentPanel createServerPropsPanel() {
    ...
    selectionListener = new SelectionChangedListener<XConnectionType>() {
      public void selectionChanged(SelectionChangedEvent<XConnectionType> se) {
        XConnectionType type = se.getSelectedItem();
        if (type == null) {
          if (input != null
            && (input.getType() == null || input.getType().isEmpty())) {
            return;
          }
        } else {
