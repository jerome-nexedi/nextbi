...
public interface WPaloServiceAsync {
  void loadHierarchyTree(String sessionId, String hierarchyId, String viewId,
    String axisId, int level, AsyncCallback<List<TreeNode>> cb);

  void loadAccounts(String sessionId, AsyncCallback<XAccount[]> cb);

  void loadPaloSuiteAccounts(String sessionId, String link,
    AsyncCallback<XAccount[]> cb);

  void loadChildren(String sessionId, TreeNode parent,
    AsyncCallback<List<TreeNode>> cb);

  void loadChildren(String sessionId, String parentType, String viewId,
  ...
  void createStaticFolder(String name, XObject parent, XUser user,
    AsyncCallback<XStaticReportFolder> cb);

  void createDynamicFolder(String name, XObject parent, XUser user,
    AsyncCallback<XDynamicReportFolder> cb);

  void addReceivers(XReportFolder parent, XObject[] receivers, XUser user,
    AsyncCallback<XReport[]> cb);

  void deleteElementTreeNodes(List<XObject> objects, XUser user,
    AsyncCallback<Boolean> cb);

  void deleteReportTreeNodes(List<XObject> objects, XUser user,
    AsyncCallback<Boolean> cb);

  void assignSubsetOrDimension(XDynamicReportFolder folder, XObject subdim,
  ...
  void applyMapping(XReport input, XObject[] keys, String[] values, XUser user,
    AsyncCallback<Boolean> cb);

  void openViewAfterLogin(String locale, String sessionId, String link,
    AsyncCallback<XDirectLinkData> cb);

  void openViewDirectly(String locale, String link, AsyncCallback<XDirectLinkData> cb);

  void openPaloSuiteView(String locale, String link,
    AsyncCallback<XDirectLinkData> cb);
}
