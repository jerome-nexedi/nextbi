...
/**
 * <code>AccountComboBox</code> TODO DOCUMENT ME
 * 
 * @version $Id: AccountComboBox.java,v 1.3 2010/02/12 13:49:50 PhilippBouillon
 *          Exp $
 **/
public class AccountComboBox {
  ...
  public final void setInput(XAccount[] xAccounts) {
    ...
    for (XAccount xAccount : xAccounts) {
      ...
      accModel.set("name", xAccount.getName() + constants.on()
        + xAccount.getConnection().getName());
  ...
  private final void initEventHandling() {
    // accounts.addSelectionChangedListener(new
    // SelectionChangedListener<XObjectModel>() {
