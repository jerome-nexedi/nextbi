...
/**
 * <code>WPaloCubeViewServiceProvider</code> TODO DOCUMENT ME
 * 
 * @version $Id: WPaloCubeViewServiceProvider.java,v 1.56 2010/04/12 11:13:36
 *          PhilippBouillon Exp $
 **/
public class WPaloCubeViewServiceProvider implements WPaloCubeViewServiceAsync {
  ...
  // if (hier.getVisibleElements() != null && hier.getVisibleElements().length >
  // 0) {
  // return true;
  // }
  // if (hier.getOldVisibleElements() != null &&
  // hier.getOldVisibleElements().length > 0) {
  // return true;
  // }
  // }
  // return false;
  ...
  // if (result) {
  // Window.alert("Warning: Serializing local filter in " + function +
  // ". Speed can be improved here!");
  // }
  // }
  ...
  public final void willExpand(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<XLoadInfo> cb) {
    proxy.willExpand(sessionId, item, viewId, axisId, cb);
  }

  public void proceedExpand(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<XDelta> cb) {
  ...
  public void cancelExpand(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<Void> cb) {
    proxy.cancelExpand(sessionId, item, viewId, axisId, cb);
  }

  public final void willCollapse(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<XLoadInfo> cb) {
  ...
  public void willSetExpandState(String sessionId, XAxisItem[] expanded,
    XAxisItem[] collapsed, int expandDepth, String viewId, String axisId,
    AsyncCallback<XLoadInfo> cb) {
    proxy.willSetExpandState(sessionId, expanded, collapsed, expandDepth, viewId,
      axisId, cb);
  }

  public void proceedSetExpandState(String sessionId, String viewId,
  ...
  public void collapse(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<Void> cb) {
  ...
  public final void saveView(String sessionId, XViewModel view,
    AsyncCallback<XViewModel> cb) {
    // checkFilter(view, "saveView");
    proxy.saveView(sessionId, view, cb);
  }

  public final void saveViewAs(String sessionId, String name, XViewModel view,
    AsyncCallback<XView> cb) {
  ...
  public void checkPermission(String sessionId, String viewId, int right,
  ...
  public void proceedChangeSelectedElement(String sessionId, XViewModel viewModel,
    XAxisHierarchy axisHierarchy, XElement selectedElement,
    AsyncCallback<XViewModel> cb) {
    // checkFilter(viewModel, "proceedChangeSelectedElement");
    proxy.proceedChangeSelectedElement(sessionId, viewModel, axisHierarchy,
      selectedElement, cb);
  }
  ...
  public void proceedReload(String sessionId, XViewModel viewModel,
    AsyncCallback<XViewModel> cb) {
  ...
  public void willReload(String sessionId, XViewModel viewModel,
    AsyncCallback<XLoadInfo> cb) {
  ...
  public void cancelUpdateView(String sessionId, XViewModel viewModel,
    AsyncCallback<XViewModel> cb) {
  ...
  public void willUpdateView(String sessionId, XViewModel viewModel,
    AsyncCallback<XLoadInfo> cb) {
    // checkFilter(viewModel, "willUpdateView");
    proxy.willUpdateView(sessionId, viewModel, cb);
  }

  public void updateView(String sessionId, XViewModel viewModel,
    AsyncCallback<Void> cb) {
  ...
  public void updateLoadInfo(String sessionId, XViewModel xViewModel,
    int cellsToDisplay, AsyncCallback<XLoadInfo> cb) {
    // checkFilter(xViewModel, "updateLoadInfo");
    proxy.updateLoadInfo(sessionId, xViewModel, cellsToDisplay, cb);
  }

  public void generatePDF(String sessionId, XViewModel xViewModel,
    XPrintConfiguration config, AsyncCallback<XPrintResult> cb) {
  ...
  public void setVisibility(String sessionId, XFolderElement element,
    ...
    proxy.setVisibility(sessionId, element, visible, editable, ownerId, accountId,
      dbId, cubeId, cb);
  }
  ...
  public void applyAlias(String sessionId, String axisHierarchyId, String viewId,
    String axisId, XAlias alias, XElementNode[] allNodes,
    AsyncCallback<XElementNode[]> cb) {
    proxy
      .applyAlias(sessionId, axisHierarchyId, viewId, axisId, alias, allNodes, cb);
  }

  public void checkLocalFilter(String sessionId, String axisHierarchyId,
    String viewId, String axisId, String filterPaths,
    XElementNode[] visibleElements, boolean displayLeft, AsyncCallback<Boolean> cb) {
    proxy.checkLocalFilter(sessionId, axisHierarchyId, viewId, axisId, filterPaths,
      visibleElements, displayLeft, cb);
  }
  ...
  public void containsElement(String sessionId, String axisHierarchyId,
    ...
    AsyncCallback<Boolean> cb) {
    proxy.containsElement(sessionId, axisHierarchyId, viewId, axisId, element,
      subset, cb);
  }

  public void getElementPath(String sessionId, String axisHierarchyId,
    String viewId, String axisId, String selectedElementId, AsyncCallback<String> cb) {
    proxy.getElementPath(sessionId, axisHierarchyId, viewId, axisId,
      selectedElementId, cb);
  }

  public void getNumberOfChildren(String sessionId, String axisHierarchyId,
    String viewId, String axisId, String selectedElementId, AsyncCallback<Integer> cb) {
    proxy.getNumberOfChildren(sessionId, axisHierarchyId, viewId, axisId,
      selectedElementId, cb);
  }

  public void hideItem(String sessionId, XAxisItem item, List<XAxisItem> roots,
  ...
  public void willUpdateView(String sessionId, String viewId,
    String axisHierarchyId, String axisId, AsyncCallback<XLoadInfo> cb) {
