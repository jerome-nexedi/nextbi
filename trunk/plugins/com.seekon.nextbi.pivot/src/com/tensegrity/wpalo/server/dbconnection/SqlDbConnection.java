 ...
 * </p>
 * 
 * @version $Id: SqlDbConnection.java,v 1.2 2009/12/17 16:14:20 PhilippBouillon
 *          Exp $
 **/
  ...
  public void connect() throws SQLException {
    if (!isConnected()) {
      try {
        ...
        connection = DriverManager.getConnection(credentials.getProperty("jdbcURL"),
          credentials.getProperty("userName"), credentials
