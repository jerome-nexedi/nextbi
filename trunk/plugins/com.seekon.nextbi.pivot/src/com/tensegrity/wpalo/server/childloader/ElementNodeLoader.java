...
/**
 * <code>ElementNodeLoader</code> TODO DOCUMENT ME
 * 
 * @version $Id: ElementNodeLoader.java,v 1.16 2010/02/16 13:53:42
 *          PhilippBouillon Exp $
 **/
public class ElementNodeLoader implements ChildLoader {
  ...
  public final boolean accepts(XObject parent) {
    return (parent instanceof XAxisHierarchy) || (parent instanceof XElementNode);
  }
  ...
  public XObject[] loadChildren(String parentType, String viewId, String axisId,
    String parentId, UserSession userSession) {
  ...
  private final XObject[] loadElementsFromHierarchy(UserSession userSession,
    String viewId, String axisId, String hierarchyId) {
  ...
  private final XObject[] loadElementsFromElementNode(UserSession userSession,
    String viewId, String elementNodeId) {
    CubeViewController viewController = getViewController(userSession, viewId);
