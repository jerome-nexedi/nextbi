...
/*  78 */     throw new PaloAPIException("Legacy subsets are not supported anymore! Please use new subsets!");
/*     */   }
/*     */ 
/*     */   final Subset addSubset(Hierarchy hierarchy, String name) {
/*  82 */     throw new PaloAPIException("Legacy subsets are not supported anymore! Please use new subsets!");
/*     */   }
/*     */ 
/*     */   final void removeSubset(Dimension dimension, Subset subset) {
/*  86 */     if ((subset == null) || (!subset.getHierarchy().equals(dimension.getDefaultHierarchy()))) {
/*     */       return;
/*     */     }
...
/* 110 */     if ((subset != null) && (subset.getHierarchy().equals(dimension.getDefaultHierarchy())))
/* 111 */       return subset;
/* 112 */     return null;
/*     */   }
/*     */ 
/*     */   final Subset getSubset(Hierarchy hierarchy, String id) throws PaloPersistenceException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   final Subset[] getSubsets(Dimension dimension) throws PaloPersistenceException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   final Subset[] getSubsets(Hierarchy hierarchy) throws PaloPersistenceException
/*     */   {
...
/*     */   {
/* 174 */     Subset[] subsets = SubsetPersistence.getInstance().loadAll(this.database);
 ...
 * Qualified Name:     org.palo.api.impl.SubsetStorageHandler
