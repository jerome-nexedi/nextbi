  ...
  /*     */protected void registerStartHandlers() {
    /* 81 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 98 */if (cubeId != null)
          /* 99 */viewBuilder.setCube(CubeViewHandler1_0.this.database
            .getCubeByName(cubeId));
        /* 100 */CubeViewHandler1_0.this.cubeView = viewBuilder
          .createView(CubeViewHandler1_0.this);
        /*     */
    ...
    /* 107 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 116 */if (id == null) {
          ...
          /* 118 */CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, null, null,
            /* 119 */4,
            /* 120 */null, 0);
          /*     */}
        /* 122 */CubeViewHandler1_0.this.currAxis = CubeViewHandler1_0.this.cubeView
          .getAxis(id);
        /* 123 */if (CubeViewHandler1_0.this.currAxis == null)
          /* 124 */CubeViewHandler1_0.this.currAxis = CubeViewHandler1_0.this.cubeView
            .addAxis(id, name);
        /*     */}
      /*     */
    });
    /* 128 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 137 */Dimension dim = CubeViewHandler1_0.this.database
          .getDimensionByName(dimId);
        /* 138 */if (dim == null) {
          /* 139 */CubeViewHandler1_0.this
          /* 142 */.addError("CubeViewReader: unknown dimension id '" + dimId +
          /* 140 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, CubeViewHandler1_0.this.database,
            /* 141 */dimId, 0,
    ...
    /* 148 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */public void startElement(String uri, String localName, String qName,
        ...
        /* 158 */Dimension dim = CubeViewHandler1_0.this.database
          .getDimensionByName(dimId);
        /* 159 */if (dim == null)
          /* 160 */CubeViewHandler1_0.this
          /* 163 */.addError("CubeViewReader: unknown dimension id '" + dimId +
          /* 161 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, CubeViewHandler1_0.this.database,
            /* 162 */dimId, 0,
        ...
        /* 171 */if (hier == null) {
          ...
          /* 173 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, CubeViewHandler1_0.this.database,
            /* 174 */hierId, 0,
        ...
        /* 178 */if (selected == null) {
          ...
          /* 180 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, dim, element,
            /* 181 */1,
    ...
    /* 188 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 198 */Dimension dim = CubeViewHandler1_0.this.database
          .getDimensionByName(dimId);
        /* 199 */if (dim == null) {
          /* 200 */CubeViewHandler1_0.this
          /* 203 */.addError("CubeViewReader: unknown dimension id '" + dimId +
          /* 201 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, CubeViewHandler1_0.this.database,
            /* 202 */dimId, 0,
        ...
        /* 206 */if (activeSub == null) {
          ...
          /* 208 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, dim, subset,
            /* 209 */8,
    ...
    /* 216 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 228 */Dimension dim = CubeViewHandler1_0.this.database
          .getDimensionByName(dimId);
        ...
        /* 230 */if (dim == null)
          ...
          /* 232 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, CubeViewHandler1_0.this.database,
            /* 233 */dimId, 0,
        ...
        /* 244 */for (int i = 0; i < repetitions.length; ++i)
          /* 245 */CubeViewHandler1_0.this.currAxis.addExpanded(dim, expPath,
            repetitions[i]);
        /*     */}
      /*     */
    });
    /* 249 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 260 */Dimension dim = CubeViewHandler1_0.this.database
          .getDimensionByName(dimId);
        /* 261 */if (dim == null)
          /* 262 */CubeViewHandler1_0.this
          /* 265 */.addError("CubeViewReader: unknown dimension id '" + dimId +
          /* 263 */"'!!", CubeViewHandler1_0.this.cubeView.getId(),
            CubeViewHandler1_0.this.cubeView, CubeViewHandler1_0.this.database,
            /* 264 */dimId, 0,
 ...
 * Qualified Name: org.palo.api.impl.views.CubeViewHandler1_0 JD-Core Version:
 * 0.5.4
 */