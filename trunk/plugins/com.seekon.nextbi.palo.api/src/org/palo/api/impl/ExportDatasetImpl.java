...
/*     */   {
/* 103 */     if ((this.context == null) || (this.cells == null) || (this.cells.length == 0)) {
/* 104 */       return false;
/*     */     }
/* 106 */     return (this.index != this.cells.length) || (this.context.getProgress() < 1.0D);
/*     */   }
/*     */ 
...
/* 120 */       CellInfo[] cells = cimpl.getConnectionInternal().getDataExport(this.cubeInfo, 
...
/* 134 */               this.cube.getDimensionAt(i).getDefaultHierarchy().getElementById(pathIds[i]);
/*     */           }
 ...
 * Qualified Name:     org.palo.api.impl.ExportDatasetImpl
