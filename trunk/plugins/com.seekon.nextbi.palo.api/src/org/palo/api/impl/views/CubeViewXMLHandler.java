...
/*  75 */     return ((this.xmlHandler != null) && (this.xmlHandler.hasErrors())) || (!this.errors.isEmpty());
/*     */   }
/*     */ 
...
/* 133 */           if ((maxMajor < major) || ((maxMajor == major) && (maxMinor < minor))) {
/* 134 */             maxMajor = major;
/* 135 */             maxMinor = minor;
 ...
 * Qualified Name:     org.palo.api.impl.views.CubeViewXMLHandler
