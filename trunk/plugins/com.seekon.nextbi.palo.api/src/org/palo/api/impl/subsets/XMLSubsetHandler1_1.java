...
/*  77 */         XMLSubsetHandler1_1.this.subsetBuilder.setId(attributes.getValue("id"));
/*  78 */         XMLSubsetHandler1_1.this.subsetBuilder.setName(attributes.getValue("name"));
...
/*  94 */             XMLSubsetHandler1_1.this.subsetBuilder.setAlias(XMLSubsetHandler1_1.this
...
/*     */       public void startElement(String uri, String localName, String qName, Attributes attributes)
/*     */       {
/* 112 */         if ((XMLSubsetHandler1_1.this.stateBuilder == null) || (XMLSubsetHandler1_1.this.subsetBuilder == null)) {
...
/* 119 */         Hierarchy srcHier = XMLSubsetHandler1_1.this.subsetBuilder.getSourceHierarchy();
...
/* 124 */           XMLSubsetHandler1_1.this.stateBuilder.setPositions(element, positions);
/*     */         }
/*     */       }
/*     */     };
 ...
 * Qualified Name:     org.palo.api.impl.subsets.XMLSubsetHandler1_1
