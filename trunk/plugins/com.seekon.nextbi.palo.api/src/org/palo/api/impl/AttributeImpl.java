...
/*     */ 
/* 132 */     HierarchyImpl srcHier = (HierarchyImpl)attrHier.getAttributeHierarchy();
/* 133 */     if (srcHier == null)
...
/*     */ 
/* 155 */     ConnectionImpl connection = (ConnectionImpl)this.attrCube.getDatabase()
/* 156 */       .getConnection();
...
/* 163 */     DimensionImpl sysDim = (DimensionImpl)this.coordinates[0].getDimension();
...
/* 213 */       throw new PaloAPIException("The number of elements and values has to be equal!");
 ...
 * Qualified Name:     org.palo.api.impl.AttributeImpl
