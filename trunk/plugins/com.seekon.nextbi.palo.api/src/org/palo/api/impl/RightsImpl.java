...
/* 339 */       return;
/*     */     }
/* 341 */     Element roleElement = this.rightsCube.getDimensionAt(0).getElementByName(role);
/* 342 */     if (roleElement == null) {
/* 343 */       return;
/*     */     }
/* 345 */     this.rightsCube.setData(new Element[] { roleElement, objectElement }, right);
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private final boolean traverseRights(Class<? extends PaloObject> object, IRightsTraverser traverser)
/*     */   {
/* 390 */     init();
...
/*     */   }
/*     */ 
/*     */   private final boolean traverseRights(PaloObject object, IRightsTraverser traverser)
/*     */   {
/* 404 */     init();
...
/*     */   }
/*     */ 
/*     */   private final boolean performCheck(Element objectElement, IRightsTraverser traverser)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   private final boolean[] checkCubeOrDimensionRight(PaloObject object, IRightsTraverser traverser)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   private final void initializeGroupsAndRoles(ConnectionImpl connection, LinkedHashSet<String> groupList, LinkedHashSet<String> roleList)
/*     */   {
...
/*     */ 
/* 501 */       int i = 0; for (int n = groupResult.length; i < n; ++i) {
/* 502 */         if ((groupResult[i] == null) || 
/* 503 */           (!groupResult[i].toString().equals("1"))) continue;
...
/*     */   }
/*     */ 
/*     */   private final void initializeRoles(LinkedHashSet<String> groupList, LinkedHashSet<String> roleList)
/*     */   {
...
/* 527 */       int i = 0; for (int n = groupRoleResults.length; i < n; ++i) {
/* 528 */         if ((groupRoleResults[i] == null) || 
/* 529 */           (!groupRoleResults[i].toString().equals("1"))) continue;
 ...
 * Qualified Name:     org.palo.api.impl.RightsImpl
