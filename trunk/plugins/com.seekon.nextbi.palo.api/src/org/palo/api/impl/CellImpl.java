...
/*  65 */     this.cube = cube;
/*  66 */     this.cInfo = cInfo;
/*  67 */     this.coordinate = ((coordinate != null) ? (Element[])coordinate.clone() : getCoordinate(cInfo));
...
/* 142 */       return (this.cube.equals(other.cube)) && (this.coordKey.equals(other.coordKey));
/*     */     }
/* 144 */     return false;
/*     */   }
...
/* 171 */         coordinate[i] = 
/* 172 */           this.cube.getDimensionAt(i).getDefaultHierarchy().getElementById(ids[i]);
/*     */       }
 ...
 * Qualified Name:     org.palo.api.impl.CellImpl
