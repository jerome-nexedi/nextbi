...
/*     */{
  ...
  /*     */
  /*     */public final void addExpanded(Dimension dimension, Element[] path,
    int repetition) {
    /* 105 */addExpanded(dimension.getDefaultHierarchy(), path, repetition);
    /*     */}

  /*     */
  /*     */public final void addExpanded(Hierarchy hierarchy, Element[] path,
    int repetition) {
  ...
  /*     */public final Dimension[] getDimensions() {
    ...
    /* 181 */int i = 0;
    for (int n = hierarchies.length; i < n; ++i) {
  ...
  /*     */public final Hierarchy[] getHierarchies() {
    /* 195 */return (Hierarchy[]) this.hiers.toArray(new Hierarchy[this.hiers
      .size()]);
    /*     */}
  ...
  /*     */
  /*     */public final int[] getRepetitionsForExpanded(Hierarchy hierarchy,
    Element[] path)
  /*     */{
  ...
  /*     */
  /*     */public final int[] getRepetitionsForExpanded(Dimension dimension,
    Element[] path) {
  ...
  /*     */{
    /* 263 */return (String[]) this.properties.keySet().toArray(
 ...
 * Qualified Name: org.palo.api.impl.views.AxisImpl JD-Core Version: 0.5.4
 */