...
/*     */   }
/*     */ 
/*     */   public CubeView findCubeViewById(Connection connection, String dbId, String cubeId, String viewId)
/*     */   {
...
/*     */ 
/* 204 */         CubeView view = 
/* 205 */           FavoriteViewXMLHandler.this.findCubeViewById(connection, databaseId, cubeId, viewId);
...
/* 221 */           return;
/*     */         }
/* 223 */         FavoriteViewXMLHandler.this.currentFolder = ((FavoriteViewTreeNode)FavoriteViewXMLHandler.this.folderStack.pop());
/* 224 */         if (FavoriteViewXMLHandler.this.folderStack.isEmpty()) {
/* 225 */           FavoriteViewXMLHandler.this.currentFolder = null;
/*     */         }
/*     */         else
/*     */         {
/* 229 */           FavoriteViewXMLHandler.this.currentFolder = ((FavoriteViewTreeNode)FavoriteViewXMLHandler.this.folderStack.lastElement());
/*     */         }
/*     */       }
/*     */     });
/*     */   }
