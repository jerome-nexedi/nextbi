...
/* 142 */       user.getDefaultHierarchy().addElement(db.getConnection().getUsername(), 
/* 143 */         1);
/*     */     }
/* 147 */     else if (user.getDefaultHierarchy().getElementByName(db.getConnection().getUsername()) == null) {
/* 148 */       user.getDefaultHierarchy().addElement(db.getConnection().getUsername(), 
/* 149 */         1);
/*     */     }
/*     */ 
...
/* 220 */       String xmlData = "";
/*     */       try {
/* 222 */         xmlData = sql.loadFavoriteView(con.getServer(), con.getService(), con.getUsername());
/*     */       } finally {
/* 224 */         sql.close();
/*     */       }
...
/* 261 */       if ((xmlData == null) || 
/* 262 */         (xmlData.length() <= 0)) return null;
...
/*     */       try {
/* 298 */         sql.writeFavoriteViews(con.getServer(), con.getService(), con.getUsername(), xmlBookmarkText);
/*     */       } finally {
/* 300 */         sql.close();
/*     */       }
/* 302 */       return;
 ...
 * Qualified Name:     org.palo.api.ext.favoriteviews.impl.FavoriteViewModel
