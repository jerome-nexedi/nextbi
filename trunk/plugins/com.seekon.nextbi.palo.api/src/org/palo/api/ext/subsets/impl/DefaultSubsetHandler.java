...
/*     */{
  ...
  /*     */
  /*     */final synchronized void use(Hierarchy hierarchy, HierarchyFilter filter,
    ...
    /*     */{
      ...
      /*     */{
        ...
        /* 105 */if (isFlat) {
          ...
          /*     */}
        /*     */else {
          /* 110 */if (!DefaultSubsetHandler.this.subsetState.getId().equals(
            "regularexpression")) {
            /* 111 */String path = ElementNodeUtilities.getPath(elementNode);
            /* 112 */if (!DefaultSubsetHandler.this.subsetState.containsPath(
              element, path))
              /* 113 */return;
            /*     */}
  ...
  /*     */{
    /* 154 */return (Element[]) this.elements.toArray(new Element[this.elements
      .size()]);
    /*     */}
 ...
 * Qualified Name: org.palo.api.ext.subsets.impl.DefaultSubsetHandler JD-Core
 * Version: 0.5.4
 */