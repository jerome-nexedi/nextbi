...
/*     */{
  ...
  /*     */{
    /* 110 */if (path.equals("/subset/data_filter/cell_operator/value")) {
      ...
      /* 112 */} else if (path
      .equals("/subset/data_filter/cell_operator/parameter")) {
    ...
    /* 154 */else if (path.equals("/subset/data_filter/subcube/source_cube/value")) {
      ...
      /* 156 */} else if (path
      .equals("/subset/data_filter/subcube/source_cube/parameter")) {
      ...
      /*     */}
    /* 161 */else if (path
      .equals("/subset/data_filter/subcube/dimension_coordinates/parameter")) {
      /* 162 */ObjectParameter sliceDimension = this.setting.getSlicePart();
      /* 163 */sliceDimension.setName(value);
      /*     */}
    /* 165 */else if (path
      .equals("/subset/data_filter/subcube/dimension_coordinates/value/element")) {
    ...
    /* 174 */else if (path.equals("/subset/data_filter/upper_percentage/value")) {
      ...
      /* 176 */} else if (path
      .equals("/subset/data_filter/upper_percentage/parameter")) {
    ...
    /* 181 */else if (path.equals("/subset/data_filter/lower_percentage/value")) {
      ...
      /* 183 */} else if (path
      .equals("/subset/data_filter/lower_percentage/parameter")) {
 ...
 * Qualified Name: org.palo.api.subsets.io.xml.DataFilterHandler JD-Core
 * Version: 0.5.4
 */