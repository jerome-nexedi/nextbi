...
/*     */{
  ...
  /*     */{
    /* 113 */Subset2Impl copy = new Subset2Impl(this.id, this.name, this.hierarchy,
      this.type);
    /*     */
  ...
  /*     */public final String[] getElementIds() {
    /* 146 */applyFilters();
    /* 147 */return (String[]) this.elements.toArray(new String[this.elements
      .size()]);
    /*     */}
  ...
  /*     */public final ElementNode[] getRootNodes() {
    /* 168 */applyFilters();
    /* 169 */return (ElementNode[]) this.rootNodes
  ...
  /*     */{
    /* 206 */return (SubsetFilter[]) this.filters.values().toArray(
      new SubsetFilter[this.filters.size()]);
    /*     */}
      ...
      /* 309 */for (SubsetFilter filter : this.filters.values()) {
        /* 310 */if (filter instanceof EffectiveFilter) {
          ...
          /* 313 */for (int type : effectiveTypes) {
            /* 314 */SubsetFilter effectiveSubsetFilter = (SubsetFilter) this.filters
              .get(
  ...
  /*     */public String getDefinition() {
    /*     */try {
      ...
      /*     */} catch (PaloIOException pio) {
      /* 368 */throw new PaloAPIException("Failed to get definition of subset '"
        + getName() +
        /* 369 */"'!", pio);
      /*     */}
    /*     */}
  ...
  /*     */public Subset2 setDefinition(String definition) {
    /*     */try {
      ...
      /* 379 */return storageHandler.load(this.id, getDimHierarchy(), getType(),
        (SubsetHandlerImpl) getDimHierarchy().getSubsetHandler());
      /*     */} catch (PaloIOException pio) {
      /* 381 */throw new PaloAPIException("Failed to get definition of subset '"
        + getName() +
        /* 382 */"'!", pio);
      /*     */}
    /*     */}
 ...
 * Qualified Name: org.palo.api.subsets.impl.Subset2Impl JD-Core Version: 0.5.4
 */