...
/*     */{
  ...
  /*     */{
    /* 71 */return (String[]) this.attrId2constraint.keySet()
  ...
  /*     */{
    ...
    /* 122 */return (AttributeConstraint[]) constraints
      .toArray(new AttributeConstraint[0]);
    /*     */}
  ...
  /*     */{
    ...
    /* 133 */for (String attrId : this.attrId2constraint.keySet()) {
      ...
      /*     */}
    /* 139 */return (AttributeConstraint[]) row.toArray(new AttributeConstraint[row
      .size()]);
    /*     */}
  ...
  /*     */final AttributeConstraint[] getConstraints() {
    ...
    /* 175 */return (AttributeConstraint[]) constraints
      .toArray(new AttributeConstraint[constraints.size()]);
    /*     */}
 ...
 * Qualified Name:
 * org.palo.api.subsets.filter.settings.AttributeConstraintsMatrix JD-Core
 * Version: 0.5.4
 */