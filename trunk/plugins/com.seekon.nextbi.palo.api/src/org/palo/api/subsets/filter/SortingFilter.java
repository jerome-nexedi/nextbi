...
/*     */ 
/* 164 */         if ((limitByLvl != -1) && (indentFilter.compare(element, limitByLvl) != 0))
/*     */         {
...
/*     */     {
/*     */     case 1:
/* 187 */       DataFilter dataFilter = 
/* 188 */         (DataFilter)this.effectiveFilters.get(Integer.valueOf(8));
/* 189 */       if (dataFilter == null)
/* 190 */         throw new PaloAPIException("No data filter defined!");
/* 191 */       Collections.sort(sortedNodes, new DataSorter(dataFilter));
/* 192 */       break;
/*     */     case 2:
/* 195 */       Collections.sort(sortedNodes, this.textualSorter);
/* 196 */       break;
/*     */     case 3:
/* 198 */       AliasFilter aliasFilter = 
/* 199 */         (AliasFilter)this.effectiveFilters.get(Integer.valueOf(64));
/* 200 */       if (aliasFilter == null)
/* 201 */         throw new PaloAPIException("No alias filter defined!");
/* 202 */       Collections.sort(sortedNodes, new AliasSorter(aliasFilter));
/* 203 */       break;
/*     */     default:
/* 205 */       Collections.sort(sortedNodes, new DefinitionSorter());
/*     */     }
/*     */ 
...
/* 223 */         for (Iterator iterator = sortedNodes.iterator(); ((Iterator)iterator).hasNext(); ) { 
...
/* 233 */     for (Object node = preservedNodes.iterator(); ((Iterator)node).hasNext(); ) { ElementNode pNode = (ElementNode)((Iterator)node).next();
/* 234 */       allNodes[pNode.getIndex()] = pNode; }
/*     */ 
/* 236 */     index = 0;
/* 237 */     for (Iterator node = sortedNodes.iterator(); ((Iterator)node).hasNext(); ) { 
...
/*     */     {
/* 247 */       boolean bool1 = this.setting.getHierarchicalMode().getValue().intValue() == 
/* 248 */         1;
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private final void createHierarchy(List<ElementNode> nodes, Map<Element, ElementNode> el2node, boolean showChildren)
/*     */   {
 ...
 * Qualified Name:     org.palo.api.subsets.filter.SortingFilter
