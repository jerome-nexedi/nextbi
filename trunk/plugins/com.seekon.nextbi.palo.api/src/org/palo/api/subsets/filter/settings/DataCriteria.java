...
/*     */   {
/* 235 */     DataCriteria copy = new DataCriteria(ALL_OPERATORS[this.operator1], this.operand1.getValue());
 ...
 * Qualified Name:     org.palo.api.subsets.filter.settings.DataCriteria
