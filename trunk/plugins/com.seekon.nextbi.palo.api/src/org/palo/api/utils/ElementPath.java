...
/* 155 */     return (Hierarchy[])hierarchies.toArray(new Hierarchy[hierarchies.size()]);
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static final ElementPath restore(Dimension[] dimensions, String pathStr)
/*     */   {
/* 220 */     Hierarchy[] hiers = new Hierarchy[dimensions.length];
/* 221 */     int i = 0; for (int n = dimensions.length; i < n; ++i) {
/* 222 */       hiers[i] = dimensions[i].getDefaultHierarchy();
/*     */     }
/* 224 */     return restore(hiers, pathStr);
/*     */   }
/*     */ 
/*     */   public static final ElementPath restore(Hierarchy[] hierarchies, String pathStr)
/*     */   {
...
/* 273 */       if (element == null) {
/* 274 */         PaloAPIException exception = new PaloAPIException("Could not find element with id '" + 
 ...
 * Qualified Name:     org.palo.api.utils.ElementPath
