...
/*     */   {
/* 108 */     super((cause.getMessage() == null) ? "PaloException" : cause.getMessage(), cause);
...
/*     */   {
/* 142 */     return (this.errorReason != null) ? this.errorReason : getDescription();
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.api.PaloAPIException
