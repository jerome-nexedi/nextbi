...
/*     */{
  ...
  /*     */{
    ...
    /* 106 */this.paloConnection.addElement(this.hierarchy, name, type, children,
      weights);
    /* 107 */loaded(elInfo);
    /* 108 */return elInfo;
    /*     */}
  ...
  /*     */{
    ...
    /* 114 */if (this.paloConnection.addElements(this.hierarchy.getDimension(),
      names, type,
  ...
  /*     */{
    ...
    /* 132 */if (this.paloConnection.addElements(this.hierarchy.getDimension(),
      names, types,
  ...
  /*     */public final ElementInfo[] replaceBulk(ElementInfo[] elements, int type,
    ElementInfo[][] children, Double[][] weights)
  /*     */{
    /* 149 */if (this.paloConnection.replaceBulk(this.hierarchy.getDimension(),
      elements, type, children, weights)) {
      /* 150 */return this.paloConnection
        .getElements(this.hierarchy.getDimension());
      /*     */}
 ...
 * Qualified Name: com.tensegrity.palojava.loader.ElementLoader JD-Core Version:
 * 0.5.4
 */