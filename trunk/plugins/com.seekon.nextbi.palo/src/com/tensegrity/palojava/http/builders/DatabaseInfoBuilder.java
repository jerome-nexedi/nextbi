...
/* 48 */       throw new PaloException("Not enough information to create DatabaseInfo!!");
/*    */     }
/*    */ 
...
/* 63 */       throw new PaloException(response[0], response[2] + ": " + response[3], 
/* 64 */         response[2] + ": " + response[3]);
/*    */     }
/* 66 */     if (response.length < 6)
/* 67 */       throw new PaloException("Not enough information to update DatabaseInfo!!");
/*    */     try
/*    */     {
