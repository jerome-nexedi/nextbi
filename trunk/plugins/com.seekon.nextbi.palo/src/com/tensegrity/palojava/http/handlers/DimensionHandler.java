...
/*     */{
  ...
  /*     */
  /*     */public final DimensionInfo clear(DimensionInfo dimension)
    throws IOException
  /*     */{
  ...
  /*     */{
    ...
    /* 227 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
  ...
  /*     */{
    ...
    /* 242 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
