...
/* 58 */       throw new PaloException("Not enough information to create ServerInfo!!");
/*    */     try
/*    */     {
...
/* 65 */       int encryption = 2;
/* 66 */       int httpsPort = 0;
/* 67 */       if (response.length > 4) encryption = Integer.parseInt(response[4]);
/* 68 */       if (response.length > 5) httpsPort = Integer.parseInt(response[5]);
/* 69 */       return new ServerInfoImpl(build, bugfix, major, minor, httpsPort, encryption, false);
/*    */     } catch (Exception e) {
