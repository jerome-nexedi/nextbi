...
/* 108 */       (errorReason == null) ? "" : new StringBuilder(" [").append(errorReason).append("]").toString()) + 
...
/* 123 */       if (!Character.isDigit(c)) break;
/* 124 */       ++index;
/*     */     }
/*     */ 
 ...
 * Qualified Name:     com.tensegrity.palojava.PaloException
