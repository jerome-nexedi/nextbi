...
/**
 * <code>AdminService</code> TODO DOCUMENT ME
 * 
 * @version $Id: AdminService.java,v 1.18 2010/01/13 08:02:44 PhilippBouillon
 *          Exp $
 **/
public class AdminService extends BasePaloServiceServlet {
  ...
  public final XAccount[] getAccounts(String sessionId)
  ...
  public final XConnection[] getConnections(String sessionId)
    throws SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  public final void delete(String sessionId, Account account)
  ...
  public final void delete(String sessionId, PaloConnection connection)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  public final void delete(String sessionId, Group group)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  public final void delete(String sessionId, Role role)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  public final void delete(String sessionId, User user)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  public final XAccount save(String sessionId, XAccount xAccount)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  private final Account createNative(String sessionId, XAccount xAccount)
    ...
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
    return adminService.createAccount(xAccount.getLogin(), xAccount.getPassword(),
      user, connection);
  }

  private final void updateNative(String sessionId, Account account,
    XAccount xAccount) throws SessionExpiredException {
    AuthUser user = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(user);
    adminService.setConnection(getNative(sessionId, xAccount.getConnection()),
      account);
  ...
  private final PaloConnection createNative(String sessionId, XConnection xConnection)
    ...
    return adminService.createConnection(xConnection.getName(), xConnection
      .getHost(), xConnection.getService(), xConnection.getConnectionType());
  }

  private final void updateNative(String sessionId, PaloConnection connection,
    XConnection xConnection) throws SessionExpiredException {
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
  ...
  public final XGroup save(String sessionId, XGroup xGroup)
    throws OperationFailedException, SessionExpiredException {
    // if(true)
  ...
  private final List<Role> getRoles(String sessionId, String[] ids)
    throws SessionExpiredException {
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
  ...
  private final List<User> getUsers(String sessionId, String[] ids)
    throws SessionExpiredException {
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
  ...
  public final XRole save(String sessionId, XRole xRole)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  private final void updateNative(String sessionId, Role role, XRole xRole)
    throws SessionExpiredException {
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
    adminService.setDescription(xRole.getDescription(), role);
    adminService.setName(xRole.getName(), role);
    adminService.setPermission(Right.fromString(xRole.getPermission()), role);
  }

  public final XUser save(String sessionId, XUser xUser)
    throws OperationFailedException, SessionExpiredException {
    AuthUser admin = getLoggedInUser(sessionId);
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(admin);
  ...
  private final User createNative(String sessionId, XUser xUser)
    ...
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
    return adminService.createUser(xUser.getFirstname(), xUser.getLastname(), xUser
      .getLogin(), xUser.getPassword());
  }
  ...
  private final List<Group> getGroups(String sessionId, String[] ids)
    throws SessionExpiredException {
    AdministrationService adminService = ServiceProvider
      .getAdministrationService(getLoggedInUser(sessionId));
