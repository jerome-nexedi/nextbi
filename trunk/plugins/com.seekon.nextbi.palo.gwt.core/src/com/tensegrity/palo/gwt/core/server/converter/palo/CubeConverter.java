...
/**
 * <code>CubeConverter</code> TODO DOCUMENT ME
 * 
 * @version $Id: CubeConverter.java,v 1.3 2009/12/17 16:14:29 PhilippBouillon
 *          Exp $
 **/
public class CubeConverter extends BaseConverter {
  ...
  public XObject toXObject(Object nativeObj) {
    ...
    XCube xCube = new XCube(cube.getId(), cube.getName(), (XDatabase) XConverter
      .createX(cube.getDatabase()));
    return xCube;
  }
}
