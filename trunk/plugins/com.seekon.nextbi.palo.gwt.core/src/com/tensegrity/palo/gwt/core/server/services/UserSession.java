...
/**
 * <code>UserSession</code> TODO DOCUMENT ME
 * 
 * @version $Id: UserSession.java,v 1.9 2010/03/12 12:49:14 PhilippBouillon Exp
 *          $
 **/
public class UserSession {
  ...
  public UserSession(AuthUser user) {
    ...
    messages = ResourceBundle.getBundle(
      "com.tensegrity.palo.gwt.core.server.services.messages", new Locale(locale),
  ...
  public void setLocale(String loc) {
    if (loc != null && !loc.isEmpty()) {
      ...
      try {
        messages = ResourceBundle.getBundle(
          "com.tensegrity.palo.gwt.core.server.services.messages",
          new Locale(locale), new UTF8ResourceBundleControl());
      } catch (Throwable t) {
        locale = "en";
        messages = ResourceBundle.getBundle(
          "com.tensegrity.palo.gwt.core.server.services.messages", new Locale("en"),
          new UTF8ResourceBundleControl());
      }
    }
  }
