...
/**
 * <code>XAxisItemTraverser</code> TODO DOCUMENT ME
 * 
 * @version $Id: AxisTraverser.java,v 1.2 2009/12/17 16:14:29 PhilippBouillon
 *          Exp $
 **/
public class AxisTraverser {
  ...
  public void traverseVisible(AxisItem item, AxisItem parent,
    AxisItem parentInPrevHierarchy, AxisItemVisitor visitor) {
  ...
  public void traverse(AxisItem item, AxisItem parent,
    AxisItem parentInPrevHierarchy, AxisItemVisitor visitor) {
    visitor.visit(item, parent, parentInPrevHierarchy);
    for (AxisItem rootInNextHierarchy : item.getRootsInNextHierarchy()) {
  ...
  public void traverse(XAxisItem item, XAxisItem parent,
    XAxisItem parentInPrevHierarchy, XAxisItemVisitor visitor) {
    visitor.visit(item, parent, parentInPrevHierarchy);
