...
/**
 * <code>CellConverter</code> TODO DOCUMENT ME
 * 
 * @version $Id: CellConverter.java,v 1.5 2009/12/17 16:14:29 PhilippBouillon
 *          Exp $
 **/
public class CellConverter extends BaseConverter {
  ...
  public XObject toXObject(Object nativeObj) {
    ...
    int type = cell.getType() == Cell.NUMERIC ? XCell.TYPE_NUMERIC
      : XCell.TYPE_STRING;
