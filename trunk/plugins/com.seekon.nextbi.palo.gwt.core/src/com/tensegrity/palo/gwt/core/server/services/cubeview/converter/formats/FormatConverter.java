...
/**
 * <code>FormatConverter</code> TODO DOCUMENT ME
 * 
 * @version $Id: FormatConverter.java,v 1.5 2009/12/17 16:14:29 PhilippBouillon
 *          Exp $
 **/
public class FormatConverter {
  ...
  public static final void convert(org.palo.api.CubeView legacyView, CubeView newView) {
    parseFormats(legacyView, newView);

  }

  private static final void parseFormats(org.palo.api.CubeView legacyView,
    CubeView view) {
