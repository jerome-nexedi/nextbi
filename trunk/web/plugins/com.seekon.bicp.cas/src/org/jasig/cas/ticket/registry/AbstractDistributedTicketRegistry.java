...
public abstract class AbstractDistributedTicketRegistry extends
  ...
  protected final Ticket getProxiedTicketInstance(final Ticket ticket) {
    ...
    if (ticket instanceof TicketGrantingTicket) {
      return new TicketGrantingTicketDelegator(this, (TicketGrantingTicket) ticket,
        needsCallback());
    }
  ...
  private static class TicketDelegator<T extends Ticket> implements Ticket {
    ...
    protected TicketDelegator(
      final AbstractDistributedTicketRegistry ticketRegistry, final T ticket,
    ...
    public final TicketGrantingTicket getGrantingTicket() {
      ...
      return (TicketGrantingTicket) this.ticketRegistry.getTicket(old.getId(),
        Ticket.class);
    }
  ...
  private static final class ServiceTicketDelegator extends
    TicketDelegator<ServiceTicket> implements ServiceTicket {
  ...
  private static final class TicketGrantingTicketDelegator extends
    TicketDelegator<TicketGrantingTicket> implements TicketGrantingTicket {
