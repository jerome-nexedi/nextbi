...
public final class SimpleWebApplicationServiceImpl extends
  ...
  private SimpleWebApplicationServiceImpl(final String id, final String originalUrl,
  ...
  public static SimpleWebApplicationServiceImpl createServiceFrom(
    ...
    return new SimpleWebApplicationServiceImpl(id, serviceToUse, artifactId, "POST"
      .equals(method) ? ResponseType.POST : ResponseType.REDIRECT, httpClient);
  }
