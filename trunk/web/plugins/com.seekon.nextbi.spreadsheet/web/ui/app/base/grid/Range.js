...
Jedox.wss.grid.Range.prototype = {
	...
	_hover : function(ev) {
		...
		case "defaultRangeBorder":
			...
			elem.style.cursor = "".concat("url(ui/app/res/img/cursors/rng_",
		...
		case "rangeEdge":
			...
			elem.style.cursor = "".concat(
					"url(ui/app/res/img/cursors/md_curr",
	...
	_setBorder : function() {
		...
		if (this._state == Jedox.wss.range.AreaState.NEW) {
			this._edgeElems[0].style.backgroundImage = "url(ui/app/res/img/borders/new_horizontal_up.gif)";
			this._edgeElems[0].style.backgroundRepeat = "repeat-x";
			this._edgeElems[0].style.backgroundPosition = "0px 2px";
			this._edgeElems[1].style.backgroundImage = "url(ui/app/res/img/borders/new_horizontal_up.gif)";
			this._edgeElems[1].style.backgroundRepeat = "repeat-x";
			this._edgeElems[1].style.backgroundPosition = "0px 1px";
			this._edgeElems[2].style.backgroundImage = "url(ui/app/res/img/borders/new_vertical_left.gif)";
			this._edgeElems[2].style.backgroundRepeat = "repeat-y";
			this._edgeElems[2].style.backgroundPosition = "2px 0px";
			this._edgeElems[3].style.backgroundImage = "url(ui/app/res/img/borders/new_vertical_left.gif)";
			...
			this._edgeElems[0].style.backgroundImage = "url(ui/app/res/img/borders/"
					.concat(colorNumber, "_horizontal_normal.gif)");
			this._edgeElems[0].style.backgroundPosition = "0px 0px";
			this._edgeElems[1].style.backgroundImage = "url(ui/app/res/img/borders/"
					.concat(colorNumber, "_horizontal_normal.gif)");
			this._edgeElems[1].style.backgroundPosition = "0px 0px";
			this._edgeElems[2].style.backgroundImage = "url(ui/app/res/img/borders/"
					.concat(colorNumber, "_vertical_normal.gif)");
			this._edgeElems[2].style.backgroundPosition = "0px 0px";
			this._edgeElems[3].style.backgroundImage = "url(ui/app/res/img/borders/"
					.concat(colorNumber, "_vertical_normal.gif)");
		...
		case "rngBorder":
			for ( var i = 0; i < this._edgeElems.length; i++) {
				this._edgeElems[i].style.cursor = "".concat(
						"url(ui/app/res/img/cursors/", cur, ".cur)",
						_curHotSpot, ", default")
			}
			break;
		case "magicDot":
			this._cornerElems[0].style.cursor = "".concat(
					"url(ui/app/res/img/cursors/", cur, ".cur)", _curHotSpot,
					", default")
		}
	},
	repaint : function() {
