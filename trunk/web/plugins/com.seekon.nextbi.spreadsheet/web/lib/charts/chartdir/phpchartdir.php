...
class ColorAxis extends AxisCD {
...
class XYChart extends BaseChart {
	...
	function addAxis($align, $offset) {
		return new AxisCD(callmethod("XYChart.addAxis", $this->ptr, $align, $offset));
	}
	function yAxis() {
		return new AxisCD(callmethod("XYChart.yAxis", $this->ptr));
	}
	function yAxis2() {
		return new AxisCD(callmethod("XYChart.yAxis2", $this->ptr));
	}
	...
	function xAxis() {
		return new AxisCD(callmethod("XYChart.xAxis", $this->ptr));
	}
	function xAxis2() {
		return new AxisCD(callmethod("XYChart.xAxis2", $this->ptr));
	}
	...
	function setPlotArea($x, $y, $width, $height, $bgColor = Transparent, $altBgColor = -1,
		...
		return new PlotAreaCD(callmethod("XYChart.setPlotArea", $this->ptr,
			$x, $y, $width, $height, $bgColor, $altBgColor, $edgeColor, $hGridColor, $vGridColor));
	}
	function getPlotArea() {
		return new PlotAreaCD(callmethod("XYChart.getPlotArea", $this->ptr));
	}
...
class SurfaceChart extends BaseChart
{
	...
	function xAxis() {
		return new AxisCD(callmethod("SurfaceChart.xAxis", $this->ptr));
	}
	function yAxis() {
		return new AxisCD(callmethod("SurfaceChart.yAxis", $this->ptr));
	}
	function zAxis() {
		return new AxisCD(callmethod("SurfaceChart.zAxis", $this->ptr));
	}
...
class PolarChart extends BaseChart
{
	...
	function radialAxis() {
		return new AxisCD(callmethod("PolarChart.radialAxis", $this->ptr));
	}
