...
public class FormatBuilder {
  ...
  final void setPriority(String prio) {
    this.prio = (prio != null && prio.length() > 0) ? Integer.parseInt(prio) : 1;
  }
  ...
  final void setFontSize(String size) {
    this.size = (size != null && size.length() > 0) ? Integer.parseInt(size) : 8;
  }
  ...
  final void setItalic(String italic) {
    this.italic = italic != null ? "italic".equalsIgnoreCase(italic) : false;
  }

  final void setUnderlined(String underlined) {
    this.underlined = underlined != null ? "underlined".equalsIgnoreCase(underlined)
      : false;
  }
