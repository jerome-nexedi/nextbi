...
class RuleImpl implements Rule {
  ...
  public void setComment(String comment) {
    dbConnection.update(ruleInfo, ruleInfo.getDefinition(), ruleInfo
      .getExternalIdentifier(), ruleInfo.useExternalIdentifier(), comment, ruleInfo
      .isActive());
    cube.fireRuleChanged(this, comment);
  }

  public void setDefinition(String definition) {
    dbConnection.update(ruleInfo, definition, ruleInfo.getExternalIdentifier(),
      ruleInfo.useExternalIdentifier(), ruleInfo.getComment(), ruleInfo.isActive());
  ...
  public void setExternalIdentifier(String externalId, boolean useIt) {
    dbConnection.update(ruleInfo, ruleInfo.getDefinition(), externalId, useIt,
      ruleInfo.getComment(), ruleInfo.isActive());
    cube.fireRuleChanged(this, externalId);
  }

  public void update(String definition, String externalIdentifier, boolean useIt,
    String comment) {
  ...
  public void update(String definition, String externalIdentifier, boolean useIt,
    ...
    dbConnection.update(ruleInfo, definition, externalIdentifier, useIt, comment,
      activate);
  ...
  public void useExternalIdentifier(boolean useIt) {
    ...
    if (extId == null || extId.equals(""))
      return;
    dbConnection.update(ruleInfo, ruleInfo.getDefinition(), ruleInfo
      .getExternalIdentifier(), useIt, ruleInfo.getComment(), ruleInfo.isActive());
  }
  ...
  public final void setActive(boolean activate) {
    dbConnection.update(ruleInfo, ruleInfo.getDefinition(), ruleInfo
      .getExternalIdentifier(), ruleInfo.useExternalIdentifier(), ruleInfo
      .getComment(), activate);
