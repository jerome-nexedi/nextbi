...
public abstract class SubsetStorageHandlerImpl implements SubsetStorageHandler {
   ...
   */
  protected abstract void rename(Subset2 subset, String newName)
   ...
   *             hierarchy
   */
  protected abstract String newSubsetCell(String name, Hierarchy hierarchy, int type)
    throws PaloIOException;
   ...
   */
  protected abstract Subset2 load(String id, Hierarchy hierarchy, int type,
  ...
  protected abstract void setDefinition(Subset2 subset, String xml)
    throws PaloIOException;
