...
/*     */{
  ...
  /*     */public SubsetXMLHandler(TypeInfoProvider typeProvider,
    ...
    /* 85 */this.filterHandlers.put("/subset/alias_filter",
      AliasFilterHandler.class);
    /* 86 */this.filterHandlers.put("/subset/text_filter", TextFilterHandler.class);
    /* 87 */this.filterHandlers.put("/subset/attribute_filter",
      AttributeFilterHandler.class);
    /* 88 */this.filterHandlers.put("/subset/data_filter", DataFilterHandler.class);
    /* 89 */this.filterHandlers.put("/subset/hierarchical_filter",
      HierarchicalFilterHandler.class);
    /* 90 */this.filterHandlers.put("/subset/picklist_filter",
      PicklistHandler.class);
    /* 91 */this.filterHandlers.put("/subset/sorting_filter",
      SortingFilterHandler.class);
    /*     */}
  ...
  /*     */{
    ...
    /* 129 */else if (this.filter != null)
      /* 130 */if (xPath.equals(this.filter.getXPath())) {
        /* 131 */this.subset.add(this.filter.createFilter(this.subset
          .getDimension()));
  ...
  /*     */private final SubsetFilterHandler createFilter(String xPath) {
    ...
    /* 235 */if (filter != null) {
      /*     */try {
        ...
        /* 238 */(SubsetFilterHandler) filter.getConstructor(new Class[0])
  ...
  /*     */{
    ...
    /* 270 */Subset2 subset = this.subsetHandler.create(id, name, dimension
      .getDefaultHierarchy(), this.type);
    /*     */
    /* 284 */return subset;
    /*     */}
 ...
 * Qualified Name: org.palo.api.subsets.io.xml.SubsetXMLHandler JD-Core Version:
 * 0.5.4
 */