...
class TableFormatReader {
  ...
  class FormatXMLHandler extends BaseXMLHandler {
    ...
    FormatXMLHandler() {
      ...
      putStartHandler("format/formatcells/numberformat", new StartHandler() {
        public void startElement(String uri, String localName, String qName,
          Attributes attributes) {
      ...
      putStartHandler("format/formatcells/background", new StartHandler() {
        public void startElement(String uri, String localName, String qName,
          Attributes attributes) {
          setBackground(cellFmtBuilder, attributes);
        }
      });
      putStartHandler("format/formatheader/background", new StartHandler() {
        public void startElement(String uri, String localName, String qName,
          Attributes attributes) {
    ...
    private void setFont(FormatBuilder fmtBuilder, Attributes attributes) {
      ...
      fmtBuilder.setFontColor(attributes.getValue("r"), attributes.getValue("g"),
        attributes.getValue("b"));
    }
