...
public class AttributeConstraintsMatrix {
  ...
  public AttributeConstraintsMatrix() {
    attrId2constraint = new HashMap<String, ArrayList<AttributeConstraint>>();
  }
  ...
  public final void addFilterConstraint(AttributeConstraint constraint) {
    ArrayList<AttributeConstraint> constraints = getConstraints(constraint
      .getAttributeId());
  ...
  public final AttributeConstraint[] getRow(int index) {
    ArrayList<AttributeConstraint> row = new ArrayList<AttributeConstraint>();
    for (String attrId : attrId2constraint.keySet()) {
      ArrayList<AttributeConstraint> constraints = attrId2constraint.get(attrId);
