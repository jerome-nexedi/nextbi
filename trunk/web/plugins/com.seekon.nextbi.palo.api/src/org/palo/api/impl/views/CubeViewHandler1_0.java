  ...
  protected void registerStartHandlers() {
      ...
      public void startElement(String uri, String localName, String qName,
        ...
        if (id == null) {
          addError("CubeViewReader: missing id attribute for axis",
            cubeView.getId(), cubeView, null, null, PersistenceError.UNKNOWN_AXIS,
    ...
    registerStartHandler(new IPaloStartHandler() {
      ...
      public void startElement(String uri, String localName, String qName,
        ...
        if (activeSub == null) {
          addError("CubeViewReader: unknown subset id '" + subset + "'!!", cubeView
            .getId(), cubeView, dim, subset, PersistenceError.UNKNOWN_SUBSET,
    ...
    registerStartHandler(new IPaloStartHandler() {
      ...
      public void startElement(String uri, String localName, String qName,
        ...
        Element[] expPath = CubeViewHandler1_0.this.getPath(path, hier, currAxis,
          PersistenceError.TARGET_EXPANDED_PATH);
    ...
    registerStartHandler(new IPaloStartHandler() {
      ...
      public void startElement(String uri, String localName, String qName,
        ...
        Element[] hiddenPath = CubeViewHandler1_0.this.getPath(path, hier, currAxis,
          PersistenceError.TARGET_HIDDEN_PATH);
