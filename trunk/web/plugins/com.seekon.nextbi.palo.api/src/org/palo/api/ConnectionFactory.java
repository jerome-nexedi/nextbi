...
public abstract class ConnectionFactory {
    ...
    try {
      ...
      if (propsStream != null) {
        ...
        if (props.containsKey("xmla_ignoreVariableCubes"))
          System.setProperty("xmla_ignoreVariableCubes", props
      ...
      instance = (ConnectionFactory) Class.forName(
  ...
  * load on demand is activated. To
   ...
   */
  public abstract Connection newConnection(String server, String service,
  ...
  * @param doLoadOnDemand activate load on demand
   ...
   */
  public abstract ConnectionConfiguration getConfiguration(String host,
    String service);
