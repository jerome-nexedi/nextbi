...
/*     */{
  ...
  /*     */IPaloStartHandler[] getStartHandlers(final Database database) {
    /* 67 */return new IPaloStartHandler[] { new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 75 */XMLSubsetHandler1_0.this.subsetBuilder.setId(attributes
          .getValue("id"));
        /* 76 */XMLSubsetHandler1_0.this.subsetBuilder.setName(attributes
          .getValue("name"));
        ...
        /*     */{
          ...
          /* 90 */if (!srcDim.getDatabase().getConnection().isLegacy())
            /* 91 */XMLSubsetHandler1_0.this.subsetBuilder
              .setAlias(XMLSubsetHandler1_0.this
          ...
          /* 96 */pe.getMessage());
          /*     */}
        /* 98 */XMLSubsetHandler1_0.this.subsetBuilder.setSourceHierarchy(srcDim
          .getDefaultHierarchy());
        /*     */}
      /*     */
    }
    /*     */, new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 109 */XMLSubsetHandler1_0.this.stateBuilder.setId(attributes
          .getValue("id"));
        /* 110 */XMLSubsetHandler1_0.this.stateBuilder.setName(attributes
          .getValue("name"));
        /*     */}
      /*     */
    }
    /*     */, new IPaloStartHandler() {
      ...
      /*     */{
        /* 119 */if (XMLSubsetHandler1_0.this.stateBuilder == null) {
          ...
          /*     */}
        /* 123 */XMLSubsetHandler1_0.this.stateBuilder.setExpression(attributes
          .getValue("expr"));
        /*     */}
      /*     */
    }
    ...
    /*     */, new IPaloStartHandler() {
      ...
      /*     */public void startElement(String uri, String localName, String qName,
        Attributes attributes)
      /*     */{
        /* 148 */if ((XMLSubsetHandler1_0.this.stateBuilder == null)
          || (XMLSubsetHandler1_0.this.subsetBuilder == null)) {
        ...
        /* 155 */Hierarchy srcHier = XMLSubsetHandler1_0.this.subsetBuilder
          .getSourceHierarchy();
        ...
        /* 159 */XMLSubsetHandler1_0.this.stateBuilder.setPositions(element,
          positions);
        /*     */}
      /*     */
    }
  ...
  /*     */IPaloEndHandler[] getEndHandlers(Database database) {
    /* 165 */return new IPaloEndHandler[] { new IPaloEndHandler() {
      ...
      /*     */public void endElement(String uri, String localName, String qName) {
        /* 171 */if ((XMLSubsetHandler1_0.this.subsetBuilder == null)
          || (XMLSubsetHandler1_0.this.stateBuilder == null)) {
          /* 172 */throw new PaloAPIException("Cannot create subset state!!");
          /*     */}
        /* 174 */SubsetState state = XMLSubsetHandler1_0.this.stateBuilder
          .createState();
  ...
  /*     */{
    /* 184 */if ((srcHier == null)
      || (srcHier.getDimension().getDatabase().getConnection().isLegacy()))
      /* 185 */return null;
 ...
 * Qualified Name: org.palo.api.impl.subsets.XMLSubsetHandler1_0 JD-Core
 * Version: 0.5.4
 */