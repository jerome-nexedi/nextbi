...
public class AttributeConstraint {
  ...
  public static final String[] ALL_OPERATORS = new String[] { NONE, LESS,
  ...
  public final boolean accept(String attrValue, int attrType) {
    ...
    if (attrType == Attribute.TYPE_NUMERIC) {
      try {
        Double dbValue = (value != null && value.length() > 0) ? Double
          .valueOf(value) : new Double(0);
        Double dbAttrValue = (value != null && value.length() > 0) ? Double
          .valueOf(attrValue) : new Double(0);
  ...
  public final boolean equals(Object obj) {
    if (obj instanceof AttributeConstraint) {
      ...
      return attrId.equals(other.attrId) && operator.equals(other.operator)
