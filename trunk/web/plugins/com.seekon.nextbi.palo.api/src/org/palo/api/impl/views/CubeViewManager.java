...
* @author ArndHouben
*
* @version $Id: CubeViewManager.java,v 1.24 2010/07/13 09:21:04 PhilippBouillon Exp $
*
*/
  ...
  final void createEnvironment(Database database) {
    ...
    try {
      ...
      //					CubeViewPersistence.LEGACY_DIMENSION_VIEW_COLUMNS);
        ...
        CubeViewPersistence.DIMENSION_VIEW_COLUMNS);
      if (columns == null)
        columns = database
          .addUserInfoDimension(CubeViewPersistence.DIMENSION_VIEW_COLUMNS);
      ...
      if (columns.getDefaultHierarchy()
        .getElementByName(CubeViewPersistence.COL_DEF) == null)
        columns.getDefaultHierarchy().addElement(CubeViewPersistence.COL_DEF,
      ...
      //					CubeViewPersistence.LEGACY_DIMENSION_VIEW_ROWS);
        ...
        CubeViewPersistence.DIMENSION_VIEW_ROWS);
      if (rows == null)
        rows = database
          .addUserInfoDimension(CubeViewPersistence.DIMENSION_VIEW_ROWS);
