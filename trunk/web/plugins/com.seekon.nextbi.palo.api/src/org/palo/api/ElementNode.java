...
* @author Stepan Rutz
*
* @version $Id: ElementNode.java,v 1.23 2010/04/29 11:26:14 PhilippBouillon Exp $
*
*/
...
public class ElementNode {
  ...
  public final String toString() {
    return "ElementNode (" + Integer.toHexString(System.identityHashCode(this))
      + "/" + Integer.toHexString(hashCode()) + " " + element.toString() + ")";
  }
