...
/*     */{
  ...
  /*     */
  /*     */public final synchronized void setSearchAttribute(
  ...
  /*     */{
    ...
    /* 217 */if (allPositions != null) {
      /* 218 */return (String[]) allPositions.toArray(new String[allPositions
        .size()]);
      /*     */}
 ...
 * Qualified Name: org.palo.api.impl.subsets.SubsetStateImpl JD-Core Version:
 * 0.5.4
 */