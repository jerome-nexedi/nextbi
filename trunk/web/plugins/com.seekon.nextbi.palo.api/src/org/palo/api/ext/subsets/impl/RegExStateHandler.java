    ...
    return new DimensionFilter() {
      ...
      public boolean acceptElement(Element element) {
        if (subsetState.getSearchAttribute() != null) {
          return element.getAttributeValue(subsetState.getSearchAttribute())
            .toString().matches(subsetState.getExpression());
        } else {
          return element.getName().matches(subsetState.getExpression());
        }
      }
