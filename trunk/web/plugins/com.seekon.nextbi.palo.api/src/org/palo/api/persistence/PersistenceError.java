...
public interface PersistenceError {
  ...
  public static final int[] ALL_ERROR_TYPES = new int[] { UNKNOWN_ERROR,
    UNKNOWN_DIMENSION, UNKNOWN_ELEMENT, UNKNOWN_CUBE_VIEW, UNKNOWN_AXIS,
    UNKNOWN_SUBSET, UNKNOWN_PATH, LOADING_FAILED };
