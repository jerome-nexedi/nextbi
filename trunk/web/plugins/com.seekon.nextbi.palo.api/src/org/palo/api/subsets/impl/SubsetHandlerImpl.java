...
/*     */{
  ...
  /*     */{
    ...
    /* 98 */this.newSubsetsSupported = ((!hierarchy.getDimension()
      .isSystemDimension())
      &&
  ...
  /*     */{
    ...
    /*     */try
    /*     */{
      /* 139 */String id = this.storageHandler.newSubsetCell(name, this.hierarchy,
        type);
      /* 140 */if (id == null)
        /* 141 */throw new PaloAPIException(
  ...
  /*     */{
    ...
    /* 210 */String[] subIds = this.storageHandler.getSubsetIDs(this.hierarchy,
      type);
  ...
  /*     */
  /*     */public final Subset2 create(String id, String name, Hierarchy hierarchy,
    int type)
  /*     */{
 ...
 * Qualified Name: org.palo.api.subsets.impl.SubsetHandlerImpl JD-Core Version:
 * 0.5.4
 */