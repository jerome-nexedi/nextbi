...
class SubsetReader {
   ...
   */
  final Subset2 fromXML(SubsetHandlerImpl handler, String name, InputStream input,
    int type) throws PaloIOException {
    Subset2 subset = null;
    try {
      ...
      SubsetXMLHandler subset2Handler = new SubsetXMLHandler(typeProvider, handler,
        name, type);
      ...
      DefaultHandler annotationHandler = new DefaultHandler() {
        public void processingInstruction(String target, String data)
          ...
          if (target.equals("palosubset")) {
            version[0] = data.substring(9, data.length() - 1).trim();
          }
