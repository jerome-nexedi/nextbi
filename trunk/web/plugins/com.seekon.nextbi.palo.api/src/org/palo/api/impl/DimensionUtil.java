...
/*     */{
  ...
  /*     */
  /*     */static void forceTraverse(ElementNode n, ElementNode p,
    ElementNodeVisitor v)
  /*     */{
    /* 103 */v.visit(n, p);
    ...
    /*     */{
      /* 111 */if (children[i] == null)
        /*     */continue;
      /* 113 */ElementNode child = new ElementNode(children[i], consolidations[i],
        index++);
 ...
 * Qualified Name: org.palo.api.impl.DimensionUtil JD-Core Version: 0.5.4
 */