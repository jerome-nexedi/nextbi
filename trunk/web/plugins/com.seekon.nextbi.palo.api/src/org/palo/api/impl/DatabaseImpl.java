...
/*      */{
  ...
  /*      */
  /*      */static final DatabaseImpl create(ConnectionImpl connection,
  ...
  /*      */
  /*      */public final String parseRule(Cube cube, String definition,
    String functions) {
    /*      */try {
      ...
      /* 419 */if (this.connection.getType() == 3) {
        ...
        /*      */} else {
        /* 441 */rule = this.dbConnection.parseRule(_cube.getInfo(), definition,
          functions);
        /*      */}
      /* 443 */return rule;
  ...
  /*      */{
    /* 968 */if (dimInfo == null) {
      /* 969 */return null;
      /*      */}
    /* 971 */DimensionImpl dimension = (DimensionImpl) this.loadedDimensions
      .get(dimInfo.getId());
  ...
  /*      */private final DimensionImpl createDimension(DimensionInfo dimInfo,
    boolean fireEvent)
  /*      */{
    /* 986 */DimensionImpl dimension = DimensionImpl.create(this.connection, this,
      dimInfo, fireEvent);
  ...
  /*      */public Property2 getProperty(String id) {
    ...
    /* 1092 */if (propInfo == null) {
      /* 1093 */return null;
      /*      */}
    /* 1095 */Property2 property = (Property2) this.loadedProperties.get(propInfo
      .getId());
  ...
  /*      */
  /*      */private final Cube addCubeInternal(String name, Dimension[] dimensions,
    int type) {
    /*      */try {
      ...
      /* 1170 */for (int i = 0; i < dimInfos.length; ++i) {
        ...
        /*      */}
      /*      */
      /* 1174 */CubeInfo cubeInfo = this.cubeLoader
        .create(name, dimInfos, infoType);
      /*      */
 ...
 * Qualified Name: org.palo.api.impl.DatabaseImpl JD-Core Version: 0.5.4
 */