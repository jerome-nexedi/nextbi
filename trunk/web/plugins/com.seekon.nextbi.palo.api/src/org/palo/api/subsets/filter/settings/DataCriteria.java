...
public class DataCriteria {
  ...
  public static final String[] ALL_OPERATORS = new String[] { LESSER, LESSER_EQUAL,
    GREATER, GREATER_EQUAL, NOT_EQUAL, EQUAL };
  ...
  final DataCriteria copy() {
    DataCriteria copy = new DataCriteria(ALL_OPERATORS[operator1], operand1
      .getValue());
