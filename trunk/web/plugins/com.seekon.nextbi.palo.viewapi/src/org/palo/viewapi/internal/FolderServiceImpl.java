...
/*     */{
  ...
  /*     */public DynamicFolder createDynamicFolder(String name,
    ExplorerTreeNode parent, Hierarchy sourceHierarchy, Subset2 sourceSubset,
    PaloConnection con)
  /*     */throws OperationFailedException
  /*     */{
  ...
  /*     */private StaticFolder createStaticFolderUnchecked(String name,
    ExplorerTreeNode parent, PaloConnection con) throws OperationFailedException
  /*     */{
    /*     */try
    /*     */{
  ...
  /*     */
  /*     */public void delete(ExplorerTreeNode node)
    throws OperationFailedException {
  ...
  /*     */
  /*     */private final void getAllViews(ExplorerTreeNode root,
    Set<String> allViews) {
          ...
          /* 247 */if (userCons.contains(conId)) {
            ...
            /*     */{
              /* 251 */if (targetNode == null) {
                /* 252 */ExplorerTreeNode node = findTreeNode(rootNode, this.user
                  .getId()
                  + "foreignViews");
                /* 253 */if (node == null)
                  /*     */try {
                    /* 255 */node = createStaticFolderUnchecked(
                      "Recently created views", rootNode, this.user.getId()
                        + "foreignViews");
                    /*     */}
                ...
                /*     */}
              /* 261 */FolderElement fe = createFolderElement(v.getName(),
                targetNode, null);
  ...
  /*     */
  /*     */private final ExplorerTreeNode findTreeNode(ExplorerTreeNode root,
    String id) {
    /* 278 */if (root == null) {
      /* 279 */return null;
      /*     */}
          ...
          /* 313 */if (userCons.contains(conId)) {
            ...
            /*     */{
              /* 317 */if (targetNode == null) {
                /* 318 */ExplorerTreeNode node = findTreeNode(rootNode, this.user
                  .getId()
                  + "foreignViews");
                /* 319 */if (node == null)
                  /*     */try {
                    /* 321 */node = createStaticFolderUnchecked(
                      "Recently created views", rootNode, this.user.getId()
                        + "foreignViews");
                    /*     */}
                  /*     */catch (OperationFailedException localOperationFailedException1) {
                ...
                /*     */}
              /* 327 */FolderElement fe = createFolderElement(v.getName(),
                targetNode, null);
  ...
  /*     */{
    ...
    /* 353 */for (Group g : this.user.getGroups()) {
      /* 354 */for (Iterator localIterator2 = g.getRoles().iterator(); localIterator2
        .hasNext();) {
        Role r = (Role) localIterator2.next();
        /* 355 */allRoles.add(r);
      }
      /*     */
      /*     */}
            ...
            /* 374 */if (userCons.contains(conId)) {
              ...
              /*     */{
                /* 378 */if (targetNode == null) {
                  /* 379 */ExplorerTreeNode node = findTreeNode(rootNode, this.user
                    .getId()
                    + "foreignViews");
                  /* 380 */if (node == null)
                    /*     */try {
                      /* 382 */node = createStaticFolderUnchecked(
                        "Recently created views", rootNode, this.user.getId()
                          + "foreignViews");
                      /*     */}
                    /*     */catch (OperationFailedException localOperationFailedException1) {
                  ...
                  /*     */}
                /* 388 */FolderElement fe = createFolderElement(v.getName(),
                  targetNode, null);
  ...
  /*     */public ExplorerTreeNode getTreeRoot() {
    ...
    /* 420 */if (rootNode == null) {
      ...
      /* 423 */String name = (((fn == null) ? "" : fn) + " " + ((ln == null) ? ""
        : ln))
      /* 424 */.trim();
  ...
  /*     */private final Account getAccount(PaloConnection forConnection)
    throws SQLException
  /*     */{
    /* 496 */Account account = getAccountManagement().findBy(this.user,
      forConnection);
    /* 497 */if (account == null)
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.FolderServiceImpl JD-Core
 * Version: 0.5.4
 */