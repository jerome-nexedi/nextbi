...
/*     */{
  ...
  /*     */public final AxisHierarchy[] getAxisHierarchies() {
    /* 144 */return (AxisHierarchy[]) this.hierarchies.values().toArray(
      new AxisHierarchy[0]);
    /*     */}

  /*     */
  /*     */public final Hierarchy[] getHierarchies() {
    /* 148 */return (Hierarchy[]) this.hierarchies.keySet().toArray(
      new Hierarchy[0]);
    /*     */}

  /*     */
  /*     */public final AxisHierarchy remove(Hierarchy hierarchy) {
    /* 152 */AxisHierarchy axisHierarchy = (AxisHierarchy) this.hierarchies
      .remove(hierarchy);
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.cubeview.AxisImpl JD-Core
 * Version: 0.5.4
 */