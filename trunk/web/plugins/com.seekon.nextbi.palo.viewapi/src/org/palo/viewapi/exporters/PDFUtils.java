...
/*     */{
  ...
  /*     */
  /*     */static final void applyBorderDataLineStyle(PdfContentByte pByte,
    BorderData bData) {
    /* 71 */if (pByte == null)
      /* 72 */return;
    /* 73 */if (bData == null) {
    ...
    /*     */case 2:
      /* 81 */
      pByte.setLineDash(2.0F, 0.0F);
      /* 82 */break;
    /*     */case 4:
      /* 84 */
      pByte.setLineDash(LINE_DASH_DOT, 0.0F);
      /* 85 */break;
    /*     */case 5:
      /* 87 */
      pByte.setLineDash(LINE_DASH_DOT_DOT, 0.0F);
      /* 88 */break;
    /*     */case 3:
      /* 90 */
      pByte.setLineDash(1.0F, 0.0F);
      /*     */
    }
    /*     */
 ...
 * .jar Qualified Name: org.palo.viewapi.exporters.PDFUtils JD-Core Version:
 * 0.5.4
 */