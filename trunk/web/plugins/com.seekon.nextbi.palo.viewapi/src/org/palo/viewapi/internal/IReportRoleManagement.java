...
public abstract interface IReportRoleManagement extends IAssociationManagement {
  public abstract List<String> getReports(Role paramRole) throws SQLException;

  public abstract List<String> getRoles(Report paramReport) throws SQLException;
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.IReportRoleManagement JD-Core
 * Version: 0.5.4
 */