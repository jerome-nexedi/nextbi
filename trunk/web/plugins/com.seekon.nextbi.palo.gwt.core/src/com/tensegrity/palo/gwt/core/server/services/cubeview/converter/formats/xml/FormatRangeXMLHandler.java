...
class FormatRangeXMLHandler extends BaseXMLHandler {
  private final HashMap<String, FormatRangeHandler> handlers = new HashMap<String, FormatRangeHandler>();
  ...
  /**
   * Registers the given <code>{@link FormatHandler}</code> for the specified
   * cube view version
   * 
   * @param version
   *          a valid cube view version
   * @param handler
   *          a handler to use for reading cube views of specified version
   */
