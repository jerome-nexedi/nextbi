...
/**
 * <code>ConnectionConverter</code> TODO DOCUMENT ME
 * 
 * @version $Id: ConnectionConverter.java,v 1.3 2009/12/17 16:14:29
 *          PhilippBouillon Exp $
 **/
public class ConnectionConverter extends BaseConverter {
  ...
  public XObject toXObject(Object nativeObj) {
    ...
    XConnection xConnection = new XConnection(connection.getId(), connection
      .getName(), connection.getType());
  ...
  private final void update(PaloConnection connection, XConnection xConnection,
