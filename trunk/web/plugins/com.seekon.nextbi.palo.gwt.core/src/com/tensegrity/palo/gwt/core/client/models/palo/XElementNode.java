...
/**
 * <code>XElementNode</code> TODO DOCUMENT ME
 * 
 * @version $Id: XElementNode.java,v 1.11 2010/02/16 13:54:00 PhilippBouillon
 *          Exp $
 **/
public class XElementNode extends XObject {
  ...
  public XElementNode(XElement xElement, String xAxisHierarchyId, String viewId) {
    setId(Long.toString(id++)); // xAxisHierarchy.getId() + ":" +
    // xElement.getId());
