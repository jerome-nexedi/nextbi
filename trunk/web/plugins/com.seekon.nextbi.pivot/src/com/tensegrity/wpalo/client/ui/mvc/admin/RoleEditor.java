...
public class RoleEditor extends AbstractTabEditor {
  ...
  public final EditorTab[] getEditorTabs() {
    return new EditorTab[] { new RolesPropertiesTab(this), new RoleRightsTab(this) };
  }
    ...
    if (input instanceof XRole) {
      ...
      if (role != null
        ...
        && (role.getName().equals("ADMIN") || role.getName().equals("EDITOR")
          || role.getName().equals("VIEWER") || role.getName().equals("POWERUSER")
          || role.getName().equals("OWNER") || role.getName().equals("CREATOR") || role
          .getName().equals("PUBLISHER"))) {
...
class RoleRightsTab extends EditorTab {
  ...
  public void set(XObject input) {
    if (input instanceof XRole) {
      XRole role = (XRole) input;
      boolean isAdm = role != null && role.getName() != null
        && role.getName().equals("ADMIN");
      ((RadioTableColumn) rightsTable.getColumnModel().getColumn(0))
        .setEnabled(!isAdm);
