 ...
 * @version $Id: TreeNode.java,v 1.25 2010/02/12 13:49:50 PhilippBouillon Exp $
 **/
public class TreeNode extends BaseTreeModel<TreeNode> implements IsSerializable,
  Serializable {
  /** generated serial id */
  ...
  public String get(String key) {
    if (key.equals(DISPLAY_PROPERTY)) {
      ...
      // }
      // ret.append(" - ");
      // if (acc.getConnection() != null && acc.getConnection().getName() !=
      // null) {
    ...
    if (key.equals("nameAndKids")) {
      if (xObject instanceof XElementNode) {
        ...
        return count == 0 ? xObject.getName() : xObject.getName()
  ...
  public int hashCode() {
    ...
    if (xObject != null) {
      if (!(xObject instanceof XFolderElement)
        ...
        && !"com.tensegrity.wpalo.client.ui.mvc.viewbrowser.ViewBrowserModel"
          .equals(xObject.getType())) {
