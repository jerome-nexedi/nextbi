...
public interface WPaloCubeViewService extends RemoteService {
  ...
  public XLoadInfo willOpen(String sessionId, XView xView)
    throws SessionExpiredException, PaloGwtCoreException;

  public XViewModel proceedOpen(String sessionId, XView xView)
    throws SessionExpiredException, PaloGwtCoreException;
  ...
  public XViewModel updateAndReloadView(String sessionId, XViewModel xViewModel)
    throws SessionExpiredException;

  public XLoadInfo willUpdateView(String sessionId, XViewModel xViewModel)
    throws SessionExpiredException;

  public XViewModel proceedUpdateView(String sessionId, XViewModel xViewModel)
    throws SessionExpiredException;
  ...
  public XLoadInfo willUpdateView(String sessionId, String viewId,
    String axisHierarchyId, String axisId) throws SessionExpiredException;

  public XElement updateAxisHierarchy(String sessionId, XAxisHierarchy hierarchy)
    throws SessionExpiredException;

  public XLoadInfo willUpdateAxisHierarchy(String sessionId, XAxisHierarchy hierarchy)
    throws SessionExpiredException;
  ...
  public XLoadInfo willReload(String sessionId, XViewModel xViewModel)
    throws SessionExpiredException;

  public XViewModel proceedReload(String sessionId, XViewModel xViewModel)
    throws SessionExpiredException;
  ...
  public XViewModel saveView(String sessionId, XViewModel view)
  ...
  public void deleteView(String sessionId, XView xView)
    throws DbOperationFailedException, SessionExpiredException;
