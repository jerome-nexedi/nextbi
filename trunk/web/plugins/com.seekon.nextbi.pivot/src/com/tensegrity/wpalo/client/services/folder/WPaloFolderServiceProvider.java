...
public class WPaloFolderServiceProvider implements WPaloFolderServiceAsync {
  ...
  public void deleteFolder(String sessionId, XStaticFolder folder,
  ...
  public void importViewsAsFolderElements(String sessionId, XView[] views,
    ...
    proxy.importViewsAsFolderElements(sessionId, views, xParentFolder, isPublic,
      isEditable, cb);
  }
  ...
  public void createFolderElement(String sessionId, XView xView,
    XStaticFolder xParentFolder, boolean isPublic, boolean isEditable,
    AsyncCallback<XFolderElement> cb) {
    proxy.createFolderElement(sessionId, xView, xParentFolder, isPublic, isEditable,
      cb);
  }
  ...
  public void renameFolderElement(String sessionId, XFolderElement xFolderElement,
    String newName, AsyncCallback<Void> cb) {
