...
/**
 * <code>ViewBrowserModel</code> TODO DOCUMENT ME
 * 
 * @version $Id: ViewBrowserModel.java,v 1.21 2010/04/12 11:13:36
 *          PhilippBouillon Exp $
 **/
public class ViewBrowserModel {
  ...
  final void addView(final XView xView, final TreeNode parent, final boolean openIt,
    final ViewBrowser delegate, final boolean isPublic, final boolean isEditable) {
    ...
    String sessionId = ((Workbench) Registry.get(Workbench.ID)).getUser()
      .getSessionId();
    WPaloFolderServiceProvider.getInstance().createFolderElement(
      sessionId,
      xView,
      xParentFolder,
      isPublic,
      isEditable,
      new Callback<XFolderElement>("Could not create view'"
