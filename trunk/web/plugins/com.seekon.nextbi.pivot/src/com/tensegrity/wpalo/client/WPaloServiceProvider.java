...
public class WPaloServiceProvider implements WPaloServiceAsync {
  ...
  private final static WPaloServiceProvider instance = new WPaloServiceProvider();
  ...
  public void loadChildren(String sessionId, TreeNode parent,
    AsyncCallback<List<TreeNode>> cb) {
    proxy.loadChildren(sessionId, parent, cb);
  }

  public void loadChildren(String sessionId, String parentType, String viewId,
    String axisId, String parentId, String parentPath,
    AsyncCallback<List<TreeNode>> cb) {
    proxy.loadChildren(sessionId, parentType, viewId, axisId, parentId, parentPath,
      cb);
  }
  ...
  public void createStaticFolder(String name, XObject parent, XUser user,
    AsyncCallback<XStaticReportFolder> cb) {
  ...
  public void assignSubsetOrDimension(XDynamicReportFolder folder, XObject subdim,
    XUser user, AsyncCallback<Boolean> cb) {
    proxy.assignSubsetOrDimension(folder, subdim, user, cb);
  }

  public void getVariables(XReport report, XUser user,
    AsyncCallback<XVariableDescriptor> cb) {
    proxy.getVariables(report, user, cb);
  }

  public void createView(XCube parentCube, String name, XUser user,
    AsyncCallback<XView> cb) {
    proxy.createView(parentCube, name, user, cb);
  }

  public void createWorkbook(XObject parent, String name, AsyncCallback<XWorkbook> cb) {
    proxy.createWorkbook(parent, name, cb);
  }

  public void applyMapping(XReport input, XObject[] keys, String[] values,
    XUser user, AsyncCallback<Boolean> cb) {
  ...
  public void openViewDirectly(String locale, String link,
    AsyncCallback<XDirectLinkData> cb) {
    proxy.openViewDirectly(locale, link, cb);
  }

  public void openViewAfterLogin(String locale, String sessionId, String link,
    AsyncCallback<XDirectLinkData> cb) {
    proxy.openViewAfterLogin(locale, sessionId, link, cb);
  }

  public void openPaloSuiteView(String locale, String link,
    AsyncCallback<XDirectLinkData> cb) {
