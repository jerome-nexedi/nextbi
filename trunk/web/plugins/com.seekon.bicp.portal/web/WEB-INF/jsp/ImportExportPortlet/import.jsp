        ...
        <div id="uploader-contents">
            ...
            <form class="flc-uploader fl-uploader" 
                ...
                <div class="fl-uploader-queue-wrapper">
                                    ...
                                    <tr class="flc-uploader-file-tmplt flc-uploader-file fl-uploader-hidden-templates">
                                        ...
                                        <td class="fl-uploader-file-actions">
                                            <button type="button" class="flc-uploader-file-action fl-uploader-file-action" tabindex="-1">
                                                <span class="fl-uploader-button-text fl-uploader-hidden">从队列删除文件</span>
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div class="flc-uploader-queue-footer fl-uploader-queue-footer">
                            ...
                            <tr>
                                ...
                                <td class=".fl-uploader-footer-buttons" align="right" >
                                    <span class="flc-uploader-button-browse fl-uploader-browse">
                                        <span class="flc-uploader-button-browse-text">浏览文件</span>
                                    </span>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="flc-uploader-errorsPanel fl-uploader-errorsPanel">
                             <div class="fl-uploader-errorsPanel-header"><span class="flc-uploader-errorPanel-header">警告:</span></div>
                ...
                <div class="fl-uploader-btns">
                    <button type="button" class="flc-uploader-button-pause fl-uploader-pause fl-uploader-hidden">停止上传</button>
                    <button type="button" class="flc-uploader-button-upload fl-uploader-upload fl-uploader-button-default fl-uploader-dim" disabled="disabled">上传</button>
                </div>
    ...
    up.jQuery(document).ready(function () {
        var myUpload = up.fluid.uploader(".flc-uploader", {
            strategy: {
                ...
                options: {
                    ...
                    flashSettings: {
                        ...
                        flashURL: "/resource/rs/fluid/1.3/lib/swfupload.swf",
            ...
            queueSettings: {
                ...
                uploadURL: "<c:url value="/portal/api/import"/>",
                fileQueueLimit: 1
            }
        });
    });
