...
<xsl:stylesheet 
  ...
  <xsl:variable name="MEDIA_PATH">web/media/skins/universality</xsl:variable>
  ...
  -->
	<xsl:param name="USER_LANG">zh_CN</xsl:param> <!-- Sets the default user language. -->
  ...
  <xsl:template name="footer.block">
    ...
    <div id="portalPageFooterNav">
      ...
      <!-- Footer Links -->
	      ...
	      <!-- Copyright -->
	      <div id="portalCopyright" style="">
	        <p>copyright© 2011-2012 seekon公司版权所有</p>
	      </div>
