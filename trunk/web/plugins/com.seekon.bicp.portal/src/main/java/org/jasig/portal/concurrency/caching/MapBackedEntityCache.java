...
public class MapBackedEntityCache implements IEntityCache {
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.IEntityCache#add(org.jasig.portal.IBasicEntity
   * )
   */
  public void add(IBasicEntity entity) throws CachingException {
    ...
    if (!this.entityType.isAssignableFrom(addType)) {
      throw new CachingException("Problem adding " + entity + ": entity type '"
        + addType + "' is incompatible with cache type '" + this.entityType + "'.");
    }
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.IEntityCache#update(org.jasig.portal.IBasicEntity
   * )
   */
