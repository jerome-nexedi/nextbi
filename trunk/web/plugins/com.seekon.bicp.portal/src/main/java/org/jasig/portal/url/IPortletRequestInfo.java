...
public interface IPortletRequestInfo {
  /**
   * @return The {@link IPortletWindowId} this request info is for, will never
   *         return null
   */
  ...
  /**
   * @return The delegation parent window id, null if the portlet is not a
   *         delegate
   * @throws IllegalStateException
   *           If parent {@link IPortalRequestInfo#getUrlType()} returns
   *           {@link UrlType#RESOURCE}
   */
  public IPortletWindowId getDelegateParentWindowId();

  /**
   * @return The requested WindowState, null if no change to the WindowState is
   *         requested
   * @throws IllegalStateException
   *           If parent {@link IPortalRequestInfo#getUrlType()} returns
   *           {@link UrlType#RESOURCE}
  ...
  /**
   * @return The requested PortletMode, null if no change to the PortletMode is
   *         requested
   * @throws IllegalStateException
   *           If parent {@link IPortalRequestInfo#getUrlType()} returns
   *           {@link UrlType#RESOURCE}
   ...
   * @throws IllegalStateException
   *           If parent {@link IPortalRequestInfo#getUrlType()} does not return
   *           {@link UrlType#RESOURCE}
   */
