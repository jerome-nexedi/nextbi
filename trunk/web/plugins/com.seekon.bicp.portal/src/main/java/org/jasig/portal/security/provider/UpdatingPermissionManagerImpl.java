 ...
 * @version $Revision$
 */
public class UpdatingPermissionManagerImpl extends PermissionManagerImpl implements
   ...
   * parameters. Includes inherited <code>IPermissions</code>. Any null
  ...
  public IPermission[] getPermissions(IAuthorizationPrincipal principal,
    String activity, String target) throws AuthorizationException {
    return getAuthorizationService().getUncachedPermissionsForPrincipal(principal,
      getOwner(), activity, target);
  }

  /**
   * Creates a new <code>IPermission</code> for the <code>principal</code> on
   * behalf of the owner of this <code>IPermissionManager</code>.
   * 
   * @param principal
   *          IAuthorizationPrincipal
   */
