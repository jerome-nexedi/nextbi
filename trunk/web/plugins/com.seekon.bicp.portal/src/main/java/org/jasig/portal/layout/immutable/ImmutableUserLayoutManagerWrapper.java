...
/**
 * Wraps {@link IUserLayoutManager} interface to prevent access to mutator
 * methods.
 * 
 * Prior to uPortal 2.5, this class existed in the package
 * org.jasig.portal.layout. It was moved to its present package to associate it
 * with the ImmutableUserLayoutSAXFilter and to separate it from the general
 * Layout API.
 * 
...
public class ImmutableUserLayoutManagerWrapper implements IUserLayoutManager {
  ...
  public ImmutableUserLayoutManagerWrapper(IUserLayoutManager manager)
  ...
  public boolean canUpdateNode(IUserLayoutNodeDescription nodeId)
    throws PortalException {
    return false;
  }
