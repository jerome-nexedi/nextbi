...
/**
 * UserPreferencesManager is responsible for keeping: user id, user layout, user
 * preferences and stylesheet descriptions. For method descriptions please see
...
public class UserPreferencesManager implements IUserPreferencesManager {
  ...
  public UserPreferencesManager(IPerson person, IUserProfile userProfile,
