...
public class PortalShell {
  ...
  protected static Options getOptions() {
    ...
    options.addOption(new Option("s", "script", true,
      "Groovy script to execute in the uPortal Shell."));
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (commandLine.hasOption("script")) {
      ...
      final CompilerConfiguration conf = new CompilerConfiguration(System
        .getProperties());
  ...
  protected static void printHelp(final Options options) {
    ...
    formatter.printHelp(pw, HelpFormatter.DEFAULT_WIDTH, "java "
      + PortalShell.class.getName(), null, options, HelpFormatter.DEFAULT_LEFT_PAD,
