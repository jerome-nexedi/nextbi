...
public class CernunnosDataExporter extends AbstractDom4jExporter {
  ...
  /**
   * An optional function that resolves the filename for each exported node. If
   * not specified the default data id used.
   */
  public void setFileNameFunction(
    Function<Tuple<String, Element>, String> fileNameFunction) {
  ...
  protected Element exportDataElement(String id) {
    ...
    final TaskResponse response = new RuntimeRequestResponse(Collections
      .<String, Object> singletonMap("Attributes.RETURN_VALUE", result));
