...
/**
 * This domain class is used in order to represent the localization of portlet
 * definition. This class is the same as
 * o.j.p.portlet.dao.jpa.PortletLocalizationData but since JPA class should be
...
class LocalizedPortletDefinition implements Serializable {
  ...
  /**
   * Initialize the state using portlet definition. Class fields will be
   * retrieved from portlet definition using specified locale.
   * 
   * @param definition
   *          portelt definition to use (must not be null).
   * @param locale
   *          specifies the localization to use.
   */
