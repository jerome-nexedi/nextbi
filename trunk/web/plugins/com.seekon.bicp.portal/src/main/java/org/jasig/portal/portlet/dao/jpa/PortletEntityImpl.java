...
class PortletEntityImpl implements IPortletEntity {
  ...
  // Hidden reference to the parent portlet definition, used by hibernate for
  // referential integrety
  @ManyToOne(targetEntity = PortletDefinitionImpl.class, cascade = {
  ...
  private final Map<StylesheetDescriptorImpl, WindowState> windowStates = new HashMap<StylesheetDescriptorImpl, WindowState>(
    0);
  ...
  public PortletEntityImpl(IPortletDefinition portletDefinition,
  ...
  public Map<Long, WindowState> getWindowStates() {
    ...
    synchronized (this.windowStates) {
      for (Map.Entry<StylesheetDescriptorImpl, WindowState> windowStateEntry : windowStates
        .entrySet()) {
        final StylesheetDescriptorImpl stylesheetDescriptor = windowStateEntry
          .getKey();
  ...
  @Override
  public void setWindowState(IStylesheetDescriptor stylesheetDescriptor,
    WindowState state) {
    synchronized (this.windowStates) {
      if (state == null) {
        ...
        this.windowStates
          .put((StylesheetDescriptorImpl) stylesheetDescriptor, state);
      }
    }
  }
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((this.layoutNodeId == null) ? 0 : this.layoutNodeId.hashCode());
    result = prime * result
      + ((this.portletDefinition == null) ? 0 : this.portletDefinition.hashCode());
  ...
  public String toString() {
    return "PortletEntity [" + "portletEntityId=" + this.portletEntityId + ", "
      + "layoutNodeId=" + this.layoutNodeId + ", " + "userId=" + this.userId + ", "
