...
public class AttributeSwapRequest implements Serializable {
  ...
  private Map<String, Attribute> currentAttributes = LazyMap.decorate(
    new HashMap<String, Attribute>(), new AttributeFactory());

  @SuppressWarnings("unchecked")
  private Map<String, Attribute> attributesToCopy = LazyMap.decorate(
    new HashMap<String, Attribute>(), new AttributeFactory());
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append(
      "currentAttributes", this.currentAttributes).append("attributesToCopy",
      this.attributesToCopy).toString();
  }
}
