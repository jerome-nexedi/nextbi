 ...
 * @version $Revision$
 */
public final class PortletLinkPlaceholderEventImpl extends
  PortletPlaceholderEventImpl implements PortletLinkPlaceholderEvent {
  ...
  public PortletLinkPlaceholderEventImpl(IPortletWindowId portletWindowId,
  ...
  private int internalHashCode() {
    ...
    result = prime
      * result
      + ((this.getPortletWindowId() == null) ? 0 : this.getPortletWindowId()
        .hashCode());
    result = prime * result
      + ((this.getEventType() == null) ? 0 : this.getEventType().hashCode());
    result = prime
      * result
      + ((this.getDefaultPortletUrl() == null) ? 0 : this.getDefaultPortletUrl()
        .hashCode());
    return result;
  }
  ...
  public String toString() {
    return "PortletLinkPlaceholderEvent [" + "portletWindowId="
      + this.getPortletWindowId() + ", " + "defaultPortletUrl="
