...
public interface IFragmentDefinitionDao {
   ...
   * 
   * @param fd
   *          A fragment definition that has been modified
   */
   ...
   * 
   * @param fd
   *          A fragment definition that exists within this data source
   */
