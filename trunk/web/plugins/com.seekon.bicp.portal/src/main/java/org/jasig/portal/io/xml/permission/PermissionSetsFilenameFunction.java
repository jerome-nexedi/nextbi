 ...
 * @version $Revision$
 */
public class PermissionSetsFilenameFunction implements
  Function<Tuple<String, Node>, String> {
  ...
  public String apply(Tuple<String, Node> data) {
    ...
    final Node node = data.second
      .selectSingleNode("/permission-set/principal/child::node()/child::text()");
