...
public class DTDResolver implements EntityResolver {
  ...
  private static final PublicId[] publicIds = new PublicId[] {
    ...
    new PublicId("-//uPortal//Channel Publishing/EN",
      "channelPublishingDocument.dtd"),
   ...
   * @param systemId
   *          the system ID
   * @return an input source based on the dtd specified in the xml document or
   *         null if we don't have a dtd that matches systemId or publicId
   */
  public InputSource resolveEntity(String publicId, String systemId) {
    ...
    if (systemId != null) {
      ...
      } else if (systemId.trim().equalsIgnoreCase(
