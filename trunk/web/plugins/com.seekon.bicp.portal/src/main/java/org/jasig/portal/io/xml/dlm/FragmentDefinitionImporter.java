 ...
 * @version $Revision$
 */
public class FragmentDefinitionImporter implements
  IDataImporter<Tuple<String, Document>>, Unmarshaller {
  ...
  public Set<PortalDataKey> getImportDataKeys() {
    return Collections
      .singleton(FragmentDefinitionPortalDataType.IMPORT_31_DATA_KEY);
  }
  ...
  public void importData(Tuple<String, Document> data) {
    ...
    final Element fragmentDefElement = this.xPathOperations.evaluate(
    ...
    FragmentDefinition fragmentDefinition = this.fragmentDefinitionDao
      .getFragmentDefinition(fragmentName);
  ...
  public Object unmarshal(Source source) throws IOException, XmlMappingException {
    ...
    try {
      ...
      throw new RuntimeException("Failed to transform " + source + " into Document",
        e);
    }
  ...
  private static class VersionCachingXMLEventStreamReader extends
    FixedXMLEventStreamReader {
