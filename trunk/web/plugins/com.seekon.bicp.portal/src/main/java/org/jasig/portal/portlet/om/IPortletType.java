...
public interface IPortletType extends IPortalData {
  ...
  /**
   * Get the URI of the ChannelPublishingDocument associated with this channel
   * type. This CPD will be used to determine configuration options for channels
   * of this type.
   * 
   ...
   * of this type.
   * 
   * @param ChannelPublishingDocument
   *          URI
   */
