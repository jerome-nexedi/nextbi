...
public class PortletRenderResult implements Serializable {
  ...
  public PortletRenderResult(String title, String externalLink, int newItemCount,
    long renderTime) {
    this.title = title;
  ...
  /**
   * @return The number of new items reported by the portlet for the current
   *         user
   */
  ...
  public String toString() {
    return "PortletRenderResult [renderTime=" + this.renderTime + ", title="
      + this.title + "]";
  }
}
