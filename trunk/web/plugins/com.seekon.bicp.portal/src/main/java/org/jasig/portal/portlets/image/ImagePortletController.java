...
/**
 * <p>
 * A simple portlet which renders an image along with an optional caption and
 * subcaption.
 * </p>
 * <p>
 * Portlet preferences:
 ...
 * <tr>
 * <td>img-uri</td>
 * <td>The URI of the image to display</td>
 * <td>http://webcam.its.hawaii.edu/uhmwebcam/image01.jpg</td>
 * <td>yes</td>
 * </tr>
 * <tr>
 * <td>img-width</td>
 * <td>The width of the image to display</td>
 * <td>320</td>
 * <td>no</td>
 * </tr>
 * <tr>
 * <td>img-height</td>
 * <td>The height of the image to display</td>
 * <td>240</td>
 * <td>no</td>
 * </tr>
 * <tr>
 * <td>img-border</td>
 * <td>The border of the image to display</td>
 * <td>0</td>
 * <td>no</td>
 * </tr>
 * <tr>
 * <td>img-link</td>
 * <td>A URI to be used as an href for the image</td>
 * <td>http://www.hawaii.edu/visitor/#webcams</td>
 * <td>no</td>
 * </tr>
 * <tr>
 * <td>caption</td>
 * <td>A caption of the image to display</td>
 * <td>Almost Live Shot of Hamilton Library Front Entrance</td>
 * <td>no</td>
 * </tr>
 * <tr>
 * <td>subcaption</td>
 * <td>The subcaption of the image to display</td>
 * <td>Updated Once per Minute During Daylight Hours</td>
 * <td>no</td>
 * </tr>
 * <tr>
 * <td>alt-text</td>
 * <td>Text to include as the 'alt' attribute of the img tag</td>
 * <td>Almost live shot of Hamilton library front enterance</td>
 * <td>no, but highly recommended in support of non-visual browsers</td>
 * </tr>
 * </table>
 * 
...
public class ImagePortletController extends AbstractController {
  ...
  protected String getPreference(String name, WebRequest request,
