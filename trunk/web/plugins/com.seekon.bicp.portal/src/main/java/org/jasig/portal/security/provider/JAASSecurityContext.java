...
class JAASSecurityContext extends ChainingSecurityContext implements
  ISecurityContext, Serializable {
  ...
  public synchronized void authenticate() throws PortalSecurityException {
    ...
    if (this.myPrincipal.UID != null
      ...
      try {
        ...
        lc = new LoginContext("uPortal", new JAASInlineCallbackHandler(
          this.myPrincipal.UID, (new String(
            this.myOpaqueCredentials.credentialstring)).toCharArray())); // could
        // not
        // come
        // up
        // w/
