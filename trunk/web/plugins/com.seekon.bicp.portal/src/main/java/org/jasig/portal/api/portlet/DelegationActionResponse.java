...
public class DelegationActionResponse extends DelegationResponse {
  ...
  public DelegationActionResponse(DelegateState delegateState,
    String redirectLocation, String renderUrlParamName) {
    super(delegateState);
  ...
  /**
   * @return The render url parameter name specified in
   *         {@link ActionResponse#sendRedirect(String, String)}, null if no
   *         redirect was sent
   */
  ...
  /**
   * @return The url specified in {@link ActionResponse#sendRedirect(String)},
   *         null if no redirect was sent
   */
  ...
  public int hashCode() {
    ...
    result = prime * result
      + ((redirectLocation == null) ? 0 : redirectLocation.hashCode());
    result = prime * result
      + ((renderParameters == null) ? 0 : renderParameters.hashCode());
    result = prime * result
      + ((renderUrlParamName == null) ? 0 : renderUrlParamName.hashCode());
  ...
  public String toString() {
    return "DelegationActionResponse [redirectLocation=" + redirectLocation
      + ", renderUrlParamName=" + renderUrlParamName + ", portletMode="
      + portletMode + ", windowState=" + windowState + ", renderParameters="
      + renderParameters + ", getDelegateState()=" + getDelegateState() + "]";
  }
}
