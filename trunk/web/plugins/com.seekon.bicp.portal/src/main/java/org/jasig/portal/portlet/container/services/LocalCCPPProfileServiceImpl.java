 ...
 * {@link ProfileFactory#getInstance()}, which returns null if no implementation
 * is available.
 * 
...
public class LocalCCPPProfileServiceImpl implements CCPPProfileService {
  ...
  /**
   * Returns null if no CCPP implementation is available. If a CCPP
   * implementation is available, may return null if no {@link Profile} can be
