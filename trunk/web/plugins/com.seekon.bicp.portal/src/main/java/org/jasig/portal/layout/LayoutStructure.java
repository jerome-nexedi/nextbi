...
public final class LayoutStructure {
  ...
  /**
   * The ID of the LayoutStructure that is the next sibling of this
   * LayoutStructure.
   */
  ...
  /**
   * A List of StructureParameter instances representing parameters to this
   * LayoutStructure.
   * 
   * Prior to uPortal 2.5, this field was null when there were no parameters.
   * Now this field is never null and no parameters are repreesented by an empty
   * list.
   */
   ...
   *          the id of this LayoutStructure
   * @param nextId
   *          the id of the next sibling of this LayoutStructure
   * @param childId
   *          the id of the first child of this LayoutStructure
   * @param chanId
   *          the id of the channel represented by this LayoutStructure, or zero
   *          if we do not represent a channel
   * @param hidden
   *          "T" or "Y" if this LayoutStructure is hidden
   * @param unremovable
   *          "T" or "Y" if this LayoutStructure is unremovable
   * @param immutable
   *          "T" or "Y" if this LayoutStructure is unchangeable
   */
  ...
  /**
   * Get the id of the next LayoutStructure or zero if there is no next
   * LayoutStructure.
   * 
  ...
  /**
   * Get the id of the channel represented by this LayoutStructure instance, or
   * zero if we do not represent a channel.
   * 
  ...
  /**
   * Get the name of the folder that this LayoutStructure represents, or null if
   * this LayoutStructure does not represent a folder.
   * 
  ...
  /**
   * Get a List of StructureParameter instances representing parameters of this
   * LayoutStructure instance.
   * 
   * Prior to uPortal 2.5, this method would return null when there were no
   * parameters. Now we return an empty list when there are no parameters. This
   * simplifies consumers of this class, who can simply blithely iterate over
  ...
  /**
   * Get the String representing the type of the folder that this
   * LayoutStructure represents, or null if this LayoutStructure does not
   * represent a folder. Different layout management approaches may define
   * differing types of folders for their own purposes. The core types typically
   * used by all are: header, footer, and regular. The value returned is the
   * value found in the up_layout_struct table's type column. For instances of
   * LayoutStructure that represent a channel this method will return a value of
   * null.
   * 
