...
/**
 * Represents the rendering state of the portal, all available states should be
 * enumerated here
 * 
...
public enum UrlState {
  /*
   * IMPORTANT, all enum keys must be completely upper case for the helper
   * methods to not cause problems
   */
  ...
  DETACHED,
  /**
   * Rendering a single portlet where the portlet is responsible for all output,
