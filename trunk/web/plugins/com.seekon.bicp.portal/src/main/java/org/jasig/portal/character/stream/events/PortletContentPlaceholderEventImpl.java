 ...
 * @version $Revision$
 */
public final class PortletContentPlaceholderEventImpl extends
  PortletPlaceholderEventImpl implements PortletContentPlaceholderEvent {
  ...
  public String toString() {
    return "PortletContentPlaceholderEvent [" + "portletWindowId="
