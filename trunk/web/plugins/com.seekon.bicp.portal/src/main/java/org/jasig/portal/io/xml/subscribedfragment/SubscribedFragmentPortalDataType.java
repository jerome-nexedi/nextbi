...
public class SubscribedFragmentPortalDataType extends AbstractPortalDataType {
   ...
   */
  @Deprecated
  public static final QName LEGACY_PORTLET_TYPE_QNAME = new QName(
    "subscribed-fragments");

  public static final PortalDataKey IMPORT_40_DATA_KEY = new PortalDataKey(
    PORTLET_TYPE_QNAME, null, "4.0");
  ...
  public static final PortalDataKey IMPORT_32_DATA_KEY = new PortalDataKey(
    ...
    "classpath://org/jasig/portal/io/import-subscribed-fragment_v3-2.crn", null);

  private static final List<PortalDataKey> PORTAL_DATA_KEYS = Arrays.asList(
    IMPORT_32_DATA_KEY, IMPORT_40_DATA_KEY);
