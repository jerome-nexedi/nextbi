...
public class LockableEntityGroupImpl extends EntityGroupImpl implements
   ...
   */
  public LockableEntityGroupImpl(String groupKey, Class groupType)
   ...
   * back-pointers of the updated members, and force the retrieval of containing
   * groups in case the memberships of THIS group have changed during the time
