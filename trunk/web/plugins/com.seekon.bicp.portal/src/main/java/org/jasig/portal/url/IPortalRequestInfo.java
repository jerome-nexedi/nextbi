...
public interface IPortalRequestInfo {
  ...
  /**
   * @return The layout node being targeted by the request. If the request isn't
   *         targeting a particular layout node null is returned.
   */
  public String getTargetedLayoutNodeId();

  /**
   * @return The portlet window id targeted by the request. If the request isn't
   *         targeting a particular portlet null is returned.
   */
  public IPortletWindowId getTargetedPortletWindowId();

  /**
   * @return The {@link IPortletRequestInfo} for the targeted portlet. If the
   *         request isn't targeting a particular portlet null is returned.
   */
   ...
   * @return The {@link IPortletRequestInfo} for the window id, null if no
   *         request info for the window
   */
  public IPortletRequestInfo getPortletRequestInfo(IPortletWindowId portletWindowId);

  /**
   * @return Information for each of the portlets that has data on the request.
   *         The returned map is read only and will never be null.
   */
