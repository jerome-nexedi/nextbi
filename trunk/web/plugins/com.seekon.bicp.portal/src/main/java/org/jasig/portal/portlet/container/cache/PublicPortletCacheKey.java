...
public class PublicPortletCacheKey implements Serializable {
  ...
  static PublicPortletCacheKey createPublicPortletRenderCacheKey(
    IPortletDefinitionId portletDefinitionId, IPortletWindow portletWindow,
    Locale locale) {
    return new PublicPortletCacheKey(portletDefinitionId, portletWindow, false,
      null, locale);
  }
  ...
  static PublicPortletCacheKey createPublicPortletRenderHeaderCacheKey(
    IPortletDefinitionId portletDefinitionId, IPortletWindow portletWindow,
    Locale locale) {
    return new PublicPortletCacheKey(portletDefinitionId, portletWindow, true, null,
      locale);
  }
  ...
  private PublicPortletCacheKey(IPortletDefinitionId portletDefinitionId,
    IPortletWindow portletWindow, boolean renderHeader, String resourceId,
    Locale locale) {
  ...
  public String toString() {
    if (renderHeader) {
      return "PublicPortletRenderHeaderCacheKey [portletDefinitionId="
        + portletDefinitionId + ", parameters=" + parameters + ", locale=" + locale
        + ", windowState=" + windowState + ", portletMode=" + portletMode + "]";
    }
    if (resourceId != null) {
      return "PublicPortletResourceCacheKey [portletDefinitionId="
        + portletDefinitionId + ", parameters=" + parameters + ", resourceId="
        + resourceId + ", locale=" + locale + ", windowState=" + windowState
        + ", portletMode=" + portletMode + "]";
    }
    return "PublicPortletRenderCacheKey [portletDefinitionId=" + portletDefinitionId
      + ", parameters=" + parameters + ", locale=" + locale + ", windowState="
