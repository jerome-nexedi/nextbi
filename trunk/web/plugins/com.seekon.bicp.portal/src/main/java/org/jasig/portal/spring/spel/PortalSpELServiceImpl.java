...
public class PortalSpELServiceImpl implements IPortalSpELService, BeanFactoryAware {
  ...
  public void setExpressionCache(
    @Qualifier("SpELExpressionCache") Ehcache expressionCache) {
  ...
  protected Expression parseCachedExpression(String expressionString,
    ParserContext parserContext) throws ParseException {
  ...
  public String parseString(String expressionString, WebRequest request) {
    final Expression expression = this.parseCachedExpression(expressionString,
      TemplateParserContext.INSTANCE);
    return this.getValue(expression, request, String.class);
  }

  @Override
  public <T> T getValue(String expressionString, WebRequest request,
  ...
  @Override
  public <T> T getValue(Expression expression, WebRequest request,
    Class<T> desiredResultType) {
  ...
  protected EvaluationContext getEvaluationContext(WebRequest request) {
    final HttpServletRequest httpRequest = this.portalRequestUtils
      .getOriginalPortalRequest(request);
   ...
   * context, but we'd like to be able to add additional objects in the future.
   */
