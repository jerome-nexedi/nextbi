...
public class PortletDefinitionRegistryLocator extends
  AbstractBeanLocator<IPortletDefinitionRegistry> {
  public static final String BEAN_NAME = "portletDefinitionRegistry";

  private static final Log LOG = LogFactory
    .getLog(PortletDefinitionRegistryLocator.class);
    ...
    if (locator == null) {
      ...
      if (locator == null) {
        ...
        return applicationContext.getBean(BEAN_NAME,
          IPortletDefinitionRegistry.class);
      }
    }
