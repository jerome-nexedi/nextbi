...
public interface DateDimensionDao {
  ...
  /**
   * @return The newest (largest time in millis) date dimension in the
   *         persistent store
   */
  DateDimension getNewestDateDimension();

  /**
   * @return The oldest (smallest time in millis) date dimension in the
   *         persistent store
   */
  ...
  /**
   * @return A list of all date dimensions in the persistent store,
   *         chronological order
   */
   ...
   * @param end
   *          End date (exclusive)
   * @return A list of the date dimensions that exist between the specified
   *         start and end
   */
