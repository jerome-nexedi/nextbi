 ...
 * Security's Authentication interface, enabling pre-authentication scenarios in
 * uPortal. This implementation wraps the IPerson object, delegating to it for
 * determining authentication state and user details. The user's current
 * SecurityContext is used as the credentials object.
 * 
