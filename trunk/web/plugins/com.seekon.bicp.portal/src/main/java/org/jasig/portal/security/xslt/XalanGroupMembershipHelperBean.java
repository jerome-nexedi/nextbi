...
public class XalanGroupMembershipHelperBean implements IXalanGroupMembershipHelper {
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.security.xslt.IXalanGroupMembershipHelper#
   * isChannelDeepMemberOf(java.lang.String, java.lang.String)
   */
  @Override
  public boolean isChannelDeepMemberOf(String fname, String groupKey) {
    ...
    try {
      ...
      this.logger.warn(
        "Caught exception while retrieving portlet definition for fname '" + fname
          + "'", e);
      return false;
    }
    ...
    final String portletId = portletDefinition.getPortletDefinitionId()
      .getStringId();
    final IEntity entity = GroupService.getEntity(portletId,
   ...
   * 
   * @see
   * org.jasig.portal.security.xslt.IXalanGroupMembershipHelper#isUserDeepMemberOf
   ...
   * 
   * @seeorg.jasig.portal.security.xslt.IXalanGroupMembershipHelper#
   * isUserDeepMemberOfGroupName(java.lang.String, java.lang.String)
   */
  @Override
  public boolean isUserDeepMemberOfGroupName(String userName, String groupName) {
    final EntityIdentifier[] results = GroupService.searchForGroups(groupName,
    ...
    if (results.length > 1) {
      this.logger.warn(results.length + " groups were found for '" + groupName
