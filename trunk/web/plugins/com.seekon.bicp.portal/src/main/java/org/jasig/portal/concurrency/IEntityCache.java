...
/**
 * Defines the api for a cache that caches <code>IBasicEntities</code> of a
 * single type.
 * 
...
public interface IEntityCache {
  ...
  /**
   * Answers the number of entries in the cache. May return -1 if the cache does
   * not make this information avaialble
   */
  public int size();
