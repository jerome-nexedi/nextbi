 ...
 * @version $Revision$
 * @deprecated code that needs an IEntityCachingService should use direct
 *             dependency injection where possible
 */
@Deprecated
public class EntityCachingServiceLocator extends
  AbstractBeanLocator<IEntityCachingService> {
  public static final String BEAN_NAME = "entityCachingService";

  private static final Log LOG = LogFactory
    .getLog(EntityCachingServiceLocator.class);
