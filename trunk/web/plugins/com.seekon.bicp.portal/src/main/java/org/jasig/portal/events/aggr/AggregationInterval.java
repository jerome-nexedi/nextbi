...
/**
 * Enumeration of all time intervals the event aggregation can handle. All of
 * the example ranges are inclusive on both ends
 * 
...
public enum AggregationInterval {
  ...
  /**
   * As defined by the deployer, divides the calendar into 4 sections. Default
   * configuration is: 3 Calendar months (Jan 1 - Mar 31, Apr 1 - Jun 30, Jul 1
   * - Sep 30, Oct 1 - Dec 31)
   */
  CALENDAR_QUARTER(null),
  /**
   * As defined by the deployer, unusable unless term boundaries have been
   * configured.
   */
  ACADEMIC_TERM(null),
  /**
  ...
  /**
   * @return the {@link DateTimeFieldType} for the {@link AggregationInterval},
