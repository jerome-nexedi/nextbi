...
public class GroupMembershipPortalDataType extends AbstractPortalDataType {
  ...
  public static final PortalDataKey IMPORT_30_DATA_KEY = new PortalDataKey(
    LEGACY_GROUP_QNAME,
    "classpath://org/jasig/portal/io/import-group_membership_v3-0.crn", null);

  public static final PortalDataKey IMPORT_32_DATA_KEY = new PortalDataKey(
    LEGACY_GROUP_QNAME,
    "classpath://org/jasig/portal/io/import-group_membership_v3-2.crn", null);
  ...
  public static final PortalDataKey IMPORT_GROUP_32_DATA_KEY = new PortalDataKey(
    LEGACY_GROUP_QNAME,
    "classpath://org/jasig/portal/io/import-group_membership_v3-2.crn", "GROUP");
  ...
  public static final PortalDataKey IMPORT_MEMBERS_32_DATA_KEY = new PortalDataKey(
    LEGACY_GROUP_QNAME,
    "classpath://org/jasig/portal/io/import-group_membership_v3-2.crn", "MEMBERS");
  ...
  public static final PortalDataKey IMPORT_GROUP_30_DATA_KEY = new PortalDataKey(
    LEGACY_GROUP_QNAME,
    "classpath://org/jasig/portal/io/import-group_membership_v3-0.crn", "GROUP");
  ...
  public static final PortalDataKey IMPORT_MEMBERS_30_DATA_KEY = new PortalDataKey(
    LEGACY_GROUP_QNAME,
    "classpath://org/jasig/portal/io/import-group_membership_v3-0.crn", "MEMBERS");

  private static final List<PortalDataKey> PORTAL_DATA_KEYS = Arrays
    .asList(IMPORT_30_DATA_KEY, IMPORT_32_DATA_KEY, IMPORT_GROUP_30_DATA_KEY,
      IMPORT_GROUP_32_DATA_KEY, IMPORT_MEMBERS_30_DATA_KEY,
      IMPORT_MEMBERS_32_DATA_KEY);

  private static final Set<PortalDataKey> GROUP_MEMBERS_30_KEYS = ImmutableSet.of(
    IMPORT_GROUP_30_DATA_KEY, IMPORT_MEMBERS_30_DATA_KEY);

  private static final Set<PortalDataKey> GROUP_MEMBERS_32_KEYS = ImmutableSet.of(
