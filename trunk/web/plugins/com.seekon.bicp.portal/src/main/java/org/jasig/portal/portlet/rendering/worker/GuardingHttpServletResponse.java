...
/**
 * Wrapper for a {@link HttpServletResponse} that makes the response
 * inaccessible once the worker has been canceled.
 * 
...
public class GuardingHttpServletResponse extends HttpServletResponseWrapper {
  ...
  public GuardingHttpServletResponse(HttpServletResponse request,
   ...
   * 
   * @see
   * javax.servlet.http.HttpServletResponseWrapper#addCookie(javax.servlet.http
   * .Cookie)
   */
  @Override
   ...
   * 
   * @see
   * javax.servlet.http.HttpServletResponseWrapper#encodeRedirectURL(java.lang
   * .String)
   */
  @Override
