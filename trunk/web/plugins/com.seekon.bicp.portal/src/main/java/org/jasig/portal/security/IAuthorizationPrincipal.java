 ...
 * <code>IPermissions</code> have been granted. Such an entity could be an
 * <code>IGroupMember</code>, an <code>IChannel</code> or an
 * <code>IPerson</code>.
 * 
...
public interface IAuthorizationPrincipal {
  ...
  /**
   * Answers if this <code>IAuthorizationPrincipal</code> has permission to use
   * the CONFIG PortletMode on the specified channel
   * 
   * @param channelPublishId
   * @return
   * @throws AuthorizationException
  ...
  /**
   * Answers if this <code>IAuthoriztionPrincipal</code> has permission to
   * render this channel.
   * 
   * @return boolean
   * @param channelPublishId
   ...
   * <code>activity</code> and <code>target</code>. This includes inherited
   * <code>IPermissions</code>. Null parameters are ignored, so
