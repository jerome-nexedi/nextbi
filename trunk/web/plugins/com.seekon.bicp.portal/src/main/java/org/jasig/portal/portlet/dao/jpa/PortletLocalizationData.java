...
/**
 * ChannelLocalizationData represents locale-specific ChannelDefinition
 * metadata. This class is intended to be used in a JPA/Hibernate-managed map
 * and does not include the locale itself as part of its data model.
 * 
