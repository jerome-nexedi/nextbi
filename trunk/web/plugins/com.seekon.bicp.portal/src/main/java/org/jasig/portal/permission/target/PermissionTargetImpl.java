 ...
 * @since 3.3
 */
public class PermissionTargetImpl implements IPermissionTarget,
  Comparable<IPermissionTarget>, Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(this.key, target.getKey()).append(this.name,
      target.getName()).isEquals();
  }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(464270933, -1074792143).append(this.key).append(
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("key",
      this.key).append("name", this.name).toString();
  }
  ...
  public int compareTo(IPermissionTarget target) {
    return new CompareToBuilder().append(this.name, target.getName()).append(
      this.key, target.getKey()).toComparison();
  }
