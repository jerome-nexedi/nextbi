...
public interface IPersonManager {
   ...
   * 
   * @param request
   *          needed to provide a session for the user
   * @return a true/false the user is actually another user impersonating as
   *         this user.
   */
   ...
   *          'true' to show that the user is impersonating another user now.
   */
