...
/**
 * Provides access to the original portal and portlet requests using the
 * {@link PortalHttpServletRequestWrapper#ATTRIBUTE__HTTP_SERVLET_REQUEST} and
 * {@link PortletHttpServletRequestWrapper#ATTRIBUTE__HTTP_SERVLET_REQUEST}
 * 
...
public class PortalRequestUtilsImpl implements IPortalRequestUtils {
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortalRequestUtils#getOriginalPortalRequest(javax
   * .portlet.PortletRequest)
   */
  @Override
  public HttpServletRequest getPortletHttpRequest(PortletRequest portletRequest) {
    final HttpServletRequest portalRequest = (HttpServletRequest) portletRequest
      .getAttribute(PortletHttpServletRequestWrapper.ATTRIBUTE__HTTP_SERVLET_REQUEST);
   ...
   */
  @Override
  public HttpServletRequest getOriginalPortalRequest(
  ...
  @Override
  public HttpServletRequest getOriginalPortletOrPortalRequest(
    HttpServletRequest request) {
    final HttpServletRequest portletRequest = (HttpServletRequest) request
      .getAttribute(PortletHttpServletRequestWrapper.ATTRIBUTE__HTTP_SERVLET_REQUEST);
  ...
  public HttpServletRequest getOriginalPortalRequest(WebRequest request) {
    final HttpServletRequest portalRequest = (HttpServletRequest) request
      .getAttribute(PortalHttpServletRequestWrapper.ATTRIBUTE__HTTP_SERVLET_REQUEST,
  ...
  public HttpServletResponse getOriginalPortalResponse(PortletRequest portletRequest) {
    final HttpServletResponse portalResponse = (HttpServletResponse) portletRequest
      .getAttribute(PortalHttpServletRequestWrapper.ATTRIBUTE__HTTP_SERVLET_RESPONSE);
  ...
  @Override
  public HttpServletResponse getOriginalPortalResponse(
    HttpServletRequest portletRequest) {
    final HttpServletResponse portalResponse = (HttpServletResponse) portletRequest
      .getAttribute(PortalHttpServletRequestWrapper.ATTRIBUTE__HTTP_SERVLET_RESPONSE);
    if (portalResponse != null) {
  ...
  public HttpServletRequest getCurrentPortalRequest() {
    ...
    if (requestAttributes instanceof ServletRequestAttributes) {
      ...
      final PortletRequest request = ((PortletRequestAttributes) requestAttributes)
        .getRequest();
      ...
      throw new IllegalStateException(
        "No ServletRequestAttributes or PortletRequestAttributes available from the RequestContextHolder. "
          + (requestAttributes == null ? null : requestAttributes.getClass()
            .getName()));
    }
  }
