...
/**
 * Implementation of DoubleCheckedCreator that stores what it creates in a
 * backing Map. Subclasses need to implement {@link #getKey(Object...)} to
 * provide a Map key to use for the arguments and {@link #create(Object...)} to
 * create new instances of the objects. <br/>
 * The default constructor uses a {@link ReferenceMap} with hard references to
 * the keys
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public abstract class MapCachingDoubleCheckedCreator<K, T> extends
  ...
  /**
   * @param cache
   *          The Map to store created instances in
   */
   ...
   *          The Map to store created instances in
   * @param readWriteLock
   *          the ReadWriteLock to use for the double checked locking
   */
  ...
  /**
   * @return A read-only view of the underlying Map used to cache created
   *         objects
   */
  ...
  /**
   * @param args
   *          Optional arguments passed to {@link #get(Object...)} used to
   *          create a key
   ...
   * @param args
   *          The object retrieval arguments
   ...
   * 
   * @see
   * org.jasig.portal.utils.threading.DoubleCheckedCreator#create(java.lang.
   * Object[])
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.utils.threading.DoubleCheckedCreator#retrieve(java.lang
   * .Object[])
   */
  @Override
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append(
      "objectCache", this.objectCache).toString();
  }
}
