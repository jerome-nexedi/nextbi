...
public class RemoteUserSettingFilter implements Filter {
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    final String remoteUserFileName = filterConfig
      .getInitParameter("remoteUserFile");
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    final String remoteUser = StringUtils.trimToNull(FileUtils
      .readFileToString(this.remoteUserFile));
    ...
    if (remoteUser != null) {
      request = new HttpServletRequestWrapper((HttpServletRequest) request) {
        ...
        public Enumeration<String> getHeaders(String name) {
          if ("REMOTE_USER".equals(name)) {
            return Iterators.asEnumeration(Collections.singleton(remoteUser)
              .iterator());
          }
         ...
         * 
         * @see
         * javax.servlet.http.HttpServletRequestWrapper#getIntHeader(java.lang
         * .String)
         */
        @Override
