...
public class PLFIntegrator {
  ...
  /**
     */
  public static void mergePLFintoILF(Document plf, Document ilf,
  ...
  private static void mergeFolder(Element plfChild, Element plfParent,
    Element ilfParent, IntegrationResult result) throws PortalException {
    String id = plfChild.getAttribute(Constants.ATT_ID);
  ...
  /**
   * This method copies a plf node and any of its children into the passed in
   * compViewParent.
   */
