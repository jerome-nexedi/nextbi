...
public class ResourcesAggregationHelper {
  /**
   * Name of {@link System} property used to toggle default/aggregated skin
   * output.
   */
  ...
  public boolean isAggregationEnabled() {
    return Included.AGGREGATED == this.resourcesElementsProvider
      .getIncludedType(null);
  }

  /**
   * Toggle resources aggregation (if and only if value parameter differs from
   * current value).
   */
