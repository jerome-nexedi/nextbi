...
class UserFragmentSubscriptionImpl implements IUserFragmentSubscription {
  ...
  @Transient
  private EntityIdentifier entityIdentifier = new EntityIdentifier(null,
    IUserFragmentSubscription.class);
  ...
  public UserFragmentSubscriptionImpl(IPerson person, IPerson fragmentOwner) {
    ...
    this.entityIdentifier = new EntityIdentifier(String.valueOf(this.fragmentOwner),
      IUserFragmentSubscription.class);
  ...
  /**
   * Returns an EntityIdentifier for this fragment owner. The key contains the
   * value of the eudPerson fragment owner attribute, or null
   * 
  ...
  public String toString() {
    return "UserFragmentSubscriptionImpl [userFragmentInfoId="
      + this.userFragmentInfoId + ", entityVersion=" + this.entityVersion
      + ", userId=" + this.userId + ", fragmentOwner=" + this.fragmentOwner
      + ", active=" + this.active + ", createdBy=" + this.createdBy
      + ", creationDate=" + this.creationDate + ", lastUpdatedDate="
      + this.lastUpdatedDate + ", entityIdentifier=" + this.entityIdentifier + "]";
  }
