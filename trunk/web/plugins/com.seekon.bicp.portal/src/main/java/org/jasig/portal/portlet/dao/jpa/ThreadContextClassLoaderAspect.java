...
/**
 * Switches context class loader for {@link Thread#currentThread()} to the class
 * loader of this class and switches it back after the method completes
 * 
...
public class ThreadContextClassLoaderAspect implements Ordered {
  private static final ClassLoader PORTAL_CLASS_LOADER = ThreadContextClassLoaderAspect.class
    .getClassLoader();
  ...
  /**
   * Wraps the targeted execution, switching the current thread's context class
   * loader to this classes class loader.
   */
  @Pointcut
