...
/**
 * Defines a lock associated with an owner and a portal entity that guarantees
 * some degree of exclusive access to the entity, depending on
 * <code>lockType</code> and <code>expirationTime</code>.
 * 
 * See IEntityLockService for the rules governing lock assignment and a code
 * example.
 * 
