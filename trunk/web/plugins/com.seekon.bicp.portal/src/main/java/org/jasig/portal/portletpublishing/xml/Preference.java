 ...
 *         &lt;element ref="{https://source.jasig.org/schemas/uportal/portlet-publishing}preference-input"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "preference", propOrder = { "name", "readOnly", "label",
  "description", "example", "preferenceInput" })
@Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
public class Preference implements Serializable, Equals, HashCode, ToString {
  ...
  @XmlElementRef(name = "preference-input", namespace = "https://source.jasig.org/schemas/uportal/portlet-publishing", type = JAXBElement.class)
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  protected JAXBElement<? extends PreferenceInputType> preferenceInput;
  ...
  /**
   * Gets the value of the preferenceInput property.
   * 
   * @return possible object is {@link JAXBElement }{@code <}
   *         {@link PreferenceInputType }{@code >} {@link JAXBElement }{@code <}
   *         {@link MultiChoicePreferenceInput }{@code >} {@link JAXBElement }
   *         {@code <}{@link MultiTextPreferenceInput }{@code >}
   *         {@link JAXBElement }{@code <}{@link SingleTextPreferenceInput }
   *         {@code >} {@link JAXBElement }{@code <}
   *         {@link SingleChoicePreferenceInput }{@code >}
   * 
   */
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  public JAXBElement<? extends PreferenceInputType> getPreferenceInput() {
    return preferenceInput;
  }

  /**
   * Sets the value of the preferenceInput property.
   * 
   * @param value
   ...
   */
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  public void setPreferenceInput(JAXBElement<? extends PreferenceInputType> value) {
    this.preferenceInput = value;
  }
  ...
  public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer,
    ...
    {
      JAXBElement<? extends PreferenceInputType> thePreferenceInput;
      thePreferenceInput = this.getPreferenceInput();
      strategy.appendField(locator, this, "preferenceInput", buffer,
        thePreferenceInput);
    }
    return buffer;
  }
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
    ...
    {
      JAXBElement<? extends PreferenceInputType> lhsPreferenceInput;
      lhsPreferenceInput = this.getPreferenceInput();
      JAXBElement<? extends PreferenceInputType> rhsPreferenceInput;
      rhsPreferenceInput = that.getPreferenceInput();
      if (!strategy.equals(LocatorUtils.property(thisLocator, "preferenceInput",
        lhsPreferenceInput), LocatorUtils.property(thatLocator, "preferenceInput",
        rhsPreferenceInput), lhsPreferenceInput, rhsPreferenceInput)) {
        return false;
      }
    }
    return true;
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
    ...
    }
    {
      ...
      thePreferenceInput = this.getPreferenceInput();
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
        "preferenceInput", thePreferenceInput), currentHashCode, thePreferenceInput);
    }
