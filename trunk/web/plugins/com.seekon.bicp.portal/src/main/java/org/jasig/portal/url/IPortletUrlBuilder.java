...
public interface IPortletUrlBuilder extends IUrlBuilder {
  ...
  /**
   * @return The parent {@link IPortalUrlBuilder} of this
   *         {@link IPortletUrlBuilder}
   */
   ...
   *           If parent {@link IPortalUrlBuilder#getUrlType()} returns
   ...
   * @throws IllegalStateException
   *           If parent {@link IPortalUrlBuilder#getUrlType()} does not return
   *           {@link UrlType#RESOURCE}
   */
  ...
  /**
   * Get the public render parameters set by this portlet. The Map is mutable
   * and making changes to the Map will affect the public render parameters on
   * the URL.
   * 
   ...
   *          If set to true all current private render parameters are copied to
   *          the URL
   */
  public void setCopyCurrentRenderParameters(boolean copyCurrentRenderParameters);

  /**
   * @return If the current private render parameters should be copied to the
   *         generared URL
   */
