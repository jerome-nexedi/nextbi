 ...
 */
@Service
public class PermissionAdministrationHelper implements
  IPermissionAdministrationHelper {
  ...
  public boolean canEditOwner(IPerson currentUser, String owner) {
    ...
    return (ap.hasPermission(PERMISSIONS_OWNER, EDIT_PERMISSION,
      ALL_PERMISSIONS_TARGET));
  }
  ...
  public boolean canViewOwner(IPerson currentUser, String owner) {
    ...
    IAuthorizationPrincipal ap = AuthorizationService.instance().newPrincipal(
      ei.getKey(), ei.getType());
    return (ap.hasPermission(PERMISSIONS_OWNER, VIEW_PERMISSION,
      ALL_PERMISSIONS_TARGET));
  }
   ...
   * 
   * @see
   * org.jasig.portal.portlets.permissionsadmin.IPermissionAdministrationHelper
   * #canEditPermission(org.jasig.portal.security.IPerson, java.lang.String)
   */
   ...
   * @see
   * org.jasig.portal.portlets.permissionsadmin.IPermissionAdministrationHelper
   * #canViewPermission(org.jasig.portal.security.IPerson, java.lang.String)
   */
  ...
  public Set<String> getCurrentPrincipals(IPermissionOwner owner,
    ...
    IPermission[] permissions = permissionStore.select(owner.getFname(), null,
      activity.getFname(), targetKey, null);
