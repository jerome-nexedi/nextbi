 ...
 */
@Repository
public class JpaPortletDefinitionDao extends BaseJpaDao implements
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    this.findDefinitionByFnameQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletDefinitionImpl>>() {
        @Override
        public CriteriaQuery<PortletDefinitionImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<PortletDefinitionImpl> criteriaQuery = cb
          ...
          criteriaQuery.select(definitionRoot);
          addFetches(definitionRoot);
          criteriaQuery.where(cb.equal(definitionRoot
            .get(PortletDefinitionImpl_.fname), fnameParameter));
    ...
    this.findDefinitionByNameQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletDefinitionImpl>>() {
        ...
        public CriteriaQuery<PortletDefinitionImpl> apply(CriteriaBuilder cb) {
          ...
          addFetches(definitionRoot);
          criteriaQuery.where(cb.equal(definitionRoot
            .get(PortletDefinitionImpl_.name), nameParameter));
    ...
    this.findDefinitionByNameOrTitleQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletDefinitionImpl>>() {
        ...
        public CriteriaQuery<PortletDefinitionImpl> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.select(definitionRoot);
          addFetches(definitionRoot);
          criteriaQuery.where(cb.or(cb.equal(definitionRoot
            .get(PortletDefinitionImpl_.name), nameParameter), cb.equal(
    ...
    this.searchDefinitionByNameOrTitleQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletDefinitionImpl>>() {
        ...
        public CriteriaQuery<PortletDefinitionImpl> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.select(definitionRoot);
          addFetches(definitionRoot);
          criteriaQuery.where(cb.or(cb.like(definitionRoot
            .get(PortletDefinitionImpl_.name), nameParameter), cb.like(
            definitionRoot.get(PortletDefinitionImpl_.title), titleParameter)));
  ...
  public IPortletDefinition getPortletDefinition(
    ...
    final PortletDefinitionImpl portletDefinition = this.entityManager.find(
      PortletDefinitionImpl.class, internalPortletDefinitionId);
  ...
  public IPortletDefinition getPortletDefinition(String portletDefinitionIdString) {
    Validate.notNull(portletDefinitionIdString,
      "portletDefinitionIdString can not be null");
  ...
  public IPortletDefinition getPortletDefinitionByFname(String fname) {
    final TypedQuery<PortletDefinitionImpl> query = this
      .createCachedQuery(this.findDefinitionByFnameQuery);
  ...
  public IPortletDefinition getPortletDefinitionByName(String name) {
    final TypedQuery<PortletDefinitionImpl> query = this
      .createCachedQuery(this.findDefinitionByNameQuery);
  ...
  public List<IPortletDefinition> searchForPortlets(String term, boolean allowPartial) {
    ...
    final TypedQuery<PortletDefinitionImpl> query = this
      .createCachedQuery(criteriaQuery);
  ...
  public List<IPortletDefinition> getPortletDefinitions() {
    final TypedQuery<PortletDefinitionImpl> query = this
      .createCachedQuery(this.findAllPortletDefinitions);

    final List<PortletDefinitionImpl> portletDefinitions = query.getResultList();
    return new ArrayList<IPortletDefinition>(new LinkedHashSet<IPortletDefinition>(
      portletDefinitions));
  }
  ...
  public IPortletDefinition createPortletDefinition(IPortletType portletType,
    ...
    final PortletDefinitionImpl portletDefinition = new PortletDefinitionImpl(
      portletType, fname, name, title, applicationId, portletName, isFramework);
   ...
   * 
   * @see
   * org.jasig.portal.dao.portlet.IPortletDefinitionDao#updatePortletDefinition
   * (org.jasig.portal.om.portlet.IPortletDefinition)
   */
  @Override
  @Transactional
  ...
  protected long getNativePortletDefinitionId(
    IPortletDefinitionId portletDefinitionId) {
