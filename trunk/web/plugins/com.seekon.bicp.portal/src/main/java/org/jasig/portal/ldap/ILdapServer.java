...
/**
 * The <code>ILdapServer</code> interface defines a set of methods to be used to
 * create a connection to an LDAP server, release the connection and get
 * information about the connection.
 * 
 * @author Eric Dalquist <a
 *         href="mailto:edalquist@unicon.net">edalquist@unicon.net</a>
 * @version $Revision$
 * @deprecated Framework code should access {@link LdapContextSource} objects in
 *             the spring context via injection instead of using these APIs.
 */
public interface ILdapServer {
   ...
   *           If there is a problem connecting to the ldap server.
   */
