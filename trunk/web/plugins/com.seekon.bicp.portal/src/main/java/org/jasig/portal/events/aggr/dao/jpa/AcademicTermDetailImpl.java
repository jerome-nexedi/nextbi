...
public class AcademicTermDetailImpl implements AcademicTermDetail, Serializable {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((this.endDateMidnight == null) ? 0 : this.endDateMidnight.hashCode());
    result = prime * result
      + ((this.startDateMidnight == null) ? 0 : this.startDateMidnight.hashCode());
    result = prime * result
      + ((this.termName == null) ? 0 : this.termName.hashCode());
    return result;
  }
  ...
  public String toString() {
    return "AcademicTermDetailImpl [termName=" + this.termName
      + ", startDateMidnight=" + this.startDateMidnight + ", endDateMidnight="
