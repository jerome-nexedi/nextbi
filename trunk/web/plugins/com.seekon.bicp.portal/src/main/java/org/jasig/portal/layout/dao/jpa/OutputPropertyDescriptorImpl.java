...
@SequenceGenerator(name = "UP_SS_DESC_OUTPUT_PROP_GEN", sequenceName = "UP_SS_DESC_OUTPUT_PROP_SEQ", allocationSize = 5)
@TableGenerator(name = "UP_SS_DESC_OUTPUT_PROP_GEN", pkColumnValue = "UP_SS_DESC_OUTPUT_PROP", allocationSize = 5)
@Cacheable
