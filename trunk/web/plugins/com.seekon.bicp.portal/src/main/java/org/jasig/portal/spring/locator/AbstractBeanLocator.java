...
/**
 * Provides base functionality for a static reference bean locator. Used by
 * legacy code that is not managed within spring, avoids direct use of
 * PortalApplicationContextLocator by client code and in the case of an already
 * created ApplicationConext uses the bean refernce injected by the context.
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public abstract class AbstractBeanLocator<T> implements DisposableBean,
  InitializingBean {
