 ...
 * @version $Revision$
 */
public abstract class AbstractDom4jExporter implements
  IDataExporter<Tuple<String, Element>>, Marshaller {
  ...
  public void marshal(Object graph, Result result) throws IOException,
    ...
    try {
      ...
      throw new RuntimeException("Failed to write Element to Result for: "
        + data.first, e);
    }
  }
}
