 ...
 * consisting of component group services. These entry points are represented by
 * <code>IGroupMembers</code>. The role of the <code>IGroupMember</code>is
 * somewhat analogous to that of an <code>InitialContext</code> in JNDI. Once a
 * client gets an <code>IGroupMember</code>, subsequent requests for navigating
...
public interface ICompositeGroupService extends IComponentGroupService {
   ...
   * <code>IGroupMember</code> is an <code>IEntityGroup</code>. Otherwise it is
