 ...
 * LDAP directory as the user so that it can authenticate the user. The user's
 ...
 * @version $Revision$
 * @deprecated As of uPortal 2.1.3, use
 *             {@link org.jasig.portal.security.provider.SimpleLdapSecurityContext}
 *             chained with
 *             {@link org.jasig.portal.security.provider.CacheSecurityContext}
 *             instead
 */
public class CacheLdapSecurityContext extends SimpleLdapSecurityContext {
  ...
  public synchronized void authenticate() throws PortalSecurityException {
    ...
    System.arraycopy(this.myOpaqueCredentials.credentialstring, 0,
      this.cachedCredentials, 0, this.myOpaqueCredentials.credentialstring.length);
