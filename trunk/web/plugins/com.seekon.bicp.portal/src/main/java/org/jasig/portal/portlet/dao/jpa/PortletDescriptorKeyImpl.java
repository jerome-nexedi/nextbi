...
class PortletDescriptorKeyImpl implements IPortletDescriptorKey, Serializable {
  ...
  public int hashCode() {
    ...
    result = prime * result
      + ((this.portletName == null) ? 0 : this.portletName.hashCode());
    result = prime * result
      + ((this.webAppName == null) ? 0 : this.webAppName.hashCode());
    return result;
  }
  ...
  public String toString() {
    return "PortletDescriptorKey [frameworkPortlet=" + this.frameworkPortlet
      + ", webAppName=" + this.webAppName + ", portletName=" + this.portletName
      + "]";
  }
}
