...
public class SqlQueryConfigurationController extends SimpleFormController {
  ...
  protected void onSubmitAction(ActionRequest request, ActionResponse response,
    ...
    prefs.setValue(SqlQueryPortletController.DATASOURCE_BEAN_NAME_PARAM_NAME, form
      .getDataSource());
    prefs.setValue(SqlQueryPortletController.SQL_QUERY_PARAM_NAME, form
      .getSqlQuery());
  ...
  protected Object formBackingObject(PortletRequest request) throws Exception {
    ...
    form.setDataSource(prefs.getValue(
      SqlQueryPortletController.DATASOURCE_BEAN_NAME_PARAM_NAME, defaultDataSource));
    form.setViewName(prefs.getValue(SqlQueryPortletController.VIEW_PARAM_NAME,
      defaultView));
