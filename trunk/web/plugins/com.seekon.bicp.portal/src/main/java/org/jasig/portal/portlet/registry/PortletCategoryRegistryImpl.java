...
public class PortletCategoryRegistryImpl implements IPortletCategoryRegistry {
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletCategoryRegistry#
   * addCategoryToCategory(org.jasig.portal.portlet.om.PortletCategory,
   * org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
   ...
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletCategoryRegistry#
   * deletePortletCategory(org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
  public void deletePortletCategory(PortletCategory category) {
    String key = String.valueOf(category.getId());
    ILockableEntityGroup categoryGroup = GroupService.findLockableGroup(key,
      "UP_PORTLET_PUBLISH");
   ...
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletCategoryRegistry#
   * getAllChildCategories(org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletCategoryRegistry#getAllChildChannels
   * (org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletCategoryRegistry#getPortletCategory
   * (java.lang.String)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletCategoryRegistry#getChildCategories
   * (org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletCategoryRegistry#getChildChannels
   * (org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
  public Set<IPortletDefinition> getChildPortlets(PortletCategory parent) {
    ...
    while (iter.hasNext()) {
      IGroupMember gm = iter.next();
      if (gm.isEntity()) {
        IPortletDefinition portletDefinition = portletDefinitionRegistry
          .getPortletDefinition(gm.getKey());
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletCategoryRegistry#getParentCategories
   * (org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
   ...
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletCategoryRegistry#
   * createPortletCategory(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public PortletCategory createPortletCategory(String name, String description,
    String creatorId) {
   ...
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletCategoryRegistry#
   * removeCategoryFromCategory(org.jasig.portal.portlet.om.PortletCategory,
   * org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
   ...
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletCategoryRegistry#
   * updatePortletCategory(org.jasig.portal.portlet.om.PortletCategory)
   */
  @Override
