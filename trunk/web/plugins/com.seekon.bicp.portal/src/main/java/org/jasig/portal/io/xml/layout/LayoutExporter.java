...
public class LayoutExporter extends AbstractDom4jExporter {
  private final Cache<Tuple<String, String>, UserProfile> layoutCache = CacheBuilder
    .newBuilder().maximumSize(1000).<Tuple<String, String>, UserProfile> build();

  private final Cache<Tuple<String, String>, Document> profileCache = CacheBuilder
    .newBuilder().maximumSize(1000).<Tuple<String, String>, Document> build();
   ...
   * 
   * @see
   * org.jasig.portal.io.xml.crn.AbstractDom4jExporter#exportDataElement(java
   * .lang.String)
   */
  @Override
  protected Element exportDataElement(String userName) {
    ...
    try {
      ...
      final IUserProfile userProfile = userLayoutStore.getUserProfileByFname(person,
        UserProfile.DEFAULT_PROFILE_FNAME);
      final Element layoutElement = userLayoutStore
        .exportLayout(person, userProfile);
