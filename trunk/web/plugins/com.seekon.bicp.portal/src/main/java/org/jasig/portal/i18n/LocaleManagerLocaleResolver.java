...
/**
 * {@link LocaleResolver} backed-up by {@link LocaleManager} for retrieving and
 * {@link ILocaleStore} for locale storing locales. This allows simplified
 * portal locale resolution if 'localeResolver' context attribute is instance of
 * this class.
 * 
...
public class LocaleManagerLocaleResolver implements LocaleResolver {
  ...
  public Locale resolveLocale(HttpServletRequest request) {
    ...
    // if there was no LocaleManager was not able to determine the locale,
    // return the locale
