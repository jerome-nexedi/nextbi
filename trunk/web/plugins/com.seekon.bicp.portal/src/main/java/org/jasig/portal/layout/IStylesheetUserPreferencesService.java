...
/**
 * Provides access to stylesheet user preference data. This is how any runtime
 * code that needs access to theme or structure stylesheet user preferences. All
 * of the details around default values, scoping and persistence are taken care
 * of here.
 * 
...
public interface IStylesheetUserPreferencesService {
   ...
   *          The current request
   * @param prefScope
   *          The stylesheet preferences scope
