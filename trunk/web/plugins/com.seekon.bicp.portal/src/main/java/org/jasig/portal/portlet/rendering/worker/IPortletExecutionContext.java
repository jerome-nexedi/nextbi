...
public interface IPortletExecutionContext {
  public enum ExecutionType {
    ACTION, EVENT, RENDER_HEADER, RENDER, RESOURCE, FAILURE;
  }
  ...
  /**
   * @return The fname of the portlet window (from
   *         {@link IPortletDefinition#getFName()})
   */
  public String getPortletFname();

  /**
   * @return The timeout setting in milliseconds for the operation in process,
   *         or -1 for no timeout.
   */
  ...
  /**
   * @return time for the execution to complete (difference between started and
   *         completed)
   */
