 ...
 * <p>
 * If there is no conflicting lock on the entity, the service responds with the
 * requested lock. If I acquire the lock, I know that no other client will get
 * be able to get a conflicting lock. From then on, I communicate with the
 ...
 *   lock.renew();<br>
  * </code>
 * <p>
 * A READ lock guarantees repeatable reads; other clients can get READ locks but
