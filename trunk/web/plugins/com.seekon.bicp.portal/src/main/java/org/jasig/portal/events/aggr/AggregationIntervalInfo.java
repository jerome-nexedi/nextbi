...
/**
 * The start and end dates for a time interval. The start date is inclusive, the
 * end date is exclusive. Also includes the synthetic keys for the start date
 * and start time of the interval
 */
public class AggregationIntervalInfo implements Serializable {
  ...
  AggregationIntervalInfo(AggregationInterval aggregationInterval, DateTime start,
    DateTime end, DateDimension dateDimension, TimeDimension timeDimension) {
  ...
  /**
   * @return The date dimension that corresponds with the {@link #getStart()}
   *         value, null if no date dimension exists yet for the start
   *         {@link DateTime}
   */
  ...
  /**
   * @return The time dimension that corresponds with the {@link #getStart()}
   *         value, null if no time dimension exists yet for the start
   *         {@link DateTime}
   */
  ...
  /**
   * @return Minutes between {@link #getStart()} and the end parameter, if the
   *         parameter is after {@link #getEnd()} then {@link #getEnd()} is used
   */
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((aggregationInterval == null) ? 0 : aggregationInterval.hashCode());
    result = prime * result
      + ((dateDimension == null) ? 0 : dateDimension.hashCode());
    result = prime * result + duration;
    result = prime * result + ((end == null) ? 0 : end.hashCode());
    result = prime * result + ((start == null) ? 0 : start.hashCode());
    result = prime * result
      + ((timeDimension == null) ? 0 : timeDimension.hashCode());
    return result;
  }
  ...
  public String toString() {
    return "AggregationIntervalInfo [aggregationInterval=" + aggregationInterval
      + ", start=" + start + ", end=" + end + ", dateDimension=" + dateDimension
      + ", timeDimension=" + timeDimension + ", duration=" + duration + "]";
  }
}