...
public class StaxEventLexicalContentHandler extends StaxEventContentHandler
  ...
  /**
   * Essentially the same logic as the parent but uses a static Location impl to
   * avoid this$0 reference holding on to StaxEventLexicalContentHandler
   * instances
   */
   ...
   * 
   * @see
   * org.springframework.util.xml.StaxEventContentHandler#charactersInternal
   * (char[], int, int)
   */
  @Override
