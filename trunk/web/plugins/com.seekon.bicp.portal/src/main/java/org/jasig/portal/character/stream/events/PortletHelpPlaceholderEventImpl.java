 ...
 * @version $Revision$
 */
public final class PortletHelpPlaceholderEventImpl extends
  PortletPlaceholderEventImpl implements PortletHelpPlaceholderEvent {
  ...
  public String toString() {
    return "PortletHelpPlaceholderEvent [" + "portletWindowId="
