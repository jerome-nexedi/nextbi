...
/**
 * JpaPermissionOwnerDao provides a default JPA/Hibernate implementation of the
 * IPermissionOwnerDao interface.
 * 
...
public class JpaPermissionOwnerDao extends BaseJpaDao implements IPermissionOwnerDao {
    ...
    this.findAllPermissionOwners = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PermissionOwnerImpl>>() {
        ...
        public CriteriaQuery<PermissionOwnerImpl> apply(CriteriaBuilder cb) {
          ...
          final Root<PermissionOwnerImpl> ownerRoot = criteriaQuery
            .from(PermissionOwnerImpl.class);
    ...
    this.findPermissionOwnerByFname = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PermissionOwnerImpl>>() {
        ...
        public CriteriaQuery<PermissionOwnerImpl> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.select(ownerRoot);
          ownerRoot.fetch(PermissionOwnerImpl_.activities, JoinType.LEFT);
          criteriaQuery.where(cb.equal(ownerRoot.get(PermissionOwnerImpl_.fname),
            fnameParameter));
  ...
  public List<IPermissionOwner> getAllPermissionOwners() {
    final TypedQuery<PermissionOwnerImpl> query = this
      .createCachedQuery(this.findAllPermissionOwners);

    final List<PermissionOwnerImpl> resultList = query.getResultList();
    return new ArrayList<IPermissionOwner>(new LinkedHashSet<IPermissionOwner>(
      resultList));
  }
   ...
   * 
   * @see
   * org.jasig.portal.permission.dao.IPermissionOwnerDao#getOrCreatePermissionOwner
   * (java.lang.String)
   */
  @Override
  @Transactional
   ...
   * 
   * @see
   * org.jasig.portal.permission.dao.IPermissionOwnerDao#getPermissionOwner(
   * java.lang.Long)
   */
  @Override
  ...
  public IPermissionOwner getPermissionOwner(String fname) {
    final TypedQuery<PermissionOwnerImpl> query = this
      .createCachedQuery(this.findPermissionOwnerByFname);
   ...
   * 
   * @see
   * org.jasig.portal.permission.dao.IPermissionOwnerDao#saveOwner(org.jasig
   * .portal.permission.IPermissionOwner)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.permission.dao.IPermissionOwnerDao#
   * getOrCreatePermissionActivity(org.jasig.portal.permission.IPermissionOwner,
   * java.lang.String)
   */
  @Override
  @Transactional
  public IPermissionActivity getOrCreatePermissionActivity(IPermissionOwner owner,
    String name, String fname, String targetProviderKey) {
   ...
   * 
   * @see
   * org.jasig.portal.permission.dao.IPermissionOwnerDao#getPermissionActivity
   * (java.lang.Long)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.permission.dao.IPermissionOwnerDao#savePermissionActivity
   * (org.jasig.portal.permission.IPermissionActivity)
   */
  @Override
  @Transactional
  ...
  protected IPermissionActivity findActivity(final IPermissionOwner permissionOwner,
    String activityFname) {
