...
@SequenceGenerator(name = "UP_SS_DESC_PARAM_GEN", sequenceName = "UP_SS_DESC_PARAM_SEQ", allocationSize = 5)
@TableGenerator(name = "UP_SS_DESC_PARAM_GEN", pkColumnValue = "UP_SS_DESC_PARAM", allocationSize = 5)
@Cacheable
