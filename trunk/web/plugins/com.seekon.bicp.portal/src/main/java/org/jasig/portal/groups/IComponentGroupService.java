 ...
 * components.
 * <p>
 * The component is only used in the process of composing the composite service,
 * so it does not define any operations on groups, only on other components.
 * 
...
public interface IComponentGroupService {
  ...
  /**
   * Returns the FULLY-QUALIFIED <code>Name</code> of the service, which may not
   * be known until the composite service is assembled.
   */
