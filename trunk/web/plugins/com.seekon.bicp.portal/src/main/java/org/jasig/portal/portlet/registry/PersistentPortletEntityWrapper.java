...
/**
 * Wrapper for portlet entities that are persistent. Overrides the entity ID to
...
class PersistentPortletEntityWrapper implements IPortletEntity {
  ...
  public PersistentPortletEntityWrapper(IPortletEntity persistentEntity,
    IPortletEntityId standardEntityId) {
  ...
  public String toString() {
    return "PortletEntity [" + "portletEntityId=" + this.standardEntityId + ", "
      + "layoutNodeId=" + this.persistentEntity.getLayoutNodeId() + ", " + "userId="
      + this.persistentEntity.getUserId() + ", " + "portletDefinition="
