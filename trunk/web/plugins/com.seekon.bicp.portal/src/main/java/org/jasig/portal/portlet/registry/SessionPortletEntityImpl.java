...
/**
 * Portlet entity data that is not persisted. Used when the entity doesn't have
 * any customizations.
 * 
...
class SessionPortletEntityImpl implements IPortletEntity, IPortletEntityDescriptor {
  ...
  public SessionPortletEntityImpl(IPortletDefinition portletDefinition,
  ...
  public int hashCode() {
    ...
    result = prime
      * result
      + ((this.portletEntityData.getLayoutNodeId() == null) ? 0
  ...
  public boolean equals(Object obj) {
    ...
    if (this.portletEntityData.getLayoutNodeId() == null) {
      if (other.getLayoutNodeId() != null)
        return false;
    } else if (!this.portletEntityData.getLayoutNodeId().equals(
      other.getLayoutNodeId()))
      return false;
  ...
  public String toString() {
    return "PortletEntity [" + "portletEntityId="
      + this.portletEntityData.getPortletEntityId() + ", " + "layoutNodeId="
      + this.portletEntityData.getLayoutNodeId() + ", " + "userId="
      + this.portletEntityData.getUserId() + ", " + "portletDefinition="
