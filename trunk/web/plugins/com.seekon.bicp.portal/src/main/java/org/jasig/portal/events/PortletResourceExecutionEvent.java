...
public final class PortletResourceExecutionEvent extends PortletExecutionEvent {
  ...
  PortletResourceExecutionEvent(PortalEventBuilder eventBuilder, String fname,
    long executionTime, Map<String, List<String>> parameters, String resourceId,
  ...
  public String toString() {
    return super.toString() + ", resourceId=" + this.resourceId
      + ", usedBrowserCache=" + this.usedBrowserCache + ", usedPortalCache="
