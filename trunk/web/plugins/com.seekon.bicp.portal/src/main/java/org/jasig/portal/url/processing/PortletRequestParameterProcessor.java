...
/**
 * Uses the {@link IPortletUrlSyntaxProvider} to parse the portlet parameters
 * from the request into {@link PortletUrl}s. The WindowState, PortletMode and
 * parameter Map is set directly on the {@link IPortletWindow}. The
 * {@link org.jasig.portal.portlet.url.RequestType} is tracked in the
 * {@link IPortletRequestParameterManager}.
 * 
...
public class PortletRequestParameterProcessor implements IRequestParameterProcessor {
   ...
   * 
   * @see
   * org.jasig.portal.url.processing.IRequestParameterProcessor#processParameters
   * (javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse)
   */
  @Override
  public boolean processParameters(HttpServletRequest request,
    ...
    for (final IPortletRequestInfo portletRequestInfo : portalRequestInfo
      ...
      case RENDER: {
        ...
        portletWindow.setRenderParameters(ParameterMap
          .convertListMap(portletParameters));
      ...
      // Override the window state of the targeted portlet window based on the
      // url state
