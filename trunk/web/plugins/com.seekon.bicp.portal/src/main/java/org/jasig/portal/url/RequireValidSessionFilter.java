...
public class RequireValidSessionFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request,
    ...
    IOException {
    // Assume shouldNotFilter was called first and returned false, session is
    // invalid and user needs login
    ...
    loginRedirect
      .append(URLEncoder.encode(request.getRequestURI(), requestEncoding));
    ...
    final String encodedRedirectURL = response.encodeRedirectURL(loginRedirect
      .toString());
