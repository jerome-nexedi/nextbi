 ...
 * ResultSet into a collection of row Map objects, and feeds that object to a
 * JSP page.
 * 
 * This portlet is useful for exposing dashboard components with relatively low
 * usage. It does not presently implement caching and so is not suitable for
 * high volume use.
 * 
 * This portlet is eminently useful for simple administrative queries.
 * 
 * Potentially useful future enhancements of this portlet might include an an
 * ability to bind user attributes to parameters of the query.
 * 
...
public class SqlQueryPortletController extends AbstractController {
  ...
  /**
   * The bean name of the DataSource against which this channel will execute the
   * SQL query is specified as a channel parameter named "dataSource". This
   * parameter is optional, defaulting to the uPortal DataSource (PortalDb).
   */
  public static final String DATASOURCE_BEAN_NAME_PARAM_NAME = "dataSource";

  /**
   * The SQL query this channel will execute is specified as a channel parameter
   * named "sql". This parameter is required.
   */
  ...
  public ModelAndView handleRenderRequest(RenderRequest request,
    ...
    String dsName = preferences
      .getValue(DATASOURCE_BEAN_NAME_PARAM_NAME, "PortalDb");
    ...
    List<Map<String, Object>> results = template.query(sqlQuery,
