...
class PortletWindowData implements IPortletWindowDescriptor, Serializable {
  ...
  private volatile Map<String, String[]> publicRenderParameters = Collections
    .emptyMap();
   ...
   *          The unique identifier for this PortletWindow
   * @param portletEntityId
   *          The unique identifier of the parent IPortletEntity
   * @param delegationParentId
   *          The delegation parent of this portlet, null allowed
   * @throws IllegalArgumentException
   *           if portletWindowId, or portletEntityId are null
   */
  public PortletWindowData(IPortletWindowId portletWindowId,
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindowData#setRenderParameters(java
   * .util.Map)
   */
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindowData#getPublicRenderParameters()
   */
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindowData#setPublicRenderParameters
   * (java.util.Map)
   */
  public void setPublicRenderParameters(Map<String, String[]> publicRenderParameters) {
    Validate.notNull(publicRenderParameters,
      "publicRenderParameters can not be null");
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindowData#setPortletMode(javax.portlet
   * .PortletMode)
   */
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindowData#setWindowState(javax.portlet
   * .WindowState)
   */
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindowData#setExpirationCache(java.
   * lang.Integer)
   */
  ...
  public String toString() {
    return "PortletWindow [" + "portletWindowId=" + this.portletWindowId + ", "
      + "delegationParentId=" + this.delegationParentId + ", " + "portletMode="
      + this.portletMode + ", " + "windowState=" + this.windowState + ", "
      + "expirationCache=" + this.expirationCache + ", " + "renderParameters="
      + this.renderParameters + ", " + "publicRenderParameters="
      + this.publicRenderParameters + ", " + "portletEntityId="
