...
public class PortletResourceRequestContextImpl extends PortletRequestContextImpl
  ...
  public PortletResourceRequestContextImpl(PortletContainer portletContainer,
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletResourceRequestContext#getCacheability()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @seeorg.apache.pluto.container.PortletResourceRequestContext#
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletResourceRequestContext#getResourceID()
   */
  @Override
