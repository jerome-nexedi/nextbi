...
public class JpaPortletEntityDao extends BaseJpaDao implements IPortletEntityDao {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    this.portletDefinitionParameter = this.createParameterExpression(
      PortletDefinitionImpl.class, "portletDefinition");
    ...
    this.findEntitiesForDefinitionQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletEntityImpl>>() {
        ...
        public CriteriaQuery<PortletEntityImpl> apply(CriteriaBuilder cb) {
          ...
          final Root<PortletEntityImpl> entityRoot = criteriaQuery
            .from(PortletEntityImpl.class);
          criteriaQuery.select(entityRoot);
          addFetches(entityRoot);
          criteriaQuery.where(cb.equal(entityRoot
            .get(PortletEntityImpl_.portletDefinition), portletDefinitionParameter));
    ...
    this.findEntitiesForUserIdQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletEntityImpl>>() {
        ...
        public CriteriaQuery<PortletEntityImpl> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.select(entityRoot);
          addFetches(entityRoot);
          criteriaQuery.where(cb.equal(entityRoot.get(PortletEntityImpl_.userId),
            userIdParameter));
   ...
   * 
   * @see
   * org.jasig.portal.dao.portlet.IPortletEntityDao#createPortletEntity(org.
   * jasig.portal.om.portlet.IPortletDefinitionId, java.lang.String, int)
   */
  @Override
  @Transactional
  public IPortletEntity createPortletEntity(
    ...
    IPortletEntity portletEntity = new PortletEntityImpl(portletDefinition,
      layoutNodeId, userId);
   ...
   * 
   * @see
   * org.jasig.portal.dao.portlet.IPortletEntityDao#deletePortletEntity(org.
   * jasig.portal.om.portlet.IPortletEntity)
   */
  @Override
  @Transactional
  ...
  public IPortletEntity getPortletEntity(IPortletEntityId portletEntityId) {
    ...
    final PortletEntityImpl portletEntity = this.entityManager.find(
      PortletEntityImpl.class, internalPortletEntityId);
    return portletEntity;
  }
   ...
   * 
   * @see
   * org.jasig.portal.dao.portlet.IPortletEntityDao#getPortletEntity(java.lang
   * .String, int)
   */
  @Override
  @Transactional(readOnly = true)
  public IPortletEntity getPortletEntity(String layoutNodeId, int userId) {
    ...
    /*
     * Since portal entities mostly are retrieved in batches (for each "channel"
     * element in user's layout), it is faster to retrieve all portlet entities,
     * so that persistence framework can place them in 2nd level cache, and
     * iterate over them manually instead of retrieving single portlet entity
     * one by one.
     */
   ...
   * 
   * @see
   * org.jasig.portal.dao.portlet.IPortletEntityDao#getPortletEntities(org.jasig
   * .portal.om.portlet.IPortletDefinitionId)
   */
  @Override
  @Transactional(readOnly = true)
  public Set<IPortletEntity> getPortletEntities(
    ...
    final TypedQuery<PortletEntityImpl> query = this
      .createCachedQuery(this.findEntitiesForDefinitionQuery);
    query.setParameter(this.portletDefinitionParameter,
      (PortletDefinitionImpl) portletDefinition);
  ...
  public Set<IPortletEntity> getPortletEntitiesForUser(int userId) {
    final TypedQuery<PortletEntityImpl> query = this
      .createCachedQuery(this.findEntitiesForUserIdQuery);
   ...
   * 
   * @see
   * org.jasig.portal.dao.portlet.IPortletEntityDao#updatePortletEntity(org.
   * jasig.portal.om.portlet.IPortletEntity)
   */
  @Override
  @Transactional
  ...
  protected long getNativePortletEntityId(IPortletEntityId portletEntityId) {
    final long internalPortletEntityId = Long.parseLong(portletEntityId
      .getStringId());
