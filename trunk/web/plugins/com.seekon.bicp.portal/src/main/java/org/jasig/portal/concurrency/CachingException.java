...
/**
 * A <code>CachingException</code> describes a problem that has arisen during an
 * attempt to add, update, remove or reference a cache entry. If the problem
...
public class CachingException extends org.jasig.portal.PortalException {
   ...
   * 
   * @param cause
   *          A throwable that caused the caching problem.
   */
   ...
   * 
   * @param msg
   *          message describing nature of caching problem.
   */
