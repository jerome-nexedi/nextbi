...
public class DelegateState {
  ...
  /**
   * @param portletMode
   *          Mode for the delegate portlet, if null the current or default mode
   *          is used
   * @param windowState
   *          State for the delegate portlet, if null the current or default
   *          state is used
   */
  ...
  public boolean equals(Object object) {
    ...
    return new EqualsBuilder().append(this.windowState, rhs.getWindowState())
      .append(this.portletMode, rhs.getPortletMode()).isEquals();
  }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(1445247369, -1009176817).append(this.windowState)
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append(
      "windowState", this.windowState).append("portletMode", this.portletMode)
      .toString();
  }
}
