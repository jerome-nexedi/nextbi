 ...
 * @version $Revision$
 */
public abstract class AbstractJaxbDataHandler<T> implements IDataImporter<T>,
  IDataExporter<T>, IDataDeleter<T>, InitializingBean {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    if (this.schemaLocation != null) {
      properties.put(javax.xml.bind.Marshaller.JAXB_SCHEMA_LOCATION,
        this.schemaLocation);
    }
