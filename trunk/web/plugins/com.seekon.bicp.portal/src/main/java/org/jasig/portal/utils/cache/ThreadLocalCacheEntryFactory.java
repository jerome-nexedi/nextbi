...
/**
 * Base CacheEntryFactory that uses a {@link ThreadLocal} to pass along
 * additional data to the {@link #createEntry(Object, Object)} method.
 * 
...
public abstract class ThreadLocalCacheEntryFactory<A> implements CacheEntryFactory {
   ...
   * 
   * @see
   * net.sf.ehcache.constructs.blocking.CacheEntryFactory#createEntry(java.lang
   * .Object)
   */
  @Override
  ...
  /**
   * Wraps an {@link Ehcache#get(Object)} call with setting/clearing the
   * {@link ThreadLocal}
   */
