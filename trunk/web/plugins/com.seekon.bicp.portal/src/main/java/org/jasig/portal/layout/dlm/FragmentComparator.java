 ...
 * highest number being higher and if equal it then sorts by fragment index with
 * the lowest number having highest precedence since it is an indication of the
 * fragments location within the config file. For those with equal precedence
 * the one defined first when loading the file should take precedence.
 * 
