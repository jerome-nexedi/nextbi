...
/**
 * PortletOutputHandler that stores all content written to a string. Requires
 * that an encoding be specified in case the portlet writes to the output
 * stream.
 * 
...
public class RenderPortletOutputHandler implements PortletOutputHandler {
  ...
  /**
   * @return The output the portlet has written, calls {@link #flushBuffer()}
   *         first
   */
  ...
  public OutputStream getOutputStream() {
    if (this.writerOutputStream == null) {
      this.writerOutputStream = new WriterOutputStream(this.printWriter,
