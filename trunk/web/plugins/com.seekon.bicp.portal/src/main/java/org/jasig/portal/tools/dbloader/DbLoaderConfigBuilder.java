...
/**
 * Configuration for the DbLoader, includes commons-cli Options set for command
 * line use.
 * 
...
public class DbLoaderConfigBuilder implements DbLoaderConfig {
  ...
  public boolean equals(Object object) {
    ...
    return new EqualsBuilder().append(this.scriptFile, rhs.scriptFile).append(
      this.dropTables, rhs.dropTables).append(this.createTables, rhs.createTables)
      .append(this.tablesFile, rhs.tablesFile).append(this.dataFile, rhs.dataFile)
      .append(this.populateTables, rhs.populateTables).isEquals();
  }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(-1864980211, 1008139621).append(this.scriptFile)
      .append(this.dropTables).append(this.createTables).append(this.tablesFile)
      .append(this.dataFile).append(this.populateTables).toHashCode();
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append(
      "tablesFile", this.tablesFile).append("dataFile", this.dataFile).append(
      "scriptFile", this.scriptFile).append("dropTables", this.dropTables).append(
      "createTables", this.createTables).append("populateTables",
      this.populateTables).toString();
  }
}
