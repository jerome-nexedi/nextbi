 ...
 * @version $Revision$
 * 
 *          An <code>IAuthorizationService</code> represents the portal's
 *          authorization service. All requests for authorization activities
 *          ultimately come here.
 */
public interface IAuthorizationService {
  ...
  /**
   * Answers if the principal has permission to use the CONFIG PortletMode on
   * this Channel.
   * 
   * @return boolean
   * @param principal
  ...
  public boolean canPrincipalConfigure(IAuthorizationPrincipal principal,
    String channelPublishId) throws AuthorizationException;
   ...
   * activity on the target. Params <code>owner</code> and <code>activity</code>
   * must be non-null. If <code>target</code> is null, then target is not
   * checked.
   * 
   * @return boolean
   * @param principal
   ...
   * <code>Principal</code> for the specified activity and target. This includes
   * inherited <code>IPermissions</code>. Null parameters will be ignored, that
   * is, all <code>IPermissions</code> matching the non-null parameters are
   * retrieved. So, <code>getPermissions(principal,null, null, null)</code>
  ...
  /**
   * Creates a new <code>IPermission</code> for the <code>principal</code> on
   * behalf of the <code>owner</code>.
   * 
   * @param owner
   *          String
   * @param principal
   ...
   */
  public IPermissionManager newPermissionManager(String key)
    throws AuthorizationException;

  /**
   * Factory method for an <code>IAuthorizationPrincipal</code>. This type wraps
   * an underlying entity so that the authorization system can treat all
   * principals alike.
   * 
   * @param key
   *          String
  ...
  /**
   * Returns the <code>IAuthorizationPrincipal</code> associated with the
  ...
  /**
   * Returns a <code>String</code> used to represent the
   * <code>IAuthorizationPrincipal</code>.
   * 
   * @param principal
   *          IAuthorizationPrincipal
