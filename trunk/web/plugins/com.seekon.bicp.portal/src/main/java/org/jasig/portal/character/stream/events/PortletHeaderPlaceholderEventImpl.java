 ...
 * @version $Revision$
 */
public final class PortletHeaderPlaceholderEventImpl extends
  PortletPlaceholderEventImpl implements PortletHeaderPlaceholderEvent {
  ...
  public String toString() {
    return "PortletHeaderPlaceholderEvent [" + "portletWindowId="
