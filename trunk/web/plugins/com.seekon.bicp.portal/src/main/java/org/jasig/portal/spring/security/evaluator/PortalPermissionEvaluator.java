 ...
 * expressions in method security annotations. This current implementation is an
 * early attempt at connecting the uPortal permissions framework to Spring
...
public class PortalPermissionEvaluator implements PermissionEvaluator {
  ...
  public boolean hasPermission(Authentication authentication,
    ...
    if (activity != null) {
      final boolean hasPermission = principal.hasPermission(
  ...
  protected AuthorizableActivity getViewActivity(final String activityKey,
    ...
    if (entity != null && activityKey.equals("VIEW")) {
      ...
      if (type.isGroup()) {
        ...
        return new AuthorizableActivity(IPermission.PORTAL_SUBSCRIBE,
