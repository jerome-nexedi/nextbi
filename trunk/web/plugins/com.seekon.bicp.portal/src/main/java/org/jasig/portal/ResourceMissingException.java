...
/**
 * This exception would inform uPortal that a particular resource required to
 * complete channel operation is missing.
 * 
...
public class ResourceMissingException extends PortalException {
   ...
   * resource, a description of the missing resource, and a message.
   * 
   * @param resourceURI
   *          URI of the missing resource
   ...
   *          description of the missing resource
   * @param msg
   *          message about the error condition
   */
  public ResourceMissingException(String resourceURI, String resourceDescription,
    String msg) {
    super(msg);
  ...
  /**
   * Instantiate a ResourceMissingException providing the URI of the missing
   * resource, a description of the missing resource, and a cause.
   * 
   * @param resourceURI
   *          URI of the missing resource
   * @param resourceDescription
  ...
  /**
   * Instantiate a ResourceMissingException providing a URI of the missing
   * resource, a description of the missing resource, a message, and indicating
   * whether channel refresh and channel reinstantiation are appropriate
   * responses to the error condition.
   * 
   * @param resourceURI
   *          URI of the missing resource
   * @param resourceDescription
   ...
   *          message about the error condition
   * @param refresh
   *          true if refreshing is an appropriate response
   * @param reinstantiate
   *          true if reinstantiation is an appropriate response
   */
  public ResourceMissingException(String resourceURI, String resourceDescription,
    String msg, boolean refresh, boolean reinstantiate) {
