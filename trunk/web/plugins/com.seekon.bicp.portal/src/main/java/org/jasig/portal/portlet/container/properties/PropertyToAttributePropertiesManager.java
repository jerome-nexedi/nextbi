...
/**
 * Portlet property manager that just translates properties to/from the portal
 * request attributes
 * 
 ...
 */
@Service
public class PropertyToAttributePropertiesManager extends
  ...
  /**
   * Map of portlet property names to attribute names, if the value is null the
   * key will be used for both the property and attribute name
   */
  ...
  /**
   * Properties that should not be namespaced with the portlet's windowId when
  ...
  public boolean addResponseProperty(HttpServletRequest portletRequest,
    ...
    if (this.propertyToAttributeMappings.isEmpty()
      && this.nonNamespacedProperties.isEmpty()) {
      return false;
    }
  ...
  protected String getAttributeName(IPortletWindow portletWindow, String property) {
    final String mappedAttributeName = this.propertyToAttributeMappings
      .get(property);
  ...
  public <P extends Populator<String, String>> void populateRequestProperties(
    ...
    final Enumeration<String> attributeNames = portalRequest.getAttributeNames(); attributeNames
      .hasMoreElements();) {
      ...
      logger.debug("Found portal request attribute {} returning as property {}",
        fullAttributeName, propertyName);
   ...
   */
  private String getPropertyName(final String windowIdStr,
    ...
    final String mappedPropertyName = this.attributeToPropertyMappings
      .get(attributeName);
  ...
  protected <P extends Populator<String, String>> void convertValue(String name,
    Object value, P propertiesPopulator) {
    if (value == null) {
      return;
    }
