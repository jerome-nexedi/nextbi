...
/**
 * Tracks customizations made by the users to the XSL transformer and layout
 * attributes. Implementations and returned data structures MUST be thread-safe
 * 
...
public interface IStylesheetUserPreferences {
   ...
   * 
   * @param name
   *          output property name, cannot be null
   * 
   * @see Map#get(Object)
   */
   ...
   *          output property name, cannot be null
   * @param value
   *          output property value, cannot be null
   * 
   ...
   * 
   * @param name
   *          xslt parameter name, cannot be null
   * 
   * @see Map#get(Object)
   */
   ...
   *          xslt parameter name, cannot be null
   * @param name
   *          xslt parameter value, cannot be null
   * 
   ...
   * 
   * @param nodeId
   *          The layout node id to get the attribute for, cannot be null
   * @param name
   *          node attribute name, cannot be null
   * 
   * @see Map#get(Object)
   */
   ...
   * 
   * @param nodeId
   *          The layout node id to apply the attribute to, cannot be null
   * @param name
   *          node attribute name, cannot be null
   * @param value
   *          node attribute name, cannot be null
  ...
  /**
   * @param nodeId
   *          The layout node id to remove the attribute from, cannot be null
   * @param name
   *          node attribute name, cannot be null
   * @see Map#remove(Object)
   */
   ...
   * 
   * @param nodeId
   *          The layout node id to get attributes for, cannot be null
   */
