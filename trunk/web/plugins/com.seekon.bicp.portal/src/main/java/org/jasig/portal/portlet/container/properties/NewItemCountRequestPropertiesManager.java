 ...
 */
@Service
public class NewItemCountRequestPropertiesManager extends
  ...
  public boolean setResponseProperty(HttpServletRequest portletRequest,
    ...
    if (NEW_ITEM_COUNT_PROPERTY.equals(property)
      || IPortletRenderer.NEW_ITEM_COUNT_PROPERTY.equals(property)) {
      portletRequest.setAttribute(
        IPortletRenderer.ATTRIBUTE__PORTLET_NEW_ITEM_COUNT, value);
      return true;
    }
