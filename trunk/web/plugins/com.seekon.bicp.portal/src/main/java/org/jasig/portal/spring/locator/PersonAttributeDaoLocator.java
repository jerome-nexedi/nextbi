 ...
 * @version $Revision$
 * @deprecated code that needs an IPersonAttributeDao should use direct
 *             dependency injection where possible
 */
@Deprecated
public class PersonAttributeDaoLocator extends
  AbstractBeanLocator<IPersonAttributeDao> {
