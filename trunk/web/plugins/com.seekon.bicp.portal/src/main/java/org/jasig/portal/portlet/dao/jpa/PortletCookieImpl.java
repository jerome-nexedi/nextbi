 ...
 */
@Entity
@Table(name = "UP_PORTLET_COOKIES", uniqueConstraints = @UniqueConstraint(columnNames = {
  "PORTAL_COOKIE_ID", "COOKIE_NAME" }))
...
@NamedQueries( { @NamedQuery(name = PortletCookieImpl.UP_PORTLET_COOKIES__DELETE_EXPIRED, query = "delete from PortletCookieImpl c where c.expires <= :expirationDate") })
class PortletCookieImpl implements IPortletCookie {
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletCookie#updateFromCookie(javax.servlet
   * .http.Cookie)
   */
  @Override
  ...
  public Cookie toCookie() {
    ...
    if (this.expires == null) {
      ...
      maxAge = (int) TimeUnit.MILLISECONDS.toSeconds(this.expires.getTime()
  ...
  public String toString() {
    return "PortletCookieImpl [internalPortletCookieId="
      + this.internalPortletCookieId + ", entityVersion=" + this.entityVersion
      + ", name=" + this.name + ", comment=" + this.comment + ", domain="
      + this.domain + ", expires=" + this.expires + ", path=" + this.path
      + ", value=" + this.value + ", version=" + this.version + ", secure="
      + this.secure + "]";
  }
