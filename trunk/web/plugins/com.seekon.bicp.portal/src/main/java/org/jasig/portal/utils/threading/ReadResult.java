...
public final class ReadResult<T> {
  private static final ReadResult<Object> READ_RESULT_NO_WRITE_NULL = new ReadResult<Object>(
    false);

  private static final ReadResult<Object> READ_RESULT_DO_WRITE_NULL = new ReadResult<Object>(
    true);
