...
/**
 * <p>
 * Java class for externalAggregatedIntervalConfig complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="externalAggregatedIntervalConfig">
 *   &lt;complexContent>
 *     &lt;extension base="{https://source.jasig.org/schemas/uportal/io/event-aggregation}externalAggregatedDimensionConfig">
 *       &lt;sequence>
 *         &lt;element name="include" type="{https://source.jasig.org/schemas/uportal/io/event-aggregation}externalAggregationInterval" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="exclude" type="{https://source.jasig.org/schemas/uportal/io/event-aggregation}externalAggregationInterval" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "externalAggregatedIntervalConfig", propOrder = { "includes",
  "excludes" })
@Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
public class ExternalAggregatedIntervalConfig extends
  ExternalAggregatedDimensionConfig implements Serializable, Equals, HashCode,
  ToString {

  @XmlElement(name = "include")
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  protected List<ExternalAggregationInterval> includes;

  @XmlElement(name = "exclude")
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  protected List<ExternalAggregationInterval> excludes;
   ...
   * {@link ExternalAggregationInterval }
   * 
   * 
   */
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  public List<ExternalAggregationInterval> getIncludes() {
    if (includes == null) {
      includes = new ArrayList<ExternalAggregationInterval>();
    }
   ...
   */
  @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-05-11T02:18:31+08:00", comments = "JAXB RI v2.2.5-b10")
  public List<ExternalAggregationInterval> getExcludes() {
    if (excludes == null) {
      excludes = new ArrayList<ExternalAggregationInterval>();
    }
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
    ...
    if (!(object instanceof ExternalAggregatedIntervalConfig)) {
      return false;
    }
    if (this == object) {
      return true;
    ...
    final ExternalAggregatedIntervalConfig that = ((ExternalAggregatedIntervalConfig) object);
    {
      List<ExternalAggregationInterval> lhsIncludes;
      lhsIncludes = (((this.includes != null) && (!this.includes.isEmpty())) ? this
        .getIncludes() : null);
      List<ExternalAggregationInterval> rhsIncludes;
    ...
    {
      List<ExternalAggregationInterval> lhsExcludes;
      lhsExcludes = (((this.excludes != null) && (!this.excludes.isEmpty())) ? this
        .getExcludes() : null);
      List<ExternalAggregationInterval> rhsExcludes;
