...
public class PortletPreferenceImpl implements IPortletPreference, Cloneable {
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletPreference#setValues(java.lang.String[])
   */
  @Override
  ...
  public boolean equals(Object object) {
    ...
    return new EqualsBuilder().append(this.name, rhs.getName()).append(
      this.readOnly, rhs.isReadOnly()).append(this.getValues(), rhs.getValues())
      .isEquals();
  }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(-1904185833, -1222355625).append(this.name).append(
      this.readOnly).append(this.values).toHashCode();
  }

  @Override
  public String toString() {
    return "PortletPreferenceImpl [portletPreferenceId=" + this.portletPreferenceId
      + ", entityVersion=" + this.entityVersion + ", name=" + this.name
