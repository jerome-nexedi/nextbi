...
/**
 * JPA/Hibernate implementation of IChannelTypeDao. This DAO handles channel
 * types and is not yet integrated with the channel definition persistence code.
 * 
...
public class JpaPortletTypeDao extends BaseJpaDao implements IPortletTypeDao {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    this.findAllTypesQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletTypeImpl>>() {
        @Override
        public CriteriaQuery<PortletTypeImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<PortletTypeImpl> criteriaQuery = cb
            .createQuery(PortletTypeImpl.class);
          criteriaQuery.from(PortletTypeImpl.class);
          return criteriaQuery;
        }
      });

    this.findTypeByNameQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<PortletTypeImpl>>() {
        @Override
        public CriteriaQuery<PortletTypeImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<PortletTypeImpl> criteriaQuery = cb
            .createQuery(PortletTypeImpl.class);
          final Root<PortletTypeImpl> typeRoot = criteriaQuery
            .from(PortletTypeImpl.class);
          criteriaQuery.select(typeRoot);
          criteriaQuery.where(cb.equal(typeRoot.get(PortletTypeImpl_.name),
            nameParameter));
   ...
   * 
   * @see
   * org.jasig.portal.channel.dao.IChannelTypeDao#deleteChannelType(org.jasig
   * .portal.channel.IChannelType)
   */
  @Override
  @Transactional
   ...
   * 
   * @see
   * org.jasig.portal.channel.dao.IChannelTypeDao#createChannelType(java.lang
   ...
   * 
   * @see
   * org.jasig.portal.channel.dao.IChannelTypeDao#getChannelType(java.lang.String
   * )
   */
  @Override
  public IPortletType getPortletType(String name) {
    final TypedQuery<PortletTypeImpl> query = this
      .createCachedQuery(this.findTypeByNameQuery);
  ...
  public List<IPortletType> getPortletTypes() {
    final TypedQuery<PortletTypeImpl> query = this
      .createCachedQuery(this.findAllTypesQuery);
   ...
   * 
   * @see
   * org.jasig.portal.channel.dao.IChannelTypeDao#saveChannelType(org.jasig.
   * portal.channel.IChannelType)
   */
  @Override
  @Transactional
