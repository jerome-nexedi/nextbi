...
/**
 * Provides a Spring locating facade in front of an actual
 * {@link IXalanGroupMembershipHelper} since the Xalan elements can only
...
public class XalanGroupMembershipHelper {
  ...
  @Autowired
  public void setGroupMembershipHelper(
    IXalanGroupMembershipHelper groupMembershipHelper) {
