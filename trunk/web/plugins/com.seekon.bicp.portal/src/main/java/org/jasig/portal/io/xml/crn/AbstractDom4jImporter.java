 ...
 * @version $Revision$
 */
public abstract class AbstractDom4jImporter implements
  IDataImporter<Tuple<String, Element>>, Unmarshaller {
  ...
  protected Element convertToElement(Source source) {
    if (source instanceof StAXSource) {
      ...
      try {
        ...
        throw new RuntimeException("Failed to parse StAX Reader into Dom4J Element",
          e);
      }
    ...
    throw new IllegalArgumentException("Source of type " + source.getClass()
      + " is not supported");
  }
}
