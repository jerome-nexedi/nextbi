 ...
 * @version $Revision$
 */
public class CachingPortletHttpServletResponseWrapper extends
  ...
  public CachingPortletHttpServletResponseWrapper(
  ...
  // if (os == null) {
  // this.cachingOutputStream = new
  // LimitedBufferOutputStream(this.cacheThresholdSize);
  // os = new TeeServletOutputStream(super.getOutputStream(),
  ...
  // this.cachedPortletData.getHeaders();
  //        
  ...
  // return (this.cachingOutputStream != null &&
  // this.cachingOutputStream.isThresholdExceeded()) ||
  ...
  // * It may return null if a bad statusCode was set, or if the length of the
  // stream exceeds
  // * the cache configuration's max threshold.
  // *
  // * @see LimitedBufferOutputStream#getCapturedContent()
  // * @return the {@link CachedPortletRenderData} for this response, or null if
  // caching could not be completed.
  // */
  ...
  // final byte[] capturedContent =
  // this.cachingOutputStream.getCapturedContent();
