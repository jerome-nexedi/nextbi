...
/**
 * Wrapper for a {@link HttpServletRequest} that makes the request inaccessible
 * once the worker has been canceled.
 * 
...
public class GuardingHttpServletRequest extends HttpServletRequestWrapper {
  ...
  public GuardingHttpServletRequest(HttpServletRequest request,
