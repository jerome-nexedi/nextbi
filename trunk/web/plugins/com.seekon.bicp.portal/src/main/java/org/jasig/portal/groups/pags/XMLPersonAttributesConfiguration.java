...
/**
 * Read in the configuration for the Person Attributes group store using an XML
 * file. See the example file in /properties/groups/PAGSGroupStoreConfig.xml and
 * the DTD in /webpages/dtd/PAGSGroupStore.dtd for information on the file
 * format.
 * 
 * @author Al Wold
 * @version $Revision$
 */
public class XMLPersonAttributesConfiguration implements
  ...
  public Map getConfig() {
    ...
    try {
      config = ResourceLoader.getResourceAsDocument(this.getClass(),
            ...
            if (testGroup instanceof Element
              ...
              for (int k = 0; k < tests.getLength(); k++) {
                ...
                if (test instanceof Element
                  ...
                  IPersonTester testerInst = initializeTester(tester, attribute,
                    value);
