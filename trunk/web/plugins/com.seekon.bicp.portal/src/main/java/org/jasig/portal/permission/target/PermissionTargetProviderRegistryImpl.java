...
/**
 * PermissionTargetProviderRegistryImpl provides the default implementation of
 * the permission target provider registry interface. This implementation is a
 ...
 * @since 3.3
 */
public class PermissionTargetProviderRegistryImpl implements
  ...
  public void setProviders(Map<String, IPermissionTargetProvider> providers) {
    ...
    for (Map.Entry<String, IPermissionTargetProvider> provider : providers
      .entrySet()) {
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.permission.target.IPermissionTargetProviderRegistry#
   * getTargetProvider(java.lang.String)
   */
   ...
   * 
   * @seeorg.jasig.portal.permission.target.IPermissionTargetProviderRegistry#
   * registerTargetProvider(java.lang.String,
   * org.jasig.portal.permission.target.IPermissionTargetProvider)
   */
