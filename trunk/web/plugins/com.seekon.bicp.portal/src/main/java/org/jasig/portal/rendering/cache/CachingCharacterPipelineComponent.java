 ...
 * @version $Revision$
 */
public class CachingCharacterPipelineComponent extends
  CachingPipelineComponent<CharacterEventReader, CharacterEvent> implements
  CharacterPipelineComponent {

  @Override
  protected CharacterEventReader createEventReader(
    ListIterator<CharacterEvent> eventCache) {
