...
public class SimpleStringPortalData implements IPortalData {
  ...
  public SimpleStringPortalData(String dataId, String dataTitle,
  ...
  public int hashCode() {
    ...
    result = prime * result
      + ((this.dataTitle == null) ? 0 : this.dataTitle.hashCode());
    return result;
  }
  ...
  public String toString() {
    return "SimpleStringPortalData [dataId=" + this.dataId + ", dataTitle="
      + this.dataTitle + ", dataDescription=" + this.dataDescription + "]";
  }
}
