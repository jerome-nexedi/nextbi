 ...
 * <code>org.jasig.portal.security.PersonFactory.guest_user_name</code> in
...
public class PersonFactory {
   ...
   */
  public static final String GUEST_USERNAME = PropertiesManager.getProperty(
  ...
  private static final SingletonDoubleCheckedCreator<Integer> GUEST_USER_ID_LOADER = new SingletonDoubleCheckedCreator<Integer>() {
    ...
    protected Integer createSingleton(Object... args) {
      ...
      final IUserIdentityStore userIdentityStore = UserIdentityStoreLocator
        .getUserIdentityStore();
      try {
        return userIdentityStore.getPortalUID(person);
      } catch (Exception e) {
        throw new RuntimeException("Error while finding user id for person: "
          + person, e);
      }
    }
  };
  ...
  public static IPerson createGuestPerson() throws Exception {
    ...
    person.setSecurityContext(InitialSecurityContextFactory
      .getInitialContext("root"));
    return person;
  }
