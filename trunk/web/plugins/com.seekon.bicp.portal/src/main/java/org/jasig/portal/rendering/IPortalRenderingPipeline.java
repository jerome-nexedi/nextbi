...
public interface IPortalRenderingPipeline {
  /**
   * <code>renderState</code> method orchestrates the rendering pipeline which
   * includes worker dispatching, and the rendering process from layout access,
   * to channel rendering, to writing content to the browser.
   * 
   * @param req
