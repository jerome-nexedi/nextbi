...
/**
 * <p>
 * This is an implementation of a SecurityContext that merely checks to see if
 * the user exists in the UP_USERS database table but otherwise presumes to be
 * pre-authenticated by the context from which it is called. The typical system
 * where this might be used is a portal whose main page is protected by HTTP
 ...
 * @version $Revision$
 */
class TrustSecurityContext extends ChainingSecurityContext implements
  ISecurityContext {
