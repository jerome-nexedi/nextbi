...
/**
 * Helper methods to allow setting window states and portlet modes during flow
 * exections
 * 
...
public class PortletUrlFlowHelper {
  public void setWindowState(ExternalContext externalContext, String windowState) {
    ...
    try {
      ...
      throw new IllegalArgumentException("The specified WindowState '" + windowState
        + "' is not valid", e);
    }
  }
  ...
  public void setPortletMode(ExternalContext externalContext, String portletMode) {
    ...
    try {
      ...
      throw new IllegalArgumentException("The specified PortletMode '" + portletMode
        + "' is not valid", e);
    }
  }
}
