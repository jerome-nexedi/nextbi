...
public interface IGroupListHelper {
   ...
   * 
   * @param entity
   *          Entity whose type needs to be determined
   ...
   * 
   * @param entityBean
   *          JsonEntityBean representation of an entity
   ...
   * populateChildren is set to <code>true</code> populate the entity bean with
   * the entity's children before returning it. This argument will be ignored
   * entirely if the entity is not of a group type, since non-group entities may
   * not have children.
   * 
   * @param entityType
   *          type of the entity to be returned
   * @param entityId
   *          ID of the entity to be returned
   * @param populateChildren
   *          <code>true</code> to populate the bean with children
