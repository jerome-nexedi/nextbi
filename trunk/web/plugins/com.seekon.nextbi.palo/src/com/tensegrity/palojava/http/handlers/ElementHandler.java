...
public class ElementHandler extends HttpHandler {
  ...
  public final boolean createBulk(DimensionInfo dimension, ElementInfo[] names,
  ...
  public final boolean createBulk(DimensionInfo dimension, String[] names,
    int[] types, ElementInfo[][] children, double[][] weights) throws IOException {
    DatabaseInfo database = dimension.getDatabase();
    StringBuffer par = new StringBuffer();
    for (int i = 0, n = names.length; i < n; i++) {
      String val = names[i];
  ...
  public final void update(ElementInfo element, int type, String[] children,
    double[] weights, ServerInfo serverInfo) throws IOException {
    DimensionInfo dimension = element.getDimension();
    DatabaseInfo database = dimension.getDatabase();
