...
public class XMLACubeLoader extends CubeLoader {
  ...
  public XMLACubeLoader(DbConnection paloConnection, XMLAClient xmlaClient,
    DatabaseInfo database, XMLAConnection con) {
  ...
  private final XMLACubeInfo loadCube(String name) {
    XMLACubeInfo cubeInfo = BuilderRegistry.getInstance().getCubeInfoBuilder()
      .getCubeInfo(xmlaClient, (XMLADatabaseInfo) database, name, xmlaConnection);
