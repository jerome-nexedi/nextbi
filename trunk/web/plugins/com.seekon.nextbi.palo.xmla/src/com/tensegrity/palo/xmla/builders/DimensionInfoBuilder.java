...
public class DimensionInfoBuilder {
  ...
  public XMLADimensionInfo[] getDimensionInfo(XMLAConnection connection,
    XMLAClient client, XMLADatabaseInfo database, XMLACubeInfo cube) {
  ...
  public XMLAHierarchyInfo[] getHierarchyInfo(XMLAConnection connection,
    XMLAClient client, XMLADimensionInfo dimension) {
    //		xmlaClient = client;
    //		connectionName = client.getConnections()[0].getName();
    ...
    XMLAHierarchyRequestor req = new XMLAHierarchyRequestor(dimension, database,
      connection);
    req.setCatalogNameRestriction(database.getId());
  ...
  public XMLAHierarchyInfo getHierarchyInfo(XMLAConnection connection,
    XMLAClient client, XMLADimensionInfo dimension, String id) {
    XMLADatabaseInfo database = (XMLADatabaseInfo) dimension.getDatabase();
    XMLAHierarchyRequestor req = new XMLAHierarchyRequestor(dimension, database,
      connection);
    req.setCatalogNameRestriction(database.getId());
    req.setCubeNameRestriction(dimension.getCubeId());
    req.setDimensionUniqueNameRestriction(dimension.getDimensionUniqueName());
    req.setHierarchyUniqueNameRestriction(XMLADimensionInfo
      .transformId(XMLADimensionInfo.getDimIdFromId(id)));
  ...
  public void updateMaxLevelAndDepth(XMLADimensionInfo dimInfo, int maxDepth,
    int maxLevel) {
