/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/XtdFunDef.java#21 $
...
/**
 * Definition of <code>Ytd</code>, <code>Qtd</code>, <code>Mtd</code>, and
 * <code>Wtd</code> MDX builtin functions.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/XtdFunDef.java#21 $
 * @since Mar 23, 2006
 */
class XtdFunDef extends FunDefBase {
  ...
  static final ResolverImpl MtdResolver = new ResolverImpl(
    ...
    new String[] { "fx", "fxm" }, LevelType.TimeMonths);
  ...
  static final ResolverImpl QtdResolver = new ResolverImpl(
    ...
    new String[] { "fx", "fxm" }, LevelType.TimeQuarters);
  ...
  static final ResolverImpl WtdResolver = new ResolverImpl(
    ...
    new String[] { "fx", "fxm" }, LevelType.TimeWeeks);
  ...
  static final ResolverImpl YtdResolver = new ResolverImpl(
    ...
    new String[] { "fx", "fxm" }, LevelType.TimeYears);
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    ...
    default:
      ...
      return new AbstractListCalc(call, new Calc[] { memberCalc }) {
        public TupleList evaluateList(Evaluator evaluator) {
          return new UnaryTupleList(periodsToDate(evaluator, level, memberCalc
  ...
  private static class ResolverImpl extends MultiResolver {
    ...
    public ResolverImpl(String name, String signature, String description,
      String[] signatures, LevelType levelType) {
