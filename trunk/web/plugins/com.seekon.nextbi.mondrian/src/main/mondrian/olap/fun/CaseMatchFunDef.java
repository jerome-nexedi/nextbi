/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/CaseMatchFunDef.java#12 $
 ...
 * @see CaseTestFunDef
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/CaseMatchFunDef.java#12 $
 * @since Mar 23, 2006
 */
class CaseMatchFunDef extends FunDefBase {
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    ...
    final Calc defaultCalc = args.length % 2 == 0 ? compiler
      .compile(args[args.length - 1]) : ConstantCalc.constantNull(call.getType());
