...
public class Parser extends java_cup.runtime.lr_parser {
  ...
  public Exp parseExpression(MdxParserValidator.QueryPartFactory factory,
    ...
    this.scanner = new PrefixScanner(debug, new StringScanner(queryString, debug),
...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(int CUP$Parser$act_num,
      ...
      // ON axis_number
    {
      ...
      AxisOrdinal axis = AxisOrdinal.StandardAxisOrdinal.forLogicalOrdinal(index);
      ...
      // where_clause_opt cell_props_opt
    {
      ...
      RESULT = parser.factory.makeQuery(parser.statement, Parser.toFormulaArray(f),
        Parser.toQueryAxisArray(a), cubeName, w, Parser.toQueryPartArray(cp),
      ...
      // else_clause_opt END
    {
      ...
      if (x == null) {
        ...
        RESULT = new UnresolvedFunCall("_CaseMatch", Syntax.Case, Parser
          .toExpArray(v));
      }
    ...
    case 50: // value_expression_primary ::= LBRACE exp_list_opt RBRACE
    {
      ...
      RESULT = new UnresolvedFunCall("{}", Syntax.Braces, Parser.toExpArray(lis));
      ...
      // exp_list_opt RPAREN
    {
      ...
      RESULT = new UnresolvedFunCall(
        i.getSegments().get(i.getSegments().size() - 1).name, Syntax.Function,
      ...
      // identifier LPAREN exp_list_opt RPAREN
    {
      ...
      lis.add(0, i);
      RESULT = new UnresolvedFunCall(j.name, Syntax.Method, Parser.toExpArray(lis));
    ...
    case 29: // term3 ::= term3 NOT IN term2
    {
      ...
      RESULT = new UnresolvedFunCall("NOT", Syntax.Prefix,
        new Exp[] { new UnresolvedFunCall("IN", Syntax.Infix, new Exp[] { x, y }) });
    ...
    case 25: // term3 ::= term3 IS EMPTY
    {
      ...
      RESULT = new UnresolvedFunCall("IS EMPTY", Syntax.Postfix, new Exp[] { x });
