/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/CaseTestFunDef.java#10 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/CaseTestFunDef.java#10 $
 * @since Mar 23, 2006
 */
class CaseTestFunDef extends FunDefBase {
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    ...
    final Calc defaultCalc = args.length % 2 == 1 ? compiler.compileScalar(
      args[args.length - 1], true) : ConstantCalc.constantNull(call.getType());
  ...
  private static class ResolverImpl extends ResolverBase {
    ...
    public FunDef resolve(Exp[] args, Validator validator,
      ...
      for (int i = 0; i < clauseCount; i++) {
        if (!validator.canConvert(j, args[j++], Category.Logical, conversions)) {
          mismatchingArgs++;
        }
