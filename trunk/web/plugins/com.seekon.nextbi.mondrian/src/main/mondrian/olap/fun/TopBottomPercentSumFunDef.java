/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/TopBottomPercentSumFunDef.java#19 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/TopBottomPercentSumFunDef
 *          .java#19 $
 * @since Mar 23, 2006
 */
class TopBottomPercentSumFunDef extends FunDefBase {
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    final ListCalc listCalc = (ListCalc) compiler.compileAs(call.getArg(0), null,
  ...
  private static class ResolverImpl extends MultiResolver {
    ...
    public ResolverImpl(final String name, final String signature,
      final String description, final String[] signatures, boolean top,
      boolean percent) {
  ...
  private class CalcImpl extends AbstractListCalc {
    ...
    public CalcImpl(ResolvedFunCall call, ListCalc listCalc, DoubleCalc doubleCalc,
      Calc calc) {
    ...
    public TupleList evaluateList(Evaluator evaluator) {
      ...
      Map<List<Member>, Object> mapMemberToValue = evaluateTuples(evaluator, calc,
        list);
      final int savepoint = evaluator.savepoint();
      evaluator.setNonEmpty(false);
      list = sortTuples(evaluator, list, list, calc, top, true, getType().getArity());
