/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/IsFunDef.java#9 $
 ...
 * @see IsNullFunDef
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/IsFunDef.java#9 $
 * @since Mar 23, 2006
 */
class IsFunDef extends FunDefBase {
  static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver("IS",
    "<Expression> IS <Expression>", "Returns whether two objects are the same",
    new String[] { "ibmm", "ibll", "ibhh", "ibdd", "ibtt" }, IsFunDef.class);
