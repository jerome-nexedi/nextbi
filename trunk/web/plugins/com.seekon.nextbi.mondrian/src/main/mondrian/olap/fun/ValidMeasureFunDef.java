  ...
  private static class CalcImpl extends GenericCalc {
    ...
    public Object evaluate(Evaluator evaluator) {
      ...
      if (calc.isWrapperFor(MemberCalc.class)) {
        ...
        final Member[] tupleMembers = calc.unwrap((TupleCalc.class)).evaluateTuple(
          evaluator);
      ...
      baseCube = getBaseCubeofMeasure(evaluator, memberList.get(measurePosition),
        baseCube);
    ...
    private List<Dimension> getDimensionsToForceToAllLevel(RolapCube virtualCube,
      RolapCube baseCube, List<Member> memberList) {
