/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/StrToTupleFunDef.java#17 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/StrToTupleFunDef.java#17
 *          $
 * @since Mar 23, 2006
 */
class StrToTupleFunDef extends FunDefBase {
  ...
  private StrToTupleFunDef(int[] parameterTypes) {
    super("StrToTuple", null, "Constructs a tuple from a string.", Syntax.Function,
      Category.Tuple, parameterTypes);
  }
  ...
  public Type getResultType(Validator validator, Exp[] args) {
    ...
    case 2:
      ...
      return new MemberType(argType.getDimension(), argType.getHierarchy(), argType
        .getLevel(), null);
  ...
  private static class ResolverImpl extends ResolverBase {
    ResolverImpl() {
      super("StrToTuple", "StrToTuple(<String Expression>)",
        "Constructs a tuple from a string.", Syntax.Function);
    }
