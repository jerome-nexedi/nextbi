 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/vba/Excel.java#7 $
 * @since Dec 31, 2007
 */
public abstract class Excel {
  ...
  @Description("Returns the arccosine, or inverse cosine, of a number. The arccosine "
  ...
  @Description("Returns the inverse hyperbolic cosine of a number. Number must be "
  ...
  @Description("Returns the arcsine, or inverse sine, of a number. The arcsine is the "
  ...
  @Description("Returns the inverse hyperbolic sine of a number. The inverse "
  ...
  @Description("Returns the arctangent, or inverse tangent, of the specified x- and "
  ...
  @Description("Returns the inverse hyperbolic tangent of a number. Number "
  ...
  public static double mod(Object first, Object second) {
    ...
    if (!(first instanceof Number)) {
      throw new InvalidArgumentException("Invalid parameter. " + "first parameter "
        + first + " of Mod function must be of type number");
    } else {
      iFirst = ((Number) first).doubleValue();
    }
    double iSecond;
    if (!(second instanceof Number)) {
      throw new InvalidArgumentException("Invalid parameter. " + "second parameter "
        + second + " of Mod function must be of type number");
    } else {
  ...
  @FunctionName("Pi")
  @Description("Returns the number 3.14159265358979, the mathematical constant pi, "
