...
public final class NameResolver {
   ...
   */
  public OlapElement resolve(OlapElement parent, List<IdentifierSegment> segments,
  ...
  private OlapElement resolveInexact(OlapElement parent,
    List<IdentifierSegment> segments, MatchType matchType, List<Namespace> namespaces) {
