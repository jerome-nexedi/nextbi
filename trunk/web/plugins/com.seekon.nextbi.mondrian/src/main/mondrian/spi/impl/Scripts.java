/*
// $Id: //open/mondrian/src/main/mondrian/spi/impl/Scripts.java#1 $
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/spi/impl/Scripts.java#1 $
 * @author jhyde
 */
public class Scripts {
  ...
  /**
   * Creates an implementation of the {@link PropertyFormatter} SPI based on a
   * script.
   * 
   * @param script
   *          Script
  ...
  public static PropertyFormatter propertyFormatter(ScriptDefinition script) {
    return create(script, PropertyFormatter.class, simple(script,
      "formatProperty(member,propertyName,propertyValue)"));
  }

  /**
   * Creates an implementation of the {@link MemberFormatter} SPI based on a
   * script.
   * 
   * @param script
   *          Script
  ...
  public static MemberFormatter memberFormatter(ScriptDefinition script) {
    return create(script, MemberFormatter.class, simple(script,
      "formatMember(member)"));
  }

  /**
   * Creates an implementation of the {@link CellFormatter} SPI based on a
   * script.
   * 
   * @param script
   *          Script
  ...
  public static CellFormatter cellFormatter(ScriptDefinition script) {
    return create(script, CellFormatter.class, simple(script, "formatCell(value)"));
  }

  /**
   * Creates an implementation of the {@link DataSourceChangeListener} SPI based
   * on a script.
   * 
   * @param script
   *          Script
  ...
  public static DataSourceChangeListener dataSourceChangeListener(
    ...
    return create(script, DataSourceChangeListener.class, code);
  }

  /**
   * Creates an implementation of the {@link DataSourceResolver} SPI based on a
   * script.
   * 
   * @param script
   *          Script
  ...
  public static DataSourceResolver dataSourceResolver(ScriptDefinition script) {
    return create(script, DataSourceResolver.class, simple(script,
  ...
  public static DynamicSchemaProcessor dynamicSchemaProcessor(ScriptDefinition script) {
    return create(script, DynamicSchemaProcessor.class, simple(script,
      "processSchema(schemaUrl, connectInfo)"));
  }

  /**
   * Creates an implementation of the {@link UserDefinedFunction} SPI based on a
   * script.
   * 
   * <p>
   * The script must declare an object called "obj" that must have a method
   * "evaluate(evaluator, arguments)" and may have fields "name", "description",
   * "syntax", "parameterTypes" and method "getReturnType(parameterTypes)".
   * </p>
   * 
   * @param script
   *          Script
   ...
   */
  public static UserDefinedFunction userDefinedFunction(ScriptDefinition script,
    String name) {
    final String code;
    switch (script.language) {
    case JAVASCRIPT:
    ...
    return create(script, UserDefinedFunction.class, code);
  }
