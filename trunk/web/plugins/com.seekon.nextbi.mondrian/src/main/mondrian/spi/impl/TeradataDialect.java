 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/spi/impl/TeradataDialect.java#5 $
 * @since Nov 23, 2008
 */
public class TeradataDialect extends JdbcDialectImpl {
  ...
  public static final JdbcDialectFactory FACTORY = new JdbcDialectFactory(
    TeradataDialect.class, DatabaseProduct.TERADATA);
  ...
  public String generateInline(List<String> columnNames, List<String> columnTypes,
    ...
    return generateInlineGeneric(columnNames, columnTypes, valueList, fromClause,
      true);
  }
