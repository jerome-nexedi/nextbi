/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jLevel.java#13 $
...
/**
 * Implementation of {@link Level} for the Mondrian OLAP engine.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jLevel.java#13
 *          $
 * @since May 25, 2007
 */
class MondrianOlap4jLevel implements Level, Named {
  ...
  private int getDepthOffset() {
    final Role.HierarchyAccess accessDetails = olap4jSchema.olap4jCatalog.olap4jDatabaseMetaData.olap4jConnection
      .getMondrianConnection2().getRole().getAccessDetails(level.getHierarchy());
  ...
  public List<Member> getMembers() throws OlapException {
    ...
    final RolapConnection mondrianConnection = olap4jConnection
      .getMondrianConnection();
    return Locus.execute(mondrianConnection, "Reading members of level",
      new Locus.Action<List<Member>>() {
        public List<Member> execute() {
          final mondrian.olap.SchemaReader schemaReader = mondrianConnection
            .getSchemaReader().withLocus();
          final List<mondrian.olap.Member> levelMembers = schemaReader
  ...
  public String getCaption() {
    return level.getLocalized(OlapElement.LocalizedProperty.CAPTION, olap4jSchema
      .getLocale());
  }

  public String getDescription() {
    return level.getLocalized(OlapElement.LocalizedProperty.DESCRIPTION,
