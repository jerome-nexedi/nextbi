 ...
 * 
 * <p>
 * The methods should not be called directly, only via the corresponding static
 * methods in {@link mondrian.olap.Util}, namely:
 * <ul>
 ...
 * 
 * <p>
 * This interface could in principle be extended to allow native implementations
 * of methods, or to serve as a factory for entire classes which have different
 * implementations in different environments.
 * </p>
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/util/UtilCompatible.java#9 $
 * @since Feb 5, 2007
 */
