...
public class Format {
  ...
  static final String[] daysOfWeekLong_en = { "", "Sunday", "Monday", "Tuesday",
    "Wednesday", "Thursday", "Friday", "Saturday" };

  static final String[] monthsShort_en = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
    "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "", };

  static final String[] monthsLong_en = { "January", "February", "March", "April",
   ...
   */
  static final FormatLocale locale_US = createLocale('\0', '\0', null, null, null,
    null, null, null, null, null, Locale.US);
  ...
  static class AlternateFormat extends BasicFormat {
    ...
    private static BigDecimal daysSince1900(Calendar calendar) {
      ...
      final long leapDays = (yearForLeap - 1900) / 4 - (yearForLeap - 1900) / 100
      ...
      final long millis = calendar.get(Calendar.HOUR_OF_DAY) * 3600000
        + calendar.get(Calendar.MINUTE) * 60000 + calendar.get(Calendar.SECOND)
  ...
  static class NumericFormat extends JavaFormat {
    ...
    NumericFormat(String token, FormatLocale locale, int expFormat,
      ...
      if (thousandSeparatorTokenMap.containsKey(formatString)) {
        ...
        if (nbThousandSeparators > 1) {
          ...
          final StringTokenizer st = new StringTokenizer(wholeFormat, String
            .valueOf(getFormatToken(FORMAT_THOUSEP)));
        ...
        thousandSeparatorTokenMap
          .put(formatString, cachedThousandSeparatorPositions);
      }
    }
    ...
    void format(double n, StringBuilder buf) {
      ...
      String s = fd.toJavaFormatString(zeroesLeftOfPoint, locale.decimalPlaceholder,
        zeroesRightOfPoint, formatDigitsRightOfPoint, expChar, expSign,
        zeroesRightOfExp, useThouSep ? locale.thousandSeparator : '\0', useDecimal,
    ...
    void format(long n, StringBuilder buf) {
      ...
      fd.shift(decimalShift);
      String s = fd.toJavaFormatString(zeroesLeftOfPoint, locale.decimalPlaceholder,
        zeroesRightOfPoint, zeroesRightOfPoint + digitsRightOfPoint, expChar,
        expSign, zeroesRightOfExp, useThouSep ? locale.thousandSeparator : '\0',
        useDecimal, getThousandSeparatorPositions());
      buf.append(s);
    }
  }
    ...
    private void format(int code, Calendar calendar, StringBuilder buf) {
      ...
      case FORMAT_C: {
        ...
        boolean timeSet = !(calendar.get(Calendar.SECOND) == 0
          && calendar.get(Calendar.MINUTE) == 0 && calendar.get(Calendar.HOUR) == 0);
        if (dateSet) {
      ...
      case FORMAT_H: {
        int h = calendar.get(twelveHourClock ? Calendar.HOUR : Calendar.HOUR_OF_DAY);
        buf.append(h);
        break;
      }
      case FORMAT_HH: {
  ...
  public static class FormatLocale {
    ...
    private FormatLocale(char thousandSeparator, char decimalPlaceholder,
      ...
      String currencyFormat, String[] daysOfWeekShort, String[] daysOfWeekLong,
      String[] monthsShort, String[] monthsLong, Locale locale) {
      this.locale = locale;
  ...
  private static final Token[] tokens = {
    ...
    nfe(FORMAT_E_MINUS_UPPER, NUMERIC | SPECIAL, "E-", "Scientific format",
    ...
    nfe(FORMAT_LITERAL, GENERAL, ")", "Display a literal character", "See -."),
    nfe(FORMAT_LITERAL, GENERAL, " ", "Display a literal character", "See -."),
    nfe(FORMAT_BACKSLASH, GENERAL | SPECIAL, "\\",
    ...
    nfe(FORMAT_SEMI, GENERAL | SPECIAL, ";",
    ...
    nfe(FORMAT_INTL_CURRENCY, NUMERIC | SPECIAL, intlCurrencySymbol + "", null,
  ...
  private static final MacroToken[] macroTokens = {
    ...
    new MacroToken("Scientific", "0.00e+00", "Uses standard scientific notation."),
  ...
  public static FormatLocale createLocale(char thousandSeparator,
    ...
    String[] daysOfWeekLong, String[] monthsShort, String[] monthsLong, Locale locale) {
    FormatLocale formatLocale = new FormatLocale(thousandSeparator,
      ...
      currencyFormat, daysOfWeekShort, daysOfWeekLong, monthsShort, monthsLong,
      locale);
    if (locale != null) {
  ...
  public static FormatLocale createLocale(Locale locale) {
    ...
    final java.text.DateFormat timeFormat = java.text.DateFormat.getTimeInstance(
      java.text.DateFormat.SHORT, locale);
    ...
    return createLocale(decimalSymbols.getGroupingSeparator(), decimalSymbols
      .getDecimalSeparator(), dateSeparator, timeSeparator, currencySymbol,
      currencyFormatString, dateSymbols.getShortWeekdays(), dateSymbols
        .getWeekdays(), dateSymbols.getShortMonths(), dateSymbols.getMonths(),
      locale);
  }
  ...
  private String parseFormatString(String formatString,
          ...
          case FORMAT_MM: {
            ...
            if (theyMeantMinute) {
              format = new DateFormat(
                (token.code == FORMAT_M ? FORMAT_N : FORMAT_NN), matched, locale,
                false);
            } else {
    ...
    for (int i = 0; i < formatList.size(); ++i) {
      if (i > 0 && formatList.get(i) instanceof LiteralFormat
        ...
        formatList.set(i - 1, new LiteralFormat(((LiteralFormat) formatList
          .get(i - 1)).s
    ...
    default:
      alternateFormat = new CompoundFormat(formatList
        .toArray(new BasicFormat[formatList.size()]));
      break;
    }
  ...
  static class FloatingDecimal {
    ...
    // jhyde added
    public String toJavaFormatString(int minDigitsLeftOfDecimal, char decimalChar, // '.' or ','
      ...
      int i = toJavaFormatString(result, 0, minDigitsLeftOfDecimal, decimalChar,
    ...
    private static final int n5bits[] = { 0, 3, 5, 7, 10, 12, 14, 17, 19, 21, 24,
      26, 28, 31, 33, 35, 38, 40, 42, 45, 47, 49, 52, 54, 56, 59, 61, };
