/*
// $Id: //open/mondrian/src/main/mondrian/util/UnsupportedList.java#10 $
...
/**
 * Implementation of {@link java.util.List} where all methods throw an
 * UnsupportedOperationException exception except for the <code>isEmpty</code>
 * method. The <code>iterator</code> and <code>listIterator</code> methods can
 * be easily implemented in derived classes by using the helper inner classes:
 * <code>Itr</code> and <code>ListItr</code>. These iterators are all read only,
 * their <code>remove</code>, <code>add</code> and <code>set</code> methods
 * throw the UnsupportedOperationException exception.
 * <p>
 * This class can be used for List implementations that only implement a subset
 * of all the methods.
 * 
 * @author Richard Emberson
 * @version $Id: //open/mondrian/src/main/mondrian/util/UnsupportedList.java#10
 *          $
 * @since Jan 16, 2007
 */
