/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/AbstractEndToEndTupleList.java#1 $
 ...
 * 
 * <p>
 * For example, if the arity is 3, the tuples {(A1, B1, C1), (A1, B2, C2)} will
 * be stored as {A1, B1, C1, A2, B2, C2}. This is memory-efficient (only one
 * array, compared to 3 arrays or one array per tuple in other representations),
 * has good locality of reference, and typical operations require few
 * indirections.
 * 
 * <p>
 ...
 * 
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/AbstractEndToEndTupleList
 *          .java#1 $
 * @author jhyde
 */
