/*
// $Id: //open/mondrian/src/main/mondrian/mdx/UnresolvedFunCall.java#14 $
...
/**
 * An expression consisting of a named function or operator applied to a set of
 * arguments. The syntax determines whether this is called infix, with function
 * call syntax, and so forth.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/mdx/UnresolvedFunCall.java#14
 *          $
 * @since Sep 28, 2005
 */
public class UnresolvedFunCall extends ExpBase implements FunCall {
  ...
  public UnresolvedFunCall(String name, Syntax syntax, Exp[] args) {
    ...
    case Empty:
      ...
      break;
    default:
      Util.assertTrue(!name.startsWith("$") && !name.equals("{}")
        && !name.equals("()"));
      break;
    }
  }
  ...
  public Exp accept(Validator validator) {
    ...
    FunDef funDef = FunUtil.resolveFunArgs(validator, null, args, newArgs, name,
      syntax);
   ...
   * @return the Exp at the specified index of this array of Exp. The first Exp
