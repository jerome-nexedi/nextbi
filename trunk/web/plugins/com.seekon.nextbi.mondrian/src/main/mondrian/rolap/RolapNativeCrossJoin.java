...
public class RolapNativeCrossJoin extends RolapNativeSet {
  ...
  NativeEvaluator createEvaluator(RolapEvaluator evaluator, FunDef fun, Exp[] args) {
    ...
    List<CrossJoinArg[]> allArgs = crossJoinArgFactory().checkCrossJoin(evaluator,
      fun, args, false);
    ...
    if (!NonEmptyCrossJoinConstraint.isValidContext(evaluator, false, levels
      .toArray(new RolapLevel[levels.size()]), restrictMemberTypes())) {
  ...
  private CrossJoinArg[] buildArgs(final RolapEvaluator evaluator,
    ...
    Set<CrossJoinArg> joinArgs = crossJoinArgFactory().buildConstraintFromAllAxes(
      evaluator);
