...
public final class SegmentCacheWorker {
  ...
  private final static Logger LOGGER = Logger.getLogger(SegmentCacheWorker.class);
  ...
  private static void setCache(String cacheName) {
    try {
      ...
      LOGGER.error(
        MondrianResource.instance().SegmentCacheFailedToInstanciate.baseMessage, e);
  ...
  public static boolean contains(SegmentHeader header) {
    ...
    if (cache != null) {
      try {
        ...
        LOGGER.error(
          MondrianResource.instance().SegmentCacheLookupTimeout.baseMessage, e);
        ...
        LOGGER.error(
          ...
          t);
        throw MondrianResource.instance().SegmentCacheFailedToLookupSegment.ex(t);
      }
    }
    return false;
  }
