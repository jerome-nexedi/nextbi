/*
// $Id: //open/mondrian/src/main/mondrian/rolap/SmartMemberReader.java#51 $
 ...
 * 
 * <p>
 * Synchronization: the MemberReader <code>source</code> must be called from
 * synchronized(this) context - it does not synchronize itself (probably it
 * should).
 * </p>
 * 
 * <p>
 * Constraints: Member.Children and Level.Members may be constrained by a
 * SqlConstraint object. In this case a subset of all members is returned. These
 * subsets are cached too and the SqlConstraint is part of the cache key. This
 * is used in NON EMPTY context.
 * </p>
 * 
 * <p>
 * Uniqueness. We need to ensure that there is never more than one
 ...
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/SmartMemberReader.java#51 $
 */
public class SmartMemberReader implements MemberReader {
  ...
  public List<RolapMember> getMembersInLevel(RolapLevel level, int startOrdinal,
    ...
    synchronized (cacheHelper) {
      ...
      List<RolapMember> members = cacheHelper.getLevelMembersFromCache(level,
        constraint);
      if (members != null) {
        return members;
      }
  ...
  public void getMemberChildren(List<RolapMember> parentMembers,
    ...
    synchronized (cacheHelper) {
      ...
      for (RolapMember parentMember : parentMembers) {
        List<RolapMember> list = cacheHelper.getChildrenFromCache(parentMember,
          constraint);
        if (list == null) {
