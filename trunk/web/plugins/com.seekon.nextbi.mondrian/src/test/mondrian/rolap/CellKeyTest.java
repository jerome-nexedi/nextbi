/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/CellKeyTest.java#17 $
 ...
 * @version $Id: //open/mondrian/testsrc/main/mondrian/rolap/CellKeyTest.java#17
 *          $
 */
public class CellKeyTest extends FoodMartTestCase {
  ...
  public void testCellLookup() {
    ...
    String query = "With Set [*NATIVE_CJ_SET] as NonEmptyCrossJoin([Gender].Children, [Address2].Children) "
    ...
    TestContext testContext = TestContext.instance().create(null, cubeDef, null,
      null, null, null);
