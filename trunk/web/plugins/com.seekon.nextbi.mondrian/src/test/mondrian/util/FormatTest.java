/*
// $Id: //open/mondrian/testsrc/main/mondrian/util/FormatTest.java#24 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/testsrc/main/mondrian/util/FormatTest.java#24 $
 * @since May 26, 2006
 */
public class FormatTest extends TestCase {
  ...
  private final Format.FormatLocale localeFra = Format.createLocale(
    ...
    new String[] { "", "Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi",
      "Vendredi", "Samedi" }, new String[] { "Jan", "Fev", "Mar", "Avr", "Mai",
      "Jui", "Jui", "Aou", "Sep", "Oct", "Nov", "Dec", "" }, new String[] {
      "Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout",
      "Septembre", "Octobre", "Novembre", "Decembre", "" }, Locale.FRENCH);
  ...
  private void checkNumbersInLocale(Format.FormatLocale locale) {
    ...
    checkNumbers("$#,##0.00;($#,##0.00)", "$6.00", "($6.00)", "$0.00", "$0.60", "",
      locale);
    checkNumbers("0%", "600%", "-600%", "0%", "60%", "", locale);
    checkNumbers("0.00%", "600.00%", "-600.00%", "0.00%", "60.00%", "", locale);
    checkNumbers("0.00E+00", "6.00E+00", "-6.00E+00", "0.00E+00", "6.00E-01", "",
      locale);
    checkNumbers("0.00E-00", "6.00E00", "-6.00E00", "0.00E00", "6.00E-01", "",
      locale);
    checkNumbers("$#,##0;;\\Z\\e\\r\\o", "$6", "-$6", "Zero", "$1", "", locale);
    checkNumbers("#,##0.0 USD", "6.0 USD", "-6.0 USD", "0.0 USD", "0.6 USD", "",
      locale);
    ...
    checkNumbers("Scientific", "6.00e+00", "-6.00e+00", "0.00e+00", "6.00e-01", "",
      locale);
  ...
  private void checkNumbers(String format, String result6, String resultNeg6,
    String result0, String resultPoint6, String resultEmpty,
  ...
  private void checkNumber(Format.FormatLocale locale, String format, Number number,
  ...
  /**
   * When there are format strings for positive and negative numbers, and a
   * number is too small to appear in either format string, it underflows to
   * 'Nil', and gets to use a third format.
   */
  public void testNil() {
    ...
    checkFormat(null, BigDecimal.ZERO,
    ...
    checkFormat(null, new BigDecimal("-0.001"), "\\P\\o\\s;\\N\\e\\g;\\Z\\e\\r\\o",
      "Neg");
  }
  ...
  public void testPercentWithStyle() {
    checkFormat(null, new BigDecimal("0.0364"), "|#.00%|style='green'",
      "|3.64%|style='green'");
  }
  ...
  public void testNegativePercentWithStyle() {
    if (Bug.BugMondrian687Fixed) {
      checkFormat(null, new BigDecimal("-0.0364"), "|#.00%|style=red",
        "-|3.64%|style=red");
    } else {
      checkFormat(null, new BigDecimal("-0.0364"), "|#.00%|style='red'",
    ...
    if (Bug.BugMondrian687Fixed) {
      ...
      checkFormat(null, -364, "|#.00|style=red", "|-364.00|style=red"); // confirmed
      // on
      // SSAS
      // 2005
    }
    ...
    checkFormat(null, 364, "|#.00|style='green';|-#.000|style='red'",
  ...
  public void testSingleQuotes() {
    if (Bug.BugMondrian687Fixed) {
      ...
      checkFormat(null, 3.64, "|#.00|style=\\'deep red\\'",
  ...
  private static Date makeCalendar(final int year, final int month, final int date,
  ...
  public void testDates() {
    ...
    checkDate("Long Date", "Tuesday, April 29, 1969", "Mardi, Avril 29, 1969",
  ...
  public void testFrenchLocale() {
    ...
    assertEquals("[, dim., lun., mar., mer., jeu., ven., sam.]", Arrays
      .toString(fr.daysOfWeekShort));
    assertEquals("[janvier, f" + I18nTest.EA + "vrier, mars, avril, mai, juin,"
      + " juillet, ao" + I18nTest.UC + "t, septembre, octobre, novembre, d"
      + I18nTest.EA + "cembre, ]", Arrays.toString(fr.monthsLong));
    assertEquals("[janv., f" + I18nTest.EA + "vr., mars, avr., mai, juin,"
      + " juil., ao" + I18nTest.UC + "t, sept., oct., nov., d" + I18nTest.EA
      + "c., ]", Arrays.toString(fr.monthsShort));
  ...
  private void checkFormat(Format.FormatLocale locale, Object o,
    String formatString, String expectedResult) {
    Format format = new Format(formatString, locale);
    String actualResult = format.format(o);
  ...
  public void testCurrency() {
    ...
    checkFormat(localeDe, 123456, "###,###.00" + Format.intlCurrencySymbol,
      "123.456,00\u20AC");
    checkFormat(localeFra, 123456, "###,###.00" + Format.intlCurrencySymbol,
      "123.456,00FF");
    ...
    // symbol it must use.
    checkFormat(Format.createLocale(Locale.JAPANESE), 123456, "Currency",
      "$ 123,456.00");

    // international currency symbol
    checkFormat(null, new BigDecimal("1.2"), "" + Format.intlCurrencySymbol + "#",
      "$1");
  }
}
