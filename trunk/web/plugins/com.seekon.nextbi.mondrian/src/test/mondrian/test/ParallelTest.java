/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/ParallelTest.java#6 $
 ...
 * @author jhyde
 * @since Jun 26, 2006
 * @version $Id: //open/mondrian/testsrc/main/mondrian/test/ParallelTest.java#6
 *          $
 */
public class ParallelTest extends FoodMartTestCase {
   ...
   */
  private void checkSchemaFlush(final int count, final int cycleCount,
