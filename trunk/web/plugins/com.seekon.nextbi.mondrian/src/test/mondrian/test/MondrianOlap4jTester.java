/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/MondrianOlap4jTester.java#1 $
 ...
 * 
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/test/MondrianOlap4jTester.
 *          java#1 $
 * @author Julian Hyde
 */
public class MondrianOlap4jTester extends AbstractMondrianOlap4jTester {
  ...
  public MondrianOlap4jTester(org.olap4j.test.TestContext testContext) {
    super(testContext, DRIVER_URL_PREFIX, DRIVER_CLASS_NAME, Flavor.MONDRIAN);
  }
