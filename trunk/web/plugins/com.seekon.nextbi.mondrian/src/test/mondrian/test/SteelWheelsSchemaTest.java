/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/SteelWheelsSchemaTest.java#7 $
...
public class SteelWheelsSchemaTest extends SteelWheelsTestCase {
  ...
  /**
   * Test case for Infobright issue where [Markets].[All Markets].[Japan] was
   * not found but [Markets].[All Markets].[JAPAN] was OK. (We've since dropped
   * 'All Xxx' from member unique names.)
   */
  public void testMarkets() {
    ...
    testContext.assertQueryReturns(
      "select [Markets].Children on 0 from [SteelWheelsSales]", "Axis #0:\n"
        + "{}\n" + "Axis #1:\n" + "{[Markets].[#null]}\n" + "{[Markets].[APAC]}\n"
        + "{[Markets].[EMEA]}\n" + "{[Markets].[Japan]}\n" + "{[Markets].[NA]}\n"
        + "Row #0: \n" + "Row #0: 12,878\n" + "Row #0: 49,578\n" + "Row #0: 4,923\n"
        + "Row #0: 37,952\n");
    ...
    testContext.assertQueryReturns("select [Markets].[Territory].Members on 0 from "
      + "[SteelWheelsSales]", "Axis #0:\n" + "{}\n" + "Axis #1:\n"
      + "{[Markets].[#null]}\n" + "{[Markets].[APAC]}\n" + "{[Markets].[EMEA]}\n"
      + "{[Markets].[Japan]}\n" + "{[Markets].[NA]}\n" + "Row #0: \n"
      + "Row #0: 12,878\n" + "Row #0: 49,578\n" + "Row #0: 4,923\n"
      + "Row #0: 37,952\n");
  ...
  public void testBugMondrian755() {
    ...
    // Zero dim query
    checkCellZero(testContext, "Select\n" + "From [SteelWheelsSales]");
    ...
    checkCellZero(testContext, "With \n"
   ...
   * MONDRIAN-756, "Error in RolapResult.replaceNonAllMembers leads to NPE"</a>.
   * 
  ...
  public void testBugMondrian756() {
    ...
    final Util.PropertyList propertyList = testContext0.getConnectionProperties()
      .clone();
  ...
  public static class Mondrian756SchemaProcessor extends
  ...
  public void testBugMondrian756b() {
    ...
    String schema = testContext0.getRawSchema().replaceAll(" hasAll=\"true\"",
      " hasAll=\"false\"");
  ...
  /**
   * Test case for bug <a
   * href="http://jira.pentaho.com/browse/MONDRIAN-805">MONDRIAN-805,
  ...
  public void testBugMondrian805() {
    ...
    String schema = testContext0.getRawSchema().replaceAll(
      "<Hierarchy hasAll=\"true\" allMemberName=\"All Markets\" ",
      "<Hierarchy hasAll=\"false\" allMemberName=\"All Markets\" ").replaceAll(
  ...
  public void testMondrianBug476_770_957() throws Exception {
    final TestContext context = SteelWheelsTestCase
      .createContext(
    ...
    final String mdxQuery = "with set [*NATIVE_CJ_SET] as 'Filter([*BASE_MEMBERS_Time], (NOT IsEmpty([Measures].[Price Each])))'\n"
    ...
    context.assertQueryReturns(mdxQuery, "Axis #0:\n" + "{}\n" + "Axis #1:\n"
  ...
  /**
   * This tests MONDRIAN-626. A Parameter type of date or timestamp was causing
   * an exception because those types were not implemented correctly.
   */
