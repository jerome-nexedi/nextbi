/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/MondrianTestRunner.java#16 $
...
public class MondrianTestRunner extends BaseTestRunner {
  ...
  public TestResult doRun(final Test suite) {
     ...
     * final long[] longa = new long[1]; result.addListener(new TestListener() {
     * public void addError(Test arg0, Throwable arg1) { // do nothing }
     * 
     * public void addFailure(Test arg0, AssertionFailedError arg1) { // do
     * nothing }
     * 
     * public void endTest(Test arg0) { if (arg0 instanceof TestCase) { long
     * longb = System.currentTimeMillis() - longa[0]; System.out.println(
     * "endTest " + ((TestCase)arg0).getName() + " " + longb + " ms"); } }
     * 
     * public void startTest(Test arg0) { if (arg0 instanceof TestCase) {
     * longa[0] = System.currentTimeMillis(); System.out.println("startTest " +
     * ((TestCase)arg0).getName()); } } } );
     */
