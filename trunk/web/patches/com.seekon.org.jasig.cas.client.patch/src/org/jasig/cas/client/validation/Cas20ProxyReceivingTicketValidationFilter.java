...
public class Cas20ProxyReceivingTicketValidationFilter extends
  ...
  private static final String[] RESERVED_INIT_PARAMS = new String[] {
    "proxyGrantingTicketStorageClass", "proxyReceptorUrl", "acceptAnyProxy",
    "allowedProxyChains", "casServerUrlPrefix", "proxyCallbackUrl", "renew",
    "exceptionOnValidationFailure", "redirectAfterValidation", "useSession",
    "serverName", "service", "artifactParameterName", "serviceParameterName",
    "encodeServiceUrl", "millisBetweenCleanUps", "hostnameVerifier", "encoding",
    "config", "Osgi-Context-Path", "filter-name", "bundle.name" };
  ...
  protected void initInternal(final FilterConfig filterConfig)
    ...
    setProxyReceptorUrl(getPropertyFromInitParams(filterConfig, "proxyReceptorUrl",
      null));
    ...
    if (proxyGrantingTicketStorageClass != null) {
      ...
      if (this.proxyGrantingTicketStorage instanceof AbstractEncryptedProxyGrantingTicketStorageImpl) {
        ...
        final String secretKey = getPropertyFromInitParams(filterConfig,
          "secretKey", null);
    ...
    this.millisBetweenCleanUps = Integer.parseInt(getPropertyFromInitParams(
      filterConfig, "millisBetweenCleanUps", Integer
  ...
  protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
    final String allowAnyProxy = getPropertyFromInitParams(filterConfig,
      "acceptAnyProxy", null);
    final String allowedProxyChains = getPropertyFromInitParams(filterConfig,
      "allowedProxyChains", null);
    final String casServerUrlPrefix = getPropertyFromInitParams(filterConfig,
    ...
    validator.setRenew(parseBoolean(getPropertyFromInitParams(filterConfig, "renew",
      "false")));
  ...
  /**
   * This processes the ProxyReceptor request before the ticket validation code
   * executes.
   */
