...
public class DefaultWebModuleRegister implements WebModuleRegister {
  ...
  public void register() throws RegisterException {
    Debug.trace("Register WebModule: " + contextPath + " (" + bundle + ")");
    try {
            ...
            try {
              ...
              if (listener instanceof ServletContextListener) {
                ...
                registeredServletContextListeners.add(listener);
              	...
              	httpService.registerServletRequestListener((ServletRequestListener)listener, contextPath);
              }
            } catch (Throwable e) {
  ...
  private void registerFilterWithServletPattern(Document doc, String filterName, String filterClass, Element el){
			...
			try {
				...
				while (iterator.hasNext()) {
					...
					if (servletNameElement != null) {
						...
						registerFilter(null, servletName, servletFilter, dictionary);
					}
				}
			} finally {
				Thread.currentThread().setContextClassLoader(contextClassLoader);
  ...
  private void registerFilterWithUrlPattern(Document doc, String filterName, String filterClass, Element el){
			...
			try {
				...
				while (iterator.hasNext()) {
					...
					if (urlPatternElement != null) {
						...
						registerFilter(filterPath, null, servletFilter, dictionary);
					}
				}
			} finally {
				Thread.currentThread().setContextClassLoader(contextClassLoader);
  ...
  public void registerFilter(String filterPath, String servletName, Filter servletFilter,
    Dictionary dictionary) throws ServletException, NamespaceException {
      ...
      for (Iterator it = servlets.iterator(); it.hasNext();) {
        ...
        try {
          ...
          if (servletClassNode != null) {
            ...
            /*
             *   servlet中配置的是jsp-file
             *     <servlet>
             *       <servlet-name>prnmaindata</servlet-name>
             *       <jsp-file>/jsp/platform/prnmaindata.jsp</jsp-file>
             *     </servlet>
             *
             */
            ...
            if (jspFileNode != null) {
              ...
              /*
               * 添加上前缀，如：web.xml中配置的路径为：/jsp/platform/prnmaindata.jsp，
               * 添加上 getContextPath()的结果是/gl/jsp/platform/prnmaindata.jsp
               */
