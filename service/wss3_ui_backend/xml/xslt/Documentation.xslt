    ...
    <description>
      <parameters>]]></text>
        ...
        <text disable-output-escaping="yes"><![CDATA[" type="text"><![CDATA[]]></text>
          <value-of select="doc:LongDescription/doc:Value" />]]<text disable-output-escaping="yes"><![CDATA[>]]></text>
      ...
      <short><![CDATA[]]></text>
        <value-of select="doc:ShortDescription/doc:Value" />]]<text disable-output-escaping="yes"><![CDATA[>]]></text>
