...
final class ServletHandlerRequest extends HttpServletRequestWrapper {
  ...
  public String getContextPath() {
    ...
    String contextPath = this.servlet.getServletConfig().getInitParameter(
      "Osgi-Context-Path");
    if (contextPath != null) {
  ...
  private String calculatePathInfo() {
    ...
    String contextPath = this.servlet.getServletConfig().getInitParameter(
      "Osgi-Context-Path");
    if (contextPath != null && pathInfo.indexOf(contextPath) > -1
      && pathInfo.startsWith(contextPath)) {// //add check
