/*
// $Id: //open/mondrian/src/main/mondrian/xmla/PropertyDefinition.java#23 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/xmla/PropertyDefinition.java#23 $
 * @since May 2, 2003
 */
public enum PropertyDefinition {
	...
	Deep(RowsetDefinition.Type.Boolean, null, XmlaConstants.Access.ReadWrite, "",
	...
	ProviderName(RowsetDefinition.Type.String, null, XmlaConstants.Access.Read,
			"Mondrian XML for Analysis Provider", XmlaConstants.Method.DISCOVER,
			"The XML for Analysis Provider name."),

	ProviderVersion(RowsetDefinition.Type.String, null,
			XmlaConstants.Access.Read, MondrianServer.forId(null).getVersion()
					.getVersionString(), XmlaConstants.Method.DISCOVER,
	...
	// mondrian-specific property for advanced drill-through
	AdvancedFlag(RowsetDefinition.Type.Boolean, null, XmlaConstants.Access.Read,
			"false", XmlaConstants.Method.DISCOVER_AND_EXECUTE, "");
	...
	PropertyDefinition(RowsetDefinition.Type type, Set<? extends Enum> enumSet,
			XmlaConstants.Access access, String value, XmlaConstants.Method usage,
			String description) {
