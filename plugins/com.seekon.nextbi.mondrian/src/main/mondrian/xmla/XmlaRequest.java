 ...
 * 
 * @author Gang Chen
 * @version $Id: //open/mondrian/src/main/mondrian/xmla/XmlaRequest.java#12 $
 */
public interface XmlaRequest {
	 ...
	 * 
	 * <p>
	 * If the value is a list of strings, the restriction passes if the column has
	 * one of the values.
	 */
	 ...
	 * 
	 * <p>
	 * Not necessarily the same as the HTTP session: the SOAP request contains its
	 * own session information.
	 * </p>
	 * 
	 * <p>
	 * The session id is used to retrieve existing olap connections. And username
	 * / password only need to be passed on the first request in a session.
	 * </p>
	 * 
