...
public class XmlaSupport {
	...
	public static DataSourcesConfig.DataSources getDataSources(
			String connectString, Map<String, String> catalogNameUrls)
			throws XOMException {
	...
	public static String getDataSourcesText(String connectString,
		...
		if (false) {
			...
			buf.append("       <Catalogs>");
			buf.append(nl);
			for (Map.Entry<String, String> catalogNameUrl : catalogNameUrls
					.entrySet()) {
	...
	public static byte[] processSoapXmla(File file, String connectString,
			Map<String, String> catalogNameUrls, String cbClassName)
			throws IOException, ServletException, SAXException {
		String requestText = XmlaSupport.readFile(file);
		return processSoapXmla(requestText, connectString, catalogNameUrls,
				cbClassName, null, null);
	}
	...
	public static byte[] processSoapXmla(Document doc, String connectString,
		...
		return processSoapXmla(requestText, connectString, catalogNameUrls,
				cbClassName, role, servletCache);
	}

	public static byte[] processSoapXmla(String requestText,
			String connectString, Map<String, String> catalogNameUrls,
			String cbClassName, Role role,
			Map<List<String>, WeakReference<Servlet>> servletCache)
			throws IOException, ServletException, SAXException {
		// read soap file
	...
	private static Servlet getServlet(String cbClassName, String dataSourceText,
		...
		servletConfig.addInitParameter(XmlaServlet.PARAM_DATASOURCES_CONFIG,
	...
	public static boolean validateSchemaSoapXmla(byte[] bytes)
		...
		return validateEmbeddedSchema(bytes, XmlUtil.getSoapXmlaXds2xs("xmla"),
	...
	public static byte[] processXmla(Element requestElem, String connectString,
		...
		XmlaRequest request = new DefaultXmlaRequest(requestElem, roleName, null,
				null, null);
	...
	public static boolean validateSchemaXmla(byte[] bytes) throws SAXException,
		...
		return validateEmbeddedSchema(bytes, XmlUtil.getXmlaXds2xs("xmla"),
	 ...
	 */
	public static boolean validateNodes(Node[] nodes) throws SAXException,
			IOException {
		if (!XmlUtil.supportsValidation()) {
			return false;
		}
	...
	public static boolean validateEmbeddedSchema(byte[] bytes,
			String schemaTransform, String dataTransform) throws SAXException,
			IOException, ParserConfigurationException, TransformerException,
	...
	public static boolean validateEmbeddedSchema(Document doc,
		...
		if (!dataDoc.hasChildNodes()) {
			LOGGER
					.debug("XmlaSupport.validateEmbeddedSchema: dataDoc has no children");
			return false;
		}
		...
		Node schemaDoc = XmlUtil.transform(doc, new BufferedReader(
	...
	public static Document transformSoapXmla(Document doc,
			String[][] namevalueParameters, String ns) throws SAXException,
			IOException, ParserConfigurationException, TransformerException {
