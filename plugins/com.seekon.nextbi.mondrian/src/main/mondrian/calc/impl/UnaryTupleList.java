/*
// $Id: //open/mondrian/src/main/mondrian/calc/impl/UnaryTupleList.java#1 $
 ...
 * 
 * <p>
 * It is implemented as a straightforward wrapper on a backing list. You can
 * provide the backing list explicitly using the
 * {@link #UnaryTupleList(java.util.List)} constructor, and you can access the
 * backing list by calling {@link #slice}(0).
 * 
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/calc/impl/UnaryTupleList.java#1 $
 * @author jhyde
 */
public class UnaryTupleList extends AbstractList<List<Member>> implements
		TupleList {
	...
	public TupleList cloneList(int capacity) {
		return new UnaryTupleList(capacity < 0 ? new ArrayList<Member>(list)
	 ...
	 * {@link UnaryTupleList}. Based upon AbstractList.Itr, but with concurrent
