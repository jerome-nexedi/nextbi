/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jPreparedStatement.java#7 $
...
/**
 * Implementation of {@link PreparedOlapStatement} for the Mondrian OLAP engine.
 * 
 * <p>
 * This class has sub-classes which implement JDBC 3.0 and JDBC 4.0 APIs; it is
 * instantiated using {@link Factory#newPreparedStatement}.
 * </p>
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jPreparedStatement
 *          .java#7 $
 * @since Jun 12, 2007
 */
abstract class MondrianOlap4jPreparedStatement extends MondrianOlap4jStatement
	...
	protected MondrianOlap4jPreparedStatement(
			MondrianOlap4jConnection olap4jConnection, String mdx)
			throws OlapException {
	...
	public void setObject(int parameterIndex, Object x) throws SQLException {
		...
		if (x instanceof MondrianOlap4jMember) {
			MondrianOlap4jMember mondrianOlap4jMember = (MondrianOlap4jMember) x;
	...
	private Parameter getParameter(int param) throws OlapException {
		...
		if (param < 1 || param > parameters.length) {
			...
			throw this.olap4jConnection.helper
					.toOlapException(this.olap4jConnection.helper
							.createException("parameter ordinal " + param + " out of range"));
		}
	...
	public String getParameterClassName(int param) throws SQLException {
		final Type type = getParameterOlapType(param);
		return foo(new TypeHelper<Class>() {
