/*
// $Id: //open/mondrian/src/main/mondrian/util/MemoryMonitorFactory.java#11 $
 ...
 * <code>MemoryMonitor</code>. The <code>MemoryMonitorFactory</code> is based
 * upon the <code>ObjectFactory.Singleton</code> generic. The
 * <code>MemoryMonitorFactory</code> implementation has a single, default
 * <code>MemoryMonitor</code> per JVM instance which can be overridden using the
 * provided <code>ThreadLocal</code> variable. Normally, this
 ...
 * own implementation of the <code>MemoryMonitor</code> interface and then calls
 * the <code>ObjectFactory</code> <code>getObject</code> method. After doing the
 * test, the <code>ThreadLocal</code> variable should be cleared.
 * <p>
 * The <code>ObjectFactory.Singleton</code> permits the use of
 * <code>System</code> properties to provide a class name to the factory. This
 * can be used to create a <code>MemoryMonitor</code> that is not the default
 * one. The property name is the <code>MemoryMonitor</code> class name,
 * "mondrian.util.MemoryMonitor".
 * 
 * @author <a>Richard M. Emberson</a>
 * @since Feb 03 2007
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/util/MemoryMonitorFactory.java#11
 *          $
 */
