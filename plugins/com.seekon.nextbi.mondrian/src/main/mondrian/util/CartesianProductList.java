/*
// $Id: //open/mondrian/src/main/mondrian/util/CartesianProductList.java#3 $
 ...
 * 
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/util/CartesianProductList.java#3 $
 * @author jhyde
 */
public class CartesianProductList<T> extends AbstractList<List<T>> implements
		RandomAccess {
