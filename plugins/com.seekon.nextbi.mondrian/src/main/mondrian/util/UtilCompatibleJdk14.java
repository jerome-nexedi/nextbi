/*
// $Id: //open/mondrian/src/main/mondrian/util/UtilCompatibleJdk14.java#10 $
...
/**
 * Implementation of {@link UtilCompatible} which runs in JDK 1.4.
 * 
 * <p>
 * The code uses JDK 1.5 constructs such as generics and for-each loops, but
 * retroweaver can convert these. It does not use <code>java.util.EnumSet</code>
 * , which is important, because retroweaver has trouble with this.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/util/UtilCompatibleJdk14.java#10 $
 * @since Feb 5, 2007
 */
public class UtilCompatibleJdk14 implements UtilCompatible {
	...
	/**
	 * This generates a BigDecimal that can have a precision that does not reflect
