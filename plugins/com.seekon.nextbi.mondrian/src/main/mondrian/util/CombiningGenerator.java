/*
// $Id: //open/mondrian/src/main/mondrian/util/CombiningGenerator.java#4 $
 ...
 * combination of those objects (also known as the <a
 * href="http://en.wikipedia.org/wiki/Power_set">power set</a> of those
 * objects).
 * 
 * @author LBoudreau
 * @author jhyde
...
public class CombiningGenerator<E> extends AbstractList<List<E>> {
	...
	/**
	 * Returns the position of the {@code seek}th bit set in {@code b}. For
	 * example, nth(0, 1) returns 0; nth(0, 2) returns 1; nth(0, 4) returns 2;
	 * nth(7, 255) returns 7.
	 * 
	 * <p>
	 * Careful. If there are not that many bits set, this method never returns.
	 * </p>
	 * 
	 * @param seek
	 *          Bit to seek
	 * @param b
	 *          Integer in which to seek bits
