...
public class Schedule {
	...
	static final int allDaysOfWeekBitmap = (1 << Calendar.MONDAY)
			...
			| (1 << Calendar.SATURDAY) | (1 << Calendar.SUNDAY);
	...
	public static Schedule createDaily(Date begin, Date end, TimeZone tz,
		...
		return new Schedule(dateSchedule, new OnceTimeSchedule(
				ScheduleUtil.createTimeCalendar(timeOfDay)), tz, begin, end);
	}
	...
	public static Schedule createMonthlyByDay(Date begin, Date end, TimeZone tz,
		...
		DateSchedule dateSchedule = new MonthlyByDayDateSchedule(
				begin == null ? null : ScheduleUtil.createCalendar(begin), period,
				daysOfMonthBitmap);
		return new Schedule(dateSchedule, new OnceTimeSchedule(
				ScheduleUtil.createTimeCalendar(timeOfDay)), tz, begin, end);
	}
	...
	public static Schedule createMonthlyByWeek(Date begin, Date end, TimeZone tz,
		...
		DateSchedule dateSchedule = new MonthlyByWeekDateSchedule(
				begin == null ? null : ScheduleUtil.createCalendar(begin), period,
				daysOfWeekBitmap, weeksOfMonthBitmap);
		return new Schedule(dateSchedule, new OnceTimeSchedule(
				ScheduleUtil.createTimeCalendar(timeOfDay)), tz, begin, end);
	}
...
class DailyDateSchedule implements DateSchedule {
	...
	DailyDateSchedule(Calendar begin, int period) {
		...
		this.beginOrdinal = ScheduleUtil
				.julianDay(begin == null ? ScheduleUtil.epochDay : begin);
	}
...
class WeeklyDateSchedule implements DateSchedule {
	...
	WeeklyDateSchedule(Calendar begin, int period, int daysOfWeekBitmap) {
		...
		ScheduleUtil.assertTrue(period > 0, "period must be positive");
		this.beginOrdinal = ScheduleUtil
				.julianDay(begin == null ? ScheduleUtil.epochDay : begin) / 7;
...
class ScheduleUtil {
	...
	public static boolean isTime(Calendar calendar) {
		return calendar.get(Calendar.YEAR) == ScheduleUtil.epochDay
				.get(Calendar.YEAR)
	...
	public static Calendar getTime(Calendar calendar) {
		...
		return createTimeCalendar(calendar.get(Calendar.HOUR_OF_DAY),
	...
	public static Time createTime(int hour, int minutes, int second) {
		return new Time(createTimeCalendar(hour, minutes, second).getTime()
				.getTime());
	}
	...
	public static int julianDay(Calendar calendar) {
		int year = calendar.get(Calendar.YEAR), day = calendar
				.get(Calendar.DAY_OF_YEAR), leapDays = (year / 4) - (year / 100)
				+ (year / 400);
	...
	public static int timezoneOffset(TimeZone tz, Calendar calendar) {
		return tz.getOffset(calendar.get(Calendar.ERA),
				calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar
						.get(Calendar.DAY_OF_MONTH), calendar.get(Calendar.DAY_OF_WEEK),
				(1000 * (60 * (60 * calendar.get(Calendar.HOUR_OF_DAY) + calendar
