/*
// $Id: //open/mondrian/src/main/mondrian/rolap/sql/MemberChildrenConstraint.java#13 $
 ...
 * @since Nov 2, 2005
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/sql/MemberChildrenConstraint
 *          .java#13 $
 */
public interface MemberChildrenConstraint extends SqlConstraint {

  /**
   * Modifies a <code>Member.Children</code> query so that only the children of
   * <code>parent</code> will be returned in the result set.
   * 
   * @param sqlQuery
   *          the query to modify
   * @param baseCube
  ...
  /**
   * Will be called once for the level that contains the children of a
   * Member.Children query. If the condition requires so, it may join the levels
