/*
// $Id: //open/mondrian/src/main/mondrian/rolap/RolapNativeSet.java#68 $
...
/**
 * Analyses set expressions and executes them in SQL if possible. Supports
 * crossjoin, member.children, level.members and member.descendants - all in non
 * empty mode, i.e. there is a join to the fact table.
 * <p/>
 * 
 * <p>
 * TODO: the order of the result is different from the order of the enumeration.
 * Should sort.
 * 
 * @author av
 * @since Nov 12, 2005
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/RolapNativeSet.java#68
 *          $
 */
