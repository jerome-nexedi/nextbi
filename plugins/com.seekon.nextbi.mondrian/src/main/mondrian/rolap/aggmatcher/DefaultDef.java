...
public class DefaultDef {
	...
	public static String[] _elements = { "AggRules", "Base", "CaseMatcher",
			"NameMatcher", "FactCountMatch", "ForeignKeyMatch", "TableMatch",
			"Mapper", "Regex", "RegexMapper", "Ref", "LevelMapRef", "MeasureMapRef",
			"IgnoreMapRef", "FactCountMatchRef", "ForeignKeyMatchRef",
			"TableMatchRef", "LevelMap", "MeasureMap", "IgnoreMap", "AggRule" };
	...
	public static class AggRules extends org.eigenbase.xom.ElementDef {
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElementArray(_out, "factCountMatches", factCountMatches,
					_indent + 1);
			displayElementArray(_out, "foreignKeyMatches", foreignKeyMatches,
					_indent + 1);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("AggRules",
					new org.eigenbase.xom.XMLAttrVector().add("tag", tag));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayElementArrayDiff("levelMaps", levelMaps, _cother.levelMaps,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("measureMaps", measureMaps,
							_cother.measureMaps, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("ignoreMaps", ignoreMaps,
							_cother.ignoreMaps, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("aggRules", aggRules, _cother.aggRules,
							_out, _indent + 1);
			return _diff;
		}
	...
	public static abstract class CaseMatcher extends Base {
		...
		public CaseMatcher(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				charcase = (String) _parser.getAttribute("charcase", "String",
						"ignore", _charcase_values, false);
				enabled = (Boolean) _parser.getAttribute("enabled", "Boolean", "true",
						null, false);
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
		...
		public static final String[] _charcase_values = { "ignore", "exact",
				"upper", "lower" };
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"CaseMatcher",
					new org.eigenbase.xom.XMLAttrVector().add("id", id)
							.add("charcase", charcase).add("enabled", enabled));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("id", id, _cother.id, _out,
					_indent + 1);
			_diff = _diff
	...
	public static abstract class NameMatcher extends CaseMatcher {
		...
		public NameMatcher(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", DefaultDef.class);
				pretemplate = (String) _parser.getAttribute("pretemplate", "String",
						null, null, false);
				posttemplate = (String) _parser.getAttribute("posttemplate", "String",
						null, null, false);
				basename = (String) _parser.getAttribute("basename", "String", null,
						null, false);
				id = (String) _parser.getAttribute("id", "String", null, null, true);
				charcase = (String) _parser.getAttribute("charcase", "String",
						"ignore", _charcase_values, false);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"NameMatcher",
					new org.eigenbase.xom.XMLAttrVector().add("pretemplate", pretemplate)
							.add("posttemplate", posttemplate).add("basename", basename)
							.add("id", id).add("charcase", charcase).add("enabled", enabled));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("posttemplate", posttemplate,
							_cother.posttemplate, _out, _indent + 1);
			_diff = _diff
	...
	public static class FactCountMatch extends NameMatcher {
		...
		public FactCountMatch(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", DefaultDef.class);
				factCountName = (String) _parser.getAttribute("factCountName",
						"String", "fact_count", null, true);
				pretemplate = (String) _parser.getAttribute("pretemplate", "String",
						null, null, false);
				posttemplate = (String) _parser.getAttribute("posttemplate", "String",
						null, null, false);
	...
	public static class ForeignKeyMatch extends NameMatcher {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("ForeignKeyMatch", new org.eigenbase.xom.XMLAttrVector()
					.add("pretemplate", pretemplate).add("posttemplate", posttemplate)
					.add("basename", basename).add("id", id).add("charcase", charcase)
					.add("enabled", enabled));
	...
	public static abstract class Mapper extends CaseMatcher {
		...
		public Mapper(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", DefaultDef.class);
				template = (String) _parser.getAttribute("template", "String", null,
						null, true);
				space = (String) _parser.getAttribute("space", "String", "_", null,
						false);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Mapper",
					new org.eigenbase.xom.XMLAttrVector().add("template", template)
							.add("space", space).add("dot", dot).add("id", id)
							.add("charcase", charcase).add("enabled", enabled));
			_out.endTag("Mapper");
		}
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("template", template,
					_cother.template, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("space", space, _cother.space, _out,
							_indent + 1);
			_diff = _diff
	...
	public static class Regex extends CaseMatcher {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Regex",
					new org.eigenbase.xom.XMLAttrVector().add("space", space)
							.add("dot", dot).add("id", id).add("charcase", charcase)
							.add("enabled", enabled));
			_out.cdata(cdata);
			_out.endTag("Regex");
		}
	...
	public static abstract class RegexMapper extends Base {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"RegexMapper",
					new org.eigenbase.xom.XMLAttrVector().add("id", id).add("enabled",
							enabled));
	...
	public static abstract class Ref extends Base {
		...
		public Ref(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", DefaultDef.class);
				refId = (String) _parser.getAttribute("refId", "String", null, null,
						true);
				enabled = (Boolean) _parser.getAttribute("enabled", "Boolean", "true",
						null, false);
			} catch (org.eigenbase.xom.XOMException _ex) {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Ref",
					new org.eigenbase.xom.XMLAttrVector().add("refId", refId).add(
							"enabled", enabled));
			_out.endTag("Ref");
		}
	...
	public static class FactCountMatchRef extends Ref {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("FactCountMatchRef", new org.eigenbase.xom.XMLAttrVector()
					.add("refId", refId).add("enabled", enabled));
	...
	public static class MeasureMap extends RegexMapper {
		...
		protected Recognizer.Matcher getMatcher(final String measureName,
			...
			return getMatcher(new String[] { measureName, measuerColumnName,
					aggregateName });
		}
		// END pass-through code block ---
	}
	...
	public static class AggRule extends Base {
		...
		public AggRule(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				ignoreMapRef = (IgnoreMapRef) _parser.getElement(IgnoreMapRef.class,
						false);
				factCountMatch = (FactCountMatch) _parser.getElement(
						FactCountMatch.class, false);
				...
				levelMapRef = (LevelMapRef) _parser
						.getElement(LevelMapRef.class, false);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayAttribute(_out, "enabled", enabled, _indent + 1);
			displayElement(_out, "ignoreMap",
					(org.eigenbase.xom.ElementDef) ignoreMap, _indent + 1);
			...
			displayElement(_out, "tableMatch",
					(org.eigenbase.xom.ElementDef) tableMatch, _indent + 1);
			...
			displayElement(_out, "measureMap",
					(org.eigenbase.xom.ElementDef) measureMap, _indent + 1);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("tag", tag, _cother.tag, _out,
					_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("countColumn", countColumn,
							_cother.countColumn, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("ignoreMap", ignoreMap, _cother.ignoreMap,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("ignoreMapRef", ignoreMapRef,
							_cother.ignoreMapRef, _out, _indent + 1);
			_diff = _diff
			...
			_diff = _diff
					&& displayElementDiff("tableMatch", tableMatch, _cother.tableMatch,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("tableMatchRef", tableMatchRef,
							_cother.tableMatchRef, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("levelMap", levelMap, _cother.levelMap, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementDiff("levelMapRef", levelMapRef,
							_cother.levelMapRef, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("measureMap", measureMap, _cother.measureMap,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("measureMapRef", measureMapRef,
							_cother.measureMapRef, _out, _indent + 1);
			return _diff;
		}
		...
		public void validate(final AggRules rules,
			...
			try {
				...
				if (isRef(rules, msgRecorder, factCountMatch, factCountMatchRef,
						"FactCountMatch")) {
					factCountMatch = rules.lookupFactCountMatch(factCountMatchRef
							.getRefId());
				}
