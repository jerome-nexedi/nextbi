/*
// $Id: //open/mondrian/src/main/mondrian/rolap/CellReader.java#15 $
...
/**
 * A <code>CellReader</code> finds the cell value for the current context held
 * by <code>evaluator</code>.
 * 
 * <p>
 * It returns:
 * <ul>
 * <li><code>null</code> if the source is unable to evaluate the cell (for
 * example, <code>AggregatingCellReader</code> does not have the cell in its
 * cache). This value should only be returned if the caller is expecting it.</li>
 ...
 * error</li>
 * <li>an Object representing a value (often a {@link Double} or a
 * {@link java.math.BigDecimal}), otherwise</li>
 * </ul>
 * 
 * @author jhyde
