/*
// $Id: //open/mondrian/src/main/mondrian/rolap/Modulos.java#7 $
 ...
 * ordinals and position arrays. There are particular implementations for the
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/Modulos.java#7 $
 */
public interface Modulos {
	...
	public class Two extends Base {
		...
		public final int[] getCellPos(final int cellOrdinal) {
			...
			return new int[] { (cellOrdinal % modulos[1]),
	 ...
	 * {@link #getCellOrdinal}. For example, if this result is 10 x 10 x 10, then
	 * cell ordinal 537 has coordinates (5, 3, 7).
	 * 
	 * @param cellOrdinal
	 *          Cell ordinal
