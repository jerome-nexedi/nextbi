/*
// $Id: //open/mondrian/src/main/mondrian/rolap/CellKey.java#15 $
 ...
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/CellKey.java#15 $
 */
public interface CellKey extends Serializable {
   ...
   * 
   * <p>
   * Note: caller should treat the array as immutable. If the contents of the
   * array are modified, behavior is unspecified.
   * 
  ...
  /**
   * This method make a copy of the int array parameter. Throws a
   * RuntimeException if the int array size is not the size of the CellKey.
   * 
   * @param pos
   *          Array of axis keys
   */
   ...
   *           if axis parameter is larger than {@link #size()}
   */
   ...
   * 
   * <p>
   * For example, if the axes have lengths {2, 5, 10} then cell (2, 3, 4) has
   * offset
   * 
   * <blockquote> (2 * mulitiplers[0]) + (3 * multipliers[1]) + (4 *
   * multipliers[2])<br/>
   * = (2 * 50) + (3 * 10) + (4 * 1)<br/>
   * = 134</blockquote>
   * 
   * <p>
   * The multipliers are the product of the lengths of all later axes, in this
   * case (50, 10, 1).
   * 
   * @param axisMultipliers
   *          For each axis, the product of the lengths of later axes
  ...
  public abstract class Generator {
     ...
     * 
     * <p>
     * This is used for testing only. The CellKey will fail to compare equal to
     * naturally created keys of size 0, 1, 2 or 3.
     * 
     * @param size
  ...
  public class Two implements CellKey {
    ...
    public int getOffset(int[] axisMultipliers) {
      return ordinal0 * axisMultipliers[0] + ordinal1;
    }
  ...
  class Three implements CellKey {
    ...
    public int getOffset(int[] axisMultipliers) {
      return ordinal0 * axisMultipliers[0] + ordinal1 * axisMultipliers[1]
        + ordinal2;
    }
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof Three) {
        Three other = (Three) o;
        return (other.ordinal0 == this.ordinal0)
          && (other.ordinal1 == this.ordinal1) && (other.ordinal2 == this.ordinal2);
      } else {
        return false;
      }
    }
