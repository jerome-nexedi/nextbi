...
public class RolapHierarchy extends HierarchyBase {
  ...
  RolapHierarchy(RolapDimension dimension, String subName, String caption,
    boolean visible, String description, boolean hasAll, RolapHierarchy closureFor,
    ...
    this.allMemberName = subName != null
      && (MondrianProperties.instance().SsasCompatibleNaming.get() || name
        .equals(subName + "." + subName)) ? "All " + subName + "s" : "All " + name
      + "s";
    this.closureFor = closureFor;
    if (hasAll) {
      this.levels = new RolapLevel[1];
      this.levels[0] = new RolapLevel(this, this.allLevelName, null, true, null, 0,
        null, null, null, null, null, null, null, RolapProperty.emptyArray,
        RolapLevel.FLAG_ALL | RolapLevel.FLAG_UNIQUE, null, null,
        RolapLevel.HideMemberCondition.Never, LevelType.Regular, "", Collections
    ...
    // the 'all' level.
    this.nullLevel = new RolapLevel(this, this.allLevelName, null, true, null, 0,
      null, null, null, null, null, null, null, RolapProperty.emptyArray,
      RolapLevel.FLAG_ALL | RolapLevel.FLAG_UNIQUE, null, null,
      RolapLevel.HideMemberCondition.Never, LevelType.Null, "", Collections
        .<String, Annotation> emptyMap());
  }
  ...
  RolapHierarchy(RolapDimension dimension, MondrianDef.Hierarchy xmlHierarchy,
    ...
    this(dimension, xmlHierarchy.name, xmlHierarchy.caption, xmlHierarchy.visible,
      xmlHierarchy.description, xmlHierarchy.hasAll, null,
    ...
    RolapLevel allLevel = new RolapLevel(this, this.allLevelName, null, true, null,
    ...
    if (xmlHierarchy.levels.length == 0) {
      throw MondrianResource.instance().HierarchyHasNoLevels.ex(getUniqueName());
    }
  ...
  void init(MondrianDef.CubeDimension xmlDimension) {
    ...
    if (this.memberReader == null) {
      this.memberReader = getRolapSchema().createMemberReader(sharedHierarchyName,
  ...
  RolapLevel newMeasuresLevel() {
    RolapLevel level = new RolapLevel(this, "MeasuresLevel", null, true, null,
      ...
      RolapProperty.emptyArray, 0, null, null, RolapLevel.HideMemberCondition.Never,
      LevelType.Regular, "", Collections.<String, Annotation> emptyMap());
  ...
  MondrianDef.Relation getUniqueTable() {
    if (relation instanceof MondrianDef.Relation) {
      ...
      throw Util.newInternal("hierarchy's relation is a " + relation.getClass());
    }
  }
  ...
  public Member getDefaultMember() {
    ...
    if (defaultMember == null) {
      ...
      for (RolapMember rootMember : UnionIterator.over(rootMembers, calcMemberList)) {
  ...
  public Member createMember(Member parent, Level level, String name, Formula formula) {
    if (formula == null) {
      ...
      return new RolapCalculatedMeasure((RolapMember) parent, (RolapLevel) level,
        name, formula);
    } else {
      return new RolapCalculatedMember((RolapMember) parent, (RolapLevel) level,
        name, formula);
    }
  }
  ...
  void addToFromInverse(SqlQuery query, MondrianDef.Expression expression) {
    ...
    if (relation instanceof MondrianDef.Join) {
      if (expression != null) {
        subRelation = relationSubsetInverse(relation, expression.getTableAlias());
      }
    }
  ...
  void addToFrom(SqlQuery query, RolapStar.Table table) {
    ...
    boolean tableAdded = query.addFrom(subRelation, table != null ? table.getAlias()
      : null, failIfExists);
  ...
  private static MondrianDef.RelationOrJoin relationSubsetInverse(
    ...
    if (relation instanceof MondrianDef.Relation) {
      ...
      MondrianDef.RelationOrJoin leftRelation = relationSubsetInverse(join.left,
        alias);
  ...
  private static MondrianDef.RelationOrJoin lookupRelationSubset(
    ...
    if (relation instanceof MondrianDef.Table) {
      ...
      MondrianDef.Join join = (MondrianDef.Join) relation;
      MondrianDef.RelationOrJoin rightRelation = lookupRelationSubset(join.right,
        targetTable);
  ...
  MemberReader createMemberReader(Role role) {
    ...
    case CUSTOM:
      ...
      case PARTIAL:
        Type memberType1 = new mondrian.olap.type.MemberType(getDimension(), this,
          null, null);
        SetType setType = new SetType(memberType1);
        ListCalc listCalc = new AbstractListCalc(new DummyExp(setType), new Calc[0]) {
          public TupleList evaluateList(Evaluator evaluator) {
            return new UnaryTupleList(FunUtil.getNonEmptyMemberChildren(evaluator,
        ...
        return new LimitedRollupSubstitutingMemberReader(getMemberReader(), role,
          hierarchyAccess, partialExp);
   ...
   */
  RolapDimension createClosedPeerDimension(RolapLevel src, MondrianDef.Closure clos,
    ...
    RolapDimension peerDimension = new RolapDimension(dimension.getSchema(),
      ...
      DimensionType.StandardDimension, dimension.isHighCardinality(), Collections
        .<String, Annotation> emptyMap());
    ...
    RolapLevel level = new RolapLevel(peerHier, "Closure", caption, true,
      description, index++, keyExp, null, null,
      null,
      null,
      null, // no longer
      // a
      // parent-child
      // hierarchy
      null, RolapProperty.emptyArray, flags | RolapLevel.FLAG_UNIQUE, src
        .getDatatype(), null, src.getHideMemberCondition(), src.getLevelType(), "",
    ...
    RolapLevel sublevel = new RolapLevel(peerHier, "Item", null, true, null,
      index++, keyExp, null, null, null,
      null,
      null, // no longer a
      // parent-child
      // hierarchy
      null, RolapProperty.emptyArray, flags, src.getDatatype(), src
        .getInternalType(), src.getHideMemberCondition(), src.getLevelType(), "",
      Collections.<String, Annotation> emptyMap());
  ...
  protected static class RolapCalculatedMeasure extends RolapCalculatedMember
    ...
    public RolapCalculatedMeasure(RolapMember parent, RolapLevel level, String name,
      Formula formula) {
    ...
    public synchronized void setProperty(String name, Object value) {
      if (name.equals(Property.CELL_FORMATTER.getName())) {
        ...
        try {
          CellFormatter formatter = RolapSchema.getCellFormatter(cellFormatterClass,
            null);
      ...
      if (name.equals(Property.CELL_FORMATTER_SCRIPT.name)) {
        ...
        try {
          ...
          throw MondrianResource.instance().CellFormatterLoadFailed.ex(scriptText,
            getUniqueName(), e);
        }
      }
