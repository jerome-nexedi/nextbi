/*
// $Id: //open/mondrian/src/main/mondrian/rolap/RolapProfilingEvaluator.java#2 $
 ...
 * dependency-checking (e.g. {@link mondrian.calc.impl.AbstractCalc#anyDepends}
 * ). A few places uses the calcs array but should use more strongly typed
 * members. e.g. FilterFunDef.MutableMemberIterCalc should have data members
 ...
 * @since October, 2010
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/RolapProfilingEvaluator.
 *          java#2 $
 */
public class RolapProfilingEvaluator extends RolapEvaluator {
	 ...
	 *          Parent evaluator
	 */
	private RolapProfilingEvaluator(RolapEvaluatorRoot root,
			RolapProfilingEvaluator evaluator, List<List<Member>> aggregationList) {
