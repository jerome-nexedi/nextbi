...
public class ResultLoader {
	...
	public ResultLoader(final int enumTargetCount,
			final List<TargetBase> targets, final SqlStatement stmt,
			final boolean execQuery, final TupleList partialResult,
