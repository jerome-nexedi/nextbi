/*
// $Id: //open/mondrian/src/main/mondrian/rolap/ResultLoader.java#9 $
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/ResultLoader.java#9 $
...
public class ResultLoader {
  ...
  public ResultLoader(final int enumTargetCount, final List<TargetBase> targets,
    final SqlStatement stmt, final boolean execQuery, final TupleList partialResult,
    final List<List<RolapMember>> newPartialResult) throws SQLException {
  ...
  public boolean loadResult() throws SQLException {
    /*
     * if (limit > 0 && limit < ++fetchCount) { throw
     * MondrianResource.instance().MemberFetchLimitExceeded .ex((long) limit); }
     */
    if (enumTargetCount == 0) {
      ...
      addTargets(0, firstEnumTarget, enumTargetCount, srcMemberIdxes, message);
  ...
  private void addTargets(int currEnumTargetIdx, int currTargetIdx,
    int nEnumTargets, int[] srcMemberIdxes, String message) {
