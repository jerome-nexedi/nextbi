...
/**
 * Implementation of a segment body which stores the data of a sparse segment
 * data set into a dense array of java objects.
 * 
 * @author LBoudreau
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/agg/SparseSegmentBody.java#2
 *          $
 */
