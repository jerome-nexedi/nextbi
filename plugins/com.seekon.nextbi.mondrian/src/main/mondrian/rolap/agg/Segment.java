	...
	Segment createSubSegment(BitSet[] axisKeepBitSets, int bestColumn,
		...
		for (int j = 0; j < axes.length; j++) {
			...
			if (firstClearBit >= axisKeys.length) {
				...
				newAxisKeys = newAxisKeyList.toArray(new Comparable<?>[newAxisKeyList
						.size()]);
		...
		// will be sparse.)
		SegmentDataset newData = createDataset(
				data instanceof SparseSegmentDataset, data.getType(), valueCount);
	...
	static class Region {
		...
		Region(List<StarColumnPredicate> predicateList,
			...
			this.predicates = predicateList
					.toArray(new StarColumnPredicate[predicateList.size()]);
		...
		public boolean equals(Object obj) {
			if (obj instanceof Region) {
				...
				return Arrays.equals(this.predicates, that.predicates)
						&& Arrays.equals(this.multiColumnPredicates,
