/*
// $Id: //open/mondrian/src/main/mondrian/rolap/agg/LiteralStarPredicate.java#6 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/agg/LiteralStarPredicate
 *          .java#6 $
 * @since Nov 2, 2006
 */
public class LiteralStarPredicate extends AbstractColumnPredicate {
  ...
  public static final LiteralStarPredicate TRUE = new LiteralStarPredicate(null,
    true);

  public static final LiteralStarPredicate FALSE = new LiteralStarPredicate(null,
    false);
