...
public class MdxParserImpl implements MdxParserImplConstants {
  ...
  Exp recursivelyParseExp(String s) throws ParseException {
    MdxParserImpl parser = new MdxParserImpl(factory, statement, s, false, funTable,
      strictValidation);
          ...
          default:
            ...
            if (jj_2_4(2)) {
              ...
              case NOT:
                ...
                y = term2();
                x = new UnresolvedFunCall("NOT", Syntax.Prefix,
                  new Exp[] { new UnresolvedFunCall("IN", Syntax.Infix, new Exp[] {
                    x, y }) });
                break;
              default:
                jj_la1[10] = jj_gen;
  ...
  final public Query selectStatement() throws ParseException {
    ...
    {
      if (true)
        return factory.makeQuery(statement, toFormulaArray(f), toQueryAxisArray(a),
          cubeName, w, toQueryPartArray(cellPropList), strictValidation);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 = new int[] { 0x40000200, 0x40000200, 0x8000000, 0x8000000, 0x2,
      0x43000230, 0x11c0000, 0x0, 0x0, 0x180000, 0x1040000, 0x0, 0x0, 0x0, 0x0,
      0x42000230, 0x0, 0x0, 0x0, 0x43000230, 0x0, 0x0, 0x42000230, 0x43000230, 0x0,
      0x800, 0x4, 0x43000230, 0x0, 0x0, 0x4400, 0x400, 0x400000, 0x400000, 0x0, 0x0,
      0x43800230, 0x0, 0x40, 0x0, 0x40000040, 0x0, 0x43000230, 0x800000, 0x200, 0x0,
      0x40000200, 0x8, 0x10000188, 0x200000, 0x8000, 0x80000000, 0x400, };
  }

  private static void jj_la1_init_1() {
    jj_la1_1 = new int[] { 0x0, 0x0, 0x1000080, 0x1000080, 0x0, 0x80000000,
      0x70000000, 0x70000000, 0x70000000, 0x0, 0x0, 0x4000000, 0x4000000, 0x400000,
      0x400000, 0x80000000, 0x8000000, 0x0, 0x0, 0x80000000, 0x800000, 0x0,
      0x80000000, 0x80000000, 0x20, 0x0, 0x0, 0x80000000, 0x2000000, 0x2000000,
      0x104, 0x104, 0x8, 0x8, 0x100, 0x2000000, 0x80000000, 0x40, 0x0, 0x2000000,
      0x0, 0x2000000, 0x80000000, 0x0, 0x0, 0x2000000, 0x0, 0x0, 0x3, 0x0, 0x0, 0x0,
      0x104, };
  }

  private static void jj_la1_init_2() {
    jj_la1_2 = new int[] { 0x70000, 0x0, 0x0, 0x0, 0x0, 0x76e2a, 0x15, 0x15, 0x15,
      0x0, 0x0, 0x28, 0x28, 0x100, 0x100, 0x76e2a, 0x0, 0x2, 0xe00, 0x76e2a, 0x0,
      0x2, 0x76e02, 0x76e2a, 0x0, 0x0, 0x0, 0x76e2a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
      0x0, 0x0, 0x76e2a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x76e2a, 0x0, 0x0, 0x0, 0x0,
      0xe00, 0xe00, 0x0, 0x0, 0x0, 0x0, };
  }
