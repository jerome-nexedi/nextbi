 ...
 * when the servlet is loaded. (This might be a bug in Tomcat 4.0.3, because it
 * worked in 4.0.1. But anyway.)
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/web/taglib/Listener.java#6 $
 */
