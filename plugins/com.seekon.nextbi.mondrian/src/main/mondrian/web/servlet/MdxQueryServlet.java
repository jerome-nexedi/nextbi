...
public class MdxQueryServlet extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request,
    ...
    try {
      ...
      for (int j = 0; j < columnWidth; j++) {
        ...
        if (j == 0 && result.getAxes().length > 1) {
          ...
          html.append("<td nowrap class='slicer' rowspan='").append(columnWidth)
            .append("' colspan='").append(rowWidth).append("'>");
        ...
        for (int i = 0; i < columns.size(); i++) {
          ...
          html.append("<td nowrap class='columnheading' colspan='").append(width)
            .append("'>").append(member.getUniqueName()).append("</td>");
        }
    ...
    getServletContext().getRequestDispatcher("/adhoc.jsp")
