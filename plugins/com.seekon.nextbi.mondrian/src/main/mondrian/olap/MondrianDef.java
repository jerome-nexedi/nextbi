...
public class MondrianDef {
	...
	public static String[] _elements = { "Schema", "CubeDimension", "Cube",
			...
			"VirtualCubeMeasure", "DimensionUsage", "Dimension", "Hierarchy",
			"Level", "Closure", "Property", "Measure", "CalculatedMember",
			"CalculatedMemberProperty", "NamedSet", "Formula",
			"MemberReaderParameter", "RelationOrJoin", "Relation", "View", "SQL",
			"Join", "Table", "Hint", "InlineTable", "ColumnDefs", "ColumnDef",
			"Rows", "Row", "Value", "AggTable", "AggName", "AggPattern",
			"AggExclude", "AggColumnName", "AggFactCount", "AggIgnoreColumn",
			"AggForeignKey", "AggLevel", "AggMeasure", "Expression", "Column",
			"ExpressionView", "KeyExpression", "ParentExpression",
			"OrdinalExpression", "NameExpression", "CaptionExpression",
			"MeasureExpression", "Role", "Grant", "SchemaGrant", "CubeGrant",
			"DimensionGrant", "HierarchyGrant", "MemberGrant", "Union", "RoleUsage",
			"UserDefinedFunction", "Parameter", "Annotations", "Annotation",
			"Script", "CellFormatter", "MemberFormatter", "PropertyFormatter" };
	...
	public static class Schema extends org.eigenbase.xom.ElementDef {
		...
		public Schema(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				name = (String) _parser
						.getAttribute("name", "String", null, null, true);
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				measuresCaption = (String) _parser.getAttribute("measuresCaption",
						"String", null, null, false);
				defaultRole = (String) _parser.getAttribute("defaultRole", "String",
						null, null, false);
				annotations = (Annotations) _parser
						.getElement(Annotations.class, false);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Schema",
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("name", name, _cother.name, _out,
					_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("description", description,
							_cother.description, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("measuresCaption", measuresCaption,
							_cother.measuresCaption, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("defaultRole", defaultRole,
							_cother.defaultRole, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("annotations", annotations,
							_cother.annotations, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("parameters", parameters,
							_cother.parameters, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("dimensions", dimensions,
							_cother.dimensions, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("cubes", cubes, _cother.cubes, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("virtualCubes", virtualCubes,
							_cother.virtualCubes, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("namedSets", namedSets, _cother.namedSets,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("roles", roles, _cother.roles, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("userDefinedFunctions",
							userDefinedFunctions, _cother.userDefinedFunctions, _out,
							_indent + 1);
			return _diff;
		}
	 ...
	 */
	public static abstract class CubeDimension extends
		...
		public CubeDimension(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				name = (String) _parser
						.getAttribute("name", "String", null, null, true);
				caption = (String) _parser.getAttribute("caption", "String", null,
						null, false);
				visible = (Boolean) _parser.getAttribute("visible", "Boolean", "true",
						null, false);
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				foreignKey = (String) _parser.getAttribute("foreignKey", "String",
						null, null, false);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("description", description,
							_cother.description, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("foreignKey", foreignKey, _cother.foreignKey,
							_out, _indent + 1);
			_diff = _diff
	...
	public static class Cube extends org.eigenbase.xom.ElementDef {
		...
		public Cube(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				defaultMeasure = (String) _parser.getAttribute("defaultMeasure",
						"String", null, null, false);
				cache = (Boolean) _parser.getAttribute("cache", "Boolean", "true",
						null, false);
				enabled = (Boolean) _parser.getAttribute("enabled", "Boolean", "true",
						null, false);
				annotations = (Annotations) _parser
						.getElement(Annotations.class, false);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "annotations",
					(org.eigenbase.xom.ElementDef) annotations, _indent + 1);
			displayElement(_out, "fact", (org.eigenbase.xom.ElementDef) fact,
					_indent + 1);
			displayElementArray(_out, "dimensions", dimensions, _indent + 1);
			displayElementArray(_out, "measures", measures, _indent + 1);
			displayElementArray(_out, "calculatedMembers", calculatedMembers,
					_indent + 1);
			displayElementArray(_out, "namedSets", namedSets, _indent + 1);
		}
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					...
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("caption", caption).add("visible", visible)
							.add("description", description)
							.add("defaultMeasure", defaultMeasure).add("cache", cache)
							.add("enabled", enabled));
			displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("cache", cache, _cother.cache, _out,
							_indent + 1);
			_diff = _diff
			...
			_diff = _diff
					&& displayElementArrayDiff("dimensions", dimensions,
							_cother.dimensions, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("measures", measures, _cother.measures,
							_out, _indent + 1);
			_diff = _diff
	...
	public static class VirtualCube extends org.eigenbase.xom.ElementDef {
		...
		public VirtualCube(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				enabled = (Boolean) _parser.getAttribute("enabled", "Boolean", "true",
						null, false);
				name = (String) _parser.getAttribute("name", "String", null, null,
						false);
				defaultMeasure = (String) _parser.getAttribute("defaultMeasure",
						"String", null, null, false);
				caption = (String) _parser.getAttribute("caption", "String", null,
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "annotations",
					(org.eigenbase.xom.ElementDef) annotations, _indent + 1);
			displayElement(_out, "cubeUsage",
					(org.eigenbase.xom.ElementDef) cubeUsage, _indent + 1);
			displayElementArray(_out, "dimensions", dimensions, _indent + 1);
			displayElementArray(_out, "measures", measures, _indent + 1);
			displayElementArray(_out, "calculatedMembers", calculatedMembers,
					_indent + 1);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"VirtualCube",
					new org.eigenbase.xom.XMLAttrVector().add("enabled", enabled)
							.add("name", name).add("defaultMeasure", defaultMeasure)
							.add("caption", caption).add("visible", visible)
							.add("description", description));
			displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayElementDiff("annotations", annotations,
							_cother.annotations, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("cubeUsage", cubeUsage, _cother.cubeUsage,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("dimensions", dimensions,
							_cother.dimensions, _out, _indent + 1);
	...
	public static class CubeUsage extends org.eigenbase.xom.ElementDef {
		...
		public CubeUsage(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				cubeName = (String) _parser.getAttribute("cubeName", "String", null,
						null, true);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayAttribute(_out, "ignoreUnrelatedDimensions",
					ignoreUnrelatedDimensions, _indent + 1);
		}

		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"CubeUsage",
					new org.eigenbase.xom.XMLAttrVector().add("cubeName", cubeName).add(
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("cubeName", cubeName,
					_cother.cubeName, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("ignoreUnrelatedDimensions",
							ignoreUnrelatedDimensions, _cother.ignoreUnrelatedDimensions,
							_out, _indent + 1);
			return _diff;
		}
	}
	...
	public static class VirtualCubeMeasure extends org.eigenbase.xom.ElementDef {
		...
		public VirtualCubeMeasure(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				name = (String) _parser.getAttribute("name", "String", null, null,
						false);
				visible = (Boolean) _parser.getAttribute("visible", "Boolean", null,
						null, false);
				annotations = (Annotations) _parser
						.getElement(Annotations.class, false);
			} catch (org.eigenbase.xom.XOMException _ex) {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("VirtualCubeMeasure", new org.eigenbase.xom.XMLAttrVector()
					.add("cubeName", cubeName).add("name", name).add("visible", visible));
			displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
	...
	public static class DimensionUsage extends CubeDimension {
		...
		public DimensionUsage(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				source = (String) _parser.getAttribute("source", "String", null, null,
						true);
				level = (String) _parser.getAttribute("level", "String", null, null,
						false);
				usagePrefix = (String) _parser.getAttribute("usagePrefix", "String",
						null, null, false);
				name = (String) _parser
						.getAttribute("name", "String", null, null, true);
				caption = (String) _parser.getAttribute("caption", "String", null,
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"DimensionUsage",
					new org.eigenbase.xom.XMLAttrVector().add("source", source)
							.add("level", level).add("usagePrefix", usagePrefix)
							.add("name", name).add("caption", caption)
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("source", source, _cother.source,
					_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("level", level, _cother.level, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("usagePrefix", usagePrefix,
							_cother.usagePrefix, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("annotations", annotations,
							_cother.annotations, _out, _indent + 1);
			return _diff;
	...
	public static class Dimension extends CubeDimension {
		...
		public Dimension(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				org.eigenbase.xom.NodeDef[] _tempArray;
				type = (String) _parser.getAttribute("type", "String", null,
						_type_values, false);
				usagePrefix = (String) _parser.getAttribute("usagePrefix", "String",
						null, null, false);
				visible = (Boolean) _parser.getAttribute("visible", "Boolean", "true",
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Dimension",
					new org.eigenbase.xom.XMLAttrVector().add("type", type)
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayElementDiff("annotations", annotations,
							_cother.annotations, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("hierarchies", hierarchies,
							_cother.hierarchies, _out, _indent + 1);
			return _diff;
		}
	...
	public static class Hierarchy extends org.eigenbase.xom.ElementDef {
		...
		public Hierarchy(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				visible = (Boolean) _parser.getAttribute("visible", "Boolean", "true",
						null, false);
				hasAll = (Boolean) _parser.getAttribute("hasAll", "Boolean", null,
						null, true);
				allMemberName = (String) _parser.getAttribute("allMemberName",
						"String", null, null, false);
				allMemberCaption = (String) _parser.getAttribute("allMemberCaption",
						"String", null, null, false);
				allLevelName = (String) _parser.getAttribute("allLevelName", "String",
						null, null, false);
				primaryKey = (String) _parser.getAttribute("primaryKey", "String",
						null, null, false);
				primaryKeyTable = (String) _parser.getAttribute("primaryKeyTable",
						"String", null, null, false);
				defaultMember = (String) _parser.getAttribute("defaultMember",
						"String", null, null, false);
				...
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				uniqueKeyLevelName = (String) _parser.getAttribute(
						"uniqueKeyLevelName", "String", null, null, false);
				annotations = (Annotations) _parser
						.getElement(Annotations.class, false);
				relation = (RelationOrJoin) _parser.getElement(RelationOrJoin.class,
						false);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayAttribute(_out, "memberReaderClass", memberReaderClass,
					_indent + 1);
			displayAttribute(_out, "caption", caption, _indent + 1);
			displayAttribute(_out, "description", description, _indent + 1);
			displayAttribute(_out, "uniqueKeyLevelName", uniqueKeyLevelName,
					_indent + 1);
			displayElement(_out, "annotations",
					(org.eigenbase.xom.ElementDef) annotations, _indent + 1);
			...
			displayElementArray(_out, "memberReaderParameters",
					memberReaderParameters, _indent + 1);
		}
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Hierarchy",
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("visible", visible).add("hasAll", hasAll)
							.add("allMemberName", allMemberName)
							.add("allMemberCaption", allMemberCaption)
							.add("allLevelName", allLevelName).add("primaryKey", primaryKey)
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("visible", visible, _cother.visible, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("hasAll", hasAll, _cother.hasAll, _out,
							_indent + 1);
			_diff = _diff
			...
			_diff = _diff
					&& displayAttributeDiff("allLevelName", allLevelName,
							_cother.allLevelName, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("primaryKey", primaryKey, _cother.primaryKey,
							_out, _indent + 1);
			_diff = _diff
			...
			_diff = _diff
					&& displayElementArrayDiff("levels", levels, _cother.levels, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("memberReaderParameters",
							memberReaderParameters, _cother.memberReaderParameters, _out,
							_indent + 1);
			return _diff;
		}
	}
	...
	public static class Level extends org.eigenbase.xom.ElementDef {
		...
		public Level(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				org.eigenbase.xom.NodeDef[] _tempArray;
				approxRowCount = (String) _parser.getAttribute("approxRowCount",
						"String", null, null, false);
				name = (String) _parser.getAttribute("name", "String", null, null,
						false);
				visible = (Boolean) _parser.getAttribute("visible", "Boolean", "true",
						null, false);
				table = (String) _parser.getAttribute("table", "String", null, null,
						false);
				column = (String) _parser.getAttribute("column", "String", null, null,
						false);
				nameColumn = (String) _parser.getAttribute("nameColumn", "String",
						null, null, false);
				ordinalColumn = (String) _parser.getAttribute("ordinalColumn",
						"String", null, null, false);
				parentColumn = (String) _parser.getAttribute("parentColumn", "String",
						null, null, false);
				nullParentValue = (String) _parser.getAttribute("nullParentValue",
						"String", null, null, false);
				type = (String) _parser.getAttribute("type", "String", "String",
						_type_values, false);
				internalType = (String) _parser.getAttribute("internalType", "String",
						null, _internalType_values, false);
				uniqueMembers = (Boolean) _parser.getAttribute("uniqueMembers",
						"Boolean", "false", null, false);
				levelType = (String) _parser.getAttribute("levelType", "String",
						"Regular", _levelType_values, false);
				hideMemberIf = (String) _parser.getAttribute("hideMemberIf", "String",
						"Never", _hideMemberIf_values, false);
				formatter = (String) _parser.getAttribute("formatter", "String", null,
						null, false);
				caption = (String) _parser.getAttribute("caption", "String", null,
						null, false);
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				captionColumn = (String) _parser.getAttribute("captionColumn",
						"String", null, null, false);
				annotations = (Annotations) _parser
						.getElement(Annotations.class, false);
				keyExp = (KeyExpression) _parser.getElement(KeyExpression.class, false);
				nameExp = (NameExpression) _parser.getElement(NameExpression.class,
						false);
				captionExp = (CaptionExpression) _parser.getElement(
						CaptionExpression.class, false);
				ordinalExp = (OrdinalExpression) _parser.getElement(
						OrdinalExpression.class, false);
				parentExp = (ParentExpression) _parser.getElement(
						ParentExpression.class, false);
		...
		public static final String[] _internalType_values = { "int", "long",
				"Object", "String" };
		...
		public static final String[] _levelType_values = { "Regular", "TimeYears",
				"TimeHalfYears", "TimeHalfYear", "TimeQuarters", "TimeMonths",
				"TimeWeeks", "TimeDays", "TimeHours", "TimeMinutes", "TimeSeconds",
				"TimeUndefined" };
		public String levelType; // attribute default: Regular
		/** Allowable values for {@link #hideMemberIf}. */
		public static final String[] _hideMemberIf_values = { "Never",
				"IfBlankName", "IfParentsName" };
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "nameExp", (org.eigenbase.xom.ElementDef) nameExp,
					_indent + 1);
			displayElement(_out, "captionExp",
					(org.eigenbase.xom.ElementDef) captionExp, _indent + 1);
			displayElement(_out, "ordinalExp",
					(org.eigenbase.xom.ElementDef) ordinalExp, _indent + 1);
			displayElement(_out, "parentExp",
					(org.eigenbase.xom.ElementDef) parentExp, _indent + 1);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Level",
					new org.eigenbase.xom.XMLAttrVector()
							.add("approxRowCount", approxRowCount).add("name", name)
							.add("visible", visible).add("table", table)
							.add("column", column).add("nameColumn", nameColumn)
							...
							.add("uniqueMembers", uniqueMembers).add("levelType", levelType)
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("visible", visible, _cother.visible, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("table", table, _cother.table, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("column", column, _cother.column, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("nameColumn", nameColumn, _cother.nameColumn,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("ordinalColumn", ordinalColumn,
							_cother.ordinalColumn, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("parentColumn", parentColumn,
			...
			_diff = _diff
					&& displayAttributeDiff("internalType", internalType,
							_cother.internalType, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("uniqueMembers", uniqueMembers,
							_cother.uniqueMembers, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("levelType", levelType, _cother.levelType,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("hideMemberIf", hideMemberIf,
							_cother.hideMemberIf, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("formatter", formatter, _cother.formatter,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("caption", caption, _cother.caption, _out,
							_indent + 1);
			...
			_diff = _diff
					&& displayElementDiff("annotations", annotations,
							_cother.annotations, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("keyExp", keyExp, _cother.keyExp, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementDiff("nameExp", nameExp, _cother.nameExp, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementDiff("captionExp", captionExp, _cother.captionExp,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("ordinalExp", ordinalExp, _cother.ordinalExp,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("parentExp", parentExp, _cother.parentExp,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("memberFormatter", memberFormatter,
							_cother.memberFormatter, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("closure", closure, _cother.closure, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("properties", properties,
							_cother.properties, _out, _indent + 1);
			return _diff;
		}
	...
	public static class Closure extends org.eigenbase.xom.ElementDef {
		...
		public Closure(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				parentColumn = (String) _parser.getAttribute("parentColumn", "String",
						null, null, true);
				childColumn = (String) _parser.getAttribute("childColumn", "String",
						null, null, true);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Closure",
					new org.eigenbase.xom.XMLAttrVector().add("parentColumn",
							parentColumn).add("childColumn", childColumn));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("parentColumn", parentColumn,
					_cother.parentColumn, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("childColumn", childColumn,
							_cother.childColumn, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("table", table, _cother.table, _out,
							_indent + 1);
			return _diff;
		}
	}
	...
	public static class Property extends org.eigenbase.xom.ElementDef {
		...
		public Property(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				dependsOnLevelValue = (Boolean) _parser.getAttribute(
						"dependsOnLevelValue", "Boolean", null, null, false);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayAttribute(_out, "caption", caption, _indent + 1);
			displayAttribute(_out, "description", description, _indent + 1);
			displayAttribute(_out, "dependsOnLevelValue", dependsOnLevelValue,
					_indent + 1);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Property",
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("column", column).add("type", type)
							.add("formatter", formatter).add("caption", caption)
							.add("description", description)
	...
	public static class Measure extends org.eigenbase.xom.ElementDef {
		...
		public Measure(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				formatString = (String) _parser.getAttribute("formatString", "String",
						null, null, false);
				aggregator = (String) _parser.getAttribute("aggregator", "String",
						null, null, true);
				formatter = (String) _parser.getAttribute("formatter", "String", null,
						null, false);
				caption = (String) _parser.getAttribute("caption", "String", null,
				...
				annotations = (Annotations) _parser
						.getElement(Annotations.class, false);
				measureExp = (MeasureExpression) _parser.getElement(
						MeasureExpression.class, false);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "annotations",
					(org.eigenbase.xom.ElementDef) annotations, _indent + 1);
			displayElement(_out, "measureExp",
					(org.eigenbase.xom.ElementDef) measureExp, _indent + 1);
			displayElement(_out, "cellFormatter",
					(org.eigenbase.xom.ElementDef) cellFormatter, _indent + 1);
			displayElementArray(_out, "memberProperties", memberProperties,
					_indent + 1);
		}
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Measure",
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("column", column).add("datatype", datatype)
							.add("formatString", formatString).add("aggregator", aggregator)
							.add("formatter", formatter).add("caption", caption)
							.add("description", description).add("visible", visible));
			displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("datatype", datatype, _cother.datatype, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("formatString", formatString,
							_cother.formatString, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("aggregator", aggregator, _cother.aggregator,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("formatter", formatter, _cother.formatter,
							_out, _indent + 1);
			...
			_diff = _diff
					&& displayElementDiff("annotations", annotations,
							_cother.annotations, _out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("measureExp", measureExp, _cother.measureExp,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("cellFormatter", cellFormatter,
							_cother.cellFormatter, _out, _indent + 1);
			_diff = _diff
	...
	public static class CalculatedMember extends org.eigenbase.xom.ElementDef {
		...
		public CalculatedMember(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				formula = (String) _parser.getAttribute("formula", "String", null,
						null, false);
				dimension = (String) _parser.getAttribute("dimension", "String", null,
						null, false);
				hierarchy = (String) _parser.getAttribute("hierarchy", "String", null,
						null, false);
				parent = (String) _parser.getAttribute("parent", "String", null, null,
						false);
				visible = (Boolean) _parser.getAttribute("visible", "Boolean", null,
						null, false);
				annotations = (Annotations) _parser
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"CalculatedMember",
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("formatString", formatString).add("caption", caption)
							.add("description", description).add("formula", formula)
							.add("dimension", dimension).add("hierarchy", hierarchy)
							.add("parent", parent).add("visible", visible));
			displayXMLElement(_out, (org.eigenbase.xom.ElementDef) annotations);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("formula", formula, _cother.formula, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("dimension", dimension, _cother.dimension,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("hierarchy", hierarchy, _cother.hierarchy,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("parent", parent, _cother.parent, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("visible", visible, _cother.visible, _out,
							_indent + 1);
	 ...
	 */
	public static class CalculatedMemberProperty extends
			org.eigenbase.xom.ElementDef {
		...
		public CalculatedMemberProperty(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				description = (String) _parser.getAttribute("description", "String",
						null, null, false);
				expression = (String) _parser.getAttribute("expression", "String",
						null, null, false);
				value = (String) _parser.getAttribute("value", "String", null, null,
						false);
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
						+ _ex.getMessage());
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					...
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("caption", caption).add("description", description)
							.add("expression", expression).add("value", value));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("description", description,
							_cother.description, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("expression", expression, _cother.expression,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("value", value, _cother.value, _out,
							_indent + 1);
			return _diff;
		}
	}
	 ...
	 * Not used
	 */
	public static class MemberReaderParameter extends
			org.eigenbase.xom.ElementDef {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					...
					new org.eigenbase.xom.XMLAttrVector().add("name", name).add("value",
							value));
	 ...
	 * A table or a join
	 */
	public static abstract class RelationOrJoin extends
			org.eigenbase.xom.ElementDef {
	...
	public static class View extends Relation {
		...
		public View(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				org.eigenbase.xom.NodeDef[] _tempArray;
				alias = (String) _parser.getAttribute("alias", "String", null, null,
						true);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("View",
					new org.eigenbase.xom.XMLAttrVector().add("alias", alias));
	...
	public static class SQL extends org.eigenbase.xom.ElementDef {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("SQL",
					new org.eigenbase.xom.XMLAttrVector().add("dialect", dialect));
			_out.cdata(cdata);
			_out.endTag("SQL");
		}
	...
	public static class Join extends RelationOrJoin {
		...
		public Join(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				leftAlias = (String) _parser.getAttribute("leftAlias", "String", null,
						null, false);
				leftKey = (String) _parser.getAttribute("leftKey", "String", null,
						null, true);
				rightAlias = (String) _parser.getAttribute("rightAlias", "String",
						null, null, false);
				rightKey = (String) _parser.getAttribute("rightKey", "String", null,
						null, true);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "left", (org.eigenbase.xom.ElementDef) left,
					_indent + 1);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Join",
					new org.eigenbase.xom.XMLAttrVector().add("leftAlias", leftAlias)
							.add("leftKey", leftKey).add("rightAlias", rightAlias)
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("leftKey", leftKey, _cother.leftKey, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("rightAlias", rightAlias, _cother.rightAlias,
							_out, _indent + 1);
			_diff = _diff
			...
			_diff = _diff
					&& displayElementDiff("right", right, _cother.right, _out,
							_indent + 1);
			return _diff;
		}
	...
	public static class Table extends Relation {
		...
		public Table(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				name = (String) _parser
						.getAttribute("name", "String", null, null, true);
				schema = (String) _parser.getAttribute("schema", "String", null, null,
						false);
				alias = (String) _parser.getAttribute("alias", "String", null, null,
						false);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("name", name, _cother.name, _out,
					_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("schema", schema, _cother.schema, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("alias", alias, _cother.alias, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementDiff("filter", filter, _cother.filter, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("aggExcludes", aggExcludes,
							_cother.aggExcludes, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("aggTables", aggTables, _cother.aggTables,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("tableHints", tableHints,
							_cother.tableHints, _out, _indent + 1);
			return _diff;
		}
		...
		public Hint(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				type = (String) _parser
						.getAttribute("type", "String", null, null, true);
				cdata = _parser.getText();
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
						+ _ex.getMessage());
	...
	public static class InlineTable extends Relation {
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			_out.println(getName());
			displayAttribute(_out, "alias", alias, _indent + 1);
			displayElement(_out, "columnDefs",
					(org.eigenbase.xom.ElementDef) columnDefs, _indent + 1);
			displayElement(_out, "rows", (org.eigenbase.xom.ElementDef) rows,
					_indent + 1);
		}

		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("InlineTable",
					new org.eigenbase.xom.XMLAttrVector().add("alias", alias));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("alias", alias, _cother.alias, _out,
					_indent + 1);
			_diff = _diff
					&& displayElementDiff("columnDefs", columnDefs, _cother.columnDefs,
							_out, _indent + 1);
			_diff = _diff
	...
	public static class ColumnDefs extends org.eigenbase.xom.ElementDef {
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayElementArrayDiff("array", array, _cother.array,
					_out, _indent + 1);
			return _diff;
		}
	}
	...
	public static class ColumnDef extends org.eigenbase.xom.ElementDef {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"ColumnDef",
					new org.eigenbase.xom.XMLAttrVector().add("name", name).add("type",
							type));
	...
	public static class Value extends org.eigenbase.xom.ElementDef {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("Value",
					new org.eigenbase.xom.XMLAttrVector().add("column", column));
			_out.cdata(cdata);
			_out.endTag("Value");
		}
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("column", column, _cother.column,
					_out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("cdata", cdata, _cother.cdata, _out, _indent + 1);
			return _diff;
	...
	public static abstract class AggTable extends org.eigenbase.xom.ElementDef {
		...
		public AggTable(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				org.eigenbase.xom.NodeDef[] _tempArray;
				ignorecase = (Boolean) _parser.getAttribute("ignorecase", "Boolean",
						"true", null, false);
		...
		public void display(java.io.PrintWriter _out, int _indent) {
			...
			displayElement(_out, "factcount",
					(org.eigenbase.xom.ElementDef) factcount, _indent + 1);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayElementDiff("factcount", factcount, _cother.factcount,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("ignoreColumns", ignoreColumns,
							_cother.ignoreColumns, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("foreignKeys", foreignKeys,
							_cother.foreignKeys, _out, _indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("measures", measures, _cother.measures,
							_out, _indent + 1);
			_diff = _diff
	...
	public static class AggPattern extends AggTable {
		...
		public AggPattern(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				org.eigenbase.xom.NodeDef[] _tempArray;
				pattern = (String) _parser.getAttribute("pattern", "String", null,
						null, true);
				ignorecase = (Boolean) _parser.getAttribute("ignorecase", "Boolean",
						"true", null, false);
				factcount = (AggFactCount) _parser.getElement(AggFactCount.class, true);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"AggPattern",
					new org.eigenbase.xom.XMLAttrVector().add("pattern", pattern).add(
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayElementArrayDiff("levels", levels, _cother.levels, _out,
							_indent + 1);
			_diff = _diff
					&& displayElementArrayDiff("excludes", excludes, _cother.excludes,
							_out, _indent + 1);
			return _diff;
		}
	...
	public static class AggExclude extends org.eigenbase.xom.ElementDef {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"AggExclude",
					new org.eigenbase.xom.XMLAttrVector().add("pattern", pattern)
							.add("name", name).add("ignorecase", ignorecase));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("name", name, _cother.name, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("ignorecase", ignorecase, _cother.ignorecase,
							_out, _indent + 1);
			return _diff;
		}
	...
	public static abstract class AggColumnName extends
			org.eigenbase.xom.ElementDef {
	...
	public static class AggForeignKey extends org.eigenbase.xom.ElementDef {
		...
		public AggForeignKey(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				factColumn = (String) _parser.getAttribute("factColumn", "String",
						null, null, true);
				aggColumn = (String) _parser.getAttribute("aggColumn", "String", null,
						null, true);
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
						+ _ex.getMessage());
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("aggColumn", aggColumn, _cother.aggColumn,
							_out, _indent + 1);
			return _diff;
		}
	...
	public static class AggLevel extends org.eigenbase.xom.ElementDef {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"AggLevel",
					new org.eigenbase.xom.XMLAttrVector().add("column", column).add(
							"name", name));
	...
	public static class Column extends org.eigenbase.xom.ElementDef implements
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Column",
					new org.eigenbase.xom.XMLAttrVector().add("table", table).add("name",
							name));
			_out.endTag("Column");
		}
	 ...
	 */
	public static abstract class ExpressionView extends
			org.eigenbase.xom.ElementDef implements Expression {
	...
	public static class Role extends org.eigenbase.xom.ElementDef {
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayElementDiff("union", union, _cother.union, _out,
							_indent + 1);
			return _diff;
		}
	}
	 ...
	 */
	public static class SchemaGrant extends org.eigenbase.xom.ElementDef
			implements Grant {
		public SchemaGrant() {
		}
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("SchemaGrant",
					new org.eigenbase.xom.XMLAttrVector().add("access", access));
	...
	public static class CubeGrant extends org.eigenbase.xom.ElementDef implements
		...
		public CubeGrant(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				org.eigenbase.xom.NodeDef[] _tempArray;
				cube = (String) _parser
						.getAttribute("cube", "String", null, null, true);
				access = (String) _parser.getAttribute("access", "String", null,
						_access_values, true);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"CubeGrant",
					new org.eigenbase.xom.XMLAttrVector().add("cube", cube).add("access",
							access));
	 ...
	 */
	public static class DimensionGrant extends org.eigenbase.xom.ElementDef
			implements Grant {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("DimensionGrant", new org.eigenbase.xom.XMLAttrVector()
					.add("dimension", dimension).add("access", access));
	 ...
	 * mondrian.olap.Level).
	 */
	public static class HierarchyGrant extends org.eigenbase.xom.ElementDef
			implements Grant {
		...
		public HierarchyGrant(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				hierarchy = (String) _parser.getAttribute("hierarchy", "String", null,
						null, true);
				topLevel = (String) _parser.getAttribute("topLevel", "String", null,
						null, false);
				bottomLevel = (String) _parser.getAttribute("bottomLevel", "String",
						null, null, false);
				rollupPolicy = (String) _parser.getAttribute("rollupPolicy", "String",
						null, null, false);
				access = (String) _parser.getAttribute("access", "String", null,
						_access_values, true);
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("topLevel", topLevel, _cother.topLevel, _out,
							_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("bottomLevel", bottomLevel,
							_cother.bottomLevel, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("rollupPolicy", rollupPolicy,
							_cother.rollupPolicy, _out, _indent + 1);
			_diff = _diff
	...
	public static class MemberGrant extends org.eigenbase.xom.ElementDef {
		...
		public MemberGrant(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				member = (String) _parser.getAttribute("member", "String", null, null,
						true);
				access = (String) _parser.getAttribute("access", "String", null,
						_access_values, true);
			} catch (org.eigenbase.xom.XOMException _ex) {
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"MemberGrant",
					new org.eigenbase.xom.XMLAttrVector().add("member", member).add(
							"access", access));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("member", member, _cother.member,
					_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("access", access, _cother.access, _out,
							_indent + 1);
			return _diff;
		}
	}
	...
	public static class RoleUsage extends org.eigenbase.xom.ElementDef {
		...
		public RoleUsage(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				roleName = (String) _parser.getAttribute("roleName", "String", null,
						null, true);
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
						+ _ex.getMessage());
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("RoleUsage",
					new org.eigenbase.xom.XMLAttrVector().add("roleName", roleName));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("roleName", roleName,
					_cother.roleName, _out, _indent + 1);
			return _diff;
		}
	}
	...
	public static class UserDefinedFunction extends org.eigenbase.xom.ElementDef {
		...
		public UserDefinedFunction(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				name = (String) _parser
						.getAttribute("name", "String", null, null, true);
				className = (String) _parser.getAttribute("className", "String", null,
						null, false);
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"UserDefinedFunction",
					new org.eigenbase.xom.XMLAttrVector().add("name", name).add(
							"className", className));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("name", name, _cother.name, _out,
					_indent + 1);
			_diff = _diff
					&& displayAttributeDiff("className", className, _cother.className,
							_out, _indent + 1);
			_diff = _diff
					&& displayElementDiff("script", script, _cother.script, _out,
							_indent + 1);
			return _diff;
		}
	}
	...
	public static class Parameter extends org.eigenbase.xom.ElementDef {
		...
		public Parameter(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				...
				type = (String) _parser.getAttribute("type", "String", "String",
						_type_values, true);
				modifiable = (Boolean) _parser.getAttribute("modifiable", "Boolean",
						"true", null, false);
				defaultValue = (String) _parser.getAttribute("defaultValue", "String",
						null, null, false);
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
						+ _ex.getMessage());
		...
		/** Allowable values for {@link #type}. */
		public static final String[] _type_values = { "String", "Numeric",
				"Integer", "Boolean", "Date", "Time", "Timestamp", "Member" };
		public String type; // attribute default: String
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag(
					"Parameter",
					new org.eigenbase.xom.XMLAttrVector().add("name", name)
							.add("description", description).add("type", type)
							.add("modifiable", modifiable).add("defaultValue", defaultValue));
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			_diff = _diff
					&& displayAttributeDiff("type", type, _cother.type, _out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("modifiable", modifiable, _cother.modifiable,
							_out, _indent + 1);
			_diff = _diff
					&& displayAttributeDiff("defaultValue", defaultValue,
							_cother.defaultValue, _out, _indent + 1);
			return _diff;
		}
	}
	...
	public static class Script extends org.eigenbase.xom.ElementDef {
		...
		public Script(org.eigenbase.xom.DOMWrapper _def)
			...
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(
						_def, "", MondrianDef.class);
				language = (String) _parser.getAttribute("language", "String",
						"JavaScript", null, false);
				cdata = _parser.getText();
			} catch (org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": "
						+ _ex.getMessage());
		...
		public void displayXML(org.eigenbase.xom.XMLOutput _out, int _indent) {
			_out.beginTag("Script",
					new org.eigenbase.xom.XMLAttrVector().add("language", language));
			_out.cdata(cdata);
			_out.endTag("Script");
		}
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other,
			...
			boolean _diff = displayAttributeDiff("language", language,
					_cother.language, _out, _indent + 1);
			_diff = _diff
					&& displayStringDiff("cdata", cdata, _cother.cdata, _out, _indent + 1);
			return _diff;
		}
