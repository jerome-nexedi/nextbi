/*
// $Id: //open/mondrian/src/main/mondrian/olap/Id.java#38 $
 ...
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Id.java#38 $
 */
public class Id extends ExpBase implements Cloneable {
	...
	public Exp accept(Validator validator) {
		...
		final Exp element = Util.lookup(validator.getQuery(), validator
				.getSchemaReader().withLocus(), segments, true);
	 ...
	 * 
	 * <p>
	 * For example, the identifier <code>[Store].USA.[New Mexico].&[45]</code> has
	 * four segments:
	 * <ul>
	...
	public static class Segment {
		...
		public static List<Segment> toList(String... nameParts) {
			final List<Segment> segments = new ArrayList<Segment>(nameParts.length);
		...
		/**
		 * Returns whether this segment matches a given name according to the rules
		 * of case-sensitivity and quoting.
		 * 
		 * @param name
		 *          Name to match
