/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/extra/NthQuartileFunDef.java#10 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/extra/NthQuartileFunDef
 *          .java#10 $
 * @since Mar 23, 2006
 */
public class NthQuartileFunDef extends AbstractAggregateFunDef {
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    ...
    final DoubleCalc doubleCalc = call.getArgCount() > 1 ? compiler
      .compileDouble(call.getArg(1)) : new ValueCalc(call);
    return new AbstractDoubleCalc(call, new Calc[] { listCalc, doubleCalc }) {
      public double evaluateDouble(Evaluator evaluator) {
        ...
        final double quartile = quartile(evaluator, members, doubleCalc, range);
