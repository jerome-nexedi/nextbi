/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/DimensionsNumericFunDef.java#1 $
...
/**
 * Definition of the <code>Dimensions(&lt;Numeric Expression&gt;)</code> MDX
 * builtin function.
 * 
 * <p>
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/DimensionsNumericFunDef
 *          .java#1 $
 * @since Jul 20, 2009
 */
  ...
  private DimensionsNumericFunDef() {
    super("Dimensions",
      "Returns the hierarchy whose zero-based position within the cube "
        + "is specified by a numeric expression.", "fhn");
  }
