...
class FilterFunDef extends FunDefBase {
	...
	public Calc compileCall(final ResolvedFunCall call, ExpCompiler compiler) {
		...
		if (styles.contains(ResultStyle.ITERABLE)
			...
			throw ResultStyleException.generate(
					ResultStyle.ITERABLE_LIST_MUTABLELIST_ANY, styles);
		}
	}
	 ...
	 */
	protected ListCalc compileCallList(final ResolvedFunCall call,
			ExpCompiler compiler) {
		...
		throw ResultStyleException.generateBadType(ResultStyle.MUTABLELIST_LIST,
