/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/PeriodsToDateFunDef.java#11 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/PeriodsToDateFunDef.java
 *          #11 $
 * @since Mar 23, 2006
 */
class PeriodsToDateFunDef extends FunDefBase {
	...
	public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
		final LevelCalc levelCalc = call.getArgCount() > 0 ? compiler
				.compileLevel(call.getArg(0)) : null;
		final MemberCalc memberCalc = call.getArgCount() > 1 ? compiler
				.compileMember(call.getArg(1)) : null;
		final RolapHierarchy timeHierarchy = levelCalc == null ? ((RolapCube) compiler
				.getEvaluator().getCube()).getTimeHierarchy(getName()) : null;
