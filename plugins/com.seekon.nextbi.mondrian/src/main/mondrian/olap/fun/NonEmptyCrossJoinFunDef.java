/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/NonEmptyCrossJoinFunDef.java#24 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/NonEmptyCrossJoinFunDef
 *          .java#24 $
 * @since Mar 23, 2006
 */
public class NonEmptyCrossJoinFunDef extends CrossJoinFunDef {
	static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
			...
			new String[] { "fxxx" }, NonEmptyCrossJoinFunDef.class);
		...
		return new AbstractListCalc(call, new Calc[] { listCalc1, listCalc2 },
			...
			public TupleList evaluateList(Evaluator evaluator) {
				...
				for (Member member : ((RolapEvaluator) evaluator).getSlicerMembers()) {
					if (getType().getElementType().usesHierarchy(member.getHierarchy(),
							true)) {
