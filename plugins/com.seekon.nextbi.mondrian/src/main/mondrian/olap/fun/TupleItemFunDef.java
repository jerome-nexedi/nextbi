/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/TupleItemFunDef.java#6 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/TupleItemFunDef.java#6 $
 * @since Mar 23, 2006
 */
	...
	public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
		...
		if (type instanceof MemberType) {
			...
			return new AbstractMemberCalc(call, new Calc[] { tupleCalc, indexCalc }) {
				final Member[] nullTupleMembers = makeNullTuple((TupleType) tupleCalc
						.getType());
