/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/StdevPFunDef.java#11 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/StdevPFunDef.java#11
 *          $
 * @since Mar 23, 2006
 */
class StdevPFunDef extends AbstractAggregateFunDef {
  ...
  static final Resolver StdevpResolver = new ReflectiveMultiResolver(
    ...
    new String[] { "fnx", "fnxn" }, StdevPFunDef.class);

  static final Resolver StddevpResolver = new ReflectiveMultiResolver("StddevP",
    "StddevP(<Set>[, <Numeric Expression>])", "Alias for StdevP.", new String[] {
      "fnx", "fnxn" }, StdevPFunDef.class);
