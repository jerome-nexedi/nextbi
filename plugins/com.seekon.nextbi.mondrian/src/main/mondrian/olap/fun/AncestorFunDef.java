/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/AncestorFunDef.java#4 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/AncestorFunDef.java#4 $
 * @since Mar 23, 2006
 */
class AncestorFunDef extends FunDefBase {
	static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
			"Ancestor", "Ancestor(<Member>, {<Level>|<Numeric Expression>})",
			"Returns the ancestor of a member at a specified level.", new String[] {
					"fmml", "fmmn" }, AncestorFunDef.class);
	...
	public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
		...
		if (type1 instanceof LevelType) {
			...
			return new AbstractMemberCalc(call,
					new Calc[] { memberCalc, distanceCalc }) {
				public Member evaluateMember(Evaluator evaluator) {
