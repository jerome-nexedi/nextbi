/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/MedianFunDef.java#13 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/MedianFunDef.java#13
 *          $
 * @since Mar 23, 2006
 */
class MedianFunDef extends AbstractAggregateFunDef {
  static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
    ...
    new String[] { "fnx", "fnxn" }, MedianFunDef.class);
