/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/FunInfo.java#19 $
 ...
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/FunInfo.java#19 $
 */
public class FunInfo implements Comparable<FunInfo> {
	...
	FunInfo(FunDef funDef) {
		...
		this.sigs = funDef instanceof FunDefBase
				&& ((FunDefBase) funDef).signature != null ? new String[] { ((FunDefBase) funDef).signature }
	...
	FunInfo(String name, String description, String flags) {
		...
		this.parameterTypes = new int[][] { FunUtil
	...
	private static String[] makeSigs(Syntax syntax, String name,
			int[] returnTypes, int[][] parameterTypes) {
	...
	/**
	 * Returns the type of value returned by this function. Values are the same as
	 * those returned by {@link mondrian.olap.Exp#getCategory()}.
	 */
	...
	/**
	 * Returns the types of the arguments of this function. Values are the same as
	 * those returned by {@link mondrian.olap.Exp#getCategory()}. The
	 * 0<sup>th</sup> argument of methods and properties are the object they are
	 * applied to. Infix operators have two arguments, and prefix operators have
	 * one argument.
	 */
