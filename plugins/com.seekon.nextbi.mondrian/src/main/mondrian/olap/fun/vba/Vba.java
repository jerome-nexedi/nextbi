...
public class Vba {
	...
	public static int fix(Object number) {
		if (number instanceof Number) {
			...
			throw new InvalidArgumentException("Invalid parameter. "
					+ "number parameter " + number + " of Int function must be "
					+ "of type number");
		}
	}
	...
	public static String hex(Object number) {
		if (number instanceof Number) {
			...
			throw new InvalidArgumentException("Invalid parameter. "
					+ "number parameter " + number + " of Hex function must be "
					+ "of type number");
		}
	}
	...
	public static String oct(Object number) {
		if (number instanceof Number) {
			...
			throw new InvalidArgumentException("Invalid parameter. "
					+ "number parameter " + number + " of Oct function must be "
					+ "of type number");
		}
	}
	...
	public static String str(Object number) {
		...
		if (number instanceof Number) {
			...
			throw new InvalidArgumentException("Invalid parameter. "
					+ "number parameter " + number + " of Str function must be "
					+ "of type number");
		}
	}
	...
	private static String _replace(String expression, String find,
			String replace, int start /* default 1 */, int count /* default -1 */) {
	...
	private enum Interval {
		yyyy("Year", Calendar.YEAR), q("Quarter", -1), m("Month", Calendar.MONTH), y(
				...
				"Weekday", Calendar.DAY_OF_WEEK), ww("Week", Calendar.WEEK_OF_YEAR), h(
