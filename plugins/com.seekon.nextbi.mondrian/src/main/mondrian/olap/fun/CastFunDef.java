/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/CastFunDef.java#11 $
 ...
 * 
 * <p>
 * <code>CAST</code> is a mondrian-specific extension to MDX, because the MDX
 * standard does not define how values are to be converted from one type to
 * another. Microsoft Analysis Services, for Resolver, uses the Visual Basic
 * functions <code>CStr</code>, <code>CInt</code>, etc. The syntax for this
 * operator was inspired by the <code>CAST</code> operator in the SQL standard.
 * 
 * <p>
 * Examples:
 * <ul>
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/CastFunDef.java#11 $
 * @since Sep 3, 2006
 */
