/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/DrilldownMemberFunDef.java#16 $
 ...
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/DrilldownMemberFunDef
 *          .java#16 $
 */
class DrilldownMemberFunDef extends FunDefBase {
  ...
  static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
    ...
    new String[] { "fxxx", "fxxxy" }, DrilldownMemberFunDef.class, reservedWords);
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    ...
    return new AbstractListCalc(call, new Calc[] { listCalc1, listCalc2 }) {
       ...
       * 
       * <p>
       * Algorithm: If object is present in {@code memberSet} adds to result
       * children of the object. If flag {@code recursive} is set then this
       * method is called recursively for the children.
       * 
       * @param evaluator
       *          Evaluator
       * @param tuple
       *          Tuple (may have arity 1)
       * @param memberSet
       *          Set of members
       * @param resultList
       *          Result
       */
      protected void drillDownObj(Evaluator evaluator, Member[] tuple,
        Set<Member> memberSet, TupleList resultList) {
      ...
      private TupleList drilldownMember(TupleList v0, TupleList v1,
        Evaluator evaluator) {
