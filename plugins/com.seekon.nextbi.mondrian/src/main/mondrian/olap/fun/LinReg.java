...
public abstract class LinReg extends FunDefBase {
  ...
  public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
    ...
    final DoubleCalc xCalc = call.getArgCount() > 2 ? compiler.compileDouble(call
      .getArg(2)) : new ValueCalc(call);
  ...
  static class Value {
    ...
    public String toString() {
      return "LinReg.Value: slope of " + slope + " and an intercept of " + intercept
        + ". That is, y=" + intercept + (slope > 0.0 ? " +" : " ") + slope + " * x.";
    }
  }
  ...
  public static class PointFunDef extends LinReg {
    ...
    public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler) {
      ...
      final DoubleCalc xCalc = call.getArgCount() > 3 ? compiler.compileDouble(call
        .getArg(3)) : new ValueCalc(call);
  ...
  private static class PointCalc extends AbstractDoubleCalc {
    ...
    public PointCalc(ResolvedFunCall call, DoubleCalc xPointCalc, ListCalc listCalc,
  ...
  protected static LinReg.Value process(Evaluator evaluator, ListCalc listCalc,
    ...
    SetWrapper[] sws = evaluateSet(evaluator, members, new DoubleCalc[] { yCalc,
      xCalc });
    evaluator.restore(savepoint);
  ...
  private static class LinRegCalc extends AbstractDoubleCalc {
    ...
    public LinRegCalc(ResolvedFunCall call, ListCalc listCalc, DoubleCalc yCalc,
      DoubleCalc xCalc, int regType) {
