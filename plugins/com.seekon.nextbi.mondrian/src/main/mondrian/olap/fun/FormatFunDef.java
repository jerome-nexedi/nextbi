/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/FormatFunDef.java#6 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/FormatFunDef.java#6
 *          $
 * @since Mar 23, 2006
 */
class FormatFunDef extends FunDefBase {
	static final ReflectiveMultiResolver Resolver = new ReflectiveMultiResolver(
			"Format", "Format(<Expression>, <String Expression>)",
			"Formats a number or date to a string.", new String[] { "fSmS", "fSnS",
					"fSDS" }, FormatFunDef.class);
