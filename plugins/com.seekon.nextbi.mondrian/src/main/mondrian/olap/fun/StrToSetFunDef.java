/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/StrToSetFunDef.java#15 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/StrToSetFunDef.java#15 $
 * @since Mar 23, 2006
 */
class StrToSetFunDef extends FunDefBase {
  ...
  private StrToSetFunDef(int[] parameterTypes) {
    super("StrToSet", "<Set> StrToSet(<String>[, <Hierarchy>...])",
      "Constructs a set from a string expression.", Syntax.Function, Category.Set,
      parameterTypes);
  }
    ...
    if (elementType instanceof MemberType) {
      ...
      return new AbstractListCalc(call, new Calc[] { stringCalc }) {
        public TupleList evaluateList(Evaluator evaluator) {
          ...
          return new UnaryTupleList(parseMemberList(evaluator, string, hierarchy));
        }
      };
    } else {
  ...
  public Type getResultType(Validator validator, Exp[] args) {
    ...
    case 2: {
      ...
      return new SetType(new MemberType(argType.getDimension(), argType
        .getHierarchy(), argType.getLevel(), null));
    }
  ...
  private static class ResolverImpl extends ResolverBase {
    ResolverImpl() {
      super("StrToSet", "StrToSet(<String Expression>)",
        "Constructs a set from a string expression.", Syntax.Function);
    }
