/*
// $Id: //open/mondrian/src/main/mondrian/olap/ResultBase.java#18 $
 ...
 * @version $Id: //open/mondrian/src/main/mondrian/olap/ResultBase.java#18 $
 */
public abstract class ResultBase implements Result {
  ...
  protected ResultBase(Execution execution, Axis[] axes) {
    ...
    assert query != null;
    this.axes = axes == null ? new Axis[query.getAxes().length] : axes;
  }
