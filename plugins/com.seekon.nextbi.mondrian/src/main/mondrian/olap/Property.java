...
public class Property extends EnumeratedValues.BasicValue {
	 ...
	 */
	public static final Property AGGREGATION_TYPE = new Property(
			"$aggregation_type", Datatype.TYPE_OTHER, AGGREGATION_TYPE_ORDINAL, true,
			false, false, null);
	...
	public static final Property NAME = new Property("$name",
			Datatype.TYPE_STRING, NAME_ORDINAL, true, false, false, null);
	 ...
	 * level.
	 */
	public static final Property LEVEL_UNIQUE_NAME = new Property(
			"LEVEL_UNIQUE_NAME", Datatype.TYPE_STRING, LEVEL_UNIQUE_NAME_ORDINAL,
			false, true, false,
	...
	public static final Property MEMBER_UNIQUE_NAME = new Property(
			"MEMBER_UNIQUE_NAME", Datatype.TYPE_STRING, MEMBER_UNIQUE_NAME_ORDINAL,
			false, true, false,
	...
	public static final Property PARENT_UNIQUE_NAME = new Property(
			"PARENT_UNIQUE_NAME", Datatype.TYPE_STRING, PARENT_UNIQUE_NAME_ORDINAL,
			false, true, false,
	...
	public static final Property CELL_FORMATTER_SCRIPT = new Property(
			...
			CELL_FORMATTER_SCRIPT_ORDINAL, false, true, false,
			"Name of the class which formats cell values of this member.");
	 ...
	 */
	public static final Property FORMATTED_VALUE = new Property(
			"FORMATTED_VALUE", Datatype.TYPE_STRING, FORMATTED_VALUE_ORDINAL, false,
			false, true,
	...
	public static final Property NON_EMPTY_BEHAVIOR = new Property(
			"NON_EMPTY_BEHAVIOR", Datatype.TYPE_STRING, NON_EMPTY_BEHAVIOR_ORDINAL,
			false, false, true,
	...
	public static final Property VALUE = new Property("VALUE",
			Datatype.TYPE_NUMERIC, VALUE_ORDINAL, false, true, true,
	 ...
	 */
	public static final Property DEPTH = new Property("DEPTH",
			Datatype.TYPE_NUMERIC, DEPTH_ORDINAL, true, true, false,
	...
	public static final Property MEMBER_KEY = new Property("MEMBER_KEY",
			Datatype.TYPE_STRING, MEMBER_KEY_ORDINAL, false, true, false,
			"Member key.");
	 ...
	 */
	static final Set<String> FORMAT_PROPERTIES = new HashSet<String>(
			Arrays.asList("format", "format_string", "FORMAT", FORMAT_STRING.name));
	...
	public static final EnumeratedValues<Property> enumeration = new EnumeratedValues<Property>(
			new Property[] { FORMAT_EXP, AGGREGATION_TYPE, NAME, CAPTION,
					...
					LEVEL_NUMBER, MEMBER_UNIQUE_NAME, MEMBER_NAME, MEMBER_TYPE,
					MEMBER_GUID, MEMBER_CAPTION, MEMBER_ORDINAL, CHILDREN_CARDINALITY,
					PARENT_LEVEL, PARENT_UNIQUE_NAME, PARENT_COUNT, DESCRIPTION, VISIBLE,
					CELL_FORMATTER, CELL_FORMATTER_SCRIPT,
					CELL_FORMATTER_SCRIPT_LANGUAGE, BACK_COLOR, CELL_EVALUATION_LIST,
					CELL_ORDINAL, FORE_COLOR, FONT_NAME, FONT_SIZE, FONT_FLAGS,
					FORMAT_STRING, FORMATTED_VALUE, NON_EMPTY_BEHAVIOR, SOLVE_ORDER,
					VALUE, DATATYPE, MEMBER_KEY, KEY, SCENARIO, DISPLAY_FOLDER, });
	...
	static {
		...
		for (String propertyName : enumeration.getNames()) {
			mapUpperNameToProperties.put(propertyName.toUpperCase(),
					enumeration.getValue(propertyName, true));
		}

		// Add synonyms.
		for (Map.Entry<String, Property> entry : synonyms.entrySet()) {
			mapUpperNameToProperties.put(entry.getKey().toUpperCase(),
					entry.getValue());
		}
	}
