/*
// $Id: //open/mondrian/src/main/mondrian/olap/type/SetType.java#16 $
 ...
 * @author jhyde
 * @since Feb 17, 2005
 * @version $Id: //open/mondrian/src/main/mondrian/olap/type/SetType.java#16 $
 */
public class SetType implements Type {
	...
	public Type computeCommonType(Type type, int[] conversionCount) {
		...
		final Type mostGeneralElementType = this.getElementType()
				.computeCommonType(that.getElementType(), conversionCount);
