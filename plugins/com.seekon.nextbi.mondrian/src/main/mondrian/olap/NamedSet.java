/*
// $Id: //open/mondrian/src/main/mondrian/olap/NamedSet.java#8 $
 ...
 * 
 * <p>
 * A set can be defined in a query, using a <code>WITH SET</code> clause, or in
 ...
 * @author jhyde
 * @since 6 August, 2001
 * @version $Id: //open/mondrian/src/main/mondrian/olap/NamedSet.java#8 $
 */
public interface NamedSet extends OlapElement, Annotated {
   ...
   * <li>A static set is evaluated only on first use, in the base context of the
   * cube.
   * </ul>
   * 
