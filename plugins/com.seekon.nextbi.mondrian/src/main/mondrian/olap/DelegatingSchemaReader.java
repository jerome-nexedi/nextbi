/*
// $Id: //open/mondrian/src/main/mondrian/olap/DelegatingSchemaReader.java#44 $
 ...
 * @since Feb 26, 2003
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/DelegatingSchemaReader.java
 *          #44 $
 */
public abstract class DelegatingSchemaReader implements SchemaReader {
  ...
  public void getParentChildContributingChildren(Member dataMember,
    ...
    schemaReader.getParentChildContributingChildren(dataMember, hierarchy, list);
  }
  ...
  public OlapElement lookupCompoundInternal(OlapElement parent,
    List<Id.Segment> names, boolean failIfNotFound, int category, MatchType matchType) {
    return schemaReader.lookupCompound(parent, names, failIfNotFound, category,
      matchType);
  }
  ...
  public int getLevelCardinality(Level level, boolean approximate,
    boolean materialize) {
    return schemaReader.getLevelCardinality(level, approximate, materialize);
  }
  ...
  public Member lookupMemberChildByName(Member member, Id.Segment memberName,
    MatchType matchType) {
    return schemaReader.lookupMemberChildByName(member, memberName, matchType);
  }
  ...
  public SchemaReader withLocus() {
    return RolapUtil.locusSchemaReader(schemaReader.getSchema()
      .getInternalConnection(), this);
  }
}
