/*
// $Id: //open/mondrian/src/main/mondrian/olap/Category.java#14 $
 ...
 * @author jhyde
 * @since Feb 21, 2003
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Category.java#14 $
 */
public class Category extends EnumeratedValues {
  ...
  private Category() {
    super(new String[] { "unknown", "array", "dimension", "hierarchy", "level",
      "logical", "member", "numeric", "set", "string", "tuple", "symbol", "cube",
      "value", "integer", "null", "empty", "datetime", }, new int[] { Unknown,
      Array, Dimension, Hierarchy, Level, Logical, Member, Numeric, Set, String,
      Tuple, Symbol, Cube, Value, Integer, Null, Empty, DateTime, }, new String[] {
      "Unknown", "Array", "Dimension", "Hierarchy", "Level", "Logical Expression",
      "Member", "Numeric Expression", "Set", "String", "Tuple", "Symbol", "Cube",
      "Value", "Integer", "Null", "Empty", "DateTime", });
  }
  ...
  /**
   * <code>Symbol</code> is a symbol, for example the <code>BASC</code> keyword
   * to the <code>Order()</code> function.
   */
  ...
  /**
   * <code>Expression</code> is a flag which, when bitwise-OR-ed with a category
   * value, indicates an expression (as opposed to a constant).
   */
  public static final int Expression = 0;

  /**
   * <code>Constant</code> is a flag which, when bitwise-OR-ed with a category
   * value, indicates a constant (as opposed to an expression).
   */
