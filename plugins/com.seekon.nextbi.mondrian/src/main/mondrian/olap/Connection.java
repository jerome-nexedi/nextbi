/*
// $Id: //open/mondrian/src/main/mondrian/olap/Connection.java#25 $
 ...
 * @see DriverManager
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Connection.java#25 $
 * @author jhyde
 */
public interface Connection {
	 ...
	 *             It operates by internally creating a statement. Better to use
	 *             olap4j and explicitly create a statement.
	 */
	 ...
	 * @param mdx
	 *          MDX string
	 * @return A {@link Query} if it is a SELECT statement, a {@link DrillThrough}
