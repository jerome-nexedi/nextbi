/*
// $Id: //open/mondrian/src/main/mondrian/olap/Parameter.java#27 $
 ...
 * 
 * <p>
 * A parameter is not an expression; see {@link mondrian.mdx.ParameterExpr}.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Parameter.java#27 $
 * @since Jul 22, 2006
 */
public interface Parameter {
	 ...
	 * 
	 * <p>
	 * If {@link #setValue(Object)} has not been called, returns the default value
	 * of this parameter.
	 * 
	 * <p>
	 * The type of the value is (depending on the type of the parameter) a
	 * {@link String}, {@link Number}, or {@link Member}.
	 * 
	 ...
	 * 
	 * @param value
	 *          Value of the parameter; must be a {@link String}, a {@link Double}
	 *          , or a {@link mondrian.olap.Member}
	 */
	 ...
	 * unset a parameter, call {@link #unsetValue}.
	 * 
	 ...
	 * 
	 * <p>
	 * After calling this method, the parameter will revert to its default value,
	 * as if {@link #setValue(Object)} had not been called, and {@link #isSet()}
