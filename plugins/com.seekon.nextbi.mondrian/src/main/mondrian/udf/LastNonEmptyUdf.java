/*
// $Id: //open/mondrian/src/main/mondrian/udf/LastNonEmptyUdf.java#12 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/udf/LastNonEmptyUdf.java#12 $
 */
public class LastNonEmptyUdf implements UserDefinedFunction {
  ...
  public Object execute(Evaluator evaluator, Argument[] arguments) {
    ...
    return (hierarchy == null) ? memberListExp.getType().getDimension()
      .getHierarchies()[0].getNullMember() : hierarchy.getNullMember();
  }
