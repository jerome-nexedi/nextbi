...
/**
 * Implementation of {@link mondrian.spi.DialectFactory} for subclasses of
 * {@link mondrian.spi.impl.JdbcDialectImpl}.
 * 
 * <p>
...
public class JdbcDialectFactory implements DialectFactory {
	 ...
	 *          Database type (e.g. Oracle) if this is a common RDBMS, or null if
	...
	public JdbcDialectFactory(Class<? extends JdbcDialectImpl> dialectClass,
		...
		try {
			...
			throw Util.newError(e, "Class does not contain constructor "
	 ...
	 * 
	 * <p>
	 * Helper method, called when {@code createDialect} is called without a
	 * {@link java.sql.Connection} and the dialect factory cannot create a dialect
	 * with {@link javax.sql.DataSource} alone.
	 * 
	 * <p>
	 * It is a user error if {@code dataSource} is null (since this implies that
	 * {@code createDialect} was called with {@code dataSource} and
	 * {@code connection} both null.
	 * </p>
	 * 
	 * @param factory
	 *          Dialect factory
	...
	protected boolean acceptsConnection(Connection connection) {
		try {
			...
			final Dialect.DatabaseProduct product = JdbcDialectImpl.getProduct(
