 ...
 * 
 * <p>
 * If you create a class that implements {@link Dialect}, you may optionally
 * provide a factory by creating a constant field in that class. For example:
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * Explicitly providing a factory gives you more control about how dialects are
 * produced.
 * </p>
 * 
 * <p>
 * If you do not provide such a field, Mondrian requires that the dialect has a
 * public constructor that takes a {@link java.sql.Connection} as a parameter,
 ...
 * 
 * <p>
 * If your dialect is a subclass of {@link mondrian.spi.impl.JdbcDialectImpl}
 * you may wish to use a dialect factory that is a subclass of
 * {@link mondrian.spi.impl.JdbcDialectFactory}.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/spi/DialectFactory.java#2 $
 * @since Jan 13, 2009
 */
