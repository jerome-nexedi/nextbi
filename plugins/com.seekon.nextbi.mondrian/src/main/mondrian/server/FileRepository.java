/*
// $Id: //open/mondrian/src/main/mondrian/server/FileRepository.java#10 $
...
/**
 * Implementation of {@link mondrian.server.Repository} that reads from a
 * {@code datasources.xml} file.
 * 
 * <p>
 * Note that for legacy reasons, the datasources.xml file's root element is
 * called DataSource whereas the olap4j standard calls them Databases. This is
 * why those two concepts are linked, as in
 * {@link FileRepository#getDatabaseNames(RolapConnection)} for example.
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/server/FileRepository.java#10
 *          $
