/*
// $Id: //open/mondrian/src/main/mondrian/server/StatementImpl.java#2 $
 ...
 * </p>
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/server/StatementImpl.java#2 $
 * @author jhyde
 */
public abstract class StatementImpl implements Statement {
   ...
   */
  protected long queryTimeout = MondrianProperties.instance().QueryTimeout.get() * 1000;
  ...
  /**
   * Whether {@link #cancel()} was called before the statement was started. When
   * the statement is started, it will immediately be marked canceled.
   */
