/*
// $Id: //open/mondrian/testsrc/main/mondrian/util/PrimeFinderTest.java#3 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/util/PrimeFinderTest.java#3 $
 * @since Feb 4, 2007
 */
public class PrimeFinderTest extends TestCase {
  ...
  public void testOne() {
    assertStatistics(1000, 1000, "new maxdev @1000@dev=0.039\n"
      + "Statistics for [1000,1000] are as follows\n" + "meanDeviation = 3.9 %\n"
      + "maxDeviation = 3.9 %\n");
  }

  public void testTwo() {
    assertStatistics(200, 1000, "new maxdev @200@dev=0.385\n"
      + "Statistics for [200,1000] are as follows\n"
      + "meanDeviation = 6.589286 %\n" + "maxDeviation = 38.5 %\n");
  }

  public void testThree() {
    assertStatistics(16, 1000, "new maxdev @16@dev=0.0625\n"
