/*
// $Id: //open/mondrian/testsrc/main/mondrian/util/FilteredIterableTest.java#7 $
 ...
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/util/FilteredIterableTest.
 *          java#7 $
 * @since May, 2008
 */
public class FilteredIterableTest extends FoodMartTestCase {
  ...
  public void testEmptyList() throws Exception {
    ...
    final List<Integer> empty = new FilteredIterableList<Integer>(base,
  ...
  public void test2Elements() throws Exception {
    ...
    final List<Integer> identical = new FilteredIterableList<Integer>(base,
      new FilteredIterableList.Filter<Integer>() {
        public boolean accept(final Integer i) {
          return true;
        }
