/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/SharedDimensionTest.java#18 $
 ...
 * @author Rushan Chen
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/rolap/SharedDimensionTest.
 *          java#18 $
 */
public class SharedDimensionTest extends FoodMartTestCase {
  ...
  public static final String queryNECJMultiLevelMemberList = "select {[Employee Store Sales]} on columns, "
    + "NonEmptyCrossJoin([Store Type].[Store Type].Members, "
  ...
  public void testVirtualCube() {
    ...
    TestContext testContext = TestContext.instance().create(sharedDimension,
  ...
  private TestContext getTestContextForSharedDimCubeACubeB() {
    return TestContext.instance().create(sharedDimension, cubeA + "\n" + cubeB,
      null, null, null, null);
  }
}
