/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/ModulosTest.java#9 $
 ...
 * @version $Id: //open/mondrian/testsrc/main/mondrian/rolap/ModulosTest.java#9
 *          $
 */
public class ModulosTest extends TestCase {
  ...
  TupleList newPositionList(int size) {
    return new UnaryTupleList(Collections.<Member> nCopies(size, null));
  }
}
