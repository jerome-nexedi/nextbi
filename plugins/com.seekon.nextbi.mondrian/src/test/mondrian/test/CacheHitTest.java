/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/CacheHitTest.java#7 $
...
/**
 * The <code>CacheHitTest</code> class contains test suites that return hit
 * ratio of aggregation cache for various sequences of MDX queries. This test
 * should be run with mondrian property
 * <code>mondrian.rolap.agg.enableCacheHitCounters=true</code> This is not run
 * as part of Main test suite as it only reports ratios for further
 * investigations.
 * 
 * @author kvu
 * @version $Id: //open/mondrian/testsrc/main/mondrian/test/CacheHitTest.java#7
 *          $
 */
public class CacheHitTest extends FoodMartTestCase {

  /**
   * Runs a set of small MDX queries that targets a small region of aggregation
   * cache sequentially. All queries reference the relational Sales cube.
   * 
   * @throws Exception
   */
  ...
  /**
   * Runs a set of small MDX queries that targets a small region of aggregation
   * cache in random order. All queries reference the relational Sales cube.
   * 
   * @throws Exception
   */
  ...
  /**
   * Runs a set of small MDX queries that targets a small region of aggregation
   * cache sequentially. All queries reference the virtual Warehouse and Sales
   * cube.
   * 
   * @throws Exception
   */
  ...
  /**
   * Runs a set of small MDX queries that targets a small region of aggregation
   * cache in random order. All queries reference the virtual Warehouse and
   * Sales cube.
   * 
   * @throws Exception
   */
  ...
  /**
   * Runs a set of bigger MDX queries that requires more memory and targets a
   * bigger region of cache in random order. Queries reference to Sales cube as
   * well as Warehouse and Sales cube.
   * 
   * @throws Exception
   */
  ...
  /**
   * Loops <code>n</code> times, each time run a random test case in the test
   * <code>suite</code>
   * 
   * @param suite
  ...
  public void runRandomSuite(TestSuite suite, int n) throws Exception {
    ...
    propSaver.set(MondrianProperties.instance().EnableCacheHitCounters, true);
  ...
  /**
   * Loops <code>numIte</code> times, each time run all child test suite in the
   * <code>suite</code>
   * 
   * @param suite
   *          the suite of test suites
   * @param numIter
