/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/InlineTableTest.java#21 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/test/InlineTableTest.java#21 $
 */
public class InlineTableTest extends FoodMartTestCase {
  ...
  public void testInlineTableSnowflake() {
    if (getTestContext().getDialect().getDatabaseProduct() == Dialect.DatabaseProduct.INFOBRIGHT) {
