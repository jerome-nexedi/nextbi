/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/I18nTest.java#12 $
 ...
 * @version $Id: //open/mondrian/testsrc/main/mondrian/test/I18nTest.java#12 $
 */
public class I18nTest extends FoodMartTestCase {
  ...
  public void testFormat() {
    ...
    assertEquals("1.234.567,79 " + Euro, currencyFormat.format(new Double(
      1234567.789)));
  ...
  private void assertFormatNumber(String localeName, String resultString) {
    final Util.PropertyList properties = TestContext.instance()
    ...
    Query query = connection
      .parseQuery("WITH MEMBER [Measures].[Foo] AS ' 12345.67 ',\n"
