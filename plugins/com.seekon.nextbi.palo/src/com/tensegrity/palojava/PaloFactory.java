...
/*    */     {
/*    */     case 1:
/* 80 */       throw new PaloException("Legacy server is not supported anymore!");
/*    */     case 2:
/* 82 */       return new HttpPaloServer(host, port, timeout);
/* 83 */     }throw new PaloException("Unknown server type!");
/*    */   }
/*    */ }

/* Location:           E:\workspace\eclipse\opensourceBI\bicp\com.seekon.bicp.paloapi\lib\palo.jar
 * Qualified Name:     com.tensegrity.palojava.PaloFactory
