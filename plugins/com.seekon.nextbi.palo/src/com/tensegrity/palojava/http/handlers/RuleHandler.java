...
/*     */   }
/*     */ 
/*     */   public final RuleInfo create(CubeInfo cube, String definition, String externalIdentifier, boolean useIt, String comment)
/*     */     throws IOException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public final RuleInfo create(CubeInfo cube, String definition, String externalIdentifier, boolean useIt, String comment, boolean activate)
/*     */     throws IOException
/*     */   {
...
/* 139 */     addRuleParameter(query, definition, externalIdentifier, useIt, comment, 
/* 140 */       activate);
...
/*     */   }
/*     */ 
/*     */   public final void update(RuleInfo rule, String definition, String externalIdentifier, boolean useIt, String comment, boolean activate)
/*     */     throws IOException
/*     */   {
...
/* 202 */     addRuleParameter(query, definition, externalIdentifier, useIt, comment, 
/* 203 */       activate);
...
/*     */   }
/*     */ 
/*     */   private final void addRuleParameter(StringBuffer query, String definition, String externalIdentifier, boolean useIt, String comment, boolean activate)
/*     */   {
 ...
 * Qualified Name:     com.tensegrity.palojava.http.handlers.RuleHandler
