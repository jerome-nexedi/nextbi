...
/*    */     {
/*    */     case 6:
/* 68 */       rule.setActive(response[5].equals("1"));
/*    */     case 5:
/* 70 */       rule.setTimestamp(Long.parseLong(response[4]) * 1000L);
/*    */     case 4:
/* 72 */       rule.setComment(response[3]);
/*    */     case 3:
/* 74 */       rule.setExternalIdentifier(response[2]);
/*    */     }
/*    */   }
/*    */ }

/* Location:           E:\workspace\eclipse\opensourceBI\bicp\com.seekon.bicp.paloapi\lib\palo.jar
 * Qualified Name:     com.tensegrity.palojava.http.builders.RuleInfoBuilder
