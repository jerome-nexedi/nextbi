...
public class XMLAVariableInfo
  implements VariableInfo
{
  private final String[] VAR_TYPE_STRING = { "Unknown", "Member", "Numeric", "Hierarchy" };
  private final String[] VAR_PROC_TYPE_STRING = { "Unknown", "User input" };
  private final String[] VAR_SELECTION_TYPE_STRING = { "Unknown", "Value", "Interval", "Complex" };
  private final String[] VAR_INPUT_TYPE_STRING = { "Optional", "Mandatory", "Mandatory not initial", "Unknown" };
  private String name;
  private String id;
  private String uid;
  ...
  public void loadVariableElements(XMLAClient paramXMLAClient, XMLAConnection paramXMLAConnection, XMLADatabaseInfo paramXMLADatabaseInfo)
  {
    BuilderRegistry.getInstance().getVariableInfoBuilder().requestVarElements(this, paramXMLAConnection, paramXMLADatabaseInfo, paramXMLAClient);
  ...
  public void setInterval(ElementInfo paramElementInfo1, ElementInfo paramElementInfo2)
  {
  ...
  {
    this.from = ((XMLADimensionInfo)this.elementDimension).getMemberByIdInternal(paramString1);
    this.to = ((XMLADimensionInfo)this.elementDimension).getMemberByIdInternal(paramString2);
  }
  ...
  {
    this.value = ((XMLADimensionInfo)this.elementDimension).getMemberByIdInternal(paramString);
  }
  ...
  public void setSelectedElements(String[] paramArrayOfString)
  {
    ...
    for (String str : paramArrayOfString)
      this.selectedElements[(i++)] = ((XMLADimensionInfo)this.elementDimension).getMemberByIdInternal(str);
  }
 ...
 * Qualified Name:     com.tensegrity.palo.xmla.XMLAVariableInfo
