...
public class XMLAElementLoader extends ElementLoader {
  ...
  public XMLAElementLoader(XMLAConnection paramXMLAConnection,
    XMLAClient paramXMLAClient, DimensionInfo paramDimensionInfo) {
  ...
  public XMLAElementLoader(XMLAConnection paramXMLAConnection,
    XMLAClient paramXMLAClient, HierarchyInfo paramHierarchyInfo) {
  ...
  public ElementInfo[] getElementsAtDepth(int paramInt) {
    ...
    XMLAElementInfo[] arrayOfXMLAElementInfo = BuilderRegistry.getInstance()
      .getElementInfoBuilder().getElements((XMLAConnection) this.paloConnection,
        this.xmlaClient,
        ((XMLADimensionInfo) this.hierarchy.getDimension()).getCubeId(),
        this.hierarchy, paramInt);
  ...
  public ElementInfo loadByName(String paramString) {
    ...
    if (!this.loadedInfo.containsKey(str)) {
      localObject = BuilderRegistry.getInstance().getElementInfoBuilder()
        .getElementInfo((XMLAConnection) this.paloConnection, this.xmlaClient,
  ...
  public final ElementInfo[] getChildren(ElementInfo paramElementInfo) {
    ...
    if ((arrayOfString == null) || (arrayOfString.length == 0)) {
      if (!localXMLAElementInfo1.hasChildren()) {
        ...
        arrayOfXMLAElementInfo1 = BuilderRegistry.getInstance()
          .getElementInfoBuilder().getChildren((XMLAConnection) this.paloConnection,
            this.xmlaClient,
            ((XMLADimensionInfo) this.hierarchy.getDimension()).getCubeId(),
            (XMLAElementInfo) paramElementInfo);
  ...
  private void loadAllElementIds() {
    ...
    try {
      ...
      localXMLAProperties.setCatalog(this.hierarchy.getDimension().getDatabase()
        .getId());
      localXMLARestrictions.setCatalog(this.hierarchy.getDimension().getDatabase()
        .getId());
      String str2 = XMLADimensionInfo.transformId(this.hierarchy.getDimension()
        .getId());
      int i = str2.indexOf("|.#.|");
  ...
  private final void loadElements() {
    ...
    XMLAElementInfo[] arrayOfXMLAElementInfo1 = BuilderRegistry.getInstance()
      .getElementInfoBuilder().getElements((XMLAConnection) this.paloConnection,
        this.xmlaClient,
        ((XMLADimensionInfo) this.hierarchy.getDimension()).getCubeId(),
        this.hierarchy);
    ...
    if (this.hierarchy != null)
      localXMLAElementLoader = (XMLAElementLoader) ((XMLAConnection) this.paloConnection)
        .getElementLoader(this.hierarchy.getDimension());
 ...
 * Qualified Name: com.tensegrity.palo.xmla.loader.XMLAElementLoader JD-Core
 * Version: 0.5.4
 */