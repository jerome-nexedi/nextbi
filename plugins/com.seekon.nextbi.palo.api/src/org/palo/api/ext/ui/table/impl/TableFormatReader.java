...
/*     */ 
/*  64 */   static final TableFormatReader getInstance() { return instance; }
/*     */ 
/*     */ 
...
/*     */     try
/*     */     {
/*  88 */       ByteArrayInputStream bin = new ByteArrayInputStream(xmlStr.getBytes("UTF-8"));
...
/*     */ 
/* 113 */           TableFormatReader.FormatXMLHandler.this.cellFmtBuilder.setPriority(prio);
/* 114 */           TableFormatReader.FormatXMLHandler.this.headerFmtBuilder.setPriority(prio);
/*     */         }
/*     */       });
...
/* 122 */           TableFormatReader.FormatXMLHandler.this.cellFmtBuilder.setNumberFormatTemplate(str);
/*     */         }
/*     */       });
...
/*     */       {
/*     */         public void startElement(String uri, String localName, String qName, Attributes attributes) {
/* 129 */           TableFormatReader.FormatXMLHandler.this.setBackground(TableFormatReader.FormatXMLHandler.this.cellFmtBuilder, attributes);
/*     */         }
/*     */       });
...
/*     */       {
/*     */         public void startElement(String uri, String localName, String qName, Attributes attributes) {
/* 136 */           TableFormatReader.FormatXMLHandler.this.setBackground(TableFormatReader.FormatXMLHandler.this.headerFmtBuilder, attributes);
/*     */         }
/*     */       });
/* 139 */       putStartHandler("format/formatcells/font", new StartHandler()
/*     */       {
/*     */         public void startElement(String uri, String localName, String qName, Attributes attributes) {
/* 142 */           TableFormatReader.FormatXMLHandler.this.setFont(TableFormatReader.FormatXMLHandler.this.cellFmtBuilder, attributes);
/*     */         }
/*     */       });
/* 145 */       putStartHandler("format/formatheader/font", new StartHandler()
/*     */       {
/*     */         public void startElement(String uri, String localName, String qName, Attributes attributes) {
/* 148 */           TableFormatReader.FormatXMLHandler.this.setFont(TableFormatReader.FormatXMLHandler.this.headerFmtBuilder, attributes);
/*     */         }
/*     */       });
/*     */     }
/*     */ 
/*     */     private void setBackground(FormatBuilder fmtBuilder, Attributes attributes)
/*     */     {
 ...
 * Qualified Name:     org.palo.api.ext.ui.table.impl.TableFormatReader
