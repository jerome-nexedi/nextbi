...
/*     */     {
/*     */     case 1:
/* 342 */       return areAll(criteria);
/*     */     case 4:
/* 343 */       return isAny(criteria);
/*     */     case 7:
/* 345 */       if (this.values.length < 1)
/* 346 */         return isInCriteriaRegion("", criteria); return isInCriteriaRegion(this.values[0].toString(), criteria);
/*     */     case 2:
/*     */     case 3:
/*     */     case 5:
/*     */     case 6: } Object value = getValue(cellOperator);
...
/* 355 */     switch (operator) {
/*     */     case 3:
/* 357 */       return Double.valueOf(getMax());
/*     */     case 5:
/* 359 */       return Double.valueOf(getMin());
/*     */     case 2:
/* 361 */       return Double.valueOf(getAvg());
/*     */     case 7:
/* 363 */       return (this.values.length > 0) ? this.values[0].toString() : "";
/*     */     case 4:
/*     */     case 6:
/* 366 */     }return Double.valueOf(getSum());
/*     */   }
/*     */ 
...
/* 410 */       }if (Double.compare(_val, max) > 0)
/* 411 */         max = _val;
/*     */     }
/* 413 */     return max;
/*     */   }
...
/* 427 */       }if (Double.compare(_val, min) < 0)
/* 428 */         min = _val;
/*     */     }
/* 430 */     return min;
/*     */   }
...
/*     */   }
/*     */ 
/*     */   private final Element[][] determineCoordinates(Hierarchy[] cubeHiers, String[][] slices)
/*     */   {
...
/*     */ 
/* 468 */     for (int i = 0; i < slices.length; ++i) coordsCount *= slices[i].length;
/*     */ 
...
/* 500 */     if ((val == null) || (operand == null) || (operator == null) || (operand.length() == 0)) {
/* 501 */       return true;
/* 503 */     }if (val instanceof Double);
/*     */     String valStr;
/*     */     try {
...
/* 513 */     }return compare(valStr, operand, operator);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.api.subsets.filter.DataCell
