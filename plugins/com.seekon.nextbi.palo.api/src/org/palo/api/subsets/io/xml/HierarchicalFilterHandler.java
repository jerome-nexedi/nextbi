...
/*     */{
  ...
  /*     */{
    ...
    /* 104 */else if (path.equals("/subset/hierarchical_filter/exclusive/value")) {
      ...
      /* 106 */} else if (path
      .equals("/subset/hierarchical_filter/exclusive/parameter")) {
    ...
    /* 111 */else if (path.equals("/subset/hierarchical_filter/element/value")) {
      ...
      /* 113 */} else if (path
      .equals("/subset/hierarchical_filter/element/parameter")) {
    ...
    /* 118 */else if (path.equals("/subset/hierarchical_filter/hide/value")) {
      ...
      /*     */}
    /* 125 */else if (path
      .equals("/subset/hierarchical_filter/revolve_element/value")) {
      /* 126 */this.hfInfo.setRevolveElement(value);
      /* 127 */} else if (path
      .equals("/subset/hierarchical_filter/revolve_element/parameter")) {
      ...
      /*     */}
    /* 132 */else if (path
      .equals("/subset/hierarchical_filter/revolve_count/value")) {
      /* 133 */this.hfInfo.setRevolveCount(SubsetXMLHandler.getInteger(value));
      /* 134 */} else if (path
      .equals("/subset/hierarchical_filter/revolve_count/parameter")) {
    ...
    /* 139 */else if (path.equals("/subset/hierarchical_filter/revolve_add/value")) {
      ...
      /* 141 */} else if (path
      .equals("/subset/hierarchical_filter/revolve_add/parameter")) {
    ...
    /* 146 */else if (path.equals("/subset/hierarchical_filter/level_start/value")) {
      ...
      /* 151 */} else if (path
      .equals("/subset/hierarchical_filter/level_start/parameter")) {
    ...
    /* 162 */else if (path.equals("/subset/hierarchical_filter/level_end/value")) {
      ...
      /* 167 */} else if (path
      .equals("/subset/hierarchical_filter/level_end/parameter")) {
  ...
  /*     */public final SubsetFilter createFilter(Dimension dimension) {
    /* 181 */if ((this.hfInfo.doLevelSelection())
      && (this.subsetVersion.equals("1.0rc2")))
    /*     */{
      /* 183 */Element start =
 ...
 * Qualified Name: org.palo.api.subsets.io.xml.HierarchicalFilterHandler JD-Core
 * Version: 0.5.4
 */