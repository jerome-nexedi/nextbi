...
/*     */{
  ...
  /*     */
  /* 80 */static final SubsetReader getInstance() {
    return instance;
  }
  ...
  /*     */{
    ...
    /*     */try {
      ...
      /* 110 */if (!isValid(input, path2xsd)) {
        ...
        /* 112 */throw new PaloAPIException(
          "Not a valid subset xml definition!\nDatabase: " +
          /* 113 */dbName + "\nSubset: " + name);
        /*     */}
      /*     */
  ...
  /*     */
  /*     */private final boolean isValid(InputStream input, String path2xsd)
  ...
  /*     */
  /*     */private final String getSubsetVersion(InputStream input)
    throws IOException {
 ...
 * Qualified Name: org.palo.api.subsets.io.SubsetReader JD-Core Version: 0.5.4
 */