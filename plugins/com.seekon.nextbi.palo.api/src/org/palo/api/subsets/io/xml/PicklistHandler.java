...
/*  89 */     } else if (path.equals("/subset/picklist_filter/manual_definition/value/pick_elem")) {
/*  90 */       this.plInfo.addElement(value);
/*  91 */     } else if (path.equals("/subset/picklist_filter/manual_definition/parameter")) {
 ...
 * Qualified Name:     org.palo.api.subsets.io.xml.PicklistHandler
