...
/*     */{
  ...
  /*     */public void setComment(String comment) {
    ...
    /* 104 */this.ruleInfo.getExternalIdentifier(), this.ruleInfo
  ...
  /*     */public void setDefinition(String definition) {
    ...
    /* 111 */this.ruleInfo.getExternalIdentifier(), this.ruleInfo
      .useExternalIdentifier(),
  ...
  /*     */public void setExternalIdentifier(String externalId, boolean useIt) {
    /* 128 */this.dbConnection.update(this.ruleInfo, this.ruleInfo.getDefinition(),
      externalId,
  ...
  /*     */public void update(String definition, String externalIdentifier,
    ...
    /* 139 */this.dbConnection.update(this.ruleInfo, definition,
      externalIdentifier, useIt,
  ...
  /*     */public void useExternalIdentifier(boolean useIt) {
    ...
    /* 146 */if ((extId == null) || (extId.equals("")))
      /* 147 */return;
    /* 148 */this.dbConnection.update(this.ruleInfo, this.ruleInfo.getDefinition(),
      this.ruleInfo.getExternalIdentifier(), useIt,
  ...
  /*     */public Property2 getProperty(String id) {
    ...
    /* 158 */if (propInfo == null) {
      /* 159 */return null;
      /*     */}
    /* 161 */Property2 property = (Property2) this.loadedProperties.get(propInfo
      .getId());
  ...
  /*     */public final void setActive(boolean activate) {
    /* 194 */this.dbConnection.update(this.ruleInfo, this.ruleInfo.getDefinition(),
      this.ruleInfo.getExternalIdentifier(), this.ruleInfo.useExternalIdentifier(),
 ...
 * Qualified Name: org.palo.api.impl.RuleImpl JD-Core Version: 0.5.4
 */