...
/*     */ 
/*     */   /** @deprecated */
/*     */   public final Connection newConnection(String server, String service, String user, String pass)
/*     */   {
/*  70 */     return newConnection(server, service, user, pass, false, 2);
/*     */   }
/*     */ 
/*     */   /** @deprecated */
/*     */   public final Connection newConnection(String server, String service, String user, String pass, boolean doLoadOnDemand, int type)
/*     */   {
/*     */     PaloServer paloSrv;
							ConnectionImpl connection;
/*  79 */     if ((type == 2) || (type == 1)) {
/*  80 */       paloSrv = 
/*  81 */         PaloFactory.getInstance().createServerConnection(server, service, type, 30000);
/*     */     }
/*     */     else
/*     */     {
/*  82 */       if (type == 3)
...
/* 122 */     ConnectionConfiguration cfg = new ConnectionConfiguration(host, service);
/*     */ 
...
/* 153 */         "'!!");
/* 154 */     }if ((connection.supportsRules()) && (type != 3)) {
...
/* 163 */     int i = 0; for (int n = cons.length; i < n; ++i) {
/* 164 */       if (!cons[i].isConnected()) {
/* 165 */         this.activePaloConnections.remove(cons[i]);
/*     */       }
/*     */     }
/* 168 */     return (Connection[])this.activePaloConnections.toArray(new Connection[0]);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.api.impl.ConnectionFactoryImpl
