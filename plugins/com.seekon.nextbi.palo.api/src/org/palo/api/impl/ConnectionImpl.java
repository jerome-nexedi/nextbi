...
/*     */{
  ...
  /*     */{
    ...
    /*     */
    /* 128 */this.connectionInfo.setData("com.tensegrity.palo.wpalo", new Boolean(
      WPALO));
    /*     */}
  ...
  /*     */
  /*     */public final synchronized void storeFavoriteViews(
  ...
  /*     */{
    /* 699 */if (dbInfo == null)
      /* 700 */return null;
    /* 701 */Database database = (Database) this.loadedDatabases
      .get(dbInfo.getId());
  ...
  /*     */
  /*     */private final DatabaseImpl createDatabase(DatabaseInfo dbInfo,
    boolean fireEvent)
  /*     */{
    /*     */try
    /*     */{
  ...
  /*     */public Property2 getProperty(String id) {
    ...
    /* 739 */if (propInfo == null) {
      /* 740 */return null;
      /*     */}
    /* 742 */Property2 property = (Property2) this.loadedProperties.get(propInfo
      .getId());
 ...
 * Qualified Name: org.palo.api.impl.ConnectionImpl JD-Core Version: 0.5.4
 */