...
/*     */{
  ...
  /*     */protected final void registerStartHandlers() {
    ...
    /* 126 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /* 141 */viewBuilder.setCube(CubeViewHandlerLegacy.this.database
          .getCubeByName(cubeId));
        /* 142 */CubeViewHandlerLegacy.this.cubeView = viewBuilder
          .createView(CubeViewHandlerLegacy.this);
        /*     */
    ...
    /* 150 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */public void startElement(String uri, String localName, String qName,
        Attributes attributes)
      /*     */{
        /* 157 */CubeViewHandlerLegacy.this.currAxis = CubeViewHandlerLegacy.this.cubeView
          .getAxis("rows");
        /* 158 */if (CubeViewHandlerLegacy.this.currAxis == null)
          /* 159 */CubeViewHandlerLegacy.this.currAxis = CubeViewHandlerLegacy.this.cubeView
            .addAxis("rows", "rows");
        /*     */}
      /*     */
    });
    ...
    /* 194 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */public void startElement(String uri, String localName, String qName,
        Attributes attributes)
      /*     */{
        /* 201 */CubeViewHandlerLegacy.this.currAxis = CubeViewHandlerLegacy.this.cubeView
          .getAxis("cols");
        /* 202 */if (CubeViewHandlerLegacy.this.currAxis == null)
          /* 203 */CubeViewHandlerLegacy.this.currAxis = CubeViewHandlerLegacy.this.cubeView
            .addAxis("cols", "columns");
        /*     */}
      /*     */
    });
    ...
    /* 238 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */public void startElement(String uri, String localName, String qName,
        Attributes attributes)
      /*     */{
        /* 245 */CubeViewHandlerLegacy.this.currAxis = CubeViewHandlerLegacy.this.cubeView
          .getAxis("selected");
        /* 246 */if (CubeViewHandlerLegacy.this.currAxis == null)
          /* 247 */CubeViewHandlerLegacy.this.currAxis = CubeViewHandlerLegacy.this.cubeView
            .addAxis("selected", "selects");
        /*     */}
      /*     */
    });
  ...
  /*     */private final void handleAxisProperties(Attributes attributes) {
    ...
    /* 298 */if (this.currDim == null) {
      /* 299 */addError("CubeViewHandlerLegacy: unknown dimension '"
        + this.currDimId +
        /* 300 */"'!!", this.cubeView.getId(), this.cubeView, this.database,
        this.currDimId,
        /* 301 */0,
        /* 302 */null, -1);
      /* 303 */return;
    ...
    /* 307 */if (useSubset) {
      ...
      /* 314 */}
    this.currAxis.setSelectedElement(this.currDim,
  ...
  /*     */{
    ...
    /* 329 */if (path == null) {
      ...
      /*     */}
    /*     */
    /* 337 */Element[] elPath = getPath(path, this.currDim.getDefaultHierarchy(),
      this.currAxis,
      /* 338 */4);
  ...
  /*     */{
    ...
    /* 355 */if (path == null) {
      ...
      /* 360 */return;
      /*     */}
    /* 362 */Element[] elPath = getPath(path, this.currDim.getDefaultHierarchy(),
      this.currAxis,
      /* 363 */2);
 ...
 * Qualified Name: org.palo.api.impl.views.CubeViewHandlerLegacy JD-Core
 * Version: 0.5.4
 */