...
/*  91 */     return (PersistenceError[])this.errors.toArray(new PersistenceError[this.errors.size()]);
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   protected final void addError(String msg, String srcId, Object src, Object causeParent, String causeId, int type, Object section, int sectionType)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected final Element[] getPathById(String path, Dimension dim, Hierarchy hier, Object section, int sectionType) throws PaloAPIException {
 ...
 * Qualified Name:     org.palo.api.impl.views.CubeViewHandler
