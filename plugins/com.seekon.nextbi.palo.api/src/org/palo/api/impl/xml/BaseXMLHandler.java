...
/*     */{
  ...
  /*     */{
    ...
    /*     */{
      ...
      /* 107 */if ((starthandler = (StartHandler) this.startHandlers
        .get(getLastPathElement())) != null)
  ...
  /*     */{
    ...
    /*     */{
      ...
      /* 120 */if ((endhandler = (EndHandler) this.endHandlers
        .get(getLastPathElement())) != null)
 ...
 * Qualified Name: org.palo.api.impl.xml.BaseXMLHandler JD-Core Version: 0.5.4
 */