...
/*     */ 
/*  59 */   static final SubsetWriter getInstance() { return instance; }
/*     */ 
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private final void toXMLInternal(OutputStream output, Subset subset) throws Exception
/*     */   {
...
/*  84 */       w.write("  description=\"" + XMLUtil.printQuoted(subset.getDescription()) + "\"\r\n");
/*  85 */       w.write("  sourceDimensionId=\"" + XMLUtil.printQuoted(subset.getDimension().getId()) + "\"\r\n");
/*  86 */       if (subset.getAlias() != null)
/*  87 */         w.write("  alias=\"" + XMLUtil.printQuoted(subset.getAlias().getName()) + "\"\r\n");
/*  88 */       SubsetState activeState = subset.getActiveState();
/*  89 */       String activeStateId = (activeState == null) ? "" : activeState.getId();
...
/* 119 */     w.write("<search attribute=\"" + XMLUtil.printQuoted(searchAttribute.getName()) + "\"/>\r\n");
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.api.impl.subsets.SubsetWriter
