...
/*     */{
  ...
  /*     */
  /* 79 */public static final SubsetPersistence getInstance() {
    return instance;
  }
  ...
  /*     */{
    ...
    /*     */{
      ...
      /*     */} catch (Exception e) {
      /* 148 */throw new PaloAPIException("Could not save subset '"
        + subset.getName() + "'!", e);
      /*     */}
    /*     */}
        ...
        /*     */{
          ...
          /* 233 */for (int i = 0; i < elements.length; ++i) {
            ...
            /* 241 */if (xmlSub != null) {
              ...
              /* 246 */(!xmlDim.getName().equals(subDim.getName())))
                continue;
 ...
 * Qualified Name: org.palo.api.impl.subsets.SubsetPersistence JD-Core Version:
 * 0.5.4
 */