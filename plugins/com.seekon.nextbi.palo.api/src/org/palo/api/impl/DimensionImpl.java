...
/*      */ 
/*      */   static final DimensionImpl create(ConnectionImpl connection, Database database, DimensionInfo dimInfo, boolean doEvents)
/*      */   {
...
/*  117 */     this.propertyLoader = this.dbConnection.getTypedPropertyLoader(dimInfo);
...
/*      */   {
/* 1091 */     ConnectionEvent ev = new ConnectionEvent(getDatabase().getConnection(), 
/* 1092 */       getDatabase(), 
/* 1093 */       4, dimensions);
/*      */ 
...
/* 1116 */       return null;
/*      */     }
/* 1118 */     Property2 property = (Property2)this.loadedProperties.get(propInfo.getId());
...
/* 1184 */     if ((this.dimInfo == null) || (this.dimInfo.getDefaultHierarchy() == null)) {
/* 1185 */       return null;
/*      */     }
 ...
 * Qualified Name:     org.palo.api.impl.DimensionImpl
