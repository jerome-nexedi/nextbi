...
/*     */   {
/* 203 */     if ((consolidation == null) || (this.consolidations.contains(consolidation)))
/* 204 */       return;
...
/* 229 */     if (this.isFlat)
/* 230 */       return null;
/* 231 */     return (Element[])this.parents.toArray(new Element[this.parents.size()]);
/*     */   }
/*     */ 
...
/* 249 */     if (this.isFlat)
/* 250 */       return null;
/* 251 */     return (Element[])this.children.toArray(new Element[this.children.size()]);
/*     */   }
/*     */ 
...
/* 292 */       return this.sourceElement.equals(((VirtualElementImpl)obj).sourceElement);
 ...
 * Qualified Name:     org.palo.api.impl.VirtualElementImpl
