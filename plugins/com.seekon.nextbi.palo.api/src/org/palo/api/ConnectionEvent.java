...
/*     */{
  ...
  /*     */
  /*     */public ConnectionEvent(Connection source, Object parent, int type,
    Object[] items)
  /*     */{
  ...
  /*     */{
    ...
    case 17:
      /* 290 */
      Attribute[] attributes = new Attribute[this.items.length];
      /* 291 */
      System.arraycopy(this.items, 0, attributes, 0, this.items.length);
      /* 292 */
      return attributes;
      /*     */
    }
  ...
  /*     */{
    ...
    case 21:
      /* 340 */
      Rule[] rules = new Rule[this.items.length];
      /* 341 */
      System.arraycopy(this.items, 0, rules, 0, this.items.length);
      /* 342 */
      return rules;
      /*     */
    }
 ...
 * Qualified Name: org.palo.api.ConnectionEvent JD-Core Version: 0.5.4
 */