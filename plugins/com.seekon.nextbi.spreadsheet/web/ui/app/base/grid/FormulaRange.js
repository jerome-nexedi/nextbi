Jedox.wss.grid.FormulaRange = (function() {
	...
	return function(selection, startPoint, endPoint, isPassive) {
		Jedox.wss.grid.FormulaRange.parent.constructor.call(this, selection,
				startPoint, endPoint);
		var that = this;
		var _curHotSpot;
		...
		for ( var htmlEl, clsName = "formularRangeEdge", i = 3; i >= 0; --i) {
...
clsRef.prototype._hover = function(ev) {
	...
	case "defaultRangeBorder":
		...
		elem.style.cursor = "".concat("url(../../app/res/img/cursors/rng_",
	...
	case "rangeEdge":
		...
		elem.style.cursor = "".concat("url(../../app/res/img/cursors/md_curr",
...
clsRef.prototype._refreshElement = function(scope, book, nmcX, nmcY) {
...
clsRef.prototype._drawCorners = function() {
	...
	var color = colors[(this.formulaToken instanceof Object ? this.formulaToken.id
			: 0)
			% colors.length];
	var offsets = [];
