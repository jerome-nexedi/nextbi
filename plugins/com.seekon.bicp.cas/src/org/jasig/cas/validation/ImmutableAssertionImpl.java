...
public final class ImmutableAssertionImpl implements Assertion {
   ...
   */
  public ImmutableAssertionImpl(final List<Authentication> principals,
  ...
  public boolean equals(final Object o) {
    ...
    return this.service.equals(a.getService())
  ...
  public String toString() {
    return "[principals={" + this.principals.toString() + "} for service="
