...
public class GoogleAccountsService extends AbstractWebApplicationService {
  ...
  private static final char[] charMapping = { 'a', 'b', 'c', 'd', 'e', 'f', 'g',
    'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p' };
  ...
  protected GoogleAccountsService(final String id, final String relayState,
    final String requestId, final PrivateKey privateKey, final PublicKey publicKey,
  ...
  public static GoogleAccountsService createServiceFrom(
    ...
    return new GoogleAccountsService(assertionConsumerServiceUrl, relayState,
      requestId, privateKey, publicKey, alternateUserName);
  }
  ...
  private String constructSamlResponse() {
    ...
    if (this.alternateUserName == null) {
      ...
      final String attributeValue = (String) getPrincipal().getAttributes().get(
