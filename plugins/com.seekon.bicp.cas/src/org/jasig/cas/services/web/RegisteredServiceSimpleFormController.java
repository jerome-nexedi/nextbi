...
public final class RegisteredServiceSimpleFormController extends
  ...
  protected final void initBinder(final HttpServletRequest request,
    ...
    binder.setRequiredFields(new String[] { "description", "serviceId", "name",
      "allowedToProxy", "enabled", "ssoEnabled", "anonymousAccess",
      "evaluationOrder" });
  ...
  protected Object formBackingObject(final HttpServletRequest request)
    ...
    final RegisteredService service = this.servicesManager.findServiceBy(Long
      .parseLong(id));
  ...
  protected final Map referenceData(final HttpServletRequest request)
    ...
    model.put("availableAttributes", this.personAttributeDao
