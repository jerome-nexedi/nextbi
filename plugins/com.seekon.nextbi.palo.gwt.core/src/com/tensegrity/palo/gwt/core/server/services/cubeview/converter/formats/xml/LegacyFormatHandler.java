...
/**
 * <code>LegacyFormatHandler</code> TODO DOCUMENT ME
 * 
 * @version $Id: LegacyFormatHandler.java,v 1.3 2009/12/17 16:14:29
 *          PhilippBouillon Exp $
 **/
public class LegacyFormatHandler {
  ...
  private static final void parse(String xml, DefaultHandler xmlHandler) {
    try {
      ...
      parser.parse(new ByteArrayInputStream(xml.getBytes("UTF-8")), xmlHandler);
    } catch (Exception e) {
