...
/**
 * <code>XFilterFactory</code> TODO DOCUMENT ME
 * 
 * @version $Id: XFilterFactory.java,v 1.2 2009/12/17 16:14:29 PhilippBouillon
 *          Exp $
 **/
class XFilterFactory {

  static final XSubset createX(Subset2 subset) { // , XHierarchy xHierarchy) {
    XSubsetType type = subset.getType() == Subset2.TYPE_GLOBAL ? XSubsetType.GLOBAL
      : XSubsetType.LOCAL;
