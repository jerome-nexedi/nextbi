...
/**
 * <code>XElementFactory</code> TODO DOCUMENT ME
 * 
 * @version $Id: XElementFactory.java,v 1.5 2010/04/15 09:54:49 PhilippBouillon
 *          Exp $
 **/
public class XElementFactory {

  public static final XElementNode createX(ElementNode elementNode,
    String axisHierarchyId, String viewId) {
