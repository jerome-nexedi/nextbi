...
/**
 * <code>DataWriter</code> TODO DOCUMENT ME
 * 
 * @version $Id: CellWriter.java,v 1.5 2009/12/17 16:14:29 PhilippBouillon Exp $
 **/
public class CellWriter {
  ...
  private static final DecimalFormat cellFormat = new DecimalFormat("#,##0.00");

  public final void writeCell(XCell cell, Element[] coordinate, Cube cube,
    NumberFormat format, AuthUser user) {
  ...
  private final void writeNumeric(XCell cell, Element[] coordinate, Cube cube,
    ...
    if (cell.value.equals(""))
      cell.value = "0"; // TODO should we ignore setting of empty numeric cell,
    // i.e. simply return in this case??
