...
public class OsgiSupportDispatcherServlet extends DispatcherServlet{
	...
	protected WebApplicationContext createWebApplicationContext(
		...
		if(parent == null && servletContext != null){
			...
			parent = (ApplicationContext)servletContext.getAttribute("context_" + bundleName);
		}
		
		if(!(parent instanceof OsgiBundleXmlWebApplicationContext)){
			throw new RuntimeException("parent must be the instance of OsgiBundleXmlWebApplicationContext.");
		}
