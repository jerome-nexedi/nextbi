...
public class OsgiSupportOpenEntityManagerInViewFilter extends OpenEntityManagerInViewFilter{
	...
	protected EntityManagerFactory lookupEntityManagerFactory() {	
		...
		if (attrName != null) {
			wac = WebApplicationContextUtils.getWebApplicationContext(getServletContext(), attrName);
		}else{
    ...
    if ((!StringUtils.hasLength(puName)) && (wac.containsBean("entityManagerFactory"))) {
