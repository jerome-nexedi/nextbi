...
/*     */ 
/*     */   public FormatImpl(String id, ColorDescriptor backgroundColor, String numberFormat, FontDescriptor font, ColorDescriptor fontColor, BorderData[] borders, TrafficLightData traffic)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public final void addTrafficLightData(double min, double max, ColorDescriptor background, ColorDescriptor foreground, FontDescriptor font)
/*     */   {
...
/* 157 */     if (traffic != null) {
/* 158 */       int i = 0; for (int n = traffic.getSize(); i < n; ++i)
...
/*     */   {
/* 170 */     if ((this.backgroundValues.size() == 0) && (this.foregroundValues.size() == 0) && 
...
/* 183 */       minVals, maxVals, (ColorDescriptor[])this.backgroundValues.toArray(new ColorDescriptor[0]), 
/* 184 */       (ColorDescriptor[])this.foregroundValues.toArray(new ColorDescriptor[0]), 
...
/*     */     } else {
/* 198 */       result.append("\n");
/* 199 */       result.append("    " + this.fontData.getName() + "-" + this.fontData.getSize() + "-" + this.fontData.isBold() + "-" + this.fontData.isItalic() + "-" + this.fontData.isUnderlined() + "\n");
/*     */     }
/*     */ 
...
/* 240 */       int i = 0; for (int n = traffic.getSize(); i < n; ++i) {
...
/* 247 */         if (font != null)
/* 248 */           result.append(font.getName() + "-" + font.getSize() + "-" + font.isBold() + "-" + font.isItalic() + "-" + font.isUnderlined() + "\n");
/*     */         else {
 ...
 * Qualified Name:     org.palo.viewapi.uimodels.formats.FormatImpl
