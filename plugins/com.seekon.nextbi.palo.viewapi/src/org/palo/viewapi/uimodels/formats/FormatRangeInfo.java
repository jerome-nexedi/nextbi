...
/*     */{
  ...
  /*     */
  /*     */public FormatRangeInfo(Dimension[] dims, String description,
  ...
  /*     */{
    /* 117 */if (hasCoordinates) {
      ...
      /* 130 */for (int i = 0; i < length; ++i)
        /* 131 */this.levelDims.put(dims[i], Integer.valueOf(Integer
          .parseInt(levels[i])));
      /*     */}
    /*     */}
 ...
 * .jar Qualified Name: org.palo.viewapi.uimodels.formats.FormatRangeInfo
