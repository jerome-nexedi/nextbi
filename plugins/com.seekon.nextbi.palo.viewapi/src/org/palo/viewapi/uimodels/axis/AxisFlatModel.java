...
/* 137 */     System.err.println("AxisFlatModel#notifyStructureChange(): " + (t1 - t0) + "ms");
...
/* 173 */         model[i] = ((items[i] != null) ? (AxisItem[])items[i].toArray(new AxisItem[0]) : 
/* 174 */           new AxisItem[0]);
/*     */     } else {
...
/* 215 */         model[i] = ((items[i] != null) ? (AxisItem[])items[i].toArray(new AxisItem[0]) : 
/* 216 */           new AxisItem[0]);
/*     */     } else {
...
/*     */   }
/*     */ 
/*     */   private final void flatten(AxisItem item, int hierIndex, AxisTreeFlattenVisitor visitor)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   private final void reverseFlatten(AxisItem item, int hierIndex, AxisTreeFlattenVisitor visitor)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   private final ArrayList<AxisItem>[] getDelta(final int hierCount, final AxisItem[][] items)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   private final void expandHorizontal(AxisItem item, int hierIndex, AxisItem[][] delta)
/*     */   {
/* 341 */     int index = 0;
...
/*     */   }
/*     */ 
/*     */   private final void expandVertical(AxisItem item, int hierIndex, AxisItem[][] delta) {
...
/*     */   {
/* 403 */     int i = 0; for (int n = this.model.length - hierIndex; i < n; ++i) {
...
/*     */   }
/*     */ 
/*     */   private final void collapseVertical(AxisItem item, int hierIndex, AxisItem[][] delta)
/*     */   {
 ...
 * Qualified Name:     org.palo.viewapi.uimodels.axis.AxisFlatModel
