...
/*  89 */     addProperty(new Property("com.tensegrity.palo.axisitem.columnwidth", new Double(100.0D)));
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public final void replaceRootInNextHierarchy(AxisItem item, AxisItem[] replacement) {
...
/* 281 */       return (getPath().equals(other.getPath())) && (this.index == other.index);
/*     */     }
/* 283 */     return false;
/*     */   }
/*     */ }
 ...
 * Qualified Name:     org.palo.viewapi.uimodels.axis.AxisItem
