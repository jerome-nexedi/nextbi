...
{
  public abstract List<String> getRoles(User paramUser)
    throws SQLException;

  public abstract List<String> getRoles(String paramString)
    throws SQLException;

  public abstract List<String> getUsers(Role paramRole)
    throws SQLException;
 ...
 * Qualified Name:     org.palo.viewapi.internal.IUserRoleManagement
