...
/*     */{
  ...
  /*     */public final List<Group> getGroups(User forUser) {
    ...
    /*     */try {
      ...
      /* 176 */IUserGroupManagement ugAssoc = this.mapperReg
  ...
  /*     */public final List<Role> getRoles(User forUser) {
    ...
    /*     */try {
      ...
      /* 274 */IUserRoleManagement urAssoc = this.mapperReg
  ...
  /*     */public final Role createRole(String name)
    throws OperationFailedException {
  ...
  /*     */
  /*     */public void add(Role role, Group toGroup)
    throws OperationFailedException {
  ...
  /*     */{
    ...
    /*     */
    /* 563 */if (!fromGroup.hasMember(user))
      return;
    /*     */try {
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.AdminServiceImpl JD-Core
 * Version: 0.5.4
 */