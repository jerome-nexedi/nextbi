...
/*     */       }
/*     */       finally {
/* 106 */         this.isBusy = false; } this.isBusy = false;
/*     */     }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public final synchronized void setAccount(AuthUser user, Account account, String sessionId)
/*     */     throws PaloIOException
/*     */   {
/* 269 */     Account oldAccount = this.account;
/* 270 */     this.account = account;
/*     */ 
/* 272 */     if ((account == null) || ((oldAccount != null) && (account.getId().equals(oldAccount.getId()))) || 
/* 273 */       (this.cubeView == null)) return;
/* 274 */     this.cubeView = null;
/*     */     try {
/* 276 */       this.cubeView = createCubeView(user, sessionId);
/*     */     } finally {
/* 278 */       ConnectionPoolManager.getInstance().disconnect(account, sessionId, "ViewImpl.setAccount");
/*     */     }
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.ViewImpl
