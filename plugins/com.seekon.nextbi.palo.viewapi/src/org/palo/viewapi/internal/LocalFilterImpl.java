...
/*  97 */     return findElementNode((ElementNode[])this.visibleRoots.toArray(new ElementNode[0]), node);
/*     */   }
/*     */ 
/*     */   public void removeVisibleElement(ElementNode rootNode) {
/* 101 */     removeVisibleElement((ElementNode[])this.visibleRoots.toArray(new ElementNode[0]), rootNode);
/*     */   }
/*     */ 
/*     */   public void clear() {
...
/*     */       }
/*     */     };
/* 128 */     return !traverse((ElementNode[])this.visibleRoots.toArray(new ElementNode[0]), visitor);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.LocalFilterImpl
