...
/* 156 */           node.setName(AxisHierarchyFilter.this.getAliasFormat(node.getElement().getName(), alias, aliasFormat));
/*     */         else
...
/* 193 */     return (this.localFilter != null) && (this.localFilter.hasVisibleElements());
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.cubeview.AxisHierarchyFilter
