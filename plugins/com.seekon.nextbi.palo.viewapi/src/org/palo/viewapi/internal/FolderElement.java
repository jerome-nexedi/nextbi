...
/*     */ 
/*     */   public static FolderElement internalCreate(ExplorerTreeNode parent, String id, String name)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   FolderElement(String id, String name, DynamicFolder parent, FolderElement original)
/*     */   {
...
/* 163 */       this.variableMapper.put(key, (String)original.variableMapper.get(key));
/*     */     }
...
/* 270 */     result.append(":");
/* 271 */     result.append(source.getDimHierarchy().getDimension().getDatabase().getId());
/* 272 */     result.append(":");
...
/* 326 */         result.append("source=\"" + this.sourceObjectDescription.substring(6) + "\" ");
/*     */       else {
/* 328 */         result.append("book=\"" + this.sourceObjectDescription.substring(4) + "\" ");
/*     */       }
/*     */     }
...
/* 336 */           text.append(encodeSubset2((Subset2)key)); } else {
/* 337 */           if (!(key instanceof Hierarchy)) continue;
...
/* 365 */     return (PaloObject[])this.variableMapper.keySet().toArray(new PaloObject[0]);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.FolderElement
