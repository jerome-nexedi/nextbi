...
/* 210 */       ((AbstractExplorerTreeNode)root).setConnectionId(etn.getConnectionId());
/*     */     }
...
/* 243 */       DbService.getConnection())) return;
/* 244 */     update(DbService.getQuery("Folder.createTable"), DbService.getConnection());
/*     */   }
/*     */ 
...
/*     */     try {
/* 262 */       if ((result == null) || (!result.next())) return null;
...
/* 299 */       return 0;
/*     */     } finally {
/* 301 */       if (statement != null) try { statement.close(); } catch (SQLException localSQLException3) {
/*     */         } 
/*     */     }
/*     */   }
/*     */ 
...
/* 314 */       return false;
/*     */     } finally {
/* 316 */       if (statement != null) try { statement.close(); } catch (SQLException localSQLException2) {
/*     */         } 
/*     */     }
/* 318 */     return true;
/*     */   }
 ...
 * Qualified Name:     org.palo.viewapi.internal.FolderModel
