...
{
  public abstract List<String> getViews(Role paramRole)
    throws SQLException;

  public abstract List<String> getRoles(View paramView)
    throws SQLException;
 ...
 * Qualified Name:     org.palo.viewapi.internal.IViewRoleManagement
