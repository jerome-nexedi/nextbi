...
/*     */ {
/*  59 */   private static final String TABLE = DbService.getQuery("UsersGroupsAssociation.tableName");
/*  60 */   private static final String COLUMNS = DbService.getQuery("UsersGroupsAssociation.columns");
/*  61 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("UsersGroupsAssociation.createTable", new String[] { TABLE });
/*  62 */   private static final String INSERT_STMT = DbService.getQuery("UsersGroupsAssociation.insert", new String[] { TABLE });
/*  63 */   private static final String FIND_BY_GROUP_STMT = DbService.getQuery("UsersGroupsAssociation.findByGroup", new String[] { COLUMNS, TABLE });
/*  64 */   private static final String FIND_BY_USER_STMT = DbService.getQuery("UsersGroupsAssociation.findByUser", new String[] { COLUMNS, TABLE });
/*  65 */   private static final String UPDATE_STMT = DbService.getQuery("UsersGroupsAssociation.update", new String[] { TABLE });
/*  66 */   private static final String DELETE_STMT = DbService.getQuery("UsersGroupsAssociation.delete", new String[] { TABLE });
/*  67 */   private static final String DELETE_GROUP_STMT = DbService.getQuery("UsersGroupsAssociation.deleteGroup", new String[] { TABLE });
/*  68 */   private static final String DELETE_USER_STMT = DbService.getQuery("UsersGroupsAssociation.deleteUser", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.UserGroupAssociation
