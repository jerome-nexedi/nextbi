...
/*     */ {
/*  58 */   private static final String TABLE = DbService.getQuery("UsersRolesAssociation.tableName");
/*  59 */   private static final String COLUMNS = DbService.getQuery("UsersRolesAssociation.columns");
/*  60 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("UsersRolesAssociation.createTable", new String[] { TABLE });
/*  61 */   private static final String INSERT_STMT = DbService.getQuery("UsersRolesAssociation.insert", new String[] { TABLE });
/*  62 */   private static final String FIND_BY_ROLE_STMT = DbService.getQuery("UsersRolesAssociation.findByRole", new String[] { COLUMNS, TABLE });
/*  63 */   private static final String FIND_BY_USER_STMT = DbService.getQuery("UsersRolesAssociation.findByUser", new String[] { COLUMNS, TABLE });
/*  64 */   private static final String UPDATE_STMT = DbService.getQuery("UsersRolesAssociation.update", new String[] { TABLE });
/*  65 */   private static final String DELETE_STMT = DbService.getQuery("UsersRolesAssociation.delete", new String[] { TABLE });
/*  66 */   private static final String DELETE_ROLE_STMT = DbService.getQuery("UsersRolesAssociation.deleteRole", new String[] { TABLE });
/*  67 */   private static final String DELETE_USER_STMT = DbService.getQuery("UsersRolesAssociation.deleteUser", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.UserRoleAssociation
