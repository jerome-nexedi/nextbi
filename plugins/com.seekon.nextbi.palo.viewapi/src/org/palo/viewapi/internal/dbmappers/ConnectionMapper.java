...
/*     */ {
/*  61 */   private static final String TABLE = DbService.getQuery("Connections.tableName");
/*  62 */   private static final String COLUMNS = DbService.getQuery("Connections.columns");
/*  63 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("Connections.createTable", new String[] { TABLE });
/*  64 */   private static final String FIND_ALL_STMT = DbService.getQuery("Connections.findAll", new String[] { COLUMNS, TABLE });
/*  65 */   private static final String FIND_BY_ID_STMT = DbService.getQuery("Connections.findById", new String[] { COLUMNS, TABLE });
/*  66 */   private static final String FIND_BY_HOST_SERVICE_STMT = DbService.getQuery("Connections.findByHost", new String[] { COLUMNS, TABLE });
/*  67 */   private static final String FIND_BY_NAME_STMT = DbService.getQuery("Connections.findByName", new String[] { COLUMNS, TABLE });
/*  68 */   private static final String INSERT_STMT = DbService.getQuery("Connections.insert", new String[] { TABLE });
/*  69 */   private static final String UPDATE_STMT = DbService.getQuery("Connections.update", new String[] { TABLE });
/*  70 */   private static final String DELETE_STMT = DbService.getQuery("Connections.delete", new String[] { TABLE });
/*     */ 
...
/*     */   {
/* 143 */     PaloConnectionImpl.Builder conBuilder = new PaloConnectionImpl.Builder(id);
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.ConnectionMapper
