...
/*     */ {
/*  59 */   private static final String TABLE = DbService.getQuery("ReportsViewsAssociation.tableName");
/*  60 */   private static final String COLUMNS = DbService.getQuery("ReportsViewsAssociation.columns");
/*  61 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("ReportsViewsAssociation.createTable", new String[] { TABLE });
/*  62 */   private static final String INSERT_STMT = DbService.getQuery("ReportsViewsAssociation.insert", new String[] { TABLE });
/*  63 */   private static final String FIND_BY_REPORT_STMT = DbService.getQuery("ReportsViewsAssociation.findByReport", new String[] { COLUMNS, TABLE });
/*  64 */   private static final String FIND_BY_VIEW_STMT = DbService.getQuery("ReportsViewsAssociation.findByView", new String[] { COLUMNS, TABLE });
/*  65 */   private static final String UPDATE_STMT = DbService.getQuery("ReportsViewsAssociation.update", new String[] { TABLE });
/*  66 */   private static final String DELETE_STMT = DbService.getQuery("ReportsViewsAssociation.delete", new String[] { TABLE });
/*  67 */   private static final String DELETE_REPORT_STMT = DbService.getQuery("ReportsViewsAssociation.deleteReport", new String[] { TABLE });
/*  68 */   private static final String DELETE_VIEW_STMT = DbService.getQuery("ReportsViewsAssociation.deleteView", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.ReportViewAssociation
