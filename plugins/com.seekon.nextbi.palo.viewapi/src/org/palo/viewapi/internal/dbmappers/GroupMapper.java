...
/*     */ {
/*  66 */   private static final String TABLE = DbService.getQuery("Groups.tableName");
/*  67 */   private static final String COLUMNS = DbService.getQuery("Groups.columns");
/*  68 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("Groups.createTable", new String[] { TABLE });
/*  69 */   private static final String FIND_ALL_STMT = DbService.getQuery("Groups.findAll", new String[] { COLUMNS, TABLE });
/*  70 */   private static final String FIND_BY_ID_STMT = DbService.getQuery("Groups.findById", new String[] { COLUMNS, TABLE });
/*  71 */   private static final String FIND_BY_NAME_STMT = DbService.getQuery("Groups.findByName", new String[] { COLUMNS, TABLE });
/*     */ 
/*  73 */   private static final String INSERT_STMT = DbService.getQuery("Groups.insert", new String[] { TABLE });
/*  74 */   private static final String UPDATE_STMT = DbService.getQuery("Groups.update", new String[] { TABLE });
/*  75 */   private static final String DELETE_STMT = DbService.getQuery("Groups.delete", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.GroupMapper
