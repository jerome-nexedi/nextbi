...
/*     */ {
/*  60 */   private static final String TABLE = DbService.getQuery("ReportsRolesAssociation.tableName");
/*  61 */   private static final String COLUMNS = DbService.getQuery("ReportsRolesAssociation.columns");
/*  62 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("ReportsRolesAssociation.createTable", new String[] { TABLE });
/*  63 */   private static final String INSERT_STMT = DbService.getQuery("ReportsRolesAssociation.insert", new String[] { TABLE });
/*  64 */   private static final String FIND_BY_REPORT_STMT = DbService.getQuery("ReportsRolesAssociation.findByReport", new String[] { COLUMNS, TABLE });
/*  65 */   private static final String FIND_BY_ROLE_STMT = DbService.getQuery("ReportsRolesAssociation.findByRole", new String[] { COLUMNS, TABLE });
/*  66 */   private static final String UPDATE_STMT = DbService.getQuery("ReportsRolesAssociation.update", new String[] { TABLE });
/*  67 */   private static final String DELETE_STMT = DbService.getQuery("ReportsRolesAssociation.delete", new String[] { TABLE });
/*  68 */   private static final String DELETE_REPORT_STMT = DbService.getQuery("ReportsRolesAssociation.deleteReport", new String[] { TABLE });
/*  69 */   private static final String DELETE_ROLE_STMT = DbService.getQuery("ReportsRolesAssociation.deleteRole", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.ReportRoleAssociation
