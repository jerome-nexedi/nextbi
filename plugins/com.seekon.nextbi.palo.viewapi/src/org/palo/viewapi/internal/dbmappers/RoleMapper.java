...
/*  70 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("Roles.createTable", new String[] { TABLE });
/*  71 */   private static final String FIND_ALL_STMT = DbService.getQuery("Roles.findAll", new String[] { COLUMNS, TABLE });
/*  72 */   private static final String FIND_BY_ID_STMT = DbService.getQuery("Roles.findById", new String[] { COLUMNS, TABLE });
/*  73 */   private static final String FIND_BY_NAME_STMT = DbService.getQuery("Roles.findByName", new String[] { COLUMNS, TABLE });
/*  74 */   private static final String FIND_BY_USER_STMT = DbService.getQuery("Roles.findByUser", new String[] { COLUMNS, TABLE });
/*  75 */   private static final String INSERT_STMT = DbService.getQuery("Roles.insert", new String[] { TABLE });
/*  76 */   private static final String UPDATE_STMT = DbService.getQuery("Roles.update", new String[] { TABLE });
/*  77 */   private static final String DELETE_STMT = DbService.getQuery("Roles.delete", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.RoleMapper
