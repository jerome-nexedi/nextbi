...
/*     */ {
/*  60 */   private static final String TABLE = DbService.getQuery("ViewsRolesAssociation.tableName");
/*  61 */   private static final String COLUMNS = DbService.getQuery("ViewsRolesAssociation.columns");
/*  62 */   private static final String CREATE_TABLE_STMT = DbService.getQuery("ViewsRolesAssociation.createTable", new String[] { TABLE });
/*  63 */   private static final String INSERT_STMT = DbService.getQuery("ViewsRolesAssociation.insert", new String[] { TABLE });
/*  64 */   private static final String FIND_BY_VIEW_STMT = DbService.getQuery("ViewsRolesAssociation.findByView", new String[] { COLUMNS, TABLE });
/*  65 */   private static final String FIND_BY_ROLE_STMT = DbService.getQuery("ViewsRolesAssociation.findByRole", new String[] { COLUMNS, TABLE });
/*  66 */   private static final String UPDATE_STMT = DbService.getQuery("ViewsRolesAssociation.update", new String[] { TABLE });
/*  67 */   private static final String DELETE_STMT = DbService.getQuery("ViewsRolesAssociation.delete", new String[] { TABLE });
/*  68 */   private static final String DELETE_ROLE_STMT = DbService.getQuery("ViewsRolesAssociation.deleteRole", new String[] { TABLE });
/*  69 */   private static final String DELETE_VIEW_STMT = DbService.getQuery("ViewsRolesAssociation.deleteView", new String[] { TABLE });
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.dbmappers.ViewRoleAssociation
