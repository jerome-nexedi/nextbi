...
/*  72 */     this.xmlHandlers.put("/folder/dynamicFolder", DynamicFolderHandler.class);
/*  73 */     this.xmlHandlers.put("/folder/folderElement", FolderElementHandler.class);
/*     */   }
/*     */ 
/*     */   public final ExplorerTreeNode getRoot() {
/*  77 */     if ((this.root != null) && (this.root.getName().equals("Invisible Root"))) {
...
/* 100 */       strippedPath = strippedPath + xPath.substring(xPath.lastIndexOf("/") + 1);
...
/* 120 */       strippedPath = strippedPath + xPath.substring(xPath.lastIndexOf("/") + 1);
...
/* 183 */         return (IXMLHandler)constructor.newInstance(new Object[] { this });
/*     */       }
/*     */       catch (Exception e) {
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.xml.FolderXMLHandler
