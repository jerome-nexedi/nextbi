...
/* 117 */         (!(a instanceof PaloAccount))) continue;
...
/* 143 */         (!(a instanceof PaloAccount))) continue;
...
/* 198 */     if ((!path.startsWith("/folder/")) || (!path.endsWith("folderElement")))
/*     */       return;
...
/* 206 */     if (name == null) {
/* 207 */       throw new PaloAPIException("FolderElementHandler: no name specified!");
/*     */     }
/*     */ 
...
/* 216 */       sourceView = StaticFolderHandler.parseSourceView(this.xmlHandler, source);
...
/*     */         else
/*     */           try {
/* 224 */             IRoleManagement roleMgmt = MapperRegistry.getInstance().getRoleManagement();
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.xml.FolderElementHandler
