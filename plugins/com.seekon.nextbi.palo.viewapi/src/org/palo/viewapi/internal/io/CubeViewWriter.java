...
/*     */ 
/*  62 */   static final CubeViewWriter getInstance() { return instance; }
/*     */ 
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private final void toXMLInternal(OutputStream output, CubeView view) throws Exception
/*     */   {
...
/*  93 */       int str2 = arrayOfProperty1.length; 
								for (int str1 = 0; str1 < str2; ++str1) { Property prop = arrayOfProperty1[str1];
...
/* 100 */       for (str2 = 0; str2 < str3; ++str2) { Axis axis = axes[str2];
...
/* 107 */       int propertyXML = formats.length; 
								for (str3 = 0; str3 < propertyXML; ++str3) { Format format = formats[str3];
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.CubeViewWriter
