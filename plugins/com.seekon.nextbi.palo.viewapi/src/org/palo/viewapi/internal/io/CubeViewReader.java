...
/*     */ 
/*  74 */   static final CubeViewReader getInstance() { return instance; }
/*     */ 
/*     */ 
/*     */   public CubeView fromXML(AuthUser user, View view, Cube cube, InputStream input)
...
/* 100 */         new StreamSource(CubeViewReader.class.getResourceAsStream("xml/cubeview.xsd")));
...
/*     */ 
/* 106 */       CubeViewXMLHandler viewHandler = new CubeViewXMLHandler(user, view, cube);
...
/* 115 */       throw new PaloIOException("XML Exception during loading of cube view!", e);
/*     */     } catch (IOException e) {
/* 117 */       throw new PaloIOException("IOException during loading of cube view!", e);
/*     */     } catch (Exception e) {
/* 119 */       throw new PaloIOException("Exception during loading of cube view!", e);
/*     */     } finally {
...
/*     */   }
/*     */ 
/*     */   private final boolean isValid(InputStream input) throws SAXException, IOException
/*     */   {
...
/* 132 */       new StreamSource(CubeViewReader.class.getResourceAsStream("xml/cubeview.xsd")));
/*     */ 
 ...
 * Qualified Name:     org.palo.viewapi.internal.io.CubeViewReader
