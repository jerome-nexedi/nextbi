...
/* 187 */       break;
/*     */     case 14:
/* 189 */       ps = PageSize.EXECUTIVE;
/* 190 */       break;
/*     */     case 15:
/* 192 */       ps = PageSize.LEGAL;
/* 193 */       break;
/*     */     case 16:
/* 195 */       ps = PageSize.LETTER;
/* 196 */       break;
/*     */     default:
/* 198 */       throw new IllegalStateException("invalid page format");
/*     */     }
 ...
 * Qualified Name:     org.palo.viewapi.exporters.PaloPDFExporterConfiguration
