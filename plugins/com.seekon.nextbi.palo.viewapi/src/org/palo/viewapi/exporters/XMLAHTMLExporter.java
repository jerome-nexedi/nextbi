...
/*     */ {
/*  70 */   private static final DecimalFormat DEFAULT_FORMATTER = new DecimalFormat("#,##0.00");
/*     */ 
...
/* 201 */           String formatted = this.cellValues[(this.cellPosition++)].toString();
...
/* 210 */       localPrefix = localPrefix.replaceAll("<td>.*?</td>", "<td>&nbsp;</td>");
...
/* 261 */         String dimId = prop.getId().substring("dimensionHierarchy-".length());
...
/* 302 */         if ((currentlySelectedElements == null) || (currentlySelectedElements.length == 0))
/* 303 */           this.html.append("<td>-</td>");
/*     */         else {
/* 305 */           this.html.append("<td>" + ah.getSelectedElements()[0].getName() + "</td>");
/*     */         } }
/*     */ 
...
/* 319 */     AxisFlatModel cols = new AxisFlatModel(view.getAxis("cols"), (rc != null) && (Boolean.parseBoolean(rc.toString())));
...
/* 327 */     AxisFlatModel rows = new AxisFlatModel(view.getAxis("rows"), 1, (rr != null) && (Boolean.parseBoolean(rr.toString())));
...
/* 383 */             if (rcCoord != null) {
/* 384 */               allCoordinates.add(new IndexRangeInfo(f, rcCoord[0].intValue(), rcCoord[1].intValue()));
/*     */             }
/*     */           }
/*     */         }
/*     */       }
...
/*     */     }
/*     */ 
/* 392 */     this.indexRanges = ((IndexRangeInfo[])allCoordinates.toArray(new IndexRangeInfo[0]));
/*     */ 
...
/* 422 */       return this.customFormatter.format(d); } catch (NumberFormatException e) {
/*     */     }
/* 424 */     return text;
/*     */   }
/*     */ 
...
/* 440 */     if (red.length() < 2) red = "0" + red;
/* 441 */     if (green.length() < 2) green = "0" + green;
/* 442 */     if (blue.length() < 2) blue = "0" + blue;
...
/* 499 */         if ((traffic.getMinValueAt(i) <= d.doubleValue()) && (d.doubleValue() <= traffic.getMaxValueAt(i))) {
...
/*     */           }
/* 508 */           return new Object[] { Boolean.valueOf(true), "<td align=\"right\" " + bgColorString + ">" + text + "</td>" };
/*     */         }
/*     */     }
/*     */     catch (NumberFormatException e) {
...
/* 542 */       result = applyTrafficLightData(f.getTrafficLightData(), text, originalText);
/*     */     }
/* 544 */     if (!((Boolean)result[0]).booleanValue())
/*     */     {
/* 546 */       text = applyFontAndColor(f.getFontData(), f.getForegroundColor(), text);
/*     */ 
...
/* 575 */       return;
/*     */     }
/* 577 */     coord[((Integer)hierIndex.get(item.getHierarchy())).intValue()] = item.getElement();
 ...
 * Qualified Name:     org.palo.viewapi.exporters.XMLAHTMLExporter
