...
public class WPaloControllerServiceProvider implements WPaloControllerServiceAsync {

  // --------------------------------------------------------------------------
  // FACTORY
  //
  private final static WPaloControllerServiceProvider instance = new WPaloControllerServiceProvider();
  ...
  private WPaloControllerServiceProvider() {
    proxy = (WPaloControllerServiceAsync) GWT.create(WPaloControllerService.class);
