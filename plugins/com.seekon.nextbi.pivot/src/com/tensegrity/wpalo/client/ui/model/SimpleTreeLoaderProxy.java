...
public class SimpleTreeLoaderProxy extends
  RpcProxy<SimpleTreeNode, List<SimpleTreeNode>> {
  ...
  protected void load(final SimpleTreeNode loadConfig,
    final AsyncCallback<List<SimpleTreeNode>> callback) {
