...
public class ShowTipsAtStartupDialog extends Dialog {
  ...
  private final void readFirstTip(final Date date, final String user,
    final boolean update) {
    WPaloPropertyServiceProvider.getInstance().getStringProperty(
      messages.tipMessage(1), new AsyncCallback<String>() {
  ...
  public ShowTipsAtStartupDialog(int tipNumber, final Date date, final String user) {
    ...
    this.user = user;
    WPaloPropertyServiceProvider.getInstance().getStringProperty(
      messages.tipMessage(tipNumber), new AsyncCallback<String>() {
  ...
  protected void onButtonPressed(Button button) {
    if (button.getItemId().equalsIgnoreCase(Dialog.NO)) {
      ...
      if (button.getItemId().equalsIgnoreCase(Dialog.YES)) {
        tipNumber -= 2;
        if (tipNumber < 1) {
          WPaloPropertyServiceProvider.getInstance().getIntProperty("lastTip", 1,
