 ...
 * 
 * @version $Id: PaloSuiteViewCreationDialog.java,v 1.6 2010/04/12 11:13:36
 *          PhilippBouillon Exp $
 **/
public class PaloSuiteViewCreationDialog extends Window {
  ...
  public void show() {
    String sessionId = ((Workbench) Registry.get(Workbench.ID)).getUser()
      .getSessionId();
    final String directLink = com.google.gwt.user.client.Window.Location
      .getQueryString();
  ...
  private final LayoutContainer createAccountPanel() {
    ...
    accounts = new AccountComboBox(constants.connection(), constants
      .lowerCaseConnection());
