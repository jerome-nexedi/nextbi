...
/**
 * <code>AccountController</code> TODO DOCUMENT ME
 * 
 * @version $Id: AccountController.java,v 1.18 2010/02/12 13:49:50
 *          PhilippBouillon Exp $
 **/
public class AccountController extends Controller implements WPaloEvent {
  ...
  public AccountController() {
    ...
    registerEventTypes(INIT, LOGIN, LOGOUT, EXPANDED_ACCOUNT_SECTION,
      EDIT_ACCOUNT_ITEM, EDIT_CONNECTION_ITEM, SELECTED_ACCOUNTS,
      SELECTED_CONNECTIONS, ADD_ACCOUNT_ITEM, ADD_CONNECTION_ITEM,
      SAVED_ACCOUNT_ITEM, SAVED_CONNECTION_ITEM, DELETED_ITEM, LOGOUT_CLICKED);
  }
  ...
  public void handleEvent(final AppEvent<?> event) {
    ...
    case DELETED_ITEM:
      ...
      if (_wb.getCurrentEditor() != null
        && _wb.getCurrentEditor().getInput() != null) {
