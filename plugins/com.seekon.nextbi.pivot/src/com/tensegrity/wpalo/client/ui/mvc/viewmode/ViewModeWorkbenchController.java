...
/**
 * <code>WorkbenchController</code> TODO DOCUMENT ME
 * 
 * @version $Id: ViewModeWorkbenchController.java,v 1.7 2009/12/17 16:14:20
 *          PhilippBouillon Exp $
 **/
public class ViewModeWorkbenchController extends Controller {
  ...
  public ViewModeWorkbenchController() {
    ...
    registerEventTypes(WPaloEvent.LOGOUT, WPaloEvent.INIT_VIEW_MODE,
      WPaloEvent.VIEW_MODE_LOGIN, WPaloEvent.VIEW_MODE_LOGOUT);
  }
