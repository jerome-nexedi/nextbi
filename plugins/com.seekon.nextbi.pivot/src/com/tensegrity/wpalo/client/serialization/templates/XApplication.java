...
public class XApplication extends XObject {
  ...
  public XApplication(XUser user, XAccount account, String id, boolean loadWBs,
    boolean loadTemps) {
  ...
  public int hashCode() {
    return 7 * (getId() == null ? 1 : getId().hashCode()) + 13
      * getType().hashCode() + 11 * account.hashCode();
  }
  ...
  public boolean equals(Object o) {
    ...
    if (getId() == null) {
      boolean ret = a.getId() == null && getType().equals(a.getType())
        && account.equals(a.account);
      return ret;
    }

    boolean ret = getId().equals(a.getId()) && getType().equals(a.getType())
      && account.equals(a.account);
    return ret;
  }
}
