...
/**
 * <code>ConnectionsChildLoader</code> TODO DOCUMENT ME
 * 
 * @version $Id: AccountConnectionChildLoader.java,v 1.7 2009/12/17 16:14:20
 *          PhilippBouillon Exp $
 **/
public class AccountConnectionChildLoader implements ChildLoader {
  ...
  private final XAccount[] getAccounts(AdministrationService adminSrv) {
    ...
    for (User user : allUsers) {
      ...
      // XUser xUser = (XUser) WPaloAdminCache.getXObject(user);
      // //XConverter.createUser(user);
      ...
      for (Account account : accounts) {
        ...
        // XAccount xAccount = (XAccount) WPaloAdminCache.getXObject(account);
        // //XConverter.createAccount(account, xUser);
  ...
  private final XConnection[] getConnections(AdministrationService adminSrv) {
    ...
    for (PaloConnection connection : connections) {
      ...
      // WPaloAdminCache.getXObject(connection);
      // //XConverter.createConnection(connection);
