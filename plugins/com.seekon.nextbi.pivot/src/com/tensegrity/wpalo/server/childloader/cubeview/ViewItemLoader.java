...
/**
 * <code>ViewItemLoader</code> TODO DOCUMENT ME
 * 
 * @version $Id: ViewItemLoader.java,v 1.6 2009/12/17 16:14:21 PhilippBouillon
 *          Exp $
 **/
public class ViewItemLoader implements ChildLoader {

  public boolean accepts(XObject parent) {
    return (parent instanceof XAxisHierarchy) || (parent instanceof XViewItem);
  }
  ...
  private final XViewItem[] loadRootItemsFrom(XAxisHierarchy xAxisHierarchy) {
    List<XViewItem> roots = new ArrayList<XViewItem>();
    // CubeViewController viewController =
    // getViewController(xAxisHierarchy.getAxis());
