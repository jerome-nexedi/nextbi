...
public class JarVisitorFactory {
  ...
  private static final EntityManagerMessageLogger LOG = Logger.getMessageLogger(
    EntityManagerMessageLogger.class, JarVisitorFactory.class.getName());
  ...
  public static URL getJarURLFromURLEntry(URL url, String entry)
    ...
    try {
      ...
      if ("jar".equals(protocol) || "wsjar".equals(protocol)) { //Websphere has it's own way
      ...
      throw new IllegalArgumentException("Unable to determine JAR Url from " + url
        + ". Cause: " + e.getMessage());
    }
  ...
  public static JarVisitor getVisitor(URL jarUrl, Filter[] filters, String entry)
    throws IllegalArgumentException {
    ...
    if ("bundleresource".equals(protocol)
      ...
      try {
        ...
        if(method != null){
          ...
          jarUrl = (URL)method.invoke(connection, null);
        }
        protocol = jarUrl.getProtocol();
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
    ...
    if ("jar".equals(protocol)) {
      ...
      try {
        ...
        throw new IllegalArgumentException("Unable to visit JAR " + jarUrl
