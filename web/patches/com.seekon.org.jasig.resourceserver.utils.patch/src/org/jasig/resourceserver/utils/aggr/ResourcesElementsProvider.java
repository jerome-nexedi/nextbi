...
public interface ResourcesElementsProvider {
   ...
   */
  public static final String RESOURCES_ELEMENTS_PROVIDER = ResourcesElementsProvider.class
    .getName();

  /**
   * System property used to determine if aggregation is enabled or not 
   */
  public static final String AGGREGATED_THEME_PARAMETER = ResourcesElementsProvider.class
    .getPackage().getName()
    + ".aggregated_theme";
   ...
   */
  public static final String DEFAULT_RESOURCE_CONTEXT = "/resource";
