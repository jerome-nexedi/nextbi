 ...
 * @version $Revision: 25520 $
 */
public class PathBasedCacheExpirationFilter extends GenericFilterBean {
  protected final Logger logger = LoggerFactory.getLogger(this.getClass());

  final Map<String, Long> DEFAULT_CACHE_PATHS = ImmutableMap.of("/**/*.aggr.min.js",
    TimeUnit.DAYS.toSeconds(365), "/**/*.aggr.min.css",
    TimeUnit.DAYS.toSeconds(365), "/**/*.min.js", TimeUnit.DAYS.toSeconds(365),
    "/**/*.min.css", TimeUnit.DAYS.toSeconds(365), "/rs/**/*", TimeUnit.DAYS
      .toSeconds(365));
  ...
  public void setCacheMaxAges(Map<String, ? extends Number> cacheMaxAges) {
    ...
    for (final Map.Entry<String, ? extends Number> cacheMaxAgeEntry : cacheMaxAges
      .entrySet()) {
  ...
  protected void initFilterBean() throws ServletException {
    if (this.resourcesElementsProvider == null) {
      ...
      if (servletContext == null) {////add 2012-05-15
        servletContext = GlobalWebContextHelper.getGlobalServletContext();
      }
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    if (response instanceof HttpServletResponse
      ...
      final Included includedType = this.resourcesElementsProvider
        ...
        for (final Entry<String, Long> entry : this.cacheMaxAges.entrySet()) {
          ...
          if (this.pathMatcher.match(entry.getKey(), path)) {
            ...
            httpResponse.setDateHeader("Expires", System.currentTimeMillis()
              + maxAge);
            httpResponse.setHeader("Cache-Control", this.cachedControlStrings
              .get(maxAge));
