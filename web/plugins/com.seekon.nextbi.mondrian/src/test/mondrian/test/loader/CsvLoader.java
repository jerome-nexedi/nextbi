/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/loader/CsvLoader.java#12 $
 ...
 * <code>java.io.InputStream, file</code> names and <code>java.io.File</code>.
 * One can also specify a separator character other than the default comma, ',',
 * character and, also, that the input's first line contains the names of the
 * columns (by default this is not assumed). Lastly, this supports only the
 * comment character '#' and only at the start of a line. This comment support
 ...
 * <p>
 * There are six special start/end characters when seen prevent the recognition
 * of both the separator character and new lines:
 * 
 * <blockquote>
 * 
 * <pre>
 ...
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/test/loader/CsvLoader.java#12
 *          $
 */
public class CsvLoader {
  ...
  public CsvLoader(Reader reader, char separator, boolean includesHeader) {
    this.bufReader = (reader instanceof BufferedReader) ? (BufferedReader) reader
  ...
  protected String[] nextColumns() throws IOException {
    ...
    do {
      ...
      while (pos < line.length()) {
        ...
        if (inDoubleQuote || inSingleQuote || inParen || inBracket || inBraces
          || inChevrons) {
          buf.append(c);
