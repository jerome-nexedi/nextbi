/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/NativeFilterMatchingTest.java#11 $
 ...
 * 
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/rolap/NativeFilterMatchingTest
 *          .java#11 $
 */
public class NativeFilterMatchingTest extends BatchTestCase {
  public void testPositiveMatching() throws Exception {
    ...
    final String sqlOracle = MondrianProperties.instance().UseAggregates.get() ? "select "
    ...
    final String sqlPgsql = MondrianProperties.instance().UseAggregates.get() ? "select "
    ...
    final String sqlMysql = MondrianProperties.instance().UseAggregates.get() ? "select "
  ...
  /**
   * <p>
   * System test case for bug <a
   * href="http://jira.pentaho.com/browse/MONDRIAN-983">MONDRIAN-983,
