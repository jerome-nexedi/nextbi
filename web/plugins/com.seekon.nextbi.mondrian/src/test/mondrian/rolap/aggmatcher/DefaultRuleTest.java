/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/aggmatcher/DefaultRuleTest.java#11 $
 ...
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/rolap/aggmatcher/DefaultRuleTest
 *          .java#11 $
 */
public class DefaultRuleTest extends TestCase {
  ...
  private Recognizer.Matcher getTableMatcher(String tag, String tableName) {
    ...
    if (tableMatch == null) {
      LOGGER.info("tableMatch == null for tag=" + tag + ", tableName=" + tableName);
    }
  ...
  private Recognizer.Matcher getLevelMatcher(String tag, String usagePrefix,
    String hierarchyName, String levelName, String levelColumnName) {
    DefaultDef.AggRule rule = getAggRule(tag);
  ...
  private Recognizer.Matcher getMeasureMatcher(String tag, String measureName,
    String measureColumnName, String aggregateName) {
    DefaultDef.AggRule rule = getAggRule(tag);
   ...
   * posttemplate="_[fF][kK]" charcase="exact" />
   */
  public void testForeignKeyCCCC() {
    ...
    Recognizer.Matcher matcher1 = getForeignKeyMatcher(tag, foreignKeyName1);
    Recognizer.Matcher matcher2 = getForeignKeyMatcher(tag, foreignKeyName2);
    Recognizer.Matcher matcher3 = getForeignKeyMatcher(tag, foreignKeyName3);
  ...
  public void testLevelDefaultOne() {
    ...
    Recognizer.Matcher matcher = getLevelMatcher(tag, usagePrefix, hierarchyName,
  ...
  public void testMeasureDefault() {
    ...
    Recognizer.Matcher matcher = getMeasureMatcher(tag, measureName,
      measureColumnName, aggregateName);
