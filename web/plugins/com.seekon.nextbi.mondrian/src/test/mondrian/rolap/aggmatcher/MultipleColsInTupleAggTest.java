/*
// $Id: //open/mondrian/testsrc/main/mondrian/rolap/aggmatcher/MultipleColsInTupleAggTest.java#7 $
...
/**
 * Testcase for levels that contain multiple columns and are collapsed in the
 * agg table.
 * 
 * @author Will Gorman
 * @version $Id: //open/mondrian/testsrc/main/mondrian/rolap/aggmatcher/
 *          MultipleColsInTupleAggTest.java#7 $
 */
public class MultipleColsInTupleAggTest extends AggTableTestCase {
  ...
  public void testTotal() throws Exception {
    ...
    String mdx2 = "select {[Measures].[Total]} on columns from [Fact] where "
  ...
  public void testTupleSelection() throws Exception {
    ...
    String mdx = "select " + "{[Measures].[Total]} on columns, "
      ...
      + "{[Store].[All Stores]}) on rows " + "from [Fact]";
