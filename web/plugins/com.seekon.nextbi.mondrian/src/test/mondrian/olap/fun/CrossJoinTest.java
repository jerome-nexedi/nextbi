/*
// $Id: //open/mondrian/testsrc/main/mondrian/olap/fun/CrossJoinTest.java#15 $
 ...
 * @version $Id:
 *          //open/mondrian/testsrc/main/mondrian/olap/fun/CrossJoinTest.java#15
 *          $
 * @since Jan 14, 2007
 */
...
public class CrossJoinTest extends FoodMartTestCase {
  ...
  static List<List<Member>> m3 = Arrays.asList(Arrays.<Member> asList(
    new TestMember("k"), new TestMember("l")), Arrays.<Member> asList(
    new TestMember("m"), new TestMember("n")));

  static List<List<Member>> m4 = Arrays.asList(Arrays.<Member> asList(
    new TestMember("U"), new TestMember("V")), Arrays.<Member> asList(
    new TestMember("W"), new TestMember("X")), Arrays.<Member> asList(
    new TestMember("Y"), new TestMember("Z")));

  static final Comparator<List<Member>> memberComparator = new Comparator<List<Member>>() {
  ...
  public void testListTupleListTupleIterCalc() {
    if (!Util.Retrowoven) {
      CrossJoinFunDef.CrossJoinIterCalc calc = crossJoinFunDef.new CrossJoinIterCalc(
  ...
  protected void doTupleTupleIterTest(CrossJoinFunDef.CrossJoinIterCalc calc) {
    ...
    String e = "{[U, V, k, l], [U, V, m, n], [W, X, k, l], "
  ...
  public void testImmutableListTupleListTupleListCalc() {
    CrossJoinFunDef.ImmutableListCalc calc = crossJoinFunDef.new ImmutableListCalc(
      getResolvedFunCall(), null);
  ...
  protected ResolvedFunCall getResolvedFunCall() {
    ...
    Exp[] args = new Exp[0];
    Type returnType = new SetType(new TupleType(
      new Type[] { new MemberType(null, null, null, null),
