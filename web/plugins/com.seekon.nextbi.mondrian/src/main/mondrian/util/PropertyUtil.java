...
public class PropertyUtil {
      ...
      System.out.println("        <Type>"
        + (o instanceof BooleanProperty ? "boolean"
          : o instanceof IntegerProperty ? "int"
            : o instanceof DoubleProperty ? "double" : "String") + "</Type>");
  ...
  private void generate() {
    final File xmlFile = new File("src/main/mondrian/olap", "MondrianProperties.xml");
  ...
  enum Generator {
    JAVA {
      @Override
      void generate(SortedMap<String, PropertyDef> propertyDefinitionMap, File file,
        PrintWriter out) {
        ...
        for (PropertyDef def : propertyDefinitionMap.values()) {
          ...
          out.println("    public transient final " + def.propertyType.className
            + " " + def.name + " =");
      ...
      void generate(SortedMap<String, PropertyDef> propertyDefinitionMap, File file,
        ...
        for (String category : categories) {
          ...
          for (PropertyDef def : propertyDefinitionMap.values()) {
            ...
            out.println("    <tr>");
            out
              .println("<td><code><a href='api/mondrian/olap/MondrianProperties.html#"
    ...
    abstract void generate(SortedMap<String, PropertyDef> propertyDefinitionMap,
  ...
  private static void printComments(PrintWriter out, String offset, String prefix,
    List<String> strings) {
  ...
  private static class PropertyDef {
    ...
    public String defaultHtml() {
      ...
      case INT:
      case DOUBLE:
        return new DecimalFormat("#,###.#").format(new BigDecimal(defaultValue));
      default:
        return defaultValue;
      }
    }
