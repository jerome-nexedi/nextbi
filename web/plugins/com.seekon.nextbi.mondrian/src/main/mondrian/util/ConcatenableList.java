/*
// $Id: //open/mondrian/src/main/mondrian/util/ConcatenableList.java#8 $
 ...
 * @version $Id: //open/mondrian/src/main/mondrian/util/ConcatenableList.java#8
 *          $
 * @since december, 2007
 */
public class ConcatenableList<T> extends AbstractList<T> {
  ...
  /**
   * Performs a load of all elements into memory, removing sequential access
   * advantages.
   */
