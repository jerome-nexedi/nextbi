/*
// $Id: //open/mondrian/src/main/mondrian/rolap/NoCacheMemberReader.java#10 $
...
/**
 * <code>NoCacheMemberReader</code> implements {@link MemberReader} but without
 * doing any kind of caching and avoiding to read all members.
 * 
 * @author jlopez, lcanals
 * @since 06 October, 2007
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/NoCacheMemberReader.java#10
 *          $
 */
public class NoCacheMemberReader implements MemberReader, MemberCache {
  ...
  NoCacheMemberReader(MemberReader source) {
    ...
    if (!source.setCache(this)) {
      throw Util.newInternal("MemberSource (" + source + ", " + source.getClass()
  ...
  public RolapMember getMember(final Object key, final boolean mustCheckCacheStatus) {
  ...
  public List<RolapMember> getMembers() {
    ...
    for (RolapLevel level : levels) {
      List<RolapMember> membersInLevel = getMembersInLevel(level, 0,
        Integer.MAX_VALUE);
  ...
  public List<RolapMember> getMembersInLevel(final RolapLevel level,
    final int startOrdinal, final int endOrdinal) {
  ...
  public List<RolapMember> getMembersInLevel(final RolapLevel level,
    final int startOrdinal, final int endOrdinal, final TupleConstraint constraint) {
    LOGGER.debug("Entering getMembersInLevel");
    return source.getMembersInLevel(level, startOrdinal, endOrdinal, constraint);
  }

  public void getMemberChildren(final RolapMember parentMember,
  ...
  public void getMemberChildren(final RolapMember parentMember,
    final List<RolapMember> children, final MemberChildrenConstraint constraint) {
  ...
  public void getMemberChildren(final List<RolapMember> parentMembers,
    final List<RolapMember> children) {
    MemberChildrenConstraint constraint = sqlConstraintFactory
      .getMemberChildrenConstraint(null);
    getMemberChildren(parentMembers, children, constraint);
  ...
  public RolapMember lookupMember(final List<Id.Segment> uniqueNameParts,
    final boolean failIfNotFound) {
    return RolapUtil.lookupMember(this, uniqueNameParts, failIfNotFound);
  }

  public List<RolapMember> getChildrenFromCache(final RolapMember member,
    final MemberChildrenConstraint constraint) {
    return null;
  }

  public List<RolapMember> getLevelMembersFromCache(final RolapLevel level,
    final TupleConstraint constraint) {
    return null;
  }

  public void putChildren(final RolapMember member,
    final MemberChildrenConstraint constraint, final List<RolapMember> children) {
  }

  public void putChildren(final RolapLevel level, final TupleConstraint constraint,
    final List<RolapMember> children) {
  }
  ...
  public void getMemberRange(final RolapLevel level, final RolapMember startMember,
    final RolapMember endMember, final List<RolapMember> list) {
  ...
  class SiblingIterator {
    ...
    boolean hasNext() {
      return (this.position < this.siblings.size() - 1) || (parentIterator != null)
    ...
    boolean hasPrevious() {
      return (this.position > 0) || (parentIterator != null)
  ...
  public RolapMember getDefaultMember() {
    RolapMember defaultMember = (RolapMember) getHierarchy().getDefaultMember();
   ...
   * 
   * @param result
   *          Children are written here, in order
   * @param members
   *          Members whose children to read
   * @param constraint
  ...
  protected void readMemberChildren(List<RolapMember> members,
    List<RolapMember> result, MemberChildrenConstraint constraint) {
