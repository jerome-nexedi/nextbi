...
/**
 * SegmentBody is the object which contains the cached data of a Segment. They
 * are stored inside a {@link mondrian.spi.SegmentCache} and can be retrieved by
 * a {@link SegmentHeader} key.
 * 
 * <p>
 * The segment body objects are immutable and fully serializable.
 * 
 * @author LBoudreau
 * @version $Id: //open/mondrian/src/main/mondrian/rolap/agg/SegmentBody.java#2
 *          $
 */
