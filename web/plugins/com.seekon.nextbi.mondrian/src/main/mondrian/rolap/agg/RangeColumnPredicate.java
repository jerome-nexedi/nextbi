/*
// $Id: //open/mondrian/src/main/mondrian/rolap/agg/RangeColumnPredicate.java#7 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/rolap/agg/RangeColumnPredicate
 *          .java#7 $
 * @since Nov 26, 2006
 */
public class RangeColumnPredicate extends AbstractColumnPredicate {
   ...
   *          Whether range includes the lower bound; must be false if not
   *          bounded below
   * @param lowerBound
   *          Lower bound, or null if not bounded below
   * @param upperInclusive
   *          Whether range includes the upper bound; must be false if not
   *          bounded above
   * @param upperBound
   *          Upper bound, or null if not bounded above
   */
  public RangeColumnPredicate(RolapStar.Column column, boolean lowerInclusive,
    ValueColumnPredicate lowerBound, boolean upperInclusive,
  ...
  public StarColumnPredicate cloneWithColumn(RolapStar.Column column) {
    return new RangeColumnPredicate(column, lowerInclusive, lowerBound,
