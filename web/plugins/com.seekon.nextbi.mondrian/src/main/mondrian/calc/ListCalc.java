/*
// $Id: //open/mondrian/src/main/mondrian/calc/ListCalc.java#9 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/calc/ListCalc.java#9 $
 * @since Sep 27, 2005
 */
public interface ListCalc extends IterCalc {
   ...
   * {@link ResultStyle#MUTABLE_LIST}. Otherwise, the caller must not modify the
   * list.
   * 
   * @param evaluator
   *          Evaluation context
