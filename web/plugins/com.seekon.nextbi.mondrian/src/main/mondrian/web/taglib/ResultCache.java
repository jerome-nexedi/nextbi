/*
// $Id: //open/mondrian/src/main/mondrian/web/taglib/ResultCache.java#19 $
...
public class ResultCache implements HttpSessionBindingListener {
  ...
  /**
   * Retrieves a cached query. It is identified by its name and the current
   * session. The servletContext parameter is necessary because
  ...
  public Result getResult() {
    if (result == null) {
      ...
      LOGGER.debug("Execute query took " + (t2 - t1) + " millisec");
    }
    return result;
  }
  ...
  public void valueBound(HttpSessionBindingEvent ev) {
    String connectString = servletContext.getInitParameter("connectString");
    ...
    if (this.connection == null) {
      throw new RuntimeException("No ROLAP connection from connectString: "
        + connectString);
    }
  }
