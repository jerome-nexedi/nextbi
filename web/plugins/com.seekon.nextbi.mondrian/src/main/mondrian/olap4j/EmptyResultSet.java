/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/EmptyResultSet.java#7 $
 ...
 * 
 * <p>
 * This class is used to implement {@link java.sql.DatabaseMetaData} methods for
 * querying object types where those object types never have any instances for
 * this particular driver.
 * </p>
 * 
 * <p>
 * This class has sub-classes which implement JDBC 3.0 and JDBC 4.0 APIs; it is
 * instantiated using {@link Factory#newEmptyResultSet}.
 * </p>
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap4j/EmptyResultSet.java#7
 *          $
 * @since May 24, 2007
 */
abstract class EmptyResultSet implements ResultSet, OlapWrapper {
  ...
  EmptyResultSet(MondrianOlap4jConnection olap4jConnection, List<String> headerList,
