/*
// $Id: //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jCellSetMetaData.java#6 $
 ...
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap4j/MondrianOlap4jCellSetMetaData
 *          .java#6 $
 * @since Jun 13, 2007
 */
class MondrianOlap4jCellSetMetaData implements CellSetMetaData {
  ...
  private final NamedList<CellSetAxisMetaData> axesMetaData = new ArrayNamedListImpl<CellSetAxisMetaData>() {
  ...
  MondrianOlap4jCellSetMetaData(MondrianOlap4jStatement olap4jStatement, Query query) {
    ...
    for (final QueryAxis queryAxis : query.getAxes()) {
      axesMetaData.add(new MondrianOlap4jCellSetAxisMetaData(this, queryAxis));
    }
    filterAxisMetaData = new MondrianOlap4jCellSetAxisMetaData(this, query
      .getSlicerAxis());
  }
  ...
  public <T> T unwrap(Class<T> iface) throws SQLException {
    ...
    throw this.olap4jStatement.olap4jConnection.helper
      .createException("does not implement '" + iface + "'");
  }
