/*
// $Id: //open/mondrian/src/main/mondrian/olap/OlapElementBase.java#24 $
 ...
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/OlapElementBase.java#24
 *          $
 * @since 6 August, 2001
 */
public abstract class OlapElementBase implements OlapElement {
  ...
  public boolean equals(Object o) {
    return (o == this) || ((o instanceof OlapElement) && equals((OlapElement) o));
  }

  public boolean equals(OlapElement mdxElement) {
    return mdxElement != null && getClass() == mdxElement.getClass()
  ...
  /**
   * Returns the display name of this catalog element. If no caption is defined,
  ...
  public String getLocalized(LocalizedProperty prop, Locale locale) {
    if (this instanceof Annotated) {
      ...
      final Map<String, Annotation> annotationMap = annotated.getAnnotationMap();
