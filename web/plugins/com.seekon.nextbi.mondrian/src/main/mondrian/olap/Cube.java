/*
// $Id: //open/mondrian/src/main/mondrian/olap/Cube.java#21 $
 ...
 * Cube.
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Cube.java#21 $
 * @author jhyde
 */
public interface Cube extends OlapElement, Annotated {
  ...
  /**
   * Returns Member[]. It builds Member[] by analyzing cellset, which gets
   * created by running mdx sQuery. <code>query</code> has to be in the format
   * of something like "[with calculated members] select *members* on columns
   * from <code>this</code>".
   */
   ...
   * lookup up members. If <code>role</code> is null, the returned schema reader
   * also obeys the access-control profile of role.
   */
   ...
   * 
   * <p>
   * The XML string must be a <code>&lt;CalculatedMember/&gt;</code> element, as
   * defined in <code>Mondrian.xml</code>.
   * 
   * @param xml
   *          XML string
   */
