/*
// $Id: //open/mondrian/src/main/mondrian/olap/type/DecimalType.java#7 $
 ...
 * @author jhyde
 * @since May 3, 2005
 * @version $Id: //open/mondrian/src/main/mondrian/olap/type/DecimalType.java#7
 *          $
 */
public class DecimalType extends NumericType {
   ...
   * 
   * @param precision
   *          Maximum number of decimal digits which a value of this type can
   *          have. Must be greater than zero. Use {@link Integer#MAX_VALUE} if
   *          the precision is unbounded.
   * @param scale
   *          Number of digits to the right of the decimal point.
   */
  public DecimalType(int precision, int scale) {
    super(precision == Integer.MAX_VALUE ? "DecimalType(" + scale + ")"
  ...
  /**
   * Returns the maximum number of decimal digits which a value of this type can
   * have.
   * 
