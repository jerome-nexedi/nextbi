/*
// $Id: //open/mondrian/src/main/mondrian/olap/Property.java#38 $
 ...
 * </ul>
 * 
 * @version $Id: //open/mondrian/src/main/mondrian/olap/Property.java#38 $
 * @author jhyde
 */
public class Property extends EnumeratedValues.BasicValue {

  public enum Datatype {
    TYPE_STRING, TYPE_NUMERIC, TYPE_BOOLEAN, TYPE_DATE, TYPE_TIME, TYPE_TIMESTAMP, TYPE_OTHER
  }
  ...
  /**
   * Definition of the internal property which holds the parsed format string
   * (an object of type {@link Exp}).
   */
  public static final Property FORMAT_EXP = new Property("$format_exp",
    Datatype.TYPE_OTHER, FORMAT_EXP_ORDINAL, true, false, false, null);

  public static final int AGGREGATION_TYPE_ORDINAL = 1;

  /**
   * Definition of the internal property which holds the aggregation type. This
   * is automatically set for stored measures, based upon their SQL aggregation.
   */
  public static final Property AGGREGATION_TYPE = new Property("$aggregation_type",
    Datatype.TYPE_OTHER, AGGREGATION_TYPE_ORDINAL, true, false, false, null);
   ...
   */
  public static final Property NAME = new Property("$name", Datatype.TYPE_STRING,
    NAME_ORDINAL, true, false, false, null);
  ...
  public static final Property CAPTION = new Property("$caption",
    Datatype.TYPE_STRING, CAPTION_ORDINAL, true, false, false, null);

  public static final int CONTRIBUTING_CHILDREN_ORDINAL = 4;

  /**
   * Definition of the internal property which holds, for a member of a
   * parent-child hierarchy, a {@link java.util.List} containing the member's
   * data member and all of its children (including non-visible children).
   * 
   * @deprecated Property is not used and will be removed in mondrian-4.0; use
   *             {@link mondrian.olap.SchemaReader#getParentChildContributingChildren}
   */
  public static final Property CONTRIBUTING_CHILDREN = new Property(
   ...
   * {@link Formula} object.
   */
  public static final Property FORMULA = new Property("$formula",
    Datatype.TYPE_OTHER, FORMULA_ORDINAL, true, false, false, null);
   ...
   */
  public static final Property MEMBER_SCOPE = new Property("$member_scope",
    Datatype.TYPE_OTHER, MEMBER_SCOPE_ORDINAL, true, true, false, null);
   ...
   */
  public static final Property CATALOG_NAME = new Property("CATALOG_NAME",
    Datatype.TYPE_STRING, CATALOG_NAME_ORDINAL, false, true, false,
   ...
   */
  public static final Property SCHEMA_NAME = new Property("SCHEMA_NAME",
    Datatype.TYPE_STRING, SCHEMA_NAME_ORDINAL, false, true, false,
   ...
   */
  public static final Property CUBE_NAME = new Property("CUBE_NAME",
    Datatype.TYPE_STRING, CUBE_NAME_ORDINAL, false, true, false,
  ...
  public static final Property DIMENSION_UNIQUE_NAME = new Property(
    "DIMENSION_UNIQUE_NAME", Datatype.TYPE_STRING, DIMENSION_UNIQUE_NAME_ORDINAL,
    false, true, false,
   ...
   * hierarchy.
   */
  public static final Property HIERARCHY_UNIQUE_NAME = new Property(
    "HIERARCHY_UNIQUE_NAME", Datatype.TYPE_STRING, HIERARCHY_UNIQUE_NAME_ORDINAL,
    false, true, false,
   ...
   * level.
   */
  public static final Property LEVEL_UNIQUE_NAME = new Property("LEVEL_UNIQUE_NAME",
    Datatype.TYPE_STRING, LEVEL_UNIQUE_NAME_ORDINAL, false, true, false,
   ...
   */
  public static final Property LEVEL_NUMBER = new Property("LEVEL_NUMBER",
    Datatype.TYPE_STRING, LEVEL_NUMBER_ORDINAL, false, true, false,
   ...
   */
  public static final Property MEMBER_ORDINAL = new Property("MEMBER_ORDINAL",
    Datatype.TYPE_NUMERIC, MEMBER_ORDINAL_ORDINAL, false, true, false,
   ...
   */
  public static final Property MEMBER_NAME = new Property("MEMBER_NAME",
    Datatype.TYPE_STRING, MEMBER_NAME_ORDINAL, false, true, false,
   ...
   * member.
   */
  public static final Property MEMBER_UNIQUE_NAME = new Property(
    "MEMBER_UNIQUE_NAME", Datatype.TYPE_STRING, MEMBER_UNIQUE_NAME_ORDINAL, false,
    true, false, "Required. Unique name of the member. For providers that "
   ...
   */
  public static final Property MEMBER_TYPE = new Property("MEMBER_TYPE",
    Datatype.TYPE_STRING, MEMBER_TYPE_ORDINAL, false, true, false,
   ...
   */
  public static final Property MEMBER_GUID = new Property("MEMBER_GUID",
    Datatype.TYPE_STRING, MEMBER_GUID_ORDINAL, false, true, false,
   ...
   */
  public static final Property MEMBER_CAPTION = new Property("MEMBER_CAPTION",
    Datatype.TYPE_STRING, MEMBER_CAPTION_ORDINAL, false, true, false,
  ...
  public static final Property CHILDREN_CARDINALITY = new Property(
    "CHILDREN_CARDINALITY", Datatype.TYPE_NUMERIC, CHILDREN_CARDINALITY_ORDINAL,
    false, true, false,
   ...
   */
  public static final Property PARENT_LEVEL = new Property("PARENT_LEVEL",
    Datatype.TYPE_NUMERIC, PARENT_LEVEL_ORDINAL, false, true, false,
  ...
  public static final Property PARENT_UNIQUE_NAME = new Property(
    "PARENT_UNIQUE_NAME", Datatype.TYPE_STRING, PARENT_UNIQUE_NAME_ORDINAL, false,
    true, false, "Required. Unique name of the member's parent. NULL is returned "
  ...
  /**
   * Definition of the property which holds the number of parents that this
   * member has. Generally 1, or 0 for root members.
   */
  public static final Property PARENT_COUNT = new Property("PARENT_COUNT",
    Datatype.TYPE_NUMERIC, PARENT_COUNT_ORDINAL, false, true, false,
  ...
  public static final Property DESCRIPTION = new Property("DESCRIPTION",
    Datatype.TYPE_STRING, DESCRIPTION_ORDINAL, false, true, false,
  ...
  public static final Property VISIBLE = new Property("$visible",
    Datatype.TYPE_BOOLEAN, VISIBLE_ORDINAL, true, false, false, null);
   ...
   */
  public static final Property CELL_FORMATTER = new Property("CELL_FORMATTER",
    Datatype.TYPE_STRING, CELL_FORMATTER_ORDINAL, false, true, false,
  ...
  /**
   * Definition of the property which holds the name of the scripting language
   * in which a scripted cell formatter is implemented, e.g. 'JavaScript'.
   * 
   * <p>
   * Despite its name, this is a member property.
   */
  public static final Property CELL_FORMATTER_SCRIPT_LANGUAGE = new Property(
    "CELL_FORMATTER_SCRIPT_LANGUAGE", Datatype.TYPE_STRING,
    CELL_FORMATTER_SCRIPT_LANGUAGE_ORDINAL, false, true, false,
   ...
   * Despite its name, this is a member property.
   */
  public static final Property CELL_FORMATTER_SCRIPT = new Property(
    "CELL_FORMATTER_SCRIPT", Datatype.TYPE_STRING, CELL_FORMATTER_SCRIPT_ORDINAL,
    false, true, false,
    "Name of the class which formats cell values of this member.");
  ...
  public static final Property BACK_COLOR = new Property("BACK_COLOR",
    Datatype.TYPE_STRING, BACK_COLOR_ORDINAL, false, false, true,
  ...
  public static final Property CELL_EVALUATION_LIST = new Property(
    "CELL_EVALUATION_LIST", Datatype.TYPE_STRING, CELL_EVALUATION_LIST_ORDINAL,
    false, false, true,
  ...
  public static final Property CELL_ORDINAL = new Property("CELL_ORDINAL",
    Datatype.TYPE_NUMERIC, CELL_ORDINAL_ORDINAL, false, false, true,
    "The ordinal number of the cell in the dataset.");

  public static final int FORE_COLOR_ORDINAL = 33;

  public static final Property FORE_COLOR = new Property("FORE_COLOR",
    Datatype.TYPE_STRING, FORE_COLOR_ORDINAL, false, false, true,
  ...
  public static final Property FONT_NAME = new Property("FONT_NAME",
    Datatype.TYPE_STRING, FONT_NAME_ORDINAL, false, false, true,
    "The font to be used to display the VALUE or FORMATTED_VALUE " + "property.");

  public static final int FONT_SIZE_ORDINAL = 35;

  public static final Property FONT_SIZE = new Property("FONT_SIZE",
    Datatype.TYPE_STRING, FONT_SIZE_ORDINAL, false, false, true,
    "Font size to be used to display the VALUE or FORMATTED_VALUE " + "property.");

  public static final int FONT_FLAGS_ORDINAL = 36;

  public static final Property FONT_FLAGS = new Property("FONT_FLAGS",
    Datatype.TYPE_NUMERIC, FONT_FLAGS_ORDINAL, false, false, true,
   ...
   */
  public static final Property FORMATTED_VALUE = new Property("FORMATTED_VALUE",
    Datatype.TYPE_STRING, FORMATTED_VALUE_ORDINAL, false, false, true,
  ...
  /**
   * Definition of the property which holds the format string used to format
   * cell values.
   */
  public static final Property FORMAT_STRING = new Property("FORMAT_STRING",
    Datatype.TYPE_STRING, FORMAT_STRING_ORDINAL, false, false, true,
  ...
  public static final Property NON_EMPTY_BEHAVIOR = new Property(
    "NON_EMPTY_BEHAVIOR", Datatype.TYPE_STRING, NON_EMPTY_BEHAVIOR_ORDINAL, false,
    false, true, "The measure used to determine the behavior of calculated members "
   ...
   */
  public static final Property SOLVE_ORDER = new Property("SOLVE_ORDER",
    Datatype.TYPE_NUMERIC, SOLVE_ORDER_ORDINAL, false, false, true,
   ...
   */
  public static final Property VALUE = new Property("VALUE", Datatype.TYPE_NUMERIC,
    VALUE_ORDINAL, false, true, true, "The unformatted value of the cell.");
   ...
   */
  public static final Property DATATYPE = new Property("DATATYPE",
    Datatype.TYPE_STRING, DATATYPE_ORDINAL, false, false, true,
   ...
   */
  public static final Property DEPTH = new Property("DEPTH", Datatype.TYPE_NUMERIC,
    DEPTH_ORDINAL, true, true, false, "The level depth of a member");
   ...
   */
  public static final Property DISPLAY_INFO = new Property("DISPLAY_INFO",
    Datatype.TYPE_NUMERIC, DISPLAY_INFO_ORDINAL, false, true, false,
    "Display instruction of a member for XML/A");

  public static final int MEMBER_KEY_ORDINAL = 45;

  /**
   * Definition of the property which holds the member key of the current
   * member.
   */
  public static final Property MEMBER_KEY = new Property("MEMBER_KEY",
    Datatype.TYPE_STRING, MEMBER_KEY_ORDINAL, false, true, false, "Member key.");
   ...
   */
  public static final Property KEY = new Property("KEY", Datatype.TYPE_STRING,
    KEY_ORDINAL, false, true, false, "Key.");
   ...
   */
  public static final Property SCENARIO = new Property("$scenario",
    Datatype.TYPE_OTHER, SCENARIO_ORDINAL, true, true, false, null);
   ...
   * client tool may use this folder to display measures in groups. This
   * property has no meaning for other members.
   */
  public static final Property DISPLAY_FOLDER = new Property("DISPLAY_FOLDER",
    Datatype.TYPE_STRING, DISPLAY_FOLDER_ORDINAL, false, true, false,
    "Folder in which to display a measure");

  public static final int LANGUAGE_ORDINAL = 50;

  /**
   * Definition of the property which holds the translation expressed as an
   * LCID. Only valid for property translations.
   */
  public static final Property LANGUAGE = new Property("LANGUAGE",
    Datatype.TYPE_NUMERIC, LANGUAGE_ORDINAL, false, false, true,
   ...
   */
  static final Set<String> FORMAT_PROPERTIES = new HashSet<String>(Arrays.asList(
  ...
  /**
   * Creates a property definition. If ordinal is negative, generates a unique
   * positive ordinal.
   */
  protected Property(String name, Datatype type, int ordinal, boolean internal,
    boolean member, boolean cell, String description) {
  ...
  public static final EnumeratedValues<Property> enumeration = new EnumeratedValues<Property>(
    new Property[] { FORMAT_EXP, AGGREGATION_TYPE, NAME, CAPTION,
      CONTRIBUTING_CHILDREN, FORMULA, CATALOG_NAME, SCHEMA_NAME, CUBE_NAME,
      DIMENSION_UNIQUE_NAME, HIERARCHY_UNIQUE_NAME, LEVEL_UNIQUE_NAME, LEVEL_NUMBER,
      MEMBER_UNIQUE_NAME, MEMBER_NAME, MEMBER_TYPE, MEMBER_GUID, MEMBER_CAPTION,
      MEMBER_ORDINAL, CHILDREN_CARDINALITY, PARENT_LEVEL, PARENT_UNIQUE_NAME,
      PARENT_COUNT, DESCRIPTION, VISIBLE, CELL_FORMATTER, CELL_FORMATTER_SCRIPT,
      CELL_FORMATTER_SCRIPT_LANGUAGE, BACK_COLOR, CELL_EVALUATION_LIST,
      CELL_ORDINAL, FORE_COLOR, FONT_NAME, FONT_SIZE, FONT_FLAGS, FORMAT_STRING,
      FORMATTED_VALUE, NON_EMPTY_BEHAVIOR, SOLVE_ORDER, VALUE, DATATYPE, MEMBER_KEY,
      KEY, SCENARIO, DISPLAY_FOLDER, });
  ...
  static {
    ...
    for (String propertyName : enumeration.getNames()) {
      mapUpperNameToProperties.put(propertyName.toUpperCase(), enumeration.getValue(
        propertyName, true));
    }
