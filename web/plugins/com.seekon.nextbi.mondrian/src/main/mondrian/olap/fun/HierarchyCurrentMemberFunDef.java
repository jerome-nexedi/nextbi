/*
// $Id: //open/mondrian/src/main/mondrian/olap/fun/HierarchyCurrentMemberFunDef.java#8 $
...
/**
 * Definition of the <code>&lt;Hierarchy&gt;.CurrentMember</code> MDX builtin
 * function.
 * 
 * @author jhyde
 * @version $Id:
 *          //open/mondrian/src/main/mondrian/olap/fun/HierarchyCurrentMemberFunDef
 *          .java#8 $
 * @since Mar 23, 2006
 */
public class HierarchyCurrentMemberFunDef extends FunDefBase {
  ...
  private HierarchyCurrentMemberFunDef() {
    super("CurrentMember",
      "Returns the current member along a hierarchy during an iteration.", "pmh");
  }
  ...
  /**
   * Compiled implementation of the Hierarchy.CurrentMember function that uses a
   * fixed hierarchy.
   */
