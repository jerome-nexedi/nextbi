 ...
 * href="http://msdn.microsoft.com/en-us/library/32s6akha(VS.80).aspx">MSDN
 * </a>.
 * 
 * @author jhyde
 * @version $Id: //open/mondrian/src/main/mondrian/olap/fun/vba/Vba.java#20 $
 * @since Dec 31, 2007
 */
public class Vba {
  ...
  @Description("Returns an expression that has been converted to a Variant of subtype "
    + "Boolean.")
        ...
        try {
          ...
          try {
            ...
            throw new InvalidArgumentException("Invalid parameter. "
              ...
              + "formatted correctly (" + String.valueOf(expression) + ")");
          }
        }
      }
    }
  ...
  @Description("Returns the integer portion of a number. If negative, returns the "
  ...
  public static int fix(Object number) {
    if (number instanceof Number) {
      ...
      throw new InvalidArgumentException("Invalid parameter. " + "number parameter "
        + number + " of Int function must be " + "of type number");
    }
  }
  ...
  public static String hex(Object number) {
    if (number instanceof Number) {
      ...
      throw new InvalidArgumentException("Invalid parameter. " + "number parameter "
        + number + " of Hex function must be " + "of type number");
    }
  }
  ...
  /**
   * Equivalent of the {@link #int_} function on the native 'double' type. Not
   * an MDX function.
   * 
   * @param dv
   *          Double value
  ...
  public static String oct(Object number) {
    if (number instanceof Number) {
      ...
      throw new InvalidArgumentException("Invalid parameter. " + "number parameter "
        + number + " of Oct function must be " + "of type number");
    }
  }
  ...
  public static String str(Object number) {
    ...
    if (number instanceof Number) {
      ...
      throw new InvalidArgumentException("Invalid parameter. " + "number parameter "
        + number + " of Str function must be " + "of type number");
    }
  }

  @FunctionName("Val")
  @Signature("Val(string)")
  @Description("Returns the numbers contained in a string as a numeric value of "
    + "appropriate type.")
  ...
  @Description("Returns a Variant (Date) containing a date to which a specified time "
  ...
  public static Date dateAdd(String intervalName, double number, Date date) {
    ...
    if (floor != number) {
      ...
      final long amount = (long) (((double) (ceilMillis - floorMillis)) * (number - floor));
      calendar.add(Calendar.DAY_OF_YEAR, (int) (amount / MILLIS_IN_A_DAY));
      calendar.add(Calendar.MILLISECOND, (int) (amount % MILLIS_IN_A_DAY));
    } else {
      interval.add(calendar, (int) floor);
    }
  ...
  @Description("Returns a Variant (Long) specifying the number of time intervals "
  ...
  public static long dateDiff(String interval, Date date1, Date date2,
    ...
    return _dateDiff(interval, date1, date2, firstDayOfWeek, FirstWeekOfYear
  ...
  @Description("Returns a Variant (Integer) containing the specified part of a given "
    + "date.")
  public static int datePart(String interval, Date date) {
    return _datePart(interval, date, Calendar.SUNDAY, FirstWeekOfYear.vbFirstJan1);
  }
  ...
  public static int datePart(String interval, Date date, int firstDayOfWeek) {
    return _datePart(interval, date, firstDayOfWeek, FirstWeekOfYear.vbFirstJan1);
  }
  ...
  private static int _datePart(String intervalName, Date date, int firstDayOfWeek,
  ...
  @FunctionName("Day")
  @Signature("Day(date)")
  @Description("Returns a Variant (Integer) specifying a whole number between 1 and "
  ...
  @FunctionName("Hour")
  @Signature("Hour(time)")
  @Description("Returns a Variant (Integer) specifying a whole number between 0 and "
  ...
  @FunctionName("Now")
  @Signature("Now()")
  @Description("Returns a Variant (Date) specifying the current date and time "
  ...
  @Description("Returns a Variant (Date) containing the time for a specific hour, "
    + "minute, and second.")
  ...
  @FunctionName("Timer")
  @Signature("Timer()")
  @Description("Returns a Single representing the number of seconds elapsed since "
    + "midnight.")
  ...
  @Description("Returns a Variant (Integer) containing a whole number representing "
    + "the day of the week.")
  ...
  @Description("Returns a Double specifying the depreciation of an asset for a "
  ...
  @Description("Returns a Double specifying the future value of an annuity based on "
  ...
  public static double fV(double rate, double nPer, double pmt, double pv,
    ...
    if (rate == 0) {
      ...
      double r1 = rate + 1;
      return ((1 - Math.pow(r1, nPer)) * (type ? r1 : 1) * pmt) / rate - pv
        * Math.pow(r1, nPer);
    }
  }
  ...
  @Description("Returns a Double specifying the interest payment for a given period "
  ...
  @Description("Returns a Double specifying the internal rate of return for a series "
  ...
  @Description("Returns a Double specifying the modified internal rate of return for "
  ...
  @Description("Returns a Double specifying the number of periods for an annuity "
  ...
  @Description("Returns a Double specifying the net present value of an investment "
  ...
  @Description("Returns a Double specifying the principal payment for a given period "
    + "of an annuity based on periodic, fixed payments and a fixed "
    + "interest rate.")
  ...
  @Description("Returns a Double specifying the payment for an annuity based on "
    + "periodic, fixed payments and a fixed interest rate.")
  ...
  @Description("Returns a Double specifying the present value of an annuity based on "
  ...
  public static double pV(double rate, double nper, double pmt, double fv,
    ...
    if (rate == 0) {
      ...
      double r1 = rate + 1;
      return (((1 - Math.pow(r1, nper)) / rate) * (due ? r1 : 1) * pmt - fv)
        / Math.pow(r1, nper);
    }
  }
  ...
  @Description("Returns a Double specifying the interest rate per period for an "
    + "annuity.")
  ...
  @Description("Returns a Double specifying the straight-line depreciation of an "
  ...
  @Description("Returns a Double specifying the sum-of-years' digits depreciation of "
  ...
  @Description("Returns a Boolean value indicating whether an expression can be "
    + "converted to a date.")
  ...
  @Description("Returns a Boolean value indicating whether an expression is an error "
    + "value.")
  ...
  @Description("Returns a Boolean value indicating whether an optional Variant "
  ...
  @Description("Returns a Boolean value that indicates whether an expression "
  ...
  @Description("Returns a value of the same type that is passed to it specifying the "
  ...
  @Description("Returns an Integer representing the character code corresponding to "
  ...
  @Description("Returns a String containing the character associated with the "
  ...
  @Signature("FormatCurrency(Expression[,NumDigitsAfterDecimal "
    + "[,IncludeLeadingDigit [,UseParensForNegativeNumbers " + "[,GroupDigits]]]])")
  @Description("Returns an expression formatted as a currency value using the "
  ...
  public static String formatCurrency(Object expression, int numDigitsAfterDecimal,
    ...
    return formatCurrency(expression, numDigitsAfterDecimal, includeLeadingDigit,
      -2, -2);
  }
  ...
  @Description("Returns an expression formatted as a currency value using the "
    + "currency symbol defined in the system control panel.")
  public static String formatCurrency(Object expression, int numDigitsAfterDecimal,
    int includeLeadingDigit, int useParensForNegativeNumbers, int groupDigits) {
  ...
  @Signature("FormatNumber(Expression[,NumDigitsAfterDecimal [,IncludeLeadingDigit "
  ...
  public static String formatNumber(Object expression, int numDigitsAfterDecimal,
    int includeLeadingDigit) {
    return formatNumber(expression, numDigitsAfterDecimal, includeLeadingDigit, -1);
  }
  ...
  public static String formatNumber(Object expression, int numDigitsAfterDecimal,
    int includeLeadingDigit, int useParensForNegativeNumbers) {
    return formatNumber(expression, numDigitsAfterDecimal, includeLeadingDigit,
  ...
  @Description("Returns an expression formatted as a number.")
  public static String formatNumber(Object expression,
    int numDigitsAfterDecimal /* default -1 */, int includeLeadingDigit /*
                                                                          * default
                                                                          * usedefault
                                                                          */,
    int useParensForNegativeNumbers /* default UseDefault */, int groupDigits /*
                                                                                * default
                                                                                * UseDefault
                                                                                */) {
  ...
  @Signature("FormatPercent(Expression[,NumDigitsAfterDecimal "
    + "[,IncludeLeadingDigit [,UseParensForNegativeNumbers " + "[,GroupDigits]]]])")
  @Description("Returns an expression formatted as a percentage (multipled by 100) "
  ...
  public static String formatPercent(
    ...
    return formatPercent(expression, numDigitsAfterDecimal, includeLeadingDigit, -1);
  }
  ...
  public static String formatPercent(
    ...
    return formatPercent(expression, numDigitsAfterDecimal, includeLeadingDigit,
      useParensForNegativeNumbers, -1);
  }
  ...
  @Description("Returns a Variant (Long) specifying the position of the first "
  ...
  @FunctionName("InStr")
  @Signature("InStr([start, ]stringcheck, stringmatch[, compare])")
  @Description("Returns the position of an occurrence of one string within "
    + "another.")
  public static int inStr(int start /* default 1 */, String stringCheck,
    String stringMatch) {
  ...
  @Description("Returns the position of an occurrence of one string within "
    + "another.")
  public static int inStr(int start /* default 1 */, String stringCheck,
    String stringMatch, int compare /* default BinaryCompare */) {
  ...
  @Description("Returns a Variant (String) containing a copy of a specified string "
  ...
  @Description("Returns a specified number of characters from the left side of a "
    + "string.")
  ...
  public static String replace(String expression, String find, String replace,
    int start, int count, int compare) {
  ...
  private static String _replace(String expression, String find, String replace,
    int start /* default 1 */, int count /* default -1 */) {
  ...
  @Description("Returns a Variant (String) containing a specified number of "
  ...
  @Description("Returns a Variant (String) consisting of the specified number of "
    + "spaces.")
  ...
  @Description("Returns a Variant (Integer) indicating the result of a string "
    + "comparison.")
  ...
  @Description("Returns a string in which the character order of a specified string "
    + "is reversed.")
  ...
  private enum Interval {
    yyyy("Year", Calendar.YEAR), q("Quarter", -1), m("Month", Calendar.MONTH), y(
      "Day of year", Calendar.DAY_OF_YEAR), d("Day", Calendar.DAY_OF_MONTH), w(
      "Weekday", Calendar.DAY_OF_WEEK), ww("Week", Calendar.WEEK_OF_YEAR), h("Hour",
      Calendar.HOUR_OF_DAY), n("Minute", Calendar.MINUTE), s("Second",
      Calendar.SECOND);
    ...
    int diff(Calendar calendar1, Calendar calendar2, int firstDayOfWeek) {
      ...
      default:
        return floor(calendar1).get(dateField) - floor(calendar2).get(dateField);
      }
    }
