...
public class XMLDocumentWriter {
  ...
  public String write(Node paramNode, String paramString) {
    ...
    case 9:
      ...
      for (localObject2 = ((Document) localObject1).getFirstChild();; localObject2 = ((Node) localObject2)
        .getNextSibling()) {
    ...
    case 10:
      ...
      if (this.out != null)
        this.out.println("<!DOCTYPE " + ((DocumentType) localObject1).getName()
          + ">");
      localStringBuffer.append("<!DOCTYPE "
        + ((DocumentType) localObject1).getName() + ">\n");
      break;
    case 1:
      ...
      localStringBuffer.append(paramString + "<"
        + ((Element) localObject1).getTagName());
      ...
      for (int i = 0; i < ((NamedNodeMap) localObject2).getLength(); ++i) {
        ...
        if (this.out != null)
          this.out.print(" " + localNode.getNodeName() + "='"
            + fixup(localNode.getNodeValue()) + "'");
        localStringBuffer.append(" " + localNode.getNodeName() + "='"
          + fixup(localNode.getNodeValue()) + "'");
      }
      if (this.out != null)
        this.out.println(">");
      ...
      for (Node localNode = ((Element) localObject1).getFirstChild(); localNode != null; localNode = localNode
        .getNextSibling())
    ...
    case 7:
      ...
      if (this.out != null)
        this.out.println(paramString + "<?"
          + ((ProcessingInstruction) localObject1).getTarget() + " "
          + ((ProcessingInstruction) localObject1).getData() + "?>");
      localStringBuffer.append(paramString + "<?"
        + ((ProcessingInstruction) localObject1).getTarget() + " "
        + ((ProcessingInstruction) localObject1).getData() + "?>\n");
      break;
    ...
    case 4:
      ...
      if (this.out != null)
        this.out.println(paramString + "<" + "![CDATA["
          + ((CDATASection) localObject1).getData() + "]]" + ">");
      localStringBuffer.append(paramString + "<![CDATA["
        + ((CDATASection) localObject1).getData() + "]]>\n");
      break;
    case 8:
 ...
 * Qualified Name: com.tensegrity.palo.xmla.XMLDocumentWriter JD-Core Version:
 * 0.5.4
 */