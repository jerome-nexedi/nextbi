...
public abstract class AbstractXMLARequestor {
  private final LinkedHashSet<String> activatedItems = new LinkedHashSet<String>();
  ...
  protected void parseXMLANodeList(NodeList parentNodeList, String connectionName,
        ...
        if (itemNode.getNodeType() == Node.ELEMENT_NODE) {
          for (String item : activatedItems) {
            if (itemNode.getNodeName().equals(item)) {
              ...
              resultMap.put(item, XMLAClient.getTextFromDOMElement(itemNode));
            }
          }
        }
      }
