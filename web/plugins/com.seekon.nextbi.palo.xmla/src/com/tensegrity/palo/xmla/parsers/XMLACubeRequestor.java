...
public class XMLACubeRequestor extends AbstractXMLARequestor {
  ...
  private final ArrayList<XMLACubeInfo> cubeInfos = new ArrayList<XMLACubeInfo>();
  ...
  protected void parseResult(HashMap<String, String> result, String connectionName,
    ...
    XMLACubeInfo cubeInfo = new XMLACubeInfo(cubeName, cubeName, database,
      connectionName, xmlaClient, connection);
    ...
    PropertyInfo pi = connection.getPropertyLoader().load(
