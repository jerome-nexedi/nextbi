 ...
 * 
 * @version $Id: ViewModeController.java,v 1.5 2009/12/17 16:14:20
 *          PhilippBouillon Exp $
 **/
public class ViewModeController extends Controller implements WPaloEvent {
  ...
  public ViewModeController() {
    ...
    registerEventTypes(LOGOUT, OPEN_VIEW_MODE,
      EXPANDED_VIEW_REPORT_STRUCTURE_SECTION, VIEW_REPORT_EVENT);
  }
