...
public interface WPaloService extends RemoteService {
  ...
  List<TreeNode> loadChildren(String sessionId, TreeNode node)
    throws SessionExpiredException, PaloGwtCoreException;

  List<TreeNode> loadHierarchyTree(String sessionId, String hierarchyId,
    String viewId, String axisId, int level) throws SessionExpiredException,
    PaloGwtCoreException;

  List<TreeNode> loadChildren(String sessionId, String parentType, String viewId,
  ...
  XAccount[] loadPaloSuiteAccounts(String sessionId, String link)
  ...
  boolean assignSubsetOrDimension(XDynamicReportFolder folder, XObject subdim,
    XUser user);
