...
/**
 * <code>TreeNode</code> TODO DOCUMENT ME
 * 
 * @version $Id: SimpleTreeNode.java,v 1.1 2010/01/13 08:02:41 PhilippBouillon
 *          Exp $
 **/
public class SimpleTreeNode extends BaseTreeModel<SimpleTreeNode> implements
  ...
  public SimpleTreeNode(SimpleTreeNode parent, String dataObjectType,
    String dataObjectId, String dataObjectName, int childCount, XObject xobj) {
    this.parent = parent;
  ...
  public String get(String key) {
    ...
    if (key.equals("nameAndKids")) {
      return dataObjectChildCount == 0 ? dataObjectName : dataObjectName
        + " <i><font color=\"gray\">(" + dataObjectChildCount + ")</i></font>";
    }
  ...
  public int hashCode() {
    int result = 7 * (dataObjectType == null ? 1 : dataObjectType.hashCode()) + 11
      * (dataObjectId == null ? 1 : dataObjectId.hashCode()) + 17
      * (dataObjectName == null ? 1 : dataObjectName.hashCode()) + 31
      * (parent == null ? 1 : parent.hashCode());
    return result;
  }
  ...
  public boolean equals(Object o) {
    if (o != null && o instanceof SimpleTreeNode) {
      ...
      return (dataObjectType == null ? tn.dataObjectType == null : dataObjectType
        .equals(tn.dataObjectType))
        && (dataObjectId == null ? tn.dataObjectId == null : dataObjectId
          .equals(tn.dataObjectId))
        && (dataObjectName == null ? tn.dataObjectName == null : dataObjectName
          .equals(tn.dataObjectName))
