...
/**
 * <code>WPaloController</code> TODO DOCUMENT ME
 * 
 * @version $Id: WPaloController.java,v 1.13 2010/02/12 13:49:50 PhilippBouillon
 *          Exp $
 **/
public class WPaloController extends Controller {
  ...
  private final void stop(String sessionId) {
    WPaloControllerServiceProvider.getInstance().stop(sessionId,
      new Callback<Void>() {
        public void onFailure(Throwable t) {
