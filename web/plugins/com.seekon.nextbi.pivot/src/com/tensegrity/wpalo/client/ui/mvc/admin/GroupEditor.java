...
public class GroupEditor extends AbstractTabEditor {
  ...
  public final EditorTab[] getEditorTabs() {
    return new EditorTab[] { new GroupPropertiesTab(this),
      new GroupMembersTab(this), new GroupRolesTab(this) };
  }
...
class GroupPropertiesTab extends EditorTab {
  ...
  public void set(XObject input) {
    if (input instanceof XGroup) {
      ...
      if (group != null
        && group.getName() != null
        && (group.getName().equals("admin") || group.getName().equals("editor")
          || group.getName().equals("creator") || group.getName().equals("viewer")
          || group.getName().equals("poweruser") || group.getName().equals(
          "publisher"))) {
...
class GroupRolesTab extends EditorTab {
  ...
  public void set(XObject input) {
    if (input instanceof XGroup) {
      ...
      boolean isAdm = group != null && group.getName() != null
