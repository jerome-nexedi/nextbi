...
/**
 * <code>WPaloAdminServiceAsync</code> TODO DOCUMENT ME
 * 
 * @version $Id: WPaloAdminServiceAsync.java,v 1.14 2010/01/13 08:02:41
 *          PhilippBouillon Exp $
 **/
public interface WPaloAdminServiceAsync {
  ...
  public void getGroups(String sessionId, XUser user,
  ...
  public void getAccounts(String sessionId, XUser user,
    AsyncCallback<XAccount[]> callback);

  public void listAccounts(String sessionId, XUser user,
    AsyncCallback<XAccount[]> callback);

  public void getConnections(String sessionId, XUser user,
  ...
  public void saveXObject(String sessionId, XObject xObj,
