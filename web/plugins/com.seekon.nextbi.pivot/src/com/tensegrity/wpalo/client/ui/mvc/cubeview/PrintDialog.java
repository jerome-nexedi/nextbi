...
public class PrintDialog extends Window {
  ...
  private EnhancedSimpleComboBox<String> addComboBox(LayoutContainer container,
    String title) {
    EnhancedSimpleComboBox<String> comboBox = new EnhancedSimpleComboBox<String>();
  ...
  private final int translateFormat(String f) {
    if (constants.a0().equals(f)) {
      return XPrintConfiguration.FORMAT_A0;
    }
    if (constants.a1().equals(f)) {
      return XPrintConfiguration.FORMAT_A1;
    }
    if (constants.a2().equals(f)) {
      return XPrintConfiguration.FORMAT_A2;
    }
    if (constants.a3().equals(f)) {
      return XPrintConfiguration.FORMAT_A3;
    }
    if (constants.a4().equals(f)) {
      return XPrintConfiguration.FORMAT_A4;
    }
    if (constants.a5().equals(f)) {
      return XPrintConfiguration.FORMAT_A5;
    }
    if (constants.a6().equals(f)) {
      return XPrintConfiguration.FORMAT_A6;
    }
    if (constants.b0().equals(f)) {
      return XPrintConfiguration.FORMAT_B0;
    }
    if (constants.b1().equals(f)) {
      return XPrintConfiguration.FORMAT_B1;
    }
    if (constants.b2().equals(f)) {
      return XPrintConfiguration.FORMAT_B2;
    }
    if (constants.b3().equals(f)) {
      return XPrintConfiguration.FORMAT_B3;
    }
    if (constants.b4().equals(f)) {
      return XPrintConfiguration.FORMAT_B4;
    }
    if (constants.b5().equals(f)) {
      return XPrintConfiguration.FORMAT_B5;
    }
    if (constants.b6().equals(f)) {
      return XPrintConfiguration.FORMAT_B6;
    }
    if (constants.executive().equals(f)) {
      return XPrintConfiguration.FORMAT_EXECUTIVE;
    }
    if (constants.legal().equals(f)) {
      return XPrintConfiguration.FORMAT_LEGAL;
    }
    if (constants.letter().equals(f)) {
      return XPrintConfiguration.FORMAT_LETTER;
    }
  ...
  public XPrintConfiguration getPrintConfiguration() {
    ...
    config.setPaperOrientation(paperOrientation.getValue().getValue().equals(
      constants.portrait()) ? XPrintConfiguration.PORTRAIT
      : XPrintConfiguration.LANDSCAPE);
