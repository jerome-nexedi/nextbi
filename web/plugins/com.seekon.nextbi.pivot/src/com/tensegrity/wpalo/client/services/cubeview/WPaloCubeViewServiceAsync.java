...
/**
 * <code>WPaloCubeViewServiceAsync</code> TODO DOCUMENT ME
 * 
 * @version $Id: WPaloCubeViewServiceAsync.java,v 1.56 2010/04/12 11:13:36
 *          PhilippBouillon Exp $
 **/
public interface WPaloCubeViewServiceAsync {
  ...
  public void updateAndReloadView(String sessionId, XViewModel xViewModel,
    AsyncCallback<XViewModel> cb);

  public void willUpdateView(String sessionId, XViewModel xViewModel,
    AsyncCallback<XLoadInfo> cb);

  public void proceedUpdateView(String sessionId, XViewModel xViewModel,
    AsyncCallback<XViewModel> cb);

  public void proceedUpdateViewWithoutTable(String sessionId, XViewModel xViewModel,
    AsyncCallback<XViewModel> cb);

  public void cancelUpdateView(String sessionId, XViewModel xViewModel,
    AsyncCallback<XViewModel> cb);
  ...
  public void updateAxisHierarchy(String sessionId, XAxisHierarchy hierarchy,
    AsyncCallback<XElement> cb);

  public void willUpdateAxisHierarchy(String sessionId, XAxisHierarchy hierarchy,
    AsyncCallback<XLoadInfo> cb);

  public void willReload(String sessionId, XViewModel xViewModel,
    AsyncCallback<XLoadInfo> cb);

  public void proceedReload(String sessionId, XViewModel xViewModel,
    AsyncCallback<XViewModel> cb);

  public void collapse(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<Void> cb);

  public void willExpand(String sessionId, XAxisItem item, String viewId,
  ...
  public void willCollapse(String sessionId, XAxisItem item, String viewId,
    String axisId, AsyncCallback<XLoadInfo> cb);
  ...
  public void saveView(String sessionId, XViewModel view,
    AsyncCallback<XViewModel> cb);

  public void saveViewAs(String sessionId, String name, XViewModel view,
