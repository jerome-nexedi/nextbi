 ...
 * 
 * @version $Id: CreateDirectLinkDialog.java,v 1.8 2010/04/13 09:45:15
 *          PhilippBouillon Exp $
 **/
public class CreateDirectLinkDialog extends Window {
  ...
  public String getLinkString() {
    ...
    String link = adaptedHostPage + "Palo_Pivot.html?";
    ...
    if (themeBox.getValue() == null) {
      SimpleComboValue<ThemeData> val = themeBox
        .findModel(new ThemeData("n", "blue"));
