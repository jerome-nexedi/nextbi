...
/**
 * <code>DimensionRepositoryRenderer</code> TODO DOCUMENT ME
 * 
 * @version $Id: DimensionRepositoryRenderer.java,v 1.8 2009/12/17 16:14:20
 *          PhilippBouillon Exp $
 **/
public class DimensionRepositoryRenderer extends VerticalContainerRenderer {
  ...
  public final ContainerWidget createWidget(XObject forModel) {
    return new HierarchySelectionWidget(container, (XAxisHierarchy) forModel);
  }
