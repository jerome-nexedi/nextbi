 ...
 * 
 * @version $Id: ModellerController.java,v 1.8 2009/12/17 16:14:20
 *          PhilippBouillon Exp $
 **/
public class ModellerController extends Controller implements WPaloEvent {
  ...
  public ModellerController() {
    ...
    // all admin events...
    registerEventTypes(SELECTED_DIMENSIONS, EDIT_DIMENSION_ITEM, SELECTED_SERVERS,
      EDIT_SERVER_ITEM, EXPANDED_SERVER_SECTION);
  }
