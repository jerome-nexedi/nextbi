...
/**
 * <code>MySqlDbConnection</code> TODO DOCUMENT ME
 * 
 * @version $Id: MySqlDbConnection.java,v 1.3 2009/12/17 16:14:20
 *          PhilippBouillon Exp $
 **/
  ...
  protected final void initialize() {
    ...
    if (connection != null && dbName != null) {
      ...
      try {
        ...
        statement.execute(buildQuery(commands, "createDatabase", dbName));
        statement = connection.createStatement();
