...
/**
 * <code>GroupConverter</code> TODO DOCUMENT ME
 * 
 * @version $Id: GroupConverter.java,v 1.4 2009/12/17 16:14:29 PhilippBouillon
 *          Exp $
 **/
public class GroupConverter extends BaseConverter {
  ...
  // public Object toNative(XObject obj, AuthUser loggedInUser) throws
  ...
  private final Group create(XGroup xGroup, AuthUser loggedInUser)
  ...
  // private final void update(Group group, XGroup xGroup, AuthUser
