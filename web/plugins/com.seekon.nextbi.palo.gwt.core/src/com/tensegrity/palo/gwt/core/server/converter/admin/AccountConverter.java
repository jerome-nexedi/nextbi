...
/**
 * <code>AccountConverter</code> TODO DOCUMENT ME
 * 
 * @version $Id: AccountConverter.java,v 1.4 2010/02/16 13:54:00 PhilippBouillon
 *          Exp $
 **/
public class AccountConverter extends BaseConverter {
  ...
  // public Object toNative(XObject xObj, AuthUser loggedInUser) throws
  ...
  public XObject toXObject(Object nativeObj) {
    ...
    xAccount
      .setConnection((XConnection) XConverter.createX(account.getConnection()));
    return xAccount;
  }

  // private final Account create(XAccount xAccount, AuthUser loggedInUser)
  ...
  // }
  // private final void update(Account account, XAccount xAccount, AuthUser
  // loggedInUser) throws OperationFailedException {
  // AdministrationService adminService =
  // ServiceProvider.getAdministrationService(loggedInUser);
  // adminService.setConnection((PaloConnection)XConverter.getNative(xAccount.getConnection(),
  // loggedInUser), account);
  // adminService.setLoginName(xAccount.getLogin(), account);
  // adminService.setPassword(xAccount.getPassword(), account);
  // adminService.setUser((User)XConverter.getNative(xAccount.getUser(),
  // loggedInUser), account);
  // }
}
