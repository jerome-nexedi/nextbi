...
up.jQuery(function() {
    ...
    var pager;
    var editUrl = "${editUrl}";
    var targetUrl = "<c:url value="/portal/api/assignments/target/${ principalString }.json?includeInherited=true"/>";
    var principalUrl = "<c:url value="/portal/api/assignments/principal/${ principalString }.json?includeInherited=true"/>";
