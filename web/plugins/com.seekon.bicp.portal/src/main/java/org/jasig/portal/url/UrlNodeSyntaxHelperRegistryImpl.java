...
public class UrlNodeSyntaxHelperRegistryImpl implements IUrlNodeSyntaxHelperRegistry {
  ...
  private Map<String, IUrlNodeSyntaxHelper> urlNodeSyntaxHelpers = Collections
    .emptyMap();

  @Autowired
  public void setUrlNodeSyntaxHelpers(
    Collection<IUrlNodeSyntaxHelper> urlNodeSyntaxHelpers) {
    ...
    for (final IUrlNodeSyntaxHelper urlNodeSyntaxHelper : urlNodeSyntaxHelpers) {
      urlNodeSyntaxHelperBuilder.put(urlNodeSyntaxHelper.getName(),
        urlNodeSyntaxHelper);
    }

    this.urlNodeSyntaxHelpers = Collections
      .unmodifiableMap(urlNodeSyntaxHelperBuilder);
  }
   ...
   * 
   * @see
   * org.jasig.portal.url.IUrlNodeSyntaxHelperRegistry#getUrlNodeSyntaxHelper
   * (java.lang.String)
   */
  @Override
  ...
  @Override
  public IUrlNodeSyntaxHelper getCurrentUrlNodeSyntaxHelper(
  ...
  public IUrlNodeSyntaxHelper getUrlNodeSyntaxHelperForStylesheet(
    ...
    if (stylesheetDescriptor == null) {
      throw new IllegalArgumentException("No IStylesheetDescriptor found for id: "
        + stylesheetDescriptorId);
    }

    final String themeUrlSyntaxHelperName = stylesheetDescriptor
