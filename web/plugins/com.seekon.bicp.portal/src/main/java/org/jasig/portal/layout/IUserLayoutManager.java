 ...
 *         href="mailto:pkharchenko@interactivebusiness.com"
 *         ">pkharchenko@interactivebusiness.com"</a>}
...
public interface IUserLayoutManager {
   ...
   * 
   * @param reload
   *          If true the reload will be forced, purging any cached data.
  ...
  /**
   * Obtain a description of a node (channel or a folder) in a given user
   * layout.
   * 
   * @param nodeId
   *          a <code>String</code> channel subscribe id or folder id.
   ...
   * 
   * @param node
   *          an <code>UserLayoutNodeDescription</code> value of a node to be
   *          added (Id doesn't have to be set)
   * @param parentId
   *          a <code>String</code> id of a folder to which the new node
   *          (channel or folder) should be added.
   * @param nextSiblingId
   *          a <code>String</code> an id of a sibling node (channel or folder)
   *          prior to which the new node should be inserted.
   * @return an <code>UserLayoutNodeDescription</code> value with a newly
   *         determined Id.
   * @exception PortalException
   *              if an error occurs
   */
   ...
   * 
   * @param nodeId
   *          a <code>String</code> value of a node Id.
   * @param parentId
   *          a <code>String</code> id of a folder to which the node should be
   *          moved.
   * @param nextSiblingId
   *          a <code>String</code> id of a sibling node (folder or channel)
   *          prior to which the node should be placed. (<code>null</code> to
   *          append at the end)
   ...
   * 
   * @param nodeId
   *          a <code>String</code> id (channel subscribe id or folder id)
   * @return a <code>boolean</code> value noting if the operation was successful
   * @exception PortalException
   *              if an error occurs
   */
   ...
   * 
   * @param node
   *          an <code>UserLayoutNodeDescription</code> value with a valid id.
   * @return a <code>boolean</code> value noting if the operation was successful
   * @exception PortalException
   *              if an error occurs
   */
   ...
   * 
   * @param node
   *          an <code>UserLayoutNodeDescription</code> value describing the
   *          node to be added.
   * @param parentId
   *          a <code>String</code> id of a parent to which the node to be
   *          added.
   * @param nextSiblingId
   *          a <code>String</code> id of a sibling prior to which the node to
   *          be inserted. (<code>null</code> to append at the end)
   ...
   * 
   * @param nodeId
   *          a <code>String</code> id of a node to be moved.
   * @param parentId
   *          a <code>String</code> id of a parent to which the node to be
   *          moved.
   * @param nextSiblingId
   *          a <code>String</code> id of a sibling prior to which the node is
   *          to be inserted (<code>null</code> to append at the end)
   * @return a <code>boolean</code> value
   * @exception PortalException
   *              if an error occurs
   */
   ...
   * 
   * @param node
   *          a <code>IUserLayoutNodeDescription</code> node id.
   * @return a <code>boolean</code> value
   * @exception PortalException
   *              if an error occurs
   */
  ...
  /**
   * Ask manager to output markings at the locations where a given node can be
   * added. The marks will appear next time <code>getUserLayout</code> method is
   * called.
   * 
   * @param node
   *          an <code>UserLayoutNodeDescription</code> value or
   *          <code>null</code> to stop outputting add markings.
   * @exception PortalException
   *              if an error occurs
   */
  ...
  /**
   * Ask manager to output markings at the locations where a given node can be
   * moved. The marks will appear next time <code>getUserLayout</code> method is
   * called.
   * 
   * @param nodeId
   *          a <code>String</code> value or <code>null</code> to stop
   *          outputting move markings.
   * @exception PortalException
   *              if an error occurs
   */
  ...
  /**
   * Returns an Id of a parent user layout node. The user layout root node
   * always has ID= {@link IUserLayout#ROOT_NODE_NAME}
   * 
   * @param nodeId
   ...
   * @param nodeId
   *          a <code>String</code> value
   * @return a <code>String</code> Id value of a next sibling node, or
   ...
   * @param nodeId
   *          a <code>String</code> value
   * @return a <code>String</code> Id value of a previous sibling node, or
   *         <code>null</code> if this is the first sibling.
   * @exception PortalException
   *              if an error occurs
   */
  ...
  /**
   * Return a cache key, uniqly corresponding to the composition and the
   * structure of the user layout.
   * 
   * @return a <code>String</code> value
   * @exception PortalException
   *              if an error occurs
  ...
  /**
   * @deprecated {@link #getUserLayout()} should be used instead. Direct
   *             manipulation of the DOM can cause caching problems and issues
   *             where the layout manager doesn't know about DOM changes. Read
   *             https://lists.wisc.edu/read/messages?id=2167043 for more
   *             information.
   */
  @Deprecated
   ...
   *          The id of the parent folder to look under
   * @param fname
   *          the functional name to lookup
   * @return a <code>String</code> subscription id, null if the fname does not
   *         exist under the specified folder id.
   */
  ...
  /**
   * A factory method to create an empty <code>IUserLayoutNodeDescription</code>
   * instance
   * 
   * @param nodeType
   *          a node type constant from <code>IUserLayoutNodeDescription</code>
   *          interface
