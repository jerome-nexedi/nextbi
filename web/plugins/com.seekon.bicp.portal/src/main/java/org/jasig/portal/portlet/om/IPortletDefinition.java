...
public interface IPortletDefinition extends IBasicEntity, IPortalData {
   ...
   *          The List of PortletPreferences, null clears the preferences but
  ...
  /**
   * @return Optional timeout for action requests in ms, if null
   *         {@link #getTimeout()} should be used, -1 means no timeout.
   */
  public Integer getActionTimeout();

  /**
   * @return Optional timeout for event requests in ms, if null
   *         {@link #getTimeout()} should be used, -1 means no timeout.
   */
  public Integer getEventTimeout();

  /**
   * @return Optional timeout for render requests in ms, if null
   *         {@link #getTimeout()} should be used, -1 means no timeout.
   */
  public Integer getRenderTimeout();

  /**
   * @return Optional timeout for resource requests in ms, if null
   *         {@link #getTimeout()} should be used, -1 means no timeout.
   */
  ...
  /**
   * @param timeout
   *          The default timeout value in ms, -1 means no timeout.
   */
  public void setTimeout(int timeout);

  /**
   * @param actionTimeout
   *          Optional timeout for action requests in ms, if null
   *          {@link #getTimeout()} will be used, -1 means no timeout.
   */
  public void setActionTimeout(Integer actionTimeout);

  /**
   * @param eventTimeout
   *          Optional timeout for event requests in ms, if null
   *          {@link #getTimeout()} will be used, -1 means no timeout.
   */
  ...
  /**
   * @param renderTimeout
   *          Optional timeout for render requests in ms, if null
   *          {@link #getTimeout()} will be used, -1 means no timeout.
   */
   ...
   *          Optional timeout for resource requests in ms, if null
   *          {@link #getTimeout()} will be used, -1 means no timeout.
   */
  ...
  /**
   * Equals must be able to compare against any other {@link IPortletDefinition}
   * and the comparison must only use the fname
   */
  @Override
