 ...
 * @version $Revision$
 */
public abstract class PortletMimeResponseContextImpl extends
  PortletResponseContextImpl implements PortletMimeResponseContext {
  ...
  public PortletMimeResponseContextImpl(PortletContainer portletContainer,
    ...
    IPortalUrlProvider portalUrlProvider, IPortletCookieService portletCookieService) {
    ...
    this.portletOutputHandler = (PortletOutputHandler) containerRequest
      .getAttribute(IPortletRenderer.ATTRIBUTE__PORTLET_OUTPUT_HANDLER);
    Validate.notNull(portletOutputHandler, "No "
      + IPortletRenderer.ATTRIBUTE__PORTLET_OUTPUT_HANDLER
      + " attribute found in request");

    this.cacheControl = (CacheControl) containerRequest
      .getAttribute(IPortletRenderer.ATTRIBUTE__PORTLET_CACHE_CONTROL);
    Validate.notNull(cacheControl, "No "
      + IPortletRenderer.ATTRIBUTE__PORTLET_OUTPUT_HANDLER
      + " attribute found in request");
  }
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletMimeResponseContext#getCacheControl()
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletMimeResponseContext#getCharacterEncoding
   * ()
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletMimeResponseContext#getOutputStream()
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletMimeResponseContext#getPortletURLProvider
  ...
  public PortletURLProvider getPortletURLProvider(TYPE type) {
    ...
    final IPortalUrlBuilder portalUrlBuilder = this.portalUrlProvider
      .getPortalUrlBuilderByPortletWindow(containerRequest, portletWindowId, urlType);
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletMimeResponseContext#setBufferSize(int)
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletMimeResponseContext#setContentType(java
   * .lang.String)
   */
  @Override
