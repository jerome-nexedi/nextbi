...
public class PortletURLProviderImpl implements PortletURLProvider {
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletURLProvider#getPublicRenderParameters()
   */
  @Override
  ...
  @Override
  public TYPE getType() {
    final IPortalUrlBuilder portalUrlBuilder = this.portletUrlBuilder
      .getPortalUrlBuilder();
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletURLProvider#setCacheability(java.lang
   * .String)
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletURLProvider#setPortletMode(javax.portlet
   * .PortletMode)
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletURLProvider#setResourceID(java.lang.String
   * )
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletURLProvider#setWindowState(javax.portlet
   * .WindowState)
   */
  @Override
