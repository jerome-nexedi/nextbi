 ...
 */
@Repository
public class JpaEventAggregationManagementDao extends BaseJpaDao implements
  ...
  public void setTransactionOperations(
    @Qualifier("aggrEvents") TransactionOperations transactionOperations) {
  ...
  public void afterPropertiesSet() throws Exception {
    this.processingTypeParameter = this.createParameterExpression(
      ProcessingType.class, "processingType");
    this.aggregatorTypeParameter = this.createParameterExpression(Class.class,
      "aggregatorType");

    this.findEventAggregatorStatusByProcessingTypeQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<EventAggregatorStatusImpl>>() {
        @Override
        public CriteriaQuery<EventAggregatorStatusImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<EventAggregatorStatusImpl> criteriaQuery = cb
            .createQuery(EventAggregatorStatusImpl.class);
          final Root<EventAggregatorStatusImpl> entityRoot = criteriaQuery
            .from(EventAggregatorStatusImpl.class);
          criteriaQuery.select(entityRoot);
          criteriaQuery.where(cb
            .equal(entityRoot.get(EventAggregatorStatusImpl_.processingType),
    ...
    this.findAllGroupConfigsQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<AggregatedGroupConfigImpl>>() {
        @Override
        public CriteriaQuery<AggregatedGroupConfigImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<AggregatedGroupConfigImpl> criteriaQuery = cb
            .createQuery(AggregatedGroupConfigImpl.class);
          final Root<AggregatedGroupConfigImpl> entityRoot = criteriaQuery
            .from(AggregatedGroupConfigImpl.class);
          criteriaQuery.select(entityRoot);
    ...
    this.findGroupConfigForAggregatorQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<AggregatedGroupConfigImpl>>() {
        @Override
        public CriteriaQuery<AggregatedGroupConfigImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<AggregatedGroupConfigImpl> criteriaQuery = cb
          ...
          entityRoot.fetch(AggregatedGroupConfigImpl_.includedGroups, JoinType.LEFT);
          criteriaQuery.where(cb
            .equal(entityRoot.get(AggregatedGroupConfigImpl_.aggregatorType),
    ...
    this.findAllIntervalConfigsQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<AggregatedIntervalConfigImpl>>() {
        @Override
        public CriteriaQuery<AggregatedIntervalConfigImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<AggregatedIntervalConfigImpl> criteriaQuery = cb
            .createQuery(AggregatedIntervalConfigImpl.class);
          final Root<AggregatedIntervalConfigImpl> entityRoot = criteriaQuery
            .from(AggregatedIntervalConfigImpl.class);
          criteriaQuery.select(entityRoot);
          entityRoot.fetch(AggregatedIntervalConfigImpl_.excludedIntervals,
            JoinType.LEFT);
          entityRoot.fetch(AggregatedIntervalConfigImpl_.includedIntervals,
            JoinType.LEFT);
    ...
    this.findIntervalConfigForAggregatorQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<AggregatedIntervalConfigImpl>>() {
        @Override
        public CriteriaQuery<AggregatedIntervalConfigImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<AggregatedIntervalConfigImpl> criteriaQuery = cb
          ...
          entityRoot.fetch(AggregatedIntervalConfigImpl_.includedIntervals,
            JoinType.LEFT);
          criteriaQuery.where(cb.equal(entityRoot
            .get(AggregatedIntervalConfigImpl_.aggregatorType),
            aggregatorTypeParameter));
    ...
    this.findAllQuarterDetailsQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<QuarterDetailImpl>>() {
        @Override
        public CriteriaQuery<QuarterDetailImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<QuarterDetailImpl> criteriaQuery = cb
            .createQuery(QuarterDetailImpl.class);
          final Root<QuarterDetailImpl> entityRoot = criteriaQuery
            .from(QuarterDetailImpl.class);
          criteriaQuery.select(entityRoot);
          criteriaQuery
            .orderBy(cb.asc(entityRoot.get(QuarterDetailImpl_.quarterId)));

          return criteriaQuery;
        }
      });

    this.findAllAcademicTermDetailsQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<AcademicTermDetailImpl>>() {
        @Override
        public CriteriaQuery<AcademicTermDetailImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<AcademicTermDetailImpl> criteriaQuery = cb
            .createQuery(AcademicTermDetailImpl.class);
          final Root<AcademicTermDetailImpl> entityRoot = criteriaQuery
            .from(AcademicTermDetailImpl.class);
          criteriaQuery.select(entityRoot);
          criteriaQuery.orderBy(cb
            .asc(entityRoot.get(AcademicTermDetailImpl_.start)));

          return criteriaQuery;
        }
      });

    this.deleteAllQuarterDetailsQuery = "DELETE FROM "
      + QuarterDetailImpl.class.getName() + " e ";
  }

  @Override
  public IEventAggregatorStatus getEventAggregatorStatus(
    final ProcessingType processingType, boolean create) {
    final TypedQuery<EventAggregatorStatusImpl> query = this
      .createCachedQuery(findEventAggregatorStatusByProcessingTypeQuery);
    ...
    if (status == null && create) {
      status = this.transactionOperations
        .execute(new TransactionCallback<EventAggregatorStatusImpl>() {
          @Override
          public EventAggregatorStatusImpl doInTransaction(TransactionStatus status) {
            final EventAggregatorStatusImpl eventAggregatorStatus = new EventAggregatorStatusImpl(
              processingType);
  ...
  public void updateEventAggregatorStatus(
  ...
  public AggregatedGroupConfig getDefaultAggregatedGroupConfig() {
    AggregatedGroupConfig groupConfig = this
      .getAggregatedGroupConfig(DEFAULT_AGGREGATOR_TYPE);

    if (groupConfig == null) {
      groupConfig = this.transactionOperations
        .execute(new TransactionCallback<AggregatedGroupConfig>() {
          @Override
  ...
  public Set<AggregatedGroupConfig> getAggregatedGroupConfigs() {
    final TypedQuery<AggregatedGroupConfigImpl> query = this
      .createCachedQuery(this.findAllGroupConfigsQuery);
  ...
  public AggregatedGroupConfig getAggregatedGroupConfig(
    ...
    final TypedQuery<AggregatedGroupConfigImpl> query = this
      .createCachedQuery(this.findGroupConfigForAggregatorQuery);
  ...
  public AggregatedGroupConfig createAggregatedGroupConfig(
    Class<? extends IPortalEventAggregator> aggregatorType) {
    final AggregatedGroupConfig aggregatedGroupConfig = new AggregatedGroupConfigImpl(
      aggregatorType);
  ...
  public Set<AggregatedIntervalConfig> getAggregatedIntervalConfigs() {
    final TypedQuery<AggregatedIntervalConfigImpl> query = this
      .createCachedQuery(this.findAllIntervalConfigsQuery);
  ...
  public AggregatedIntervalConfig getDefaultAggregatedIntervalConfig() {
    AggregatedIntervalConfig intervalConfig = this
      .getAggregatedIntervalConfig(DEFAULT_AGGREGATOR_TYPE);

    if (intervalConfig == null) {
      intervalConfig = this.transactionOperations
        .execute(new TransactionCallback<AggregatedIntervalConfig>() {
          @Override
  ...
  public AggregatedIntervalConfig getAggregatedIntervalConfig(
    Class<? extends IPortalEventAggregator> aggregatorType) {
    final TypedQuery<AggregatedIntervalConfigImpl> query = this
      .createCachedQuery(this.findIntervalConfigForAggregatorQuery);
    query.setParameter(this.aggregatorTypeParameter, aggregatorType);
    return DataAccessUtils.uniqueResult(query.getResultList());
  }
  ...
  public AggregatedIntervalConfig createAggregatedIntervalConfig(
    Class<? extends IPortalEventAggregator> aggregatorType) {
    final AggregatedIntervalConfig aggregatedIntervalConfig = new AggregatedIntervalConfigImpl(
      aggregatorType);
  ...
  @Override
  @Transactional(value = "aggrEventsTransactionManager")
  public void updateAggregatedIntervalConfig(
  ...
  @Override
  @Transactional(value = "aggrEventsTransactionManager")
  public void deleteAggregatedIntervalConfig(
    AggregatedIntervalConfig aggregatedIntervalConfig) {
  ...
  public List<QuarterDetail> getQuartersDetails() {
    final TypedQuery<QuarterDetailImpl> query = this
      .createCachedQuery(this.findAllQuarterDetailsQuery);
    ...
    return this.transactionOperations
      .execute(new TransactionCallback<List<QuarterDetail>>() {

        @Override
        public List<QuarterDetail> doInTransaction(TransactionStatus status) {
          final List<QuarterDetail> standardQuarters = EventDateTimeUtils
  ...
  public void setQuarterDetails(List<QuarterDetail> newQuarterDetails) {
    ...
    final Query deleteAllQuery = this.entityManager
      .createQuery(deleteAllQuarterDetailsQuery);
  ...
  public List<AcademicTermDetail> getAcademicTermDetails() {
    final TypedQuery<AcademicTermDetailImpl> query = this
      .createCachedQuery(this.findAllAcademicTermDetailsQuery);
  ...
  public void addAcademicTermDetails(DateMidnight start, DateMidnight end,
    String termName) {
    // Check if term dates overlap and fail if they do
    final List<AcademicTermDetail> academicTermDetail = this
      .getAcademicTermDetails();
    AcademicTermDetail existingTerm = EventDateTimeUtils.findDateRangeSorted(start,
      academicTermDetail);
    if (existingTerm != null) {
      throw new IllegalArgumentException(
        "Cannot create new term, the start date of " + start
          + " overlaps with existing term: " + existingTerm);
    }

    existingTerm = EventDateTimeUtils.findDateRangeSorted(end.minusDays(1),
      academicTermDetail);
    if (existingTerm != null) {
      throw new IllegalArgumentException("Cannot create new term, the end date of "
        + end + " overlaps with existing term: " + existingTerm);
    }

    final AcademicTermDetailImpl newTerm = new AcademicTermDetailImpl(start, end,
      termName);
