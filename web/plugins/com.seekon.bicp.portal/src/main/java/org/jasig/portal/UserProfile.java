...
/**
 * A user profile associates a user layout with a structure and theme
 * stylesheet.
 * 
...
public class UserProfile implements Serializable, IUserProfile {
  ...
  public UserProfile(int id, String fname, String name, String desc, int layout_id,
    int struct_ss, int theme_ss) {
    this.id = id;
    this.fname = fname;
    pName = name;
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.IUserProfile#setLocaleManager(org.jasig.portal.i18n.
   * LocaleManager)
   */
  @Override
  ...
  public String toString() {
    return "name :" + pName + "," + "description: " + description + ","
      + "layout_id: " + layout_id + "," + "struct_ss_id: " + struct_ss_id + ","
      + "theme_ss_id: " + theme_ss_id + "," + "system: " + system + ","
