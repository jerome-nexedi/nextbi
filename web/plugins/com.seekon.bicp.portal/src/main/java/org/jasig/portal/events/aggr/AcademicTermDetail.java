 ...
 * @version $Revision$
 */
public interface AcademicTermDetail extends DateRange<DateMidnight>,
  Comparable<AcademicTermDetail> {
  /**
  ...
  /**
   * Compare to another {@link AcademicTermDetail}, must sort by
   * {@link #getStart()}
   */
  @Override
