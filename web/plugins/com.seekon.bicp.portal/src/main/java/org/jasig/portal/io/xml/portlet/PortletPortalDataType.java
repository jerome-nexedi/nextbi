...
public class PortletPortalDataType extends AbstractPortalDataType {
   ...
   */
  @Deprecated
  public static final QName LEGACY_CHANNEL_DEFINITION_QNAME = new QName(
    "channel-definition");

  public static final PortalDataKey IMPORT_40_DATA_KEY = new PortalDataKey(
    PORTLET_DEFINITION_QNAME, null, "4.0");
  ...
  public static final PortalDataKey IMPORT_26_DATA_KEY = new PortalDataKey(
    ...
    "classpath://org/jasig/portal/io/import-channel_v2-6.crn", null);
  ...
  public static final PortalDataKey IMPORT_30_DATA_KEY = new PortalDataKey(
    LEGACY_CHANNEL_DEFINITION_QNAME,
    "classpath://org/jasig/portal/io/import-channel_v3-0.crn", null);
  ...
  public static final PortalDataKey IMPORT_31_DATA_KEY = new PortalDataKey(
    LEGACY_CHANNEL_DEFINITION_QNAME,
    "classpath://org/jasig/portal/io/import-channel_v3-1.crn", null);
  ...
  public static final PortalDataKey IMPORT_32_DATA_KEY = new PortalDataKey(
    LEGACY_CHANNEL_DEFINITION_QNAME,
    "classpath://org/jasig/portal/io/import-channel_v3-2.crn", null);

  private static final List<PortalDataKey> PORTAL_DATA_KEYS = Arrays.asList(
    IMPORT_26_DATA_KEY, IMPORT_30_DATA_KEY, IMPORT_31_DATA_KEY, IMPORT_32_DATA_KEY,
    IMPORT_40_DATA_KEY);
