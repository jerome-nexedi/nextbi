...
/**
 * Returns the subscribe ID of a channel having the passed in functional name or
 * null if it can't find such a channel in the layout.
 */
public class PortletSubscribeIdResolver implements INodeIdResolver {
  ...
  /**
   * @param fname
   *          Functional name of portlet whose subscribe id to search for.
   */
