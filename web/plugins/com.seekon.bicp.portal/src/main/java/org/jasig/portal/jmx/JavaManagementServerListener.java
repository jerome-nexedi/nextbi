...
/**
 * A Listener that wraps a {@link JavaManagementServerBean}. Please look at its
 * documentation for the appropriate system properties to set. <br>
 * <br>
 * The ports are configured via &lt;context-param&gt; elements in the web.xml<br>
 * The
 * <code>org.jasig.portal.servlet.JavaManagementServerListener.portOne</code>
 * context-param is <b>required</b>. The
 * <code>org.jasig.portal.servlet.JavaManagementServerListener.portTwo</code>
 * context-param is optional, if not specified portTwo is calculated as portOne
 * + 1. <br>
 * <br>
 * If a failure to start or stop the JMX server should cause the listener to
 * throw an exception set the context-param
 * <code>org.jasig.portal.servlet.JavaManagementServerListener.failOnException</code>
 * to true.
 * 
...
public class JavaManagementServerListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent event) {
    ...
    final String failOnExceptionStr = servletContext
      .getInitParameter(FAIL_ON_EXCEPTION);
    ...
    try {
      ...
      this.logger.warn("init-parameter '" + JMX_RMI_PORT_1
        + "' is required and must contain a number. '" + portOneStr
        + "' is not a valid number.", nfe);
    }
    ...
    try {
      ...
      this.logger.debug("Failed to convert init-parameter '" + JMX_RMI_PORT_2
        + "' with value '" + portTwoStr
