 ...
 * <code>IBasicEntities</code>. Cached entities of a given type are stored in an
 * <code>IEntityCache</code>. The service manages access to these caches and is
 * respon sible for initiating any cache clean up or invalidation.
 * <p>
...
public interface IEntityCachingService {
  ...
  /**
   * Removes the cached entity identified by type and key from the cache and
