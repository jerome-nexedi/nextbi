...
/**
 * Base class for application event readers that simply want to filter or
 * monitor events passing through the reader.
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public abstract class FilteringCharacterEventReader extends
  CharacterEventReaderDelegate {
