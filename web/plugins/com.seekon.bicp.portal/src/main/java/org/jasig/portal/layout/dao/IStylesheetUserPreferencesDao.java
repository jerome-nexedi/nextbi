...
public interface IStylesheetUserPreferencesDao {
  ...
  /**
   * @deprecated Use
   *             {@link #createStylesheetUserPreferences(IStylesheetDescriptor, IPerson, IUserProfile)}
   */
  @Deprecated
  public IStylesheetUserPreferences createStylesheetUserPreferences(
  ...
  /**
   * @deprecated Use
   *             {@link #getStylesheetUserPreferences(IStylesheetDescriptor, IPerson, IUserProfile)}
   */
  @Deprecated
  public IStylesheetUserPreferences getStylesheetUserPreferences(
