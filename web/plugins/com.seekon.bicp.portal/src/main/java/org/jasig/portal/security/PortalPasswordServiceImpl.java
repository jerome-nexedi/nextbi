...
public class PortalPasswordServiceImpl implements IPortalPasswordService {
  ...
  public PortalPasswordServiceImpl() {
    ...
    /*
     * Create an MD5 password encryptor that uses an 8-byte salt with one hash
     * iteration. This encryptor should be capable of validating legacy uPortal
     * passwords.
     */
    ...
    /*
     * Create a stronger SHA-256 password encryptor for setting and validating
     * new passwords.
     */
   ...
   * 
   * @see
   * org.jasig.portal.security.IPortalPasswordService#encryptPassword(java.lang
   * .String)
   */
   ...
   * 
   * @see
   * org.jasig.portal.security.IPortalPasswordService#validatePassword(java.
