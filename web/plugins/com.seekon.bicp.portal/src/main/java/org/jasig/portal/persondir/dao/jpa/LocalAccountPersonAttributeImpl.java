...
@SequenceGenerator(name = "UP_PERSON_ATTR_GEN", sequenceName = "UP_PERSON_ATTR_SEQ", allocationSize = 10)
...
class LocalAccountPersonAttributeImpl implements Serializable {
  ...
  public String toString() {
    return "LocalAccountPersonAttributeImpl [id=" + this.id + ", entityVersion="
      + this.entityVersion + ", name=" + this.name + "]";
  }
}
