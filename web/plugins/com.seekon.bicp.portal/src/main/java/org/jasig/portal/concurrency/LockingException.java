...
/**
 * A <code>LockingException</code> describes a problem that has arisen during an
 * attempt to create or alter an <code>IEntityLock</code>. If the problem occurs
 * in the lock store, the <code>LockingException</code> should wrap an
 * <code>Exception</code> specific to the store, like a
...
public class LockingException extends org.jasig.portal.PortalException {
   ...
   * 
   * @param cause
   *          Throwable that caused the locking problem
   */
   ...
   * 
   * @param msg
   *          message describing nature of locking problem
   */
