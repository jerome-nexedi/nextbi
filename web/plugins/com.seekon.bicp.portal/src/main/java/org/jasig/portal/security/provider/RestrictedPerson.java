...
/**
 * An IPerson object that wraps another IPerson object and prevents access to
 * the underlying sercurity context.
 * 
...
public class RestrictedPerson implements IPerson {
  ...
  /**
   * RestrictedPerson's implementation of getSecurityContext prevents access to
   * the security context by always returning null.
   * 
   * @return null
   */
