...
public class GuestSessionExpirationInterceptor extends HandlerInterceptorAdapter {
  ...
  /**
   * The {@link HttpSession#setMaxInactiveInterval(int)} value to set for guest
   * users. Defaults to 0. If <= 0 no override is done.
   */
  public void setUnauthenticatedUserSessionTimeout(
    int unauthenticatedUserSessionTimeout) {
