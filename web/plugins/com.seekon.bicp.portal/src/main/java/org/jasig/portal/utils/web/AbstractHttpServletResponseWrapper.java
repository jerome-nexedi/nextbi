...
/**
 * A custom HttpServletResponse wrapper that does NOT extend
 * {@link HttpServletResponseWrapper} to ensure the container can not unwrap too
 * far.
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public abstract class AbstractHttpServletResponseWrapper implements
  HttpServletResponse {
