...
public interface IPermission {
  ...
  /**
   * Gets that date that this <code>IPermission</code> should become effective
   * on.
   * 
  ...
  /**
   * Sets the date that this <code>IPermission</code> should become effective
   * on.
   * 
   * @param effective
   *          java.util.Date
  ...
  /**
   * Returns a String representing the <code>IAuthorizationPrincipal</code>
  ...
  /**
   * Sets the principal String representing the
