...
public class PortletDelegationManagerImpl implements IPortletDelegationManager {
  private static final String DELEGATION_REQUEST_MAP_ATTR = PortletDelegationManagerImpl.class
    .getName()
    + ".DELEGATION_REQUEST_MAP";
  ...
  @Override
  public void setDelegationRequest(HttpServletRequest request,
    IPortletWindowId delegatePortletWindowId, DelegationRequest delegationRequest) {
  ...
  @Override
  public DelegationRequest getDelegationRequest(HttpServletRequest request,
  ...
  protected ConcurrentMap<IPortletWindowId, DelegationRequest> getDelegationRequestMap(
    ...
    final ConcurrentMap<IPortletWindowId, DelegationRequest> delegationRequestMap = PortalWebUtils
      .getMapRequestAttribute(request, DELEGATION_REQUEST_MAP_ATTR);
