 ...
 *@version $Revision$
 */
class RemoteUserSecurityContext extends ChainingSecurityContext implements
  ISecurityContext {
  ...
  /**
   * Constructor for the RemoteUserSecurityContext object. Store the value of
  ...
  public synchronized void authenticate() throws PortalSecurityException {
    if (this.remoteUser != null) {
      ...
      if (this.remoteUser.equals(newUid)) {
        ...
        log.info("Authentication failed. REMOTE_USER(" + this.remoteUser
          + ") != user(" + newUid + ").");
      }
    } else if (log.isInfoEnabled()) {
      log.info("Authentication failed. REMOTE_USER not set for("
