 ...
 * @version $Revision$
 */
public class LayoutsDataFunction implements
  Function<IPortalDataType, Iterable<? extends IPortalData>>, InitializingBean {
  ...
  public Iterable<? extends IPortalData> apply(IPortalDataType input) {
    ...
    final List<String> userList = this.jdbcOperations.queryForList(
      ...
      Collections.singletonMap("userNames", fragmentOwners), String.class);
