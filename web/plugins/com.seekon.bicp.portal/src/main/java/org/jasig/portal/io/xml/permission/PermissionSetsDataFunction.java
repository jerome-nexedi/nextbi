 ...
 * @version $Revision$
 */
public class PermissionSetsDataFunction implements
  Function<IPortalDataType, Iterable<? extends IPortalData>> {
  private JdbcOperations jdbcOperations;

  private static final String QUERY = "SELECT DISTINCT UPP.OWNER, UPET.ENTITY_TYPE_NAME, UPP.PRINCIPAL_KEY, UPP.ACTIVITY, UPP.PRINCIPAL_TYPE\n"
