...
public class JpaStylesheetUserPreferencesDao extends BaseJpaDao implements
  IStylesheetUserPreferencesDao {
  ...
  public void afterPropertiesSet() throws Exception {
    this.stylesheetDescriptorParameter = this.createParameterExpression(
    ...
    this.profileIdParameter = this.createParameterExpression(Integer.class,
      "profileId");

    this.findAllPreferences = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<StylesheetUserPreferencesImpl>>() {
        @Override
        public CriteriaQuery<StylesheetUserPreferencesImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<StylesheetUserPreferencesImpl> criteriaQuery = cb
            .createQuery(StylesheetUserPreferencesImpl.class);
          final Root<StylesheetUserPreferencesImpl> descriptorRoot = criteriaQuery
            .from(StylesheetUserPreferencesImpl.class);
    ...
    this.findPreferencesByDescriptorUserProfileQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<StylesheetUserPreferencesImpl>>() {
        @Override
        public CriteriaQuery<StylesheetUserPreferencesImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<StylesheetUserPreferencesImpl> criteriaQuery = cb
          ...
          criteriaQuery.select(descriptorRoot);
          addFetches(descriptorRoot);
          criteriaQuery.where(cb.and(cb.equal(descriptorRoot
            .get(StylesheetUserPreferencesImpl_.userId), userIdParameter), cb.equal(
            descriptorRoot.get(StylesheetUserPreferencesImpl_.stylesheetDescriptor),
            stylesheetDescriptorParameter), cb.equal(descriptorRoot
            .get(StylesheetUserPreferencesImpl_.profileId), profileIdParameter)));

          return criteriaQuery;
        }
      });

    this.findAllPreferencesForUser = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<StylesheetUserPreferencesImpl>>() {
        @Override
        public CriteriaQuery<StylesheetUserPreferencesImpl> apply(CriteriaBuilder cb) {
          final CriteriaQuery<StylesheetUserPreferencesImpl> criteriaQuery = cb
          ...
          criteriaQuery.select(descriptorRoot);
          addFetches(descriptorRoot);
          criteriaQuery.where(cb.equal(descriptorRoot
            .get(StylesheetUserPreferencesImpl_.userId), userIdParameter));
  ...
  public List<? extends IStylesheetUserPreferences> getStylesheetUserPreferencesForUser(
    int personId) {
    final TypedQuery<StylesheetUserPreferencesImpl> query = this
      .createCachedQuery(this.findAllPreferencesForUser);
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.layout.dao.IStylesheetUserPreferencesDao#
   * createStylesheetUserPreferences
   * (org.jasig.portal.layout.om.IStylesheetDescriptor,
   * org.jasig.portal.security.IPerson, org.jasig.portal.UserProfile)
   */
  @Transactional
  @Override
  public IStylesheetUserPreferences createStylesheetUserPreferences(
    ...
    final StylesheetUserPreferencesImpl stylesheetUserPreferences = new StylesheetUserPreferencesImpl(
      stylesheetDescriptor, userId, profileId);
   ...
   * 
   * @seeorg.jasig.portal.layout.dao.IStylesheetUserPreferencesDao#
   * getStylesheetUserPreferences(int)
   */
  @Override
   ...
   * 
   * @seeorg.jasig.portal.layout.dao.IStylesheetUserPreferencesDao#
   * getStylesheetUserPreferences(long, org.jasig.portal.security.IPerson,
   * org.jasig.portal.UserProfile)
   */
  @Override
  public IStylesheetUserPreferences getStylesheetUserPreferences(
    IStylesheetDescriptor stylesheetDescriptor, IPerson person, IUserProfile profile) {
    return this.getStylesheetUserPreferences(stylesheetDescriptor, person.getID(),
  ...
  public IStylesheetUserPreferences getStylesheetUserPreferences(
    ...
    final TypedQuery<StylesheetUserPreferencesImpl> query = this
      .createCachedQuery(findPreferencesByDescriptorUserProfileQuery);
    query.setParameter(this.stylesheetDescriptorParameter,
   ...
   * 
   * @seeorg.jasig.portal.layout.dao.IStylesheetUserPreferencesDao#
   * storeStylesheetUserPreferences
   * (org.jasig.portal.layout.om.IStylesheetUserPreferences)
   */
  @Transactional
  @Override
