...
class StylesheetUserPreferencesImpl implements IStylesheetUserPreferences {
  ...
  @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
  @Fetch(FetchMode.JOIN)
  private final Map<String, LayoutNodeAttributesImpl> layoutAttributes = new LinkedHashMap<String, LayoutNodeAttributesImpl>(
    0);
  ...
  StylesheetUserPreferencesImpl(IStylesheetDescriptor stylesheetDescriptor,
  ...
  @PrePersist
  @SuppressWarnings("unused")
  // Called by jpa/hibernate via reflection
  private void purgeEmptyLayoutNodes() {
    // Remove layout attribute objects when they have no values left.
    for (final Iterator<LayoutNodeAttributesImpl> layoutNodeAttrsItr = this.layoutAttributes
      .values().iterator(); layoutNodeAttrsItr.hasNext();) {
  ...
  protected LayoutNodeAttributesImpl getLayoutNodeAttributes(String nodeId,
    boolean create) {
  ...
  public String getLayoutAttribute(String nodeId, String name) {
    ...
    final LayoutNodeAttributesImpl layoutAttribute = getLayoutNodeAttributes(nodeId,
      true);
   ...
   * 
   * @see
   * org.jasig.portal.layout.om.IStylesheetUserPreferences#setLayoutAttribute
   ...
   * 
   * @see
   * org.jasig.portal.layout.om.IStylesheetUserPreferences#removeLayoutAttribute
  ...
  public <P extends Populator<String, String>> P populateLayoutAttributes(
    ...
    final LayoutNodeAttributesImpl nodeAttributes = this.layoutAttributes
      .get(nodeId);
  ...
  public String toString() {
    return "StylesheetUserPreferencesImpl [id=" + this.id + ", entityVersion="
      + this.entityVersion + ", stylesheetDescriptor=" + this.stylesheetDescriptor
  ...
  public int hashCode() {
    ...
    result = prime
      * result
      + ((this.stylesheetDescriptor == null) ? 0 : this.stylesheetDescriptor
        .hashCode());
