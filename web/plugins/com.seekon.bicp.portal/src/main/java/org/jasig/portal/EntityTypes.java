...
/**
 * This class provides access to the entity types used by
 * <code>IBasicEntities</code> and the classes in
 * <code>org.jasig.portal.groups</code> and
...
public class EntityTypes {
  ...
  public Class<? extends IBasicEntity> getEntityTypeFromID(Integer id) {
    final List<Class> result = this.jdbcOperations.query(
  ...
  public Integer getEntityIDFromType(Class<? extends IBasicEntity> type) {
    return DataAccessUtils.singleResult(this.jdbcOperations.queryForList(
      "SELECT ENTITY_TYPE_ID FROM UP_ENTITY_TYPE WHERE ENTITY_TYPE_NAME = ?",
      Integer.class, type.getName()));
  }
  ...
  public Iterator<Class> getAllEntityTypes() {
    return this.jdbcOperations.query("SELECT ENTITY_TYPE_NAME FROM UP_ENTITY_TYPE",
      CLASS_ROW_MAPPER).iterator();
  }

  @TriggersRemove(cacheName = { "org.jasig.portal.EntityTypes.ALL" }, removeAll = true)
  @Transactional
  public void addEntityTypeIfNecessary(Class<? extends IBasicEntity> newType,
    String description) throws java.lang.Exception {
  ...
  @TriggersRemove(cacheName = { "org.jasig.portal.EntityTypes.CLASS_BY_ID",
    "org.jasig.portal.EntityTypes.ID_BY_CLASS", "org.jasig.portal.EntityTypes.ALL" }, removeAll = true)
  @Transactional
