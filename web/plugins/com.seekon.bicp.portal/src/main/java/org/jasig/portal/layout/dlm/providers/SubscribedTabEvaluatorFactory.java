 ...
 * child elements. The factory will automatically configure evaluators using the
 * ownerID attribute associated with the parent element fragmentDefinition
 * element.
 * 
...
public class SubscribedTabEvaluatorFactory implements EvaluatorFactory {
   ...
   * 
   * @see
   * org.jasig.portal.layout.dlm.EvaluatorFactory#getEvaluator(org.w3c.dom.Node)
   */
