...
public abstract class PortletExecutionEvent extends PortalEvent {
  ...
  PortletExecutionEvent(PortalEventBuilder eventBuilder, String fname,
    long executionTimeNano, Map<String, List<String>> parameters) {
    super(eventBuilder);
  ...
  public String toString() {
    return super.toString() + ", fname=" + this.fname + ", executionTimeNano="
      + this.getExecutionTimeNano() + ", parameters=" + this.parameters.size();
  }
}
