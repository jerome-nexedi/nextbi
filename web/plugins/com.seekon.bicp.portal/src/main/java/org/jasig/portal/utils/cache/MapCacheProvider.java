...
/**
 * Hides a {@link CacheProviderFacade} behind a the {@link Map} interface. Only
 ...
 * </ul>
 * 
 * The {@link #put(Serializable, Object)} and {@link #remove(Object)} methods
 * call {@link #get(Object)} before performing the requested operation to be
 * able to return the 'old' value.
 * 
...
public class MapCacheProvider<K extends Serializable, V> implements Map<K, V> {
   ...
   *          The facade to expose as a Map.
   * @param cachingModel
   *          The cache model to use for storing and retrieving data
   * @param flushModel
   *          The flushing model to use when clearing the cache
   */
