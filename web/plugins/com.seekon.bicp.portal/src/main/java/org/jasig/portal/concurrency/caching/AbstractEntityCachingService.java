...
public abstract class AbstractEntityCachingService implements IEntityCachingService {
   ...
   * 
   * @param entityType
   *          The type to retrieve the cache for
   * @return The cache for the specified type, should never be null.
   * @throws CachingException
   *           If no cache can be found/created for the specified entityType.
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.IEntityCachingService#add(org.jasig.portal
   * .IBasicEntity)
   */
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.IEntityCachingService#get(java.lang.Class,
   * java.lang.String)
   */
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.IEntityCachingService#remove(java.lang.Class,
   * java.lang.String)
   */
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.IEntityCachingService#update(org.jasig.portal
   * .IBasicEntity)
   */
