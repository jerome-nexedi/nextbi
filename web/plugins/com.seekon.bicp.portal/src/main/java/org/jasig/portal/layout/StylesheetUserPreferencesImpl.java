...
/**
 * Stylesheet user preferences setup for memory or serialized storage. All APIs
 * and returned objects are thread safe.
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public class StylesheetUserPreferencesImpl implements IStylesheetUserPreferences,
  Serializable {
  ...
  public StylesheetUserPreferencesImpl(long stylesheetDescriptorId, int userId,
    int profileId) {
  ...
  public String toString() {
    return "StylesheetUserPreferencesImpl [outputProperties="
      + this.outputProperties + ", parameters=" + this.parameters
