...
class PortletUrlBuilder extends AbstractUrlBuilder implements IPortletUrlBuilder {
  ...
  public PortletUrlBuilder(IPortletWindowId portletWindowId,
    IPortalUrlBuilder portalUrlBuilder) {
    Preconditions.checkNotNull(portletWindowId, "IPortletWindowId can not be null");
    Preconditions
      .checkNotNull(portalUrlBuilder, "IPortalUrlBuilder can not be null");
      ...
      new MapConstraint<String, String[]>() {
        ...
        public void checkKeyValue(String key, String[] value) {
          ...
          Validate.noNullElements(value,
            "values can not be null or contain null elements");
        }
      });
  }
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortletUrlBuilder#setCopyCurrentRenderParameters(
   * boolean)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortletUrlBuilder#getCopyCurrentRenderParameters()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.url.IPortletUrlBuilder#setWindowState(javax.portlet.
   * WindowState)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.url.IPortletUrlBuilder#setPortletMode(javax.portlet.
   * PortletMode)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortletUrlBuilder#setResourceId(java.lang.String)
   */
  @Override
  public void setResourceId(String resourceId) {
    Preconditions.checkArgument(this.urlType == UrlType.RESOURCE,
      "UrlType must be %s but was %s", UrlType.RESOURCE, this.urlType);
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortletUrlBuilder#setCacheability(java.lang.String)
   */
  @Override
  ...
  public String toString() {
    return "PortletUrlBuilder [portletWindowId=" + this.portletWindowId
      + ", windowState=" + this.windowState + ", portletMode=" + this.portletMode
      + ", resourceId=" + this.resourceId + ", cacheability=" + this.cacheability
      + ", parameters=" + this.getParameters() + ", publicRenderParameters="
  ...
  public int hashCode() {
    ...
    result = prime * result
      + ((this.cacheability == null) ? 0 : this.cacheability.hashCode());
    result = prime * result
      + ((this.portletMode == null) ? 0 : this.portletMode.hashCode());
    result = prime * result
      + ((this.portletWindowId == null) ? 0 : this.portletWindowId.hashCode());
    result = prime * result
      + ((this.resourceId == null) ? 0 : this.resourceId.hashCode());
    result = prime * result
      + ((this.windowState == null) ? 0 : this.windowState.hashCode());
    return result;
  }
