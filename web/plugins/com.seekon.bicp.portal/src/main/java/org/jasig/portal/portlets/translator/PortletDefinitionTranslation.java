...
/**
 * This domain class represents the original and localized translation of
 * portlet definiton.
 * 
...
class PortletDefinitionTranslation implements Serializable {
   ...
   * 
   * @param locale
   *          locale of translated portlet definition.
   */
   ...
   * 
   * @param original
   *          default translation of portlet definition.
   */
  ...
  /**
   * Set the portlet definition translated into locale specified by
   * {@link #locale}.
   * 
   * @param localized
   *          translated portlet definition.
   */
