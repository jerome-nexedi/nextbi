...
/**
 * Implementation that does reflection on the native request to determine if a
 * {@link PortletMvcView} or a {@link ServletMvcView} should be used.
 * 
...
public class RuntimeMvcViewFactory extends AbstractMvcViewFactory {
  ...
  public RuntimeMvcViewFactory(Expression viewId, FlowViewResolver viewResolver,
   ...
   * 
   * @see
   * org.springframework.webflow.mvc.view.AbstractMvcViewFactory#createMvcView
