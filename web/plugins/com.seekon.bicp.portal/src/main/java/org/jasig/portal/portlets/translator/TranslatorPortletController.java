...
/**
 * This controller simply returns a single JSP page and populates "locales"
 * request attribute by setting it to locales supported by portal. All further
 * interactions are using AJAX calls which are handled by a controllers
 * depending on selected entity type. For example, by selecting "portlet" entity
 * type to translate, {@link PortletEntityTranslationController} will be used.
 * 
