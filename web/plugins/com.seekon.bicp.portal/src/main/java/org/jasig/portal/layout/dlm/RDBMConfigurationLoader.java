 ...
 * {@link FragmentDefinition} objects from the database using JPA/Hibernate. You
 * can enable this feature by setting the <code>ConfigurationLoader.impl</code>
 * property in dlm.xml.
 * 
 * @author awills
 */
