...
public interface IPermissionOwnerDao {
   ...
   * If no matching permission owner can be found, create a new permission owner
   * instance with the supplied functional name.
   * 
   * @Param name Name of the permission owner
   * @param fname
   *          functional name of the desired permission owner
   * @return
   */
  ...
  /**
   * Persist a permission owner to the data layer, creating or updating the
  ...
  /**
   * Retrieve a permission activity under the specified permission owner with
   * the provided activity functional name.
   * 
   * @param ownerId
   *          unique ID of the desired activity's owner
   * @param activityFname
   *          functional name of the desired activity
   * @return
   */
   ...
   * 
   * @param ownerFname
   *          functional name of the desired activity's owner
   * @param activityFname
   *          functional name of the activity itself
   * @return
   */
   ...
   * name, under the specified permission owner. If no matching activity can be
   * found, create a new permission activity instance with the supplied owner
   * and activity functional name.
   * 
   * 
   * @param owner
   *          permission owner
  ...
  /**
   * Persist a permission activity to the data layer, creating or updating the
