...
/**
 * Adds JsonWrapperFilteringCharacterEventReader into the character event reader
 * stream
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public class JsonWrapperFilteringCharacterPipelineComponent extends
  ...
  public PipelineEventReader<CharacterEventReader, CharacterEvent> getEventReader(
    ...
    final JsonWrapperFilteringCharacterEventReader jsonWrapperFilteringCharacterEventReader = new JsonWrapperFilteringCharacterEventReader(
      eventReader);
