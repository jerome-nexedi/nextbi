 ...
 * @version $Revision$
 */
public interface IPerson extends Principal, IAdditionalDescriptor, IBasicEntity,
  Serializable {
  ...
  /**
   * Explicitly set the entity identifier The default implementation enforces a
   * one time setting so that the value can't be changed once explicitly set.
   * 
   * @param ei
   */
