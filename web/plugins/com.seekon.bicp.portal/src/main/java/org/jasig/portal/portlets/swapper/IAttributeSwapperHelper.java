...
public interface IAttributeSwapperHelper {
  /**
   * Portlet preference name to use to specify a List of attributes that will be
   * displayed for the user to work with.
   */
   ...
   * 
   * @param uid
   *          The user name of the user to get the attributes for.
   ...
   * 
   * @param externalContext
   *          The {@link ExternalContext} to get the current user from
   * @param attributeSwapRequest
   *          The swap request with the new attributes
   */
