...
/**
 * Generates a URL string from a {@link IPortalUrlBuilder} or parses a request
 * URL into {@link IPortalRequestInfo}
 * 
...
public interface IUrlSyntaxProvider {
   ...
   *          The URL object to create a URL string from
   * @return A URL to be used in markup or as a redirect. The URL will be
   *         absolute, starting with a / or with a protocol such as http://
   */
