...
public class GoogleCustomSearchService implements IPortalSearchService {
  ...
  public SearchResults getSearchResults(PortletRequest request, SearchRequest query) {
    ...
    final JsonNode googleResponse = this.restOperations.getForObject(
      BASE_SEARCH_URL, JsonNode.class, parameters);
    ...
    for (final Iterator<JsonNode> resultItr = results.getElements(); resultItr
      .hasNext();) {
