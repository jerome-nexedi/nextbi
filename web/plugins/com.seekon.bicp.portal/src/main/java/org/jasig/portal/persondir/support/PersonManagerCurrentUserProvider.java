...
public class PersonManagerCurrentUserProvider implements ICurrentUserProvider {
   ...
   * 
   * @see
   * org.jasig.services.persondir.support.ICurrentUserProvider#getCurrentUserName
   * ()
   */
  public String getCurrentUserName() {
    ...
    try {
      ...
      this.logger
        .warn("No current portal request available, cannot determine current user name.");
      return null;
    }
    ...
    if (person == null) {
      this.logger
        .warn("IPersonManager returned no IPerson for request, cannot determine current user name. "
          + portalRequest);
      return null;
    }
