...
/**
 * Generate random tokens. The default character set is the numbers 2-9 and
 * lower case letters a-z except i, l and o. This is intended to create a set
 * that avoids numbers and letters which can easily be confused with others
...
public final class RandomTokenGenerator {
  private static final char[] DEFAULT_TOKEN_CHARS = new char[] { '2', '3', '4', '5',
    '6', '7', '8', '9', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n',
    'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z' };

  /**
   * The recommended generator, uses its own instance of {@link SecureRandom}
   */
  public static final RandomTokenGenerator INSTANCE = new RandomTokenGenerator(
    new SecureRandom());
   ...
   *          User defined random source
   * @param tokenChars
   *          User defined character set to generate tokens from
   */
  ...
  /**
   * @param tokenChars
   *          User defined character set to generate tokens from, performance
   *          will be better if the length of the array is a power of 2
   */
  ...
  /**
   * Determine the token length required to assure the specified number of bits
   * of randomness
   */
  ...
  /**
   * Determine the number of bits of randomness a token of the specified length
