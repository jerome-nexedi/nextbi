...
/**
 * Used to set the state of the delegate and for the basis of URLs generated by
 * the delegate.
 * 
...
public class DelegationRequest {
  ...
  public int hashCode() {
    ...
    result = prime * result
      + ((this.parentPortletMode == null) ? 0 : this.parentPortletMode.hashCode());
    result = prime * result
      + ((this.parentWindowState == null) ? 0 : this.parentWindowState.hashCode());
    return result;
  }
  ...
  public String toString() {
    return "DelegationRequest [delegateState=" + this.delegateState
      + ", parentWindowState=" + this.parentWindowState + ", parentPortletMode="
      + this.parentPortletMode + ", parentParameters=" + this.parentParameters + "]";
  }
}
