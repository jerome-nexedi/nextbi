 ...
 * 
 * Examples of permission owners might include a subsystem in the portal such as
 * the set of permissions for subscribing to uPortal portlets or a portlet
 ...
 * 
 * The IPermissionOwner interface replaces the IPermissible interface as of the
 * uPortal 3.3 release.
 * 
...
public interface IPermissionOwner {
   ...
   * unique, this identifier should not be expected to be constant over time and
   * may change between uPortal versions due to import/export operations.
   * 
   * @return
   */
  public Long getId();
  ...
  /**
   * Get the unique, unchanging functional name for this permission owner. This
   * identifier should not change over time and should consist of a short,
   * meaningful string.
   * 
   * @return
   */
  ...
  /**
   * Set the set of permission activities to be associated with this permission
   * owner.
   * 
   * @param activities
   */
