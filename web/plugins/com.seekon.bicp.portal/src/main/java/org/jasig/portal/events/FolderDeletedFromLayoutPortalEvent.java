...
public final class FolderDeletedFromLayoutPortalEvent extends LayoutPortalEvent {
  ...
  FolderDeletedFromLayoutPortalEvent(PortalEventBuilder portalEventBuilder,
  ...
  public String toString() {
    return super.toString() + ", oldParentFolderId=" + this.oldParentFolderId
      + ", deletedFolderId=" + this.deletedFolderId + ", deletedFolderName="
