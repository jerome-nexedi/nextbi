...
public class EntitiesRESTController {
   ...
   * </p>
   * 
   * @param groupListHelper
   *          IGroupListHelper instance
   */
  @Autowired
  ...
  public JsonEntityBean findEntity(HttpServletRequest request,
    HttpServletResponse response, @PathVariable("entityType") String entityType,
    @PathVariable("entityId") String entityId) {

    final JsonEntityBean result = groupListHelper.getEntity(entityType, entityId,
      true);
    return result;
  ...
  public Set<JsonEntityBean> doSearch(HttpServletRequest request,
    HttpServletResponse response, @RequestParam("q") String query,
