...
public class PortalEventDaoQueuingEventHandler extends
  QueueingEventHandler<PortalEvent> {
  private IPortalEventDao portalEventDao;

  /**
   * @param portalEventDao
   *          the portalEventDao to set
   */
  @Autowired
   ...
   * 
   * @see
   * org.jasig.portal.events.handlers.QueueingEventHandler#onApplicationEvents
   * (java.lang.Iterable)
   */
  @Override
