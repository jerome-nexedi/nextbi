...
public class ProfileEvaluator extends Evaluator {
  ...
  public boolean isApplicable(IPerson person) {
    ...
    final ApplicationContext applicationContext = ApplicationContextLocator
      .getApplicationContext();
    final IPortalRequestUtils portalRequestUtils = applicationContext
      .getBean(IPortalRequestUtils.class);
    final IProfileMapper profileMapper = applicationContext
      .getBean(IProfileMapper.class);
