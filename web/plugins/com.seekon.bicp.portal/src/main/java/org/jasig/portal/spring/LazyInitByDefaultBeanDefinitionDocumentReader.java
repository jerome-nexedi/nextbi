 ...
 * {@link BeanDefinitionParserDelegate#DEFAULT_LAZY_INIT_ATTRIBUTE} to true,
 * usefull when loading a context during testing or with command line tools.
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public class LazyInitByDefaultBeanDefinitionDocumentReader extends
  ...
  protected BeanDefinitionParserDelegate createHelper(
    ...
    root.setAttribute(BeanDefinitionParserDelegate.DEFAULT_LAZY_INIT_ATTRIBUTE,
      "true");
