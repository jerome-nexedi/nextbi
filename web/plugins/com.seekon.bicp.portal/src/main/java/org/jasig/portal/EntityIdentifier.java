...
public class EntityIdentifier implements Serializable {
  ...
  public boolean equals(Object object) {
    ...
    return new EqualsBuilder().append(this.type, rhs.type).append(this.key, rhs.key)
      .isEquals();
  }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(-646446001, 994968607).append(this.type).append(
      this.key).toHashCode();
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append(
      "type", this.type).append("key", this.key).toString();
  }
}
