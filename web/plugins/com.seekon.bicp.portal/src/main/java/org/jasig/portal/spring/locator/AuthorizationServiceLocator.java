...
/**
 * <p>
 * The factory class for the uPortal reference IAuthorizationService
 * implementation.
 * </p>
 * 
 ...
 */
@Deprecated
public class AuthorizationServiceLocator extends
  AbstractBeanLocator<IAuthorizationService> {
  public static final String BEAN_NAME = "authorizationService";

  private static final Log LOG = LogFactory
    .getLog(AuthorizationServiceLocator.class);
