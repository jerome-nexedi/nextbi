...
class PortletEntityData implements Serializable, IPortletEntityDescriptor {
  ...
  public PortletEntityData(IPortletEntityId portletEntityId,
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletEntityDescriptor#getPortletEntityId
   * ()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.portlet.registry.IPortletEntityDescriptor#
   ...
   * 
   * @see
   * org.jasig.portal.portlet.registry.IPortletEntityDescriptor#getLayoutNodeId
   * ()
   */
  @Override
  ...
  public int hashCode() {
    ...
    result = prime
      * result
      + ((this.portletDefinitionId == null) ? 0 : this.portletDefinitionId
        .hashCode());
    result = prime * result
  ...
  public String toString() {
    return "PortletEntityData [portletEntityId=" + this.portletEntityId
      + ", portletDefinitionId=" + this.portletDefinitionId + ", layoutNodeId="
      + this.layoutNodeId + ", userId=" + this.userId + "]";
  }
}
