...
/**
 * Wraps {@link SessionScope} to provide functionality when no session is
 * available by using a singleton instance.
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public class PortalSessionScope implements Scope {
  public static final String DESTRUCTION_CALLBACK_NAME_PREFIX = PortalSessionScope.class
    .getName()
  ...
  public void registerDestructionCallback(String name, Runnable callback) {
    final HttpSession session = this.getPortalSesion(true);
    final DestructionCallbackBindingListener callbackListener = new DestructionCallbackBindingListener(
      callback);
