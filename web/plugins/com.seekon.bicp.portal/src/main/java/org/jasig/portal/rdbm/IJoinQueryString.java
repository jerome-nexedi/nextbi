...
/**
 * The join query interface defines methods for storing and retrieving queries
 * fragments that will be used for performing joins in SQL.
 * 
...
public interface IJoinQueryString {
   ...
   * @throws SQLException
   *           Will be thrown if no query exists for the key
   */
  public String getQuery(String key) throws SQLException;

  /**
   * Adds a query for the specified key, overwriting and query that was already
   * associated with the key.
   * 
   * @param key
   *          The key to store the query under.
   * @param value
