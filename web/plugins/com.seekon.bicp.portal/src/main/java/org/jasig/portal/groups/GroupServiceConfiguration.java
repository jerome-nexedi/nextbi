...
public class GroupServiceConfiguration {
  ...
  class GroupConfigurationHandler extends org.xml.sax.helpers.DefaultHandler {
    ...
    public void characters(char ch[], int start, int length) {
      if (elementName == null || elementName.equals("service")
  ...
  */
  ...
  public static synchronized GroupServiceConfiguration getConfiguration()
    throws Exception {
  ...
  */
  public String getNodeSeparator() {
    ...
    return (nodeSeparator == null) ? IGroupConstants.NODE_SEPARATOR
  ...
  */
  ...
  protected void parseXml() throws Exception {
    InputSource xmlSource = new InputSource(ResourceLoader.getResourceAsStream(
