 ...
 * @version 1.0
 */
public class UserLayoutFolderDescription extends UserLayoutNodeDescription implements
   ...
   * Returns folder type.
   * 
   * @return an <code>int</code> value corresponding to one of the valid folder
   *         types.
   */
   ...
   * 
   * @param folderType
   *          an <code>int</code> value corresponding to one of the valid folder
   *          types.
   */
