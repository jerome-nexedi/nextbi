...
/**
 * DAO for retrieving information about fragments (pre-formatted tabs) to which
 ...
 */
@Repository
public class JpaUserFragmentSubscriptionDaoImpl extends BaseJpaDao implements
  IUserFragmentSubscriptionDao {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    this.fragmentOwnerParameter = this.createParameterExpression(String.class,
      "fragmentOwner");
    ...
    this.findUserFragmentInfoByPersonQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<UserFragmentSubscriptionImpl>>() {
        ...
        public CriteriaQuery<UserFragmentSubscriptionImpl> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.where(cb.equal(root
            .get(UserFragmentSubscriptionImpl_.userId), userIdParameter));
      ...
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<UserFragmentSubscriptionImpl>>() {
        ...
        public CriteriaQuery<UserFragmentSubscriptionImpl> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.where(cb.and(cb.equal(root
            .get(UserFragmentSubscriptionImpl_.userId), userIdParameter), cb.equal(
    ...
    this.findUsersWithActiveSubscriptionsQuery = this
      .createCriteriaQuery(new Function<CriteriaBuilder, CriteriaQuery<String>>() {
        ...
        public CriteriaQuery<String> apply(CriteriaBuilder cb) {
          ...
          criteriaQuery.where(cb.equal(root
            .get(UserFragmentSubscriptionImpl_.active), true));
  ...
  public IUserFragmentSubscription createUserFragmentInfo(IPerson person,
    ...
    final IUserFragmentSubscription userFragmentInfo = new UserFragmentSubscriptionImpl(
      person, fragmentOwner);
  ...
  public List<IUserFragmentSubscription> getUserFragmentInfo(IPerson person) {
    ...
    final List<UserFragmentSubscriptionImpl> fragmentSubscriptions = query
      .getResultList();
  ...
  public IUserFragmentSubscription getUserFragmentInfo(long userFragmentInfoId) {
    ...
    final UserFragmentSubscriptionImpl userFragmentInfo = this.entityManager.find(
      UserFragmentSubscriptionImpl.class, userFragmentInfoId);
