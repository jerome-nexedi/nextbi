...
class TransientPortletEntity implements IPortletEntity {
  ...
  public TransientPortletEntity(IPortletEntity portletEntity,
    String transientLayoutNodeId) {
  ...
  public int hashCode() {
    ...
    result = prime
      * result
      + ((this.transientLayoutNodeId == null) ? 0 : this.transientLayoutNodeId
        .hashCode());
    result = prime
      * result
      + ((this.delegatePortletEntity.getPortletDefinition() == null) ? 0
  ...
  public boolean equals(Object obj) {
    ...
    if (this.delegatePortletEntity.getPortletDefinition() == null) {
      if (other.getPortletDefinition() != null)
        return false;
    } else if (!this.delegatePortletEntity.getPortletDefinition().equals(
      other.getPortletDefinition()))
      return false;
  ...
  public String toString() {
    return "PortletEntity [" + "portletEntityId="
      + this.delegatePortletEntity.getPortletEntityId() + ", " + "layoutNodeId="
      + this.transientLayoutNodeId + ", " + "userId="
      + this.delegatePortletEntity.getUserId() + ", " + "portletDefinition="
