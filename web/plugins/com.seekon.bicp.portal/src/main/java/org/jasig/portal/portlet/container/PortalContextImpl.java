...
/**
 * Provides basic information about uPortal and features it supports. The class
 * will function with no configuration but no properties, states or modes are
 * set by default.
 * 
...
public class PortalContextImpl implements PortalContext {
   ...
   *          the portalProperties to set, can not be null.
   */
  ...
  /**
   * @param portletModes
   *          the portletModes to set, can not be null.
   */
  ...
  /**
   * @param windowStates
   *          the windowStates to set, can not be null.
   */
