...
public class SingleTextParameterInput extends ParameterInputType implements
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
    ...
    if (!(object instanceof SingleTextParameterInput)) {
      return false;
    }
    if (this == object) {
      return true;
    ...
    final SingleTextParameterInput that = ((SingleTextParameterInput) object);
    {
