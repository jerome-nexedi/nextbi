...
/**
 * Partial implemenation of {@link IJoinQueryString} which provides the
 * implemention of storing and retrieving join queries. It also requires a test
 * query be specified.
 * 
...
public abstract class JoinQueryString implements IJoinQueryString {
   ...
   * 
   * @param testQuery
   *          The query to use to test if joins in the class are supported.
   */
  ...
  /**
   * @see org.jasig.portal.rdbm.IJoinQueryString#addQuery(java.lang.String,
   *      java.lang.String)
   */
