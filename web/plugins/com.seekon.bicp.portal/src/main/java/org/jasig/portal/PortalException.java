...
/**
 * Base portal exception class. Information contained in this class allows
 * ErrorChannel to handle errors gracefully. This class also reports itself to
 * the ProblemsTable whenever it is instantiated. The Problems servlet displays
 * recently reported PortalExceptions.
 * 
...
public class PortalException extends RuntimeException {
  ...
  /**
   * should the user be given an option to reinstantiate the channel in a given
   * session
   */
  boolean reinstantiable = true;

  /**
   * should the user be given an option to retry rendering that same channel
   * instance
   */
  boolean refreshable = true;

  /**
   * True if logging is pending on this exception instance (has not yet been
   * logged but potentially will be). True if all the logging that ought to
   * happen has happened.
   */
  ...
  /**
   * Instantiate a generic PortalException. Instantiating a bare, no-message, no
   * ErrorID, no frills PortalException is pretty anti-social. Wouldn't you
   * rather use a constructor that provides more information?
   */
   ...
   * 
   * @param cause
   *          a <code>Throwable</code> causing this exception
   */
  ...
  /**
   * Creates a new <code>PortalException</code> instance, with a contained text
   * message.
   * 
   * @param msg
   *          describes exceptional condition
   */
  ...
  /**
   * Set if the user should be presented with an option to retry the same
   * operation on the component that has generated the error.
   * 
   * @param refresh
  ...
  /**
   * Set if the user should be presented with an option to reinstantiate the
   * component (channel) that generated the error.
   * 
   * @param reinstantiate
   *          a <code>boolean</code> value
   */
   ...
   * 
   * @return <code>true</code> if the log is pending, otherwise
   *         <code>false</code>
   */
   ...
   * 
   * @param string
   *          - parameter to ErrorID template message.
   */
   ...
   * @param refresh
   *          - whether refresh is appropriate response
   * @param reinstantiate
   *          - whether reinstantiate is appropriate response
   */
   ...
   * @param refresh
   *          - true if refresh is an appropriate response
   * @param reinstantiate
   *          - true if reinstantiate is an appropriate response
   */
  public PortalException(String msg, Throwable cause, boolean refresh,
