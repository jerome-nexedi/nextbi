...
public interface IPermissionActivity extends Comparable<IPermissionActivity> {
   ...
   * This identifier should not change over time and should consist of a short,
   * meaningful string.
   * 
   * @return
   */
  ...
  /**
   * Get the key for the IPermissionTargetProvider implementation associated
   * with this activity. The target provider key is a string that may be used to
   * retrieve an IPermissionTargetProvider instance from an
   * IPermissionTargetProvider registry. This target provider should provide
  ...
  /**
   * Set the key of the IPermissionTargetProvider implementation associated with
   * this activity.
   * 
