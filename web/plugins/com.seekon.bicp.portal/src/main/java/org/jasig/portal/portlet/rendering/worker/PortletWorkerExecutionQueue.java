 ...
 * @version $Revision$
 */
public class PortletWorkerExecutionQueue extends
  QualityOfServiceBlockingQueue<String, PortletExecutionCallable<?>> {
   ...
   * 
   * @see
   * org.jasig.portal.portlet.rendering.QualityOfServiceQueue#getElementKey(
   * java.lang.Object)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.rendering.QualityOfServiceQueue#getNextElementKey
   * ()
   */
  @Override
      ...
      if (!this.keyIterator.hasNext()) {
        ...
        if (reset) {
          throw new IllegalStateException(
            "getNextElementKey() was called but no key could be found that had queued elements: "
              + this.toString());
        }
