...
public class QuarterDetailImpl implements QuarterDetail, Serializable {
  ...
  public DateMidnight getStartDateMidnight(ReadableInstant instant) {
    ...
    if (this.end.isBefore(this.start) && instantMonthDay.isBefore(this.start)
      ...
      return this.start.toDateTime(new DateTime(instant).minusYears(1))
        .toDateMidnight();
    }
  ...
  public DateMidnight getEndDateMidnight(ReadableInstant instant) {
    ...
    if (this.end.isBefore(this.start) && !this.end.isAfter(instantMonthDay)
      ...
      return this.end.toDateTime(new DateTime(instant).plusYears(1))
        .toDateMidnight();
    }
  ...
  public String toString() {
    return "QuarterDetailImpl [quarterId=" + this.quarterId + ", start="
