...
/**
 * Utility class to simplify logic needed in CRN script when importing user
 * profile data
 * 
...
public class ProfileImportHelper {
  ...
  public ProfileImportHelper(IStylesheetDescriptorDao stylesheetDescriptorDao,
    IStylesheetUserPreferencesDao stylesheetUserPreferencesDao,
    long structureStylesheetId, long themeStylesheetId, int personId, int profileId) {

    this.stylesheetUserPreferencesDao = stylesheetUserPreferencesDao;
    this.structureStylesheetDescriptor = stylesheetDescriptorDao
      .getStylesheetDescriptor(structureStylesheetId);
    this.themeStylesheetDescriptor = stylesheetDescriptorDao
      .getStylesheetDescriptor(themeStylesheetId);
  ...
  public void addStructureParameter(String name, String value) {
    if (this.structureStylesheetUserPreferences == null) {
      this.structureStylesheetUserPreferences = this
        .getCreateStylesheetUserPreferences(this.structureStylesheetDescriptor);
    }
  ...
  public void addThemeParameter(String name, String value) {
    if (this.themeStylesheetUserPreferences == null) {
      this.themeStylesheetUserPreferences = this
        .getCreateStylesheetUserPreferences(this.themeStylesheetDescriptor);
    }
  ...
  public void save() {
    if (this.structureStylesheetUserPreferences != null) {
      this.stylesheetUserPreferencesDao
        .storeStylesheetUserPreferences(this.structureStylesheetUserPreferences);
    }

    if (this.themeStylesheetUserPreferences != null) {
      this.stylesheetUserPreferencesDao
        .storeStylesheetUserPreferences(this.themeStylesheetUserPreferences);
    }
  }
  ...
  protected IStylesheetUserPreferences getCreateStylesheetUserPreferences(
    ...
    final IStylesheetUserPreferences stylesheetUserPreferences = this.stylesheetUserPreferencesDao
      .getStylesheetUserPreferences(stylesheetDescriptor, personId, profileId);
