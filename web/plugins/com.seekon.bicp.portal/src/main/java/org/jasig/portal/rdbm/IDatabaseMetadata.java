...
public interface IDatabaseMetadata {
  /**
   * Gets the appropriate {@link IJoinQueryString} implemenation for the
   * database. If {@link #supportsOuterJoins()} returns <code>false</code> this
  ...
  /**
   * Returns <code>true</code> if the database server supports outer joins. The
   * query to use if this returns <code>true</code> can be retrieved from the
   * {@link #getJoinQuery()} method.
   * 
  ...
  /**
   * Returns <code>true</code> if the database server supports prepared
   * statements.
   * 
