...
public abstract class LayoutPortalEvent extends PortalEvent {
  ...
  LayoutPortalEvent(PortalEventBuilder portalEventBuilder, IPerson layoutOwner,
    long layoutId) {
  ...
  /**
   * @return the layoutOwnerPerson, may be null, if so fall back to
   *         {@link #getLayoutOwner()}
   */
  ...
  public String toString() {
    return super.toString() + ", layoutId=" + this.layoutId + ", layoutOwner="
      + this.layoutOwner + ", layoutOwnerPerson=" + this.layoutOwnerPerson;
  }
}
