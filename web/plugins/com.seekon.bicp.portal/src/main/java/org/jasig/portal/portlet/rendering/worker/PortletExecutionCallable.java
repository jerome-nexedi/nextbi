 ...
 * @param <V>
 */
final class PortletExecutionCallable<V> extends FutureTask<V> implements
  Callable<V>, IPortletExecutionContext {
  private final Callable<V> callable;

  private final IPortletExecutionContext portletExecutionContext;

  public PortletExecutionCallable(Callable<V> callable,
    IPortletExecutionContext portletExecutionContext) {
    super(callable);
