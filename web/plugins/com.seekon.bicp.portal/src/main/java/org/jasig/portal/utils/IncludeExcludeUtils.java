...
public final class IncludeExcludeUtils {
  ...
  /**
   * Determines if the specified value is included based on the contents of the
   * include and exclude collections.
   * <p/>
   ...
   */
  public static <T> boolean included(T value, Collection<? extends T> includes,
