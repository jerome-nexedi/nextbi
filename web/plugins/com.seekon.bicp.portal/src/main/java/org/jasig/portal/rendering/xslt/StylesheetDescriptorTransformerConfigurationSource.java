...
/**
 * Exposes transformer parameters from
 * {@link IStylesheetDescriptor#getStylesheetParameterDescriptors()}
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public abstract class StylesheetDescriptorTransformerConfigurationSource extends
  ...
  public final CacheKey getCacheKey(HttpServletRequest request,
    ...
    final PreferencesScope preferencesScope = this
    ...
    final IStylesheetDescriptor stylesheetDescriptor = this.stylesheetUserPreferencesService
      .getStylesheetDescriptor(request, preferencesScope);
