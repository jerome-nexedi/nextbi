 ...
 * 
 * Prior to uPortal 2.5, this class existed in the org.jasig.portal.layout
 * package. It was moved to its present package to reflect that it is part of
 * the Simple Layout Management implementation.
 * 
...
public class SimpleLayout implements IUserLayout {
   ...
   * 
   * @see
   * org.jasig.portal.layout.IUserLayout#findNodeId(javax.xml.xpath.XPathExpression
   * )
   */
  @Override
  public String findNodeId(XPathExpression xpathExpression) throws PortalException {
    try {
      ...
      throw new PortalException("Exception while executing XPathExpression: "
        + xpathExpression, e);
    }
  }
