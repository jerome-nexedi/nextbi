...
/**
 * Utility for caching portlet windows and window data in memory. Ensures a
...
class PortletWindowCache<T extends IPortletWindowDescriptor> {
  ...
  public T storeIfAbsentWindow(IPortletWindowId portletWindowId,
    Function<IPortletWindowId, T> windowCreator) {
  ...
  protected Set<T> getWindowSet(final IPortletEntityId portletEntityId,
    boolean create) {
