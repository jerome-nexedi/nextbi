...
public interface IStylesheetDescriptor extends IPortalData {
  ...
  /**
   * Resource string used to locate the XSLT Stylesheet Must be a valid Spring
   * Resource string
   * http://static.springsource.org/spring/docs/3.0.x/spring-framework
   * -reference/html/resources.html#resources-resource-strings
   */
  ...
  /**
   * The name of the {@link IUrlNodeSyntaxHelper} as it is registered in the
   * {@link IUrlNodeSyntaxHelperRegistry}, can be null if no
   * {@link IUrlNodeSyntaxHelper} is associated with this stylesheet.
   */
  public void setUrlNodeSyntaxHelperName(String urlNodeSyntaxHelperName);

  /**
   * @return The name of the {@link IUrlNodeSyntaxHelper} as it is registered in
   *         the {@link IUrlNodeSyntaxHelperRegistry}, can be null if no
   *         {@link IUrlNodeSyntaxHelper} is associated with this stylesheet.
   */
  public String getUrlNodeSyntaxHelperName();

  /**
   * Output properties to use on the {@link Transformer} for the stylesheet this
  ...
  /**
   * Parameters to use on the {@link Transformer} for the stylesheet this
   * defines The returned Map is read-only
   */
  ...
  /**
   * Attributes to be added to layout elements prior to transformation by the
   * stylesheet this defines The returned Map is read-only
   */
