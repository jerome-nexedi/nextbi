 ...
 * @version $Revision$
 */
public class PortletActionResponseContextImpl extends
  PortletStateAwareResponseContextImpl implements PortletActionResponseContext {
  private final IPortalActionUrlBuilder portalActionUrlBuilder;

  public PortletActionResponseContextImpl(PortletContainer portletContainer,
    ...
    super(portletContainer, portletWindow, containerRequest, containerResponse,
      requestPropertiesManager, portletUrlBuider, portletContextService,
