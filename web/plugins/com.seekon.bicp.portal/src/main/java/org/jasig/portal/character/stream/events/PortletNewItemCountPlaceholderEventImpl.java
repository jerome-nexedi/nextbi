 ...
 * @version $Revision$
 */
public final class PortletNewItemCountPlaceholderEventImpl extends
  PortletPlaceholderEventImpl implements PortletNewItemCountPlaceholderEvent {
  ...
  public String toString() {
    return "PortletNewItemCountPlaceholderEvent [" + "portletWindowId="
