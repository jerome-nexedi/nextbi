...
/**
 * FilenameFilter that uses a Set of regular expressions for testing. The file
 * name must match any one of the patterns
 * 
...
public class AntPatternFileFilter implements FileFilter {
  ...
  public AntPatternFileFilter(boolean acceptDirectories, boolean ignoreHidden,
    String include, Collection<String> excludes) {
  ...
  public boolean accept(File pathname) {
    ...
    try {
      ...
      throw new RuntimeException("Could not determine canonical path of: "
        + pathname, e);
    }
