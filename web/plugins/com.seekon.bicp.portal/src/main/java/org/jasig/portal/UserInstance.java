...
/**
 * A class handling holding all user state information. The class is also
 * reponsible for request processing and orchestrating the entire rendering
 * procedure. (this is a replacement for the good old LayoutBean class)
 * 
...
public class UserInstance implements IUserInstance {
  ...
  public UserInstance(IPerson person, IUserPreferencesManager preferencesManager,
