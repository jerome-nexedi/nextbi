 ...
 * 
 */
public class UserLayoutHelperImpl extends SimpleJdbcDaoSupport implements
  IUserLayoutHelper {
  ...
  /**
   * @param userIdentityStore
   *          the userIdentityStore to set
   */
  @Autowired
  ...
  public void resetUserLayout(final IPersonAttributes personAttributes) {
    ...
    // get the integer uid into the person object without creating any new
    // person data
    ...
    try {
      ...
      // Finally set the layout id to 0. This orphans the existing layout but it
