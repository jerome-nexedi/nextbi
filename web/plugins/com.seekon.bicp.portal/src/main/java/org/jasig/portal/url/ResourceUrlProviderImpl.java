...
public class ResourceUrlProviderImpl implements IPortletResourcePortalUrl {
  ...
  public ResourceUrlProviderImpl(IPortletWindow portletWindow,
   ...
   * 
   * @see
   * org.apache.pluto.container.ResourceURLProvider#setAbsoluteURL(java.lang
   * .String)
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.ResourceURLProvider#setFullPath(java.lang.String
   * )
   */
  @Override
  ...
  public int hashCode() {
    ...
    result = prime * result
      + ((this.portletWindow == null) ? 0 : this.portletWindow.hashCode());
    return result;
  }
