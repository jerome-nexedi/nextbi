...
abstract class AbstractStylesheetDataImpl implements IStylesheetData {
   ...
   * 
   * @see
   * org.jasig.portal.layout.om.IStylesheetData#setDefaultValue(java.lang.String
   * )
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.layout.om.IStylesheetData#setScope(org.jasig.portal.layout
   * .om.IStylesheetData.Scope)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.layout.om.IStylesheetData#setDescription(java.lang.String)
   */
  @Override
  ...
  public String toString() {
    return "AbstractStylesheetDataImpl [entityVersion=" + this.entityVersion
      + ", name=" + this.name + ", defaultValue=" + this.defaultValue + ", scope="
