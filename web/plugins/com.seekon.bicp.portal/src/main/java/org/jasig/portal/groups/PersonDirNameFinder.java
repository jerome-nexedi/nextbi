...
public class PersonDirNameFinder implements IEntityNameFinder {
  ...
  private Map<String, String> names = new ReferenceMap(ReferenceMap.HARD,
   ...
   * 
   * @param pa
   *          DAO to back this PersonDirNameFinder
   */
   ...
   * 
   * @param key
   *          - entity key which in this case is a unique identifier for a user
