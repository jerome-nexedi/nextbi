...
/**
 * Simple Function for use in
 * {@link CernunnosDataExporter#setPortalDataRetriever(Function)} that uses a
 * parameter-less sql query to build a list of IPortalData objects
 * 
 * @author Eric Dalquist
 * @version $Revision$
 */
public class SqlPortalDataFunction implements
  Function<IPortalDataType, Iterable<? extends IPortalData>> {
  ...
  /**
   * @param id
   *          Column column name that contains the id, if null the first column
   *          is used
   */
  ...
  /**
   * @param nameColumn
   *          Column column name that contains the name, if null no name is set
   */
  ...
  /**
   * @param nameColumn
   *          Column column name that contains the description, if null no
   *          description is set
   */
