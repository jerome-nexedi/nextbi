...
public class PermissionManagerImpl implements IPermissionManager {
  ...
  /**
   * This constructor ensures that the PermissionManager will be created with an
   * owner specified
   * 
   * @param newOwner
   *          the new owner
  ...
  /**
   * Retrieve an array of <code>IPermission</code> objects based on the given
   * parameters. Includes inherited <code>Permissions</code>. Any null
   ...
   * <code>IPermissions</code> by the owner of this
  ...
  public IAuthorizationPrincipal[] getAuthorizedPrincipals(String activity,
    ...
    return getAuthorizationService().getAuthorizedPrincipals(getOwner(), activity,
      target);
  }
  ...
  public IPermission[] getPermissions(String activity, String target)
    ...
    return getAuthorizationService().getPermissionsForOwner(getOwner(), activity,
      target);
  }
