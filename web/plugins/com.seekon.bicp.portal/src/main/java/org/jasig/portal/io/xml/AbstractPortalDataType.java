...
public abstract class AbstractPortalDataType implements IPortalDataType {
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.io.xml.IPortalDataType#postProcessPortalDataKey(org.
   * springframework.core.io.Resource, org.jasig.portal.io.xml.PortalDataKey,
   * javax.xml.stream.XMLEventReader)
   */
  @Override
  public Set<PortalDataKey> postProcessPortalDataKey(String systemId,
    PortalDataKey portalDataKey, XMLEventReader reader) {
    final PortalDataKey singlePortalDataKey = this.postProcessSinglePortalDataKey(
      systemId, portalDataKey, reader);
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((this.getTypeId() == null) ? 0 : this.getTypeId().hashCode());
    result = prime
      * result
      + ((this.getDataKeyImportOrder() == null) ? 0 : this.getDataKeyImportOrder()
        .hashCode());
    return result;
  }
  ...
  public String toString() {
    return this.getClass().getSimpleName() + " [QName=" + this.defaultQName
      + ", supportedDataKeys=" + this.getDataKeyImportOrder() + "]";
  }
}
