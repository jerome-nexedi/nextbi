...
public class AuthorizationException extends PortalException {
   ...
   * 
   * @param cause
   *          defines the causing Throwable of the authorization violation.
   */
   ...
   * 
   * @param msg
   *          explains the nature of the attempted authorization violation.
   */
  ...
  /**
   * Instantiate an AuthorizationException with an explanatory message and an
   * underlying Throwable cause.
   * 
   * @param msg
   *          explains the nature of the attempted authorization violation.
   * @param cause
   *          - an underlying cause of this Exception.
   */
   ...
   *          - explanatory message
   * @param refresh
   *          - true if refresh is appropriate response
   * @param reinstantiate
