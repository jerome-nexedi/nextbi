...
/**
 * <p>
 * A simple extension of ChainingSecurityContext that acts merely as a
 * placeholder but considers itself in an "authenticated" state if any of its
 * subcontexts are "authenticated."
 * </p>
 * 
 * @author Shawn Bayern
