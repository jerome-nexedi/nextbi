...
/**
 * Provides APIs for creating, storing and retrieving {@link IPortletDefinition}
 * objects.
 * 
...
public interface IPortletDefinitionDao {
   ...
   *          The portlet definition to store the changes for
  ...
  /**
   * Get a {@link IPortletDefinition} for the specified
   * {@link IPortletDefinitionId}.
   * 
   * @param portletDefinitionId
   *          The id to get the definition for.
