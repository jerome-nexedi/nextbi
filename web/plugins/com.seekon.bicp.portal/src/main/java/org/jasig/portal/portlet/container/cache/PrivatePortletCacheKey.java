...
public class PrivatePortletCacheKey implements Serializable {
  ...
  private int internalHashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((portletEntityId == null) ? 0 : portletEntityId.hashCode());
    result = prime * result
  ...
  public String toString() {
    if (this.publicPortletCacheKey.isRenderHeader()) {
      return "PrivatePortletRenderHeaderCacheKey [sessionId=" + sessionId
        + ", portletWindowId=" + portletWindowId + ", portletEntityId="
        + portletEntityId + ", " + publicPortletCacheKey + "]";
    }
    if (this.publicPortletCacheKey.getResourceId() != null) {
      return "PrivatePortletResourceCacheKey [sessionId=" + sessionId
        + ", portletWindowId=" + portletWindowId + ", portletEntityId="
        + portletEntityId + ", " + publicPortletCacheKey + "]";
    }
    return "PrivatePortletRenderCacheKey [sessionId=" + sessionId
      + ", portletWindowId=" + portletWindowId + ", portletEntityId="
      + portletEntityId + ", " + publicPortletCacheKey + "]";
  }
}