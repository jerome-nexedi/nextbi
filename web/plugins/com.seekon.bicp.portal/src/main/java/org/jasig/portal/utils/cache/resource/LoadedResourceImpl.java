...
public class LoadedResourceImpl<T> implements LoadedResource<T> {
  ...
  public LoadedResourceImpl(T resource, Map<Resource, Long> additionalSources) {
    ...
    if (additionalSources == null) {
      ...
      this.additionalSources = Collections
        .unmodifiableMap(new LinkedHashMap<Resource, Long>(additionalSources));
    }
  }
   ...
   * 
   * @see
   * org.jasig.portal.utils.cache.resource.LoadedResource#getAdditionalSources()
   */
  @Override
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((this.additionalSources == null) ? 0 : this.additionalSources.hashCode());
    result = prime * result
  ...
  public String toString() {
    return "LoadedResourceImpl [resource=" + this.resource + ", additionalSources="
