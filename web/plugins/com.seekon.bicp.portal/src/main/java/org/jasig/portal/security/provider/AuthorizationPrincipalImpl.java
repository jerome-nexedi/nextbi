...
public class AuthorizationPrincipalImpl implements IAuthorizationPrincipal {
  ...
  /**
   * Answers if this <code>IAuthorizationPrincipal</code> has permission to
   * manage this channel.
   * 
   * @return boolean
   * @param channelPublishId
   *          String - the Channel publish ID
   * @exception AuthorizationException
   *              thrown when authorization information could not be retrieved.
   */
  public boolean canManage(String channelPublishId)
   ...
   *              thrown when authorization information could not be retrieved.
   */
  public boolean canRender(String channelPublishId)
    throws org.jasig.portal.AuthorizationException {
   ...
   *              thrown when authorization information could not be retrieved.
   */
  public boolean canSubscribe(String channelPublishId)
    throws org.jasig.portal.AuthorizationException {
  ...
  /**
   * Returns the <code>IPermissions</code> for this
   * <code>IAuthorizationPrincipal</code>, including inherited
  ...
  /**
   * Returns the <code>IPermissions</code> for this
   * <code>IAuthorizationPrincipal</code> for the specified <code>owner</code>,
   * <code>activity</code> and <code>target</code>. Inherited
   * <code>IPermissions</code> are included. Null parameters are ignored, so
   * <code>getPermissions(null, null, null)</code> should retrieve all
  ...
  public IPermission[] getAllPermissions(String owner, String activity, String target)
    throws AuthorizationException {
    return getAuthorizationService().getAllPermissionsForPrincipal(this, owner,
      activity, target);
  }
   ...
   * Returns the <code>IPermissions</code> for this
   * <code>IAuthorizationPrincipal</code> for the specified <code>owner</code>,
   * <code>activity</code> and <code>target</code>. Null parameters are ignored,
   * so <code>getPermissions(null, null, null)</code> should retrieve all
   * <code>IPermissions</code> for an <code>IAuthorizationPrincipal</code>.
   * 
   * @return org.jasig.portal.security.IPermission[]
   * @param owner
  ...
  public IPermission[] getPermissions(String owner, String activity, String target)
    throws AuthorizationException {
    return getAuthorizationService().getPermissionsForPrincipal(this, owner,
      activity, target);
  }
  ...
  /**
   * Answers if this <code>IAuthorizationPrincipal</code> has permission to
   * perform the <code>activity</code> on the <code>target</code>. Params
   * <code>owner</code> and <code>activity</code> must be non-null. If
   * <code>target</code> is null, then the target is not checked.
   * 
   * @return boolean
   * @param owner
   *          String
  ...
  public boolean hasPermission(String owner, String activity, String target)
    throws org.jasig.portal.AuthorizationException {
    return getAuthorizationService().doesPrincipalHavePermission(this, owner,
      activity, target);
  }
  ...
  /**
   * Answers if this <code>IAuthorizationPrincipal</code> has permission to
   * perform the <code>activity</code> on the <code>target</code>, as evaluated
   * by the <code>policy</code>. Params <code>policy</code>, <code>owner</code>
   ...
   */
  public boolean hasPermission(String owner, String activity, String target,
    IPermissionPolicy policy) throws AuthorizationException {
    return getAuthorizationService().doesPrincipalHavePermission(this, owner,
      activity, target, policy);
  }
