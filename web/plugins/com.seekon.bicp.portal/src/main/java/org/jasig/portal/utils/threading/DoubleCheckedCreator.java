...
public abstract class DoubleCheckedCreator<T> {
  ...
  /**
   * @param args
   *          Arguments to use when retrieving the object
   ...
   * @param args
   *          Arguments to use when validating the object
   ...
   * 
   * @param args
   *          Optional arguments to pass to {@link #retrieve(Object...)},
   *          {@link #create(Object...)}, and
   *          {@link #invalid(Object, Object...)}.
