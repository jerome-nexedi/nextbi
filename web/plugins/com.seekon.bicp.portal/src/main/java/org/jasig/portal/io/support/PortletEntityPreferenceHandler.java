...
public class PortletEntityPreferenceHandler {
  ...
  public void setEntityPreference(String fName, String channelSubscribeId,
    Integer userId, LinkedHashMap<String, List<String>> preferencesMap) {
    final IPortletEntity portletEntity = this.getPortletEntity(fName,
      channelSubscribeId, userId);

    // Convert the Map to a List of IPortletPreference objects
    final List<IPortletPreference> portletPreferencesList = new ArrayList<IPortletPreference>(
      preferencesMap.size());
    for (final Entry<String, List<String>> prefEntry : preferencesMap.entrySet()) {
      ...
      final IPortletPreference portletPreference = new PortletPreferenceImpl(
        prefName, false, prefValues.toArray(new String[prefValues.size()]));
  ...
  protected IPortletEntity getPortletEntity(String fName, String layoutNodeId,
    ...
    try {
      portletDefinition = this.portletDefinitionDao
