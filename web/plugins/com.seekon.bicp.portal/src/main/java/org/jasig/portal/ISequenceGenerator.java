 ...
 * 
 * The following methods are devoted to creating and using these counters, which
 * can be used as oids.
 * <p>
 * <code>createCounter(String name)</code> <code>getNextInt()</code>
 * <code>getNextInt(String name)</code> <code>setCounter(String name)</code>
 * <p>
 * ISequenceGenerator inherits the following more general methods from
 * IOIDGenerator, which return Strings:
 * <p>
 * <code>getNext()</code> <code>getNext(String name)</code>
 * <p>
 * 
