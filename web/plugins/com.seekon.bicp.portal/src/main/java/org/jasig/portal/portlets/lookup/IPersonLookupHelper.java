...
public interface IPersonLookupHelper {
  /**
   * Portlet preference name to use to specify a List of attributes displayed in
   * query UI
   */
  ...
  /**
   * Portlet preference name to use to specify a MessageFormat string for search
   * results list
   */
  ...
  /**
   * Portlet preference name to use to specify a list of attributes who's values
   * should be passed to the MessageFormat for the resultsMessage string
   */
  ...
  /**
   * Portlet preference name to use to specify a attributes to display in the
   * user details view
   */
  public static final String PERSON_LOOKUP_PERSON_DETAILS_DETAILS_ATTRIBUTES = "person-lookup.personDetails.detailsAttributes";

  /**
   * Portlet preference name to use to specify a attributes to exclude in the
   * user details view
   */
   ...
   *          The {@link ExternalContext} to get the flows's configuration from
   ...
   *          The {@link ExternalContext} to get the flows's configuration from
   * @param person
   *          The person who's attributes will be displayed
   ...
   * of the searching user. Both the returned person list and the attributes of
   * the returned people will be filtered according to the searching user's
   * permissions.
   * 
   * @param searcher
   * @param query
