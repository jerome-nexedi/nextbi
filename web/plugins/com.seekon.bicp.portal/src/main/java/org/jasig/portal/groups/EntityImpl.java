...
public class EntityImpl extends GroupMemberImpl implements IEntity {
  ...
  public EntityImpl(EntityIdentifier ei) throws GroupsException {
    ...
    entityIdentifier = new EntityIdentifier(key,
      org.jasig.portal.EntityTypes.LEAF_ENTITY_TYPE);
  }
  ...
  /**
   * Returns this object's type, as opposed to the type of its underlying
   * entity.
   * 
   * @return java.lang.Class
   */
