...
public class PermissionImpl implements IPermission, Serializable {
  ...
  /**
   * This constructor ensures that all Permission objects are created with an
   * owner specified.
   * 
   * @param owner
   */
  ...
  /**
   * Returns the token that represents the activity associated with this
  ...
  /**
   * Returns the token that represents the target associated with this
   * <code>IPermission</code>.
   */
  ...
  /**
   * Specifies the token that represents the activity associated with this
   * <code>IPermission</code>.
   * 
   * @param activity
   *          String
  ...
  /**
   * Specifies the date that this <code>IPermission</code> will become
   * effective.
   * 
   * @param effective
   *          java.util.Date
  ...
  /**
   * Specifies the token that represents the
   * <code>IAuthorizationPrincipal</code> associated with this
   * <code>IPermission</code>.
   * 
   * @param newPrincipal
   *          String
  ...
  /**
   * Specifies the token that represents the target associated with this
   * <code>IPermission</code>.
   * 
   * @param target
   *          String
