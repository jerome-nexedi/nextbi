...
public interface IPortalActionUrlBuilder extends IPortalUrlBuilder {
  /**
   * @param location
   *          The redirect location to generate a URL for.
   */
  public void setRedirectLocation(String location);

  /**
   * Generates the portal render URL represented by this url builder and passes
   * it to the redirect location.
   * 
   * @param location
   *          The redirect location to generate a URL for.
   * @param renderUrlParamName
   *          The parameter name to pass the render url with
   */
