...
public class LayoutPortalDataType extends AbstractPortalDataType {
  ...
  public static final PortalDataKey IMPORT_32_DATA_KEY = new PortalDataKey(
    LEGACY_LAYOUT_QNAME, "classpath://org/jasig/portal/io/import-layout_v3-2.crn",
    null);
  ...
  public static final PortalDataKey IMPORT_30_DATA_KEY = new PortalDataKey(
    LEGACY_LAYOUT_QNAME, "classpath://org/jasig/portal/io/import-layout_v3-0.crn",
    null);
  ...
  public static final PortalDataKey IMPORT_26_DATA_KEY = new PortalDataKey(
    LEGACY_LAYOUT_QNAME, "classpath://org/jasig/portal/io/import-layout_v2-6.crn",
    null);
   ...
   */
  @Deprecated
  public static final QName LEGACY_LAYOUT_DEFAULT_USER_QNAME = new QName(
    "default-user-layout");
  ...
  public static final PortalDataKey IMPORT_32_DEFAULT_USER_DATA_KEY = new PortalDataKey(
    ...
    "classpath://org/jasig/portal/io/import-layout_v3-2.crn", null);
  ...
  public static final PortalDataKey IMPORT_30_DEFAULT_USER_DATA_KEY = new PortalDataKey(
    LEGACY_LAYOUT_DEFAULT_USER_QNAME,
    "classpath://org/jasig/portal/io/import-layout_v3-0.crn", null);
  ...
  public static final PortalDataKey IMPORT_26_DEFAULT_USER_DATA_KEY = new PortalDataKey(
    LEGACY_LAYOUT_DEFAULT_USER_QNAME,
    "classpath://org/jasig/portal/io/import-layout_v2-6.crn", null);

  private static final List<PortalDataKey> PORTAL_DATA_KEYS = Arrays.asList(
    IMPORT_26_DEFAULT_USER_DATA_KEY, IMPORT_30_DEFAULT_USER_DATA_KEY,
    IMPORT_32_DEFAULT_USER_DATA_KEY, IMPORT_26_DATA_KEY, IMPORT_30_DATA_KEY,
    IMPORT_32_DATA_KEY);
  ...
  @Override
  protected PortalDataKey postProcessSinglePortalDataKey(String systemId,
    ...
    if (systemId.endsWith(".fragment-layout.xml")
      ...
      /*
       * NOTE: In the future we could consider handling this case similarly to
       * how "default" users are handled (below): by reading the username
       * attribute and checking it against the list of known fragment layout
       * owners.
       */
      return convertToFragmentKey(portalDataKey);
    }

    // Check if the layout is for an older style that includes the profile data
    // (only possible in 2.6 and 3.0 format layout files)
    if (IMPORT_26_DATA_KEY.equals(portalDataKey)
      || IMPORT_30_DATA_KEY.equals(portalDataKey)) {
      final StartElement startElement = StaxUtils.getRootElement(reader);
      final Attribute usernameAttr = startElement.getAttributeByName(new QName(
        "username"));
  ...
  private PortalDataKey convertToDefaultUserKey(PortalDataKey portalDataKey) {
    ...
    throw new IllegalArgumentException("Portal Data Key " + portalDataKey
      + " has no default user equivalent");
  }
  ...
  private PortalDataKey convertToFragmentKey(PortalDataKey portalDataKey) {
    ...
    throw new IllegalArgumentException("Portal Data Key " + portalDataKey
      + " has no fragment layout equivalent");
  }
}
