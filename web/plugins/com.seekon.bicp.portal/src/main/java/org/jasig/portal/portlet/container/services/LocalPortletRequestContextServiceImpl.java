...
public class LocalPortletRequestContextServiceImpl implements
  ...
  @Autowired
  public void setRequestPropertiesManager(
   ...
   * (non-Javadoc)
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletActionRequestContext(org.apache.pluto.container.PortletContainer,
  ...
  public PortletRequestContext getPortletActionRequestContext(
    ...
    final IPortletWindow portletWindow = this.portletWindowRegistry
      .convertPortletWindow(containerRequest, window);
    final IPortalRequestInfo portalRequestInfo = this.urlSyntaxProvider
      .getPortalRequestInfo(containerRequest);
    return new PortletRequestContextImpl(container, portletWindow, containerRequest,
      containerResponse, this.requestPropertiesManager, portalRequestInfo,
      portletCookieService, requestAttributeService);
  }
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletActionResponseContext
  ...
  public PortletActionResponseContext getPortletActionResponseContext(
    ...
    final IPortalActionUrlBuilder portalActionUrlBuilder = this.portalUrlProvider
      .getPortalActionUrlBuilder(containerRequest);
    final IPortletUrlBuilder portletUrlBuilder = portalActionUrlBuilder
      .getPortletUrlBuilder(portletWindow.getPortletWindowId());

    return new PortletActionResponseContextImpl(container, portletWindow,
      containerRequest, containerResponse, requestPropertiesManager,
      portalActionUrlBuilder, portletUrlBuilder, this.portletContextService,
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletEventRequestContext(org.apache.pluto.container.PortletContainer,
   * javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse,
   * org.apache.pluto.container.PortletWindow)
   */
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletEventResponseContext(org.apache.pluto.container.PortletContainer,
   * javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse,
   * org.apache.pluto.container.PortletWindow)
   */
  ...
  public PortletEventResponseContext getPortletEventResponseContext(
    ...
    return new PortletEventResponseContextImpl(container, portletWindow,
      containerRequest, containerResponse, requestPropertiesManager,
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletRenderRequestContext(org.apache.pluto.container.PortletContainer,
   * javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse,
   * org.apache.pluto.container.PortletWindow)
   */
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletRenderResponseContext
   * (org.apache.pluto.container.PortletContainer,
   * javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse,
   * org.apache.pluto.container.PortletWindow)
  ...
  public PortletRenderResponseContext getPortletRenderResponseContext(
    ...
    final IPortletWindow portletWindow = this.portletWindowRegistry
      .convertPortletWindow(containerRequest, window);
    return new PortletRenderResponseContextImpl(container, portletWindow,
      containerRequest, containerResponse, this.requestPropertiesManager,
      this.portalUrlProvider, this.portletCookieService);
  }
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletResourceRequestContext
   * (org.apache.pluto.container.PortletContainer,
   * javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse,
   * org.apache.pluto.container.PortletWindow)
  ...
  public PortletResourceRequestContext getPortletResourceRequestContext(
    ...
    final IPortalRequestInfo portalRequestInfo = this.urlSyntaxProvider
      .getPortalRequestInfo(containerRequest);
    return new PortletResourceRequestContextImpl(container, portletWindow,
      containerRequest, containerResponse, this.requestPropertiesManager,
      portalRequestInfo, this.portletCookieService, requestAttributeService);
  }
   ...
   * 
   * @seeorg.apache.pluto.container.PortletRequestContextService#
   * getPortletResourceResponseContext
   * (org.apache.pluto.container.PortletContainer,
   * javax.servlet.http.HttpServletRequest,
   * javax.servlet.http.HttpServletResponse,
   * org.apache.pluto.container.PortletWindow)
  ...
  public PortletResourceResponseContext getPortletResourceResponseContext(
    ...
    return new PortletResourceResponseContextImpl(container, portletWindow,
      containerRequest, containerResponse, this.requestPropertiesManager,
      this.portalUrlProvider, this.portletCookieService);
  }
}
