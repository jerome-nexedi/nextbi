...
/**
 * Implementation of the {@link IPortletWindow} interface that tracks the
...
class StatelessPortletWindowImpl implements IPortletWindow, PortletWindow {
   ...
   * 
   * @param portletWindowData
   *          The persistent portlet window data
   * @param portletEntity
   *          The parent IPortletEntity
   * @param portletDefinition
   *          The pluto portlet descriptor level object (pluto calls it a
   *          definition)
   * @throws IllegalArgumentException
   *           if any parameters are null
   */
  public StatelessPortletWindowImpl(PortletWindowData portletWindowData,
    IPortletEntity portletEntity, PortletDefinition portletDefinition) {
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindow#setPortletMode(javax.portlet
   * .PortletMode)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindow#setWindowState(javax.portlet
   * .WindowState)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindow#setRequestParameters(java.util
   * .Map)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.portlet.om.IPortletWindow#setExpirationCache(java.lang
   * .Integer)
   */
  @Override
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result
      + ((this.portletEntity == null) ? 0 : this.portletEntity.hashCode());
    result = prime
      * result
      + ((this.portletWindowData.getPortletWindowId() == null) ? 0
        : this.portletWindowData.getPortletWindowId().hashCode());
    result = prime
      * result
      + ((this.portletWindowData.getDelegationParentId() == null) ? 0
  ...
  public boolean equals(Object obj) {
    ...
    if (this.portletWindowData.getDelegationParentId() == null) {
      if (other.getDelegationParentId() != null)
        return false;
    } else if (!this.portletWindowData.getDelegationParentId().equals(
      other.getDelegationParentId()))
      return false;
    if (this.portletWindowData.getPortletWindowId() == null) {
      if (other.getPortletWindowId() != null)
        return false;
    } else if (!this.portletWindowData.getPortletWindowId().equals(
      other.getPortletWindowId()))
      return false;
    return true;
  }
  ...
  public String toString() {
    return "PortletWindow [" + "portletWindowId="
      + this.portletWindowData.getPortletWindowId() + ", " + "delegationParentId="
      + this.portletWindowData.getDelegationParentId() + ", " + "portletMode="
      + this.portletWindowData.getPortletMode() + ", " + "windowState="
      + this.portletWindowData.getWindowState() + ", " + "expirationCache="
      + this.portletWindowData.getExpirationCache() + ", " + "renderParameters="
      + this.portletWindowData.getRenderParameters() + ", "
      + "publicRenderParameters="
      + this.portletWindowData.getPublicRenderParameters() + ", " + "portletEntity="
      + this.portletEntity + "]";
  }
}
