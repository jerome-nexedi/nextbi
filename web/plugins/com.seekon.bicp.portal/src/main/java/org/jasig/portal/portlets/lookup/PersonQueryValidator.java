...
public class PersonQueryValidator {
  ...
  /**
   * {@link IPersonLookupHelper} to use for getting configuration and query
  ...
  public void validatePersonLookup(PersonQuery personQuery, MessageContext context) {
    ...
    final Set<String> queryAttributes = personLookupHelper
      .getQueryAttributes(externalContext);
