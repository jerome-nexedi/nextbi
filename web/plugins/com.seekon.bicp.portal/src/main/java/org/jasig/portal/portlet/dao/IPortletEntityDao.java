...
/**
 * Provides APIs for creating, storing and retrieving {@link IPortletEntity}
 * objects.
 * 
...
public interface IPortletEntityDao {
  /**
   * Creates, initializes and persists a new {@link IPortletEntity} based on the
   * specified {@link IPortletDefinitionId}, layout node id and user id.
   * 
   * @param portletDefinitionId
   *          The id of the
   *          {@link org.jasig.portal.portlet.om.IPortletDefinition} that is the
   *          parent of the new entity
   * @param layoutNodeId
   *          The layout node id in the user's layout.
   * @param userId
   *          The id of the user the entity is for.
   * @return A newly created, initialized and persisted entity.
   * @throws IllegalArgumentException
   *           if portletDefinitionId or layoutNodeId are null.
   * @throws org.springframework.dao.DataIntegrityViolationException
   *           If an entity already exists for the layout node id and userId
   *           pair
   * @throws org.springframework.dao.DataRetrievalFailureException
   *           If no {@link org.jasig.portal.portlet.om.IPortletDefinition}
   ...
   * 
   * @param portletEntity
   *          The portlet entity to store the changes for
   * @throws IllegalArgumentException
   ...
   * 
   * @param layoutNodeId
   *          The node id from the user's layout to get the entity for
   * @param userId
   *          The user id to get the entity for
   * @return The portlet entity for the id, null if no entity exists for the
   *         ids.
   * @throws IllegalArgumentException
   *           if layoutNodeId is null.
   */
  public IPortletEntity getPortletEntity(String layoutNodeId, int userId);

  /**
   * Get all {@link IPortletEntity}s based on the specified
   * {@link IPortletDefinitionId}.
   * 
   * @param portletDefinitionId
   *          The ID of the parent portlet definition
   * @return A set of all entities based on the specified portlet definition id,
   *         will be empty if no entities exist for the id, will never be null.
   * @throws IllegalArgumentException
  ...
  /**
   * Get all {@link IPortletEntity}s that exist for the specified user id. (From
   * {@link org.jasig.portal.security.IPerson#getID()}.
   * 
   * @param userId
   *          The id of the user to get the entities for.
   * @return A set of all entities base on the specified user id, will be empty
   *         if no entities exist for the id, will never be null.
   */
