...
public class LoggingCharacterComponent extends CharacterPipelineComponentWrapper {
  ...
  public PipelineEventReader<CharacterEventReader, CharacterEvent> getEventReader(
    ...
    final LoggingCharacterEventReader loggingEventReader = new LoggingCharacterEventReader(
      eventReader);
  ...
  private class LoggingCharacterEventReader extends FilteringCharacterEventReader {
     ...
     * 
     * @see
     * org.jasig.portal.character.stream.FilteringCharacterEventReader#filterEvent
     * (org.jasig.portal.character.stream.events.CharacterEvent, boolean)
     */
    @Override
