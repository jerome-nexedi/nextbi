...
public interface IXalanAuthorizationHelper {
   ...
   * 
   * @param userName
   *          Looks up the user with the matching
   *          {@link org.jasig.portal.security.IPerson#USERNAME}
   * @param channelFName
   *          Looks up the {@link org.jasig.portal.ChannelDefinition} with the
   *          matching fname
   * @return true if the user has permission to render the channel, false for
   *         any other case.
   */
