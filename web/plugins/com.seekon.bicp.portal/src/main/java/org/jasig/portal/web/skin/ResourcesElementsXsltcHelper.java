...
/**
 * Used by Xalan to transform a {@link Resources} to the correct HTML head
 * elements (script tags for javascript and link tags for css).
 * 
 * @author Nicholas Blair, npblair@wisc.edu TransformerConfigurationSource
 */
public class ResourcesElementsXsltcHelper extends
  TransformerConfigurationSourceAdapter {
  ...
  public String getResourcesParameter(HttpServletRequest request, String skinXml,
    String name) {
    return this.resourcesElementsProvider.getResourcesParameter(request, skinXml,
      name);
  }
  ...
  public CacheKey getCacheKey(HttpServletRequest request,
    HttpServletResponse response) {
    return CacheKey.build(ResourcesElementsXsltcHelper.class.getName(),
