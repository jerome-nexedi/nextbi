...
public class GroupMembershipEvaluatorFactory extends PersonEvaluatorFactory {
  /**
   * Returns an instance of an evaluator specific to this factory and the passed
   * in values. Name should be a well known group name. Case is important. The
   * mode should be "memberOf" for now. Other modes may be added in the future
   * like, "deepMemberOf".
   */
