...
/**
 * Parameter tag, uses the {@link ParameterizableTag} as a parent to add
 * parameters
 * 
...
public class ParamTag extends TagSupport {
  ...
  public int doStartTag() throws JspException {
    final ParameterizableTag parameterizableTag = (ParameterizableTag) findAncestorWithClass(
      this, ParameterizableTag.class);
