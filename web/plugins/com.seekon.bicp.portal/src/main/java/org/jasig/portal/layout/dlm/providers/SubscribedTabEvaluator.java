 ...
 * is in the specified IPerson's fragment subscription list. This evaluator also
 * performs a real-time permissions lookup to ensure that the user is still
 * permissioned to be include the fragment.
 * 
...
public class SubscribedTabEvaluator extends Evaluator {
  ...
  public boolean isApplicable(IPerson person) {
    ...
    IUserFragmentSubscriptionDao userFragmentInfoDao = UserFragmentSubscriptionDaoLocator
