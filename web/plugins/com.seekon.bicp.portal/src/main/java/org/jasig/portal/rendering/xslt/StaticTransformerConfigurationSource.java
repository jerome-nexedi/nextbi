 ...
 * @version $Revision$
 */
public class StaticTransformerConfigurationSource implements
  ...
  public void setParameterExpressions(Map<String, String> parameterExpressions) {
    ...
    for (final Map.Entry<String, String> expressionEntry : parameterExpressions
      .entrySet()) {
  ...
  public CacheKey getCacheKey(HttpServletRequest request,
    ...
    final LinkedHashMap<String, Object> transformerParameters = this.getParameters(
      request, response);
    transformerParameters.keySet().removeAll(this.cacheKeyExcludedParameters);
    return CacheKey.build(this.getClass().getName(), this.outputProperties,
  ...
  @Override
  public LinkedHashMap<String, Object> getParameters(HttpServletRequest request,
    HttpServletResponse response) {
    ...
    if (this.parameterExpressions != null) {
      for (final Map.Entry<String, Expression> expressionEntry : this.parameterExpressions
        .entrySet()) {
