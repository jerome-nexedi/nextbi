...
/**
 * Factory bean that gets a Map<K extends Serializable, V> cache wrapper from
 * the configured {@link CacheFactory} for the specified cache name. If no name
 * is specified the default cache is used.
 * 
