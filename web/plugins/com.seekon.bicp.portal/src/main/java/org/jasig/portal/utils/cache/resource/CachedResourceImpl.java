...
class CachedResourceImpl<T> implements CachedResource<T> {
  ...
  public CachedResourceImpl(Resource resource, LoadedResource<T> loadedResource,
    long lastLoadTime, Serializable cacheKey) {
  ...
  public int hashCode() {
    ...
    result = prime
      * result
      + ((this.additionalResources == null) ? 0 : this.additionalResources
        .hashCode());
    result = prime * result
      + ((this.cacheKey == null) ? 0 : this.cacheKey.hashCode());
    result = prime * result
      + ((this.cachedResource == null) ? 0 : this.cachedResource.hashCode());
    result = prime * result
      + (int) (this.lastCheckTime ^ (this.lastCheckTime >>> 32));
  ...
  public String toString() {
    return "CachedResourceImpl [resource=" + this.resource
      + ", additionalResources=" + this.additionalResources + ", cachedResource="
      + this.cachedResource + ", lastLoadTime=" + this.lastLoadTime + ", cacheKey="
