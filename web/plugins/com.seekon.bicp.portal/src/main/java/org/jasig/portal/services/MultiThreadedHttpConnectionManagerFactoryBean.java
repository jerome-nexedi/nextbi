...
public class MultiThreadedHttpConnectionManagerFactoryBean extends
  AbstractFactoryBean<MultiThreadedHttpConnectionManager> {
  ...
  protected MultiThreadedHttpConnectionManager createInstance() throws Exception {
    ...
    final HttpConnectionManagerParams pars = multiThreadedHttpConnectionManager
      .getParams();
  ...
  @Override
  protected void destroyInstance(MultiThreadedHttpConnectionManager instance)
    throws Exception {
