...
class PortalUrlBuilder extends AbstractUrlBuilder implements IPortalActionUrlBuilder {
  ...
  public PortalUrlBuilder(IUrlSyntaxProvider urlSyntaxProvider,
    HttpServletRequest httpServletRequest, String targetFolderId,
    IPortletWindowId targetPortletWindowId, UrlType urlType) {

    Preconditions.checkNotNull(urlSyntaxProvider,
      "IUrlSyntaxProvider can not be null");
    Preconditions.checkNotNull(httpServletRequest,
      "HttpServletRequest can not be null");
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortalActionUrlBuilder#setRedirectLocation(java.lang
   * .String)
   */
  @Override
   ...
   * 
   * @see
   * org.jasig.portal.url.IPortalUrlBuilder#getPortletUrlBuilder(org.jasig.portal
   * .portlet.om.IPortletWindowId)
   */
  @Override
  public IPortletUrlBuilder getPortletUrlBuilder(IPortletWindowId portletWindowId) {
    ...
    if (portletUrlBuilder == null) {
      portletUrlBuilder = ConcurrentMapUtils.putIfAbsent(this.portletUrlBuilders,
        portletWindowId, new PortletUrlBuilder(portletWindowId, this));
    }
  ...
  public String toString() {
    return "PortalUrlBuilder [targetFolderId=" + this.targetFolderId
      + ", targetPortletWindowId=" + this.targetPortletWindowId + ", urlType="
      + this.urlType + ", parameters=" + this.getParameters() + "]";
  }
  ...
  public int hashCode() {
    ...
    result = prime
      * result
      + ((this.targetPortletWindowId == null) ? 0 : this.targetPortletWindowId
        .hashCode());
