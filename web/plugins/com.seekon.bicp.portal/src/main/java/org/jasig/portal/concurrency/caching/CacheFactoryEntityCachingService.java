...
/**
 * Creates {@link MapBackedEntityCache} instances that wrap {@link Map} caches
 * retrieved from the {@link CacheFactory} service.
 * 
...
public class CacheFactoryEntityCachingService extends AbstractEntityCachingService {
   ...
   * 
   * @see
   * org.jasig.portal.concurrency.caching.AbstractEntityCachingService#getCache
   * (java.lang.Class)
   */
  @Override
  ...
  private class EntityCacheCreator extends
    MapCachingDoubleCheckedCreator<String, IEntityCache> {
    ...
    protected IEntityCache createInternal(String typeName, Object... args) {
      final Map<Serializable, IBasicEntity> cacheMap = CacheFactoryEntityCachingService.this.cacheFactory
        .getCache(typeName);
      final Class<? extends IBasicEntity> entityType = (Class<? extends IBasicEntity>) args[0];
