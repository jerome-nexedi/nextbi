 ...
 * @version $Revision$
 */
public final class PortletTitlePlaceholderEventImpl extends
  PortletPlaceholderEventImpl implements PortletTitlePlaceholderEvent {
  ...
  public String toString() {
    return "PortletTitlePlaceholderEvent [" + "portletWindowId="
