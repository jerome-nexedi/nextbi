...
/**
 * An ILdapServer impl that wraps a Spring-LDAP ContextSource for getting
 * contections to provide legacy ILdapServer support.
 * 
...
public class ContextSourceLdapServerImpl implements ILdapServer {
  ...
  public void releaseConnection(DirContext conn) {
    try {
      ...
      this.logger.warn("An exception occured while closing DirContext='" + conn
        + "'", ne);
    }
  }
}
