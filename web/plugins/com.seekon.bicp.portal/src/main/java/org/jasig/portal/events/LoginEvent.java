...
public final class LoginEvent extends PortalEvent {
  ...
  LoginEvent(PortalEventBuilder eventBuilder, Set<String> groups,
    ...
    for (final Map.Entry<String, List<String>> attributeEntry : attributes
      .entrySet()) {
      attributesBuilder.put(attributeEntry.getKey(), ImmutableList
        .copyOf(attributeEntry.getValue()));
    }
  ...
  public String toString() {
    return super.toString() + ", groups=" + this.groups.size() + ", attributes="
