...
public interface IPortletTypeDao {
  /**
   * Creates, initializes and persists a new {@link IPortletType} based on the
   * specified parameters
   * 
   * @param name
   *          The name of the channel type
   * @param cpdUri
   *          The URI to the CPD file used when publishing channels of this type
   * 
   ...
   *           If a IChannelType already exists for the provide arguments
   ...
   * 
   * @param type
   *          The channel type to store the changes for
   * @throws IllegalArgumentException
   *           if type is null.
   */
   ...
   * 
   * @param name
   *          The name to get the type for.
   * @return The channel type for the name, null if no type exists for the
   *         fname.
   * @throws IllegalArgumentException
   *           if name is null.
   */
