...
/**
 * Returned by the {@link CachingResourceLoader}. Represents a IO loaded
 * resource including information about when it was last loaded.
 * 
...
public interface CachedResource<T> {
   ...
   * 
   * @return The timestamp for the last time the resource was checked for
   *         modification
   */
  public long getLastCheckTime();

  /**
   * Sets the timestamp for the last time the resource was checked for
   * modification Must be thread safe and follow data visibility rules
   */
