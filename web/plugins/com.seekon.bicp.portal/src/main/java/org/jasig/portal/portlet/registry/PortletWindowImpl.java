 ...
 * {@link PortletWindowData} object. Tracks changes both locally and in the
 * backing object.
 * 
...
class PortletWindowImpl implements IPortletWindow, PortletWindow {
  ...
  public PortletWindowImpl(PortletDefinition portletDefinition,
    IPortletEntity portletEntity, PortletWindowData portletWindowData) {
