...
public class PortalDialectResolver extends AbstractDialectResolver {
  ...
  protected final Dialect resolveDialectInternal(DatabaseMetaData metaData)
    ...
    if ("PostgreSQL".equals(databaseName) && 8 == databaseMajorVersion
      && databaseMinorVersion <= 1) {
      return new PostgreSQL81Dialect();
    }

    // This is due to a jTDS not supporting SQL Server 2008+, hence does not
    // support some new types like TIME.
