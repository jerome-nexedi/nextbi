...
public interface IPortalRequestUtils {
  ...
  /**
   * Gets the HttpServletRequest passed into Pluto to initiate this portlet
   * request
   * 
   * @param portletRequest
   *          The request targeted to the portlet
  ...
  /**
   * Useful for container service callbacks and service portlets that are
   * provided with the portlet's request but need access to the portal's
   * HttpServletRequest.
   * 
   * @param request
   *          The request targeted to the portlet
  ...
  /**
   * Uses {@link org.springframework.web.context.request.RequestContextHolder}
   * to retrieve the current portal HttpServletRequest
   */
  public HttpServletRequest getCurrentPortalRequest();

  /**
   * Useful for container service callbacks and service portlets that are
   * provided with a {@link HttpServletRequest} but need either the root portlet
   * request or the root portal request (depending on where processing is
