...
/**
 * Base class for both {@link PortletRequestContext} and
 * {@link PortletResponseContext} implementations
 * 
...
public abstract class AbstractPortletContextImpl {
  ...
  public AbstractPortletContextImpl(PortletContainer portletContainer,
    IPortletWindow portletWindow, HttpServletRequest containerRequest,
    HttpServletResponse containerResponse, IPortletCookieService portletCookieService) {
   ...
   * @see org.apache.pluto.container.PortletResponseContext#init(javax.servlet.http.HttpServletRequest,
