...
@SequenceGenerator(name = "UP_AGGREGATE_GROUP_MAPPING_GEN", sequenceName = "UP_AGGREGATE_GROUP_MAPPING_SEQ", allocationSize = 10)
@TableGenerator(name = "UP_AGGREGATE_GROUP_MAPPING_GEN", pkColumnValue = "UP_AGGREGATE_GROUP_MAPPING_PROP", allocationSize = 10)
@Immutable
@Cacheable
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class AggregatedGroupMappingImpl implements AggregatedGroupMapping,
  Serializable {
  ...
  public String toString() {
    return "AggregatedGroupMapping [id=" + id + ", groupService=" + groupService
      + ", groupName=" + groupName + "]";
  }
}
