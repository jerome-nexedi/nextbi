...
public class ImmutableUserLayoutXMLEventReader extends FilteringXMLEventReader {
  ...
  private static final class ImmutableStartElementWrapper extends
    StartElementWrapper {
    ...
    public Iterator<Attribute> getAttributes() {
      ...
      for (final Iterator<Attribute> attributeItr = super.getAttributes(); attributeItr
        .hasNext();) {
      ...
      final Attribute immutableAttribute = EVENT_FACTORY.createAttribute(
        immutableName, "true");
      attributes.put(immutableName, immutableAttribute);

      final QName unremovableName = new QName("unremovable");
      final Attribute unremovableAttribute = EVENT_FACTORY.createAttribute(
        unremovableName, "true");
