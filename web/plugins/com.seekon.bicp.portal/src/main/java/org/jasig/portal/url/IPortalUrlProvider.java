...
public interface IPortalUrlProvider {
   ...
   * @param request
   *          the current request
   * @return The current portal action url builder, null if there is no portal
   *         action url builder for this requet
   */
  public IPortalActionUrlBuilder getPortalActionUrlBuilder(HttpServletRequest request);

  /**
   * Converts a standard {@link IPortalUrlBuilder} to a
   * {@link IPortalActionUrlBuilder}
   * 
   * @param request
   *          The current request
   * @param portalUrlBuilder
   *          The url builder to convert
  ...
  /**
   * Gets the default portal URL, this is equivalent to the first URL rendered
   * by the portal when a user logs in. Always a {@link UrlType#RENDER}
   * 
   * @param request
   ...
   *          The current portal request
   * @param layoutNodeId
   *          ID of the node in the user's layout that should be targeted by the
   *          URL.
   * @param urlType
   *          The type of the portal url to create
   * @return {@link IPortalUrlBuilder} targeting the specified node in the
   *         user's layout
   * @throws IllegalArgumentException
   *           If the specified ID doesn't exist for a folder in the users
   *           layout.
   */
  ...
  // public IPortalUrlBuilder
  // getPortalUrlBuilderByLayoutFName(HttpServletRequest request, String
   ...
   *          ID of the portlet window that should be targeted by the URL.
   * @param urlType
   *          The type of the portal url to create
   * @return {@link IPortalUrlBuilder} targeting the specified node in the
   *         user's layout
   ...
   *          The current portal request
   * @param portletFName
   *          The fname of the portlet that should be targeted by the URL
   * @param urlType
   *          The type of the portal url to create
   * @return {@link IPortalUrlBuilder} targeting the specified node in the
   *         user's layout
