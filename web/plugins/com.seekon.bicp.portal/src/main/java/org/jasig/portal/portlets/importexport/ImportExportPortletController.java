...
public class ImportExportPortletController {
  ...
  public ModelAndView getExportView(PortletRequest request) {
    ...
    final Iterable<IPortalDataType> exportPortalDataTypes = this.portalDataHandlerService
      .getExportPortalDataTypes();
    final List<IPortalDataType> types = getAllowedTypes(request, EXPORT_PERMISSION,
      exportPortalDataTypes);
  ...
  public ModelAndView getDeleteView(PortletRequest request) {
    ...
    final Iterable<IPortalDataType> deletePortalDataTypes = this.portalDataHandlerService
   ...
   * @return
   */
  protected List<IPortalDataType> getAllowedTypes(PortletRequest request,
    String activityName, Iterable<IPortalDataType> dataTypes) {
