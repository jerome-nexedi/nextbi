...
public final class PortletRenderHeaderExecutionEvent extends PortletExecutionEvent {
  ...
  PortletRenderHeaderExecutionEvent(PortalEventBuilder eventBuilder, String fname,
  ...
  /**
   * @return If the portlet was explicitly targeted by the request that resulted
   *         in it rendering
   */
  ...
  public String toString() {
    return super.toString() + ", targeted=" + this.targeted + ", cached="
      + this.cached + "]";
  }
}
