...
/**
 * Interface describing the parent cookie used to relate all Portlet Cookies to
 * one HTTP Cookie.
 * 
...
public interface IPortalCookie {
  ...
  public static final String PORTAL_COOKIE_NAME = IPortalCookie.class.getPackage()
    .getName()
    + ".PORTLET_COOKIE_TOKEN";
