...
/**
 * CacheControl where calls to {@link #setExpirationTime(int)},
 * {@link #setPublicScope(boolean)}, and {@link #setETag(String)} result setting
 * headers Last-Modified, CacheControl and ETag
 * 
...
public class HeaderSettingCacheControl implements CacheControl {
  ...
  private void setCacheHeaders(int time, boolean publicScope) {
    PortletCachingHeaderUtils.setCachingHeaders(time, publicScope, lastModified,
