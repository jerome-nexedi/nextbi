...
public class GroupListHelperImpl implements IGroupListHelper {
   ...
   * 
   * @see
   * org.jasig.portal.layout.dlm.remoting.IGroupListHelper#search(java.lang.
  ...
  public Set<JsonEntityBean> search(String entityType, String searchTerm) {
    ...
    // otherwise use the getGroupMember method
      ...
      identifiers = GroupService.searchForEntities(searchTerm,
        GroupService.CONTAINS, entityEnum.getClazz());
   ...
   * 
   * @see
   * org.jasig.portal.layout.dlm.remoting.IGroupListHelper#getRootEntity(java
   * .lang.String)
   */
  public JsonEntityBean getRootEntity(String groupType) {
    ...
    if (EntityEnum.GROUP.equals(type)) {
      ...
      IEntityGroup categoryGroup = GroupService
        .getDistinguishedGroup(IGroupConstants.PORTLET_CATEGORIES);
   ...
   * (non-Javadoc)
   * 
   * @seeorg.jasig.portal.layout.dlm.remoting.IGroupListHelper#
   * getEntityTypesForGroupType(java.lang.String)
   */
  public Set<String> getEntityTypesForGroupType(String groupType) {
    ...
    /*
     * If the supplied type is a person group, add the person entity type. If
     * the supplied type is a category, add the channel type. Otherwise, throw
     * an exception.
     * 
     * This method will require an update if more entity types are added in the
     * future.
     */
   ...
   * 
   * @see
   * org.jasig.portal.layout.dlm.remoting.IGroupListHelper#getEntity(java.lang
   * .String, java.lang.String, boolean)
   */
  public JsonEntityBean getEntity(String entityType, String entityId,
    ...
    if (entityEnum.isGroup()) {
      ...
      if (entity == null) {
        ...
        if (populateChildren) {
          @SuppressWarnings("unchecked")
          Iterator<IGroupMember> members = (Iterator<IGroupMember>) entity
            .getMembers();
    ...
    // otherwise use the getGroupMember method
      ...
      IGroupMember entity = GroupService.getGroupMember(entityId, entityEnum
        .getClazz());
   ...
   * 
   * @see
   * org.jasig.portal.layout.dlm.remoting.IGroupListHelper#getEntity(org.jasig
  ...
  /**
   * <p>
   * Populates the children of the JsonEntityBean. Creates new JsonEntityBeans
   * for the known types (person, group, or category), and adds them as children
   * to the current bean.
   * </p>
   * 
   * @param jsonBean
   *          Entity bean to which the children are added
   * @param children
   *          An Iterator containing IGroupMember elements. Usually obtained
   *          from entity.getMembers().
   * @return jsonBean with the children populated
   */
  private JsonEntityBean populateChildren(JsonEntityBean jsonBean,
    Iterator<IGroupMember> children) {
   ...
   * 
   * @see
   * org.jasig.portal.layout.dlm.remoting.IGroupListHelper#getEntityType(org
   * .jasig.portal.groups.IGroupMember)
   */
   ...
   * 
   * @see
   * org.jasig.portal.portlets.groupselector.GroupsSelectorHelper#getEntityBeans
   * (java.util.List)
   */
  ...
  /**
   * <p>
   * Convenience method that looks up the name of the given group member. Used
   * for person types.
   * </p>
   * 
   * @param groupMember
  ...
  public String lookupEntityName(JsonEntityBean entity) {
    ...
    if (entityEnum.isGroup()) {
      ...
      finder = EntityNameFinderService.instance().getNameFinder(
        entityEnum.getClazz());
    }
    ...
    try {
      ...
      /*
       * An exception here isn't the end of the world. Just log it and return
       * null.
       */
