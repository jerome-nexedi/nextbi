...
public class DbTest {
  ...
  private static void printInfo(Connection conn) throws Exception {
    ...
    boolean supportsOpenCursorsAcrossCommit = dbMetaData
      .supportsOpenCursorsAcrossCommit();
    boolean supportsOpenCursorsAcrossRollback = dbMetaData
      .supportsOpenCursorsAcrossRollback();
    boolean supportsOpenStatementsAcrossCommit = dbMetaData
      .supportsOpenStatementsAcrossCommit();
    boolean supportsOpenStatementsAcrossRollback = dbMetaData
    ...
    System.out
      .println("supportsANSI92EntryLevelSQL: " + supportsANSI92EntryLevelSQL);
