...
/**
 * IPortalSpELService provides an interface for parsing strings using the Spring
 * expression language. Strings are assumed to be a potential mixture of SpEL
 * expressions contained inside a ${ } and text string content. For example, a
 * portal-relative URL path might be formatted as
...
public interface IPortalSpELService {
   ...
   * @param request
   *          request (may be either a portlet or servlet request)
