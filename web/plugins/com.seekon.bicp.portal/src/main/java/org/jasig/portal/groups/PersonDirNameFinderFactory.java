...
/**
 * Factory for creating and obtaining reference to a static singleton
 * <code>PersonDirNameFinder</code>.
 * 
 * @author Alex Vigdor
 * @version $Revision$
 */
public class PersonDirNameFinderFactory implements IEntityNameFinderFactory {
  ...
  /**
   * Lazily initialized static singleton PersonDirNameFinder backed by the
   * IPersonAttributeDao provided by the PersonDirectory static service.
   */
