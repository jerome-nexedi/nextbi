...
@SequenceGenerator(name = "UP_PORTLET_DEF_PARAM_GEN", sequenceName = "UP_PORTLET_DEF_PARAM_SEQ", allocationSize = 5)
@TableGenerator(name = "UP_PORTLET_DEF_PARAM_GEN", pkColumnValue = "UP_PORTLET_DEF_PARAM", allocationSize = 5)
@Cacheable
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class PortletDefinitionParameterImpl implements IPortletDefinitionParameter,
  Serializable {
  ...
  /**
   * Instantiate a ChannelParameter with a particular name, default value, and
   ...
   * 
   * @see
   * org.jasig.portal.channel.IChannelParameter#setDescription(java.lang.String)
   */
  @Override
  ...
  public String toString() {
    return "PortletDefinitionParameter [name=" + this.name + ", value=" + this.value
      + ", descr=" + this.descr + "]";
  }
