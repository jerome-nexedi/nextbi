...
public interface XmlUtilities {
  ...
  /**
   * Gets an appropriate cache key for the specified stylesheet resource. The
   * key should be valid for both {@link Transformer}s and {@link Templates}
  ...
  /**
   * The standard shared XMLOutputFactory to be used by uPortal code. Clients
   * should not set any properties on this XMLOutputFactory.
   */
  public XMLOutputFactory getXmlOutputFactory();

  /**
   * The standard shared XMLOutputFactory to be used by uPortal code writing
   * StAX to HTML. Clients should not set any properties on this
   * XMLOutputFactory
   */
  public XMLOutputFactory getHtmlOutputFactory();

  /**
   * The standard shared XMLInputFactory to be used by uPortal code. Clients
   * should not set any properties on this XMLInputFactory, if they need to they
   * should use {@link XMLInputFactory#newFactory()} directly
   */
  ...
  /**
   * Serializes the List of XMLEvents into a XML String using HTML safe
   * formatting
   */
