...
public class PortletRenderResponseContextImpl extends PortletMimeResponseContextImpl
  ...
  public PortletRenderResponseContextImpl(PortletContainer portletContainer,
   ...
   * (non-Javadoc)
   * 
   * @seeorg.apache.pluto.container.PortletRenderResponseContext#
   * setNextPossiblePortletModes(java.util.Collection)
   */
  @Override
   ...
   * 
   * @see
   * org.apache.pluto.container.PortletRenderResponseContext#setTitle(java.lang
   * .String)
   */
  @Override
  public void setTitle(String title) {
    this.checkContextStatus();
    this.servletRequest.setAttribute(IPortletRenderer.ATTRIBUTE__PORTLET_TITLE,
      title);
  }
}
