...
public interface IMessageDao {
   ...
   * 
   * @param code
   *          The code of the message to be retrieved.
   * @param locale
   *          The locale of the message to be retrieved.
   * @return The message for code and locale or null if such message could not
   *         be found.
   */
  Message getMessage(String code, Locale locale);

  /**
   * Creates, initializes and persists a new {@link Message} based on the
   * spcified parameters.
   * 
   * @param code
   ...
   * @param value
   *          Localized message string for the locale.
   ...
   * 
   * @param message
   *          The message to store the changes for.
   ...
   * 
   * @param code
   *          The code to retrieve messages for.
   * @return A list of all translated messages for specific code.
   */
  Set<Message> getMessagesByCode(String code);

  /**
   * Get all message codes regardless of translation. This can be used in order
   * to find out the missing translations for specific locales.
   * 
