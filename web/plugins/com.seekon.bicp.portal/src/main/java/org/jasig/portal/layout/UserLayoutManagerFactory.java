...
public class UserLayoutManagerFactory implements BeanFactoryAware {
  ...
  public IUserLayoutManager getUserLayoutManager(IPerson person, IUserProfile profile)
    ...
    final IUserLayoutManager userLayoutManager = (IUserLayoutManager) this.beanFactory
      .getBean(USER_LAYOUT_MANAGER_PROTOTYPE_BEAN_NAME, person, profile);
   ...
   * 
   * @param man
   *          an <code>IUserLayoutManager</code> value
   * @return an immutable <code>IUserLayoutManager</code> value
   * @exception PortalException
   *              if an error occurs
   */
  public IUserLayoutManager immutableUserLayoutManager(IUserLayoutManager man)
    throws PortalException {
