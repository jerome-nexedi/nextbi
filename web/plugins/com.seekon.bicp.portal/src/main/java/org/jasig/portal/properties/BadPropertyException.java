 ...
 * PropertiesManager when a property is requested but cannot be parsed and
 * returned as the desired type.
 * 
...
public class BadPropertyException extends RuntimeException {
   ...
   *          - the name of the property
   * @param propertyValue
   *          - the bad value of the property.
   * @param desiredType
   *          - the name of the desired type which the value wasn't, making it
   *          bad.
   */
  public BadPropertyException(String propertyName, String propertyValue,
    String desiredType) {
   ...
   */
  public BadPropertyException(String propertyName, String propertyValue,
    String desiredType, Throwable cause) {
    super(cause);
    this.propertyName = propertyName;
    this.propertyValue = propertyValue;
    this.desiredType = desiredType;
