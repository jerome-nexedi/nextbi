...
public class AuthorizationService {
  ...
  static {
    ...
    java.io.InputStream secprops = AuthorizationService.class
    ...
    try {
      pr.load(secprops);
      secprops.close();
      // Look for our authorization factory and instantiate an instance of it or
      // die trying.
      if ((s_factoryName = pr.getProperty("authorizationProvider")) == null) {
        ...
        try {
          m_Factory = (IAuthorizationServiceFactory) Class.forName(s_factoryName)
            .newInstance();
        } catch (Exception e) {
          log.error("Failed to instantiate AuthorizationProvider " + s_factoryName,
            new PortalSecurityException(
