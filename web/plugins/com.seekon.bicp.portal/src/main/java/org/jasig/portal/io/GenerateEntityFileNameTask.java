...
public class GenerateEntityFileNameTask implements Task {
  ...
  public static final Reagent ENTITY_ELEMENT = new SimpleReagent("ENTITY_ELEMENT",
    ...
    "Root element of the finished XML entity document", new AttributePhrase(
      Attributes.NODE));
  ...
  public static final Reagent LAYOUT_STORE = new SimpleReagent("LAYOUT_STORE",
    ...
    "The portal's running IUserLayoutStore instance", new AttributePhrase(
      "layoutStore"));
  ...
  public Formula getFormula() {
    return new SimpleFormula(GenerateEntityFileNameTask.class, new Reagent[] {
      ENTITY_ELEMENT, LAYOUT_STORE });
  }
  ...
  public void perform(TaskRequest req, TaskResponse res) {
    ...
    final IUserLayoutStore rdbmdls = (IUserLayoutStore) layoutStore.evaluate(req,
      res);
    SupportedFileTypes y = SupportedFileTypes.getApplicableFileType(rootElement,
      rdbmdls);
