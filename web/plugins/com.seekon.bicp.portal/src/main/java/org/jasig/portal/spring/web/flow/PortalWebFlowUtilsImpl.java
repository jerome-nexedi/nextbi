...
public class PortalWebFlowUtilsImpl implements IPortalWebFlowUtils {
   ...
   * 
   * @see
   * org.jasig.portal.spring.web.flow.IPortalWebFlowUtils#getCurrentPerson(org
   ...
   * 
   * @see
   * org.jasig.portal.spring.web.flow.IPortalWebFlowUtils#getCurrentPrincipal
   * (org.springframework.webflow.context.ExternalContext)
   */
  public IAuthorizationPrincipal getCurrentPrincipal(
  ...
  protected HttpServletRequest getServletRequestFromExternalContext(
    ...
    if (request instanceof PortletRequest) {
      return portalRequestUtils
        .getPortletHttpRequest((PortletRequest) externalContext.getNativeRequest());
    }
