...
public interface IUserPreferencesManager {
  ...
  /**
   * Returns {@link IUserLayoutManager} object for performing layout-related
   * operations.
   * 
   ...
   * 
   * @deprecated use {@link #getUserProfile()} and
   *             {@link UserProfile#getThemeStylesheetId()}
   */
  @Deprecated
   ...
   * 
   * @deprecated use {@link #getUserProfile()} and
   *             {@link UserProfile#getStructureStylesheetId()}
   */
  @Deprecated
