...
/*     */{
  ...
  /* 72 */private static final String CREATE_TABLE_STMT = DbService.getQuery(
    "Users.createTable", new String[] { TABLE });

  /* 73 */private static final String FIND_ALL_STMT = DbService.getQuery(
    "Users.findAll", new String[] { COLUMNS, TABLE });

  /* 74 */private static final String FIND_BY_ID_STMT = DbService.getQuery(
    "Users.findById", new String[] { COLUMNS, TABLE });

  /* 75 */private static final String FIND_BY_LOGIN_STMT = DbService.getQuery(
    "Users.findByLogin", new String[] { COLUMNS, TABLE });

  /* 76 */private static final String INSERT_STMT = DbService.getQuery(
    "Users.insert", new String[] { TABLE });

  /* 77 */private static final String UPDATE_STMT = DbService.getQuery(
    "Users.update", new String[] { TABLE });

  /* 78 */private static final String DELETE_STMT = DbService.getQuery(
    "Users.delete", new String[] { TABLE });
  ...
  /*     */
  /*     */protected DomainObject doLoad(String id, ResultSet rs)
    throws SQLException {
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.dbmappers.UserMapper JD-Core
 * Version: 0.5.4
 */