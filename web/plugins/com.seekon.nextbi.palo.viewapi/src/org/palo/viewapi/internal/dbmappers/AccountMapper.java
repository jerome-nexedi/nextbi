...
/*     */{
  /* 63 */private static final String TABLE = DbService
    .getQuery("Accounts.tableName");

  /* 64 */private static final String COLUMNS = DbService
    .getQuery("Accounts.columns");

  /* 65 */private static final String CREATE_TABLE_STMT = DbService.getQuery(
    "Accounts.createTable", new String[] { TABLE });

  /* 66 */private static final String FIND_ALL_STMT = DbService.getQuery(
    "Accounts.findAll", new String[] { COLUMNS, TABLE });

  /* 67 */private static final String FIND_BY_ID_STMT = DbService.getQuery(
    "Accounts.findById", new String[] { COLUMNS, TABLE });

  /* 68 */private static final String FIND_BY_NAME_STMT = DbService.getQuery(
    "Accounts.findByName", new String[] { COLUMNS, TABLE });

  /* 69 */private static final String FIND_BY_USER_STMT = DbService.getQuery(
    "Accounts.findByUser", new String[] { COLUMNS, TABLE });

  /* 70 */private static final String FIND_BY_CONNECTION_STMT = DbService.getQuery(
    "Accounts.findByConnection", new String[] { COLUMNS, TABLE });

  /* 71 */private static final String FIND_BY_USER_CONNECTION_STMT = DbService
    .getQuery("Accounts.findByUserConnection", new String[] { COLUMNS, TABLE });

  /* 72 */private static final String FIND_BY_LOGIN_CONNECTION_STMT = DbService
    .getQuery("Accounts.findByLoginConnection", new String[] { COLUMNS, TABLE });

  /* 73 */private static final String INSERT_STMT = DbService.getQuery(
    "Accounts.insert", new String[] { TABLE });

  /* 74 */private static final String UPDATE_STMT = DbService.getQuery(
    "Accounts.update", new String[] { TABLE });

  /* 75 */private static final String DELETE_STMT = DbService.getQuery(
    "Accounts.delete", new String[] { TABLE });

  /* 76 */private static final String DELETE_CONNECTION_STMT = DbService.getQuery(
    "Accounts.deleteConnection", new String[] { TABLE });

  /*     */
  /*     */public final Account findBy(String login, PaloConnection connection)
    throws SQLException
  /*     */{
  ...
  /*     */
  /*     */public final Account findBy(User user, PaloConnection connection)
    throws SQLException
  /*     */{
  ...
  /*     */
  /*     */public List<Account> getAccountsBy(String connectionId)
    throws SQLException {
 ...
 * .jar Qualified Name: org.palo.viewapi.internal.dbmappers.AccountMapper
