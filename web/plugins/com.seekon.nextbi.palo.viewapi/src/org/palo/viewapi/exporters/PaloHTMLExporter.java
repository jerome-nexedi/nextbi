...
/*     */{
  /* 71 */private static final DecimalFormat DEFAULT_FORMATTER = new DecimalFormat(
    "#,##0.00");
  ...
  /*     */public void traverseVisible(AxisItem item, AxisItem parent,
    AxisItem parentInPrevHierarchy, ArrayList<Integer> result, boolean start) {
    /* 210 */if (!item.hasRootsInNextHierarchy()) {
      /* 211 */result.set(0, Integer
        .valueOf(((Integer) result.get(0)).intValue() + 1));
      /*     */}
    /* 213 */for (AxisItem rootInNextHierarchy : item.getRootsInNextHierarchy()) {
      ...
      /*     */}
    /* 216 */if ((start) ||
    /* 217 */(!item.hasChildren()) || (!item.hasState(2)))
      return;
  ...
  /*     */
  /*     */private final String drawRows(AxisItem[][] rowModel,
    AxisItem[][] colModel, ArrayList<Integer> emptyColumns,
      ...
      /*     */else {
        ...
        /* 254 */for (int j = 0; j < rowModel[i].length; ++j) {
          ...
          /* 259 */if (((Integer) isEmpty.get(Integer.valueOf(j))).intValue() != 0) {
            /* 260 */isEmpty.put(Integer.valueOf(j), Integer
              .valueOf(((Integer) isEmpty.get(Integer.valueOf(j))).intValue() - 1));
        ...
        /* 275 */for (int c = start; c < end; ++c)
          /* 276 */if (emptyColumns.contains(Integer.valueOf(c - start))) {
            ...
            /*     */}
          /*     */else {
            /* 280 */String formatted = this.cellValues[(this.cellPosition++)]
              .getValue().toString();
  ...
  /*     */{
    ...
    /* 338 */if (axisHierarchies.length != 0) {
      ...
      for (int selElements1 = 0; selElements1 < arrayOfElement2; ++selElements1) {
        AxisHierarchy ah = axisHierarchies[selElements1];
        /* 345 */this.html.append("<td>" + ah.getSelectedElements()[0].getName()
          + "</td>");
      }
      /*     */
    ...
    /* 351 */AxisFlatModel cols = new AxisFlatModel(view.getAxis("cols"),
    ...
    /* 358 */AxisFlatModel rows = new AxisFlatModel(view.getAxis("rows"), 1,
      ...
      /* 442 */for (FormatRangeInfo r : f.getRanges()) {
        /* 443 */if (r.getCells() != null) {
          /* 444 */for (Element[] e : r.getCells()) {
            ...
            /* 446 */if (rcCoord != null)
              /* 447 */allCoordinates.add(new IndexRangeInfo(f, rcCoord[0]
        ...
        /*     */}
      /*     */}
    /* 463 */this.indexRanges = ((IndexRangeInfo[]) allCoordinates
    ...
    /* 470 */this.html
      .append(drawRows(rowModel, colModel, emptyColumns, emptyRows));
    /* 471 */this.html.append("</table>\r\n</body></html>\r\n");
    /*     */}

  /*     */
  /*     */private final String drawCols(AxisItem[][] rowModel,
    AxisItem[][] colModel, ArrayList<Integer> emptyColumns) {
      ...
      /*     */{
        ...
        /*     */{
          ...
          /* 513 */if (((Integer) isEmpty.get(Integer.valueOf(i))).intValue() != 0) {
            /* 514 */isEmpty.put(Integer.valueOf(i), Integer
              .valueOf(((Integer) isEmpty.get(Integer.valueOf(i))).intValue() - 1));
  ...
  /*     */{
    ...
    /*     */try {
      ...
      /* 554 */return this.customFormatter.format(d);
    } catch (NumberFormatException e) {
      /*     */}
    /* 556 */return text;
    /*     */}
  ...
  /*     */{
    ...
    /* 572 */if (red.length() < 2)
      red = "0" + red;
    /* 573 */if (green.length() < 2)
      green = "0" + green;
    /* 574 */if (blue.length() < 2)
      blue = "0" + blue;
  ...
  /*     */{
    ...
    /*     */{
      ...
      /* 629 */for (int i = 0; i < traffic.getSize(); ++i)
        /* 630 */if ((traffic.getMinValueAt(i) <= d.doubleValue())
          ...
          /* 636 */if (bg != null) {
            ...
            /*     */}
          /* 639 */return new Object[] { Boolean.valueOf(true),
  ...
  /*     */{
    ...
    /* 672 */if (f.getTrafficLightData() != null) {
      /* 673 */result = applyTrafficLightData(f.getTrafficLightData(), text,
        originalText);
      /*     */}
    /* 675 */if (!((Boolean) result[0]).booleanValue())
    /*     */{
      /* 677 */text = applyFontAndColor(f.getFontData(), f.getForegroundColor(),
        text);
      /*     */
  ...
  /*     */{
    /* 705 */if (item == null) {
      ...
      /*     */}
    /*     */
    /* 710 */coord[((Integer) hierIndex.get(item.getHierarchy())).intValue()] = item
      .getElement();
    /* 711 */fill(coord, item.getParentInPrevHierarchy(), hierIndex);
    /*     */}

  /*     */
  /*     */private final Format getFormat(int row, int col,
    IndexRangeInfo[] ranges, Element[] coords)
  /*     */{
    /* 724 */Format f = null;
    /* 725 */if (coords != null) {
      /* 726 */for (Element e : coords) {
        ...
        /* 728 */if (this.allDimensionLevels.containsKey(e.getDimension())) {
          /* 729 */valid = false;
          /* 730 */for (LevelRangeInfo i : this.allDimensionLevels.get(e
            .getDimension())) {
 ...
 * .jar Qualified Name: org.palo.viewapi.exporters.PaloHTMLExporter JD-Core
 * Version: 0.5.4
 */