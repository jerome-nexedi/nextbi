...
/*     */{
  ...
  /*     */
  /*     */public final ElementInfo append(ElementInfo element,
  ...
  /*     */{
    ...
    /* 124 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
  ...
  /*     */
  /*     */public final ElementInfo create(DimensionInfo dimension, String name,
  ...
  /*     */{
    ...
    /* 152 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
    /* 153 */return elementBuilder.create(dimension, response[0]);
    /*     */}

  /*     */
  /*     */public final boolean createBulk(DimensionInfo dimension,
    ElementInfo[] names, int type, ElementInfo[][] children, double[][] weights)
    throws IOException
  /*     */{
  ...
  /*     */
  /*     */public final boolean createBulk(DimensionInfo dimension, String[] names,
  ...
  /*     */
  /*     */private final void verifyParameters(String[] names, int[] types,
    ElementInfo[][] children, double[][] weights)
  /*     */{
  ...
  /*     */{
    ...
    /* 386 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
  ...
  /*     */{
    ...
    /* 406 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
  ...
  /*     */public final ElementInfo reload(ElementInfo element) throws IOException {
    ...
    /* 423 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
  ...
  /*     */{
    ...
    /* 442 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
  ...
  /*     */public final void update(ElementInfo element, int type,
    String[] children, double[] weights, ServerInfo serverInfo) throws IOException
  /*     */{
    ...
    /* 474 */ElementInfoBuilder elementBuilder = this.builderReg
      .getElementBuilder();
 ...
 * Qualified Name: com.tensegrity.palojava.http.handlers.ElementHandler JD-Core
 * Version: 0.5.4
 */