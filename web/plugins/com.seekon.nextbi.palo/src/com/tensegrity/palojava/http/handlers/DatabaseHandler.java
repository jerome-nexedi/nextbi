...
/*     */{
  ...
  /*     */
  /*     */public final CubeInfo[] getAllCubes(DatabaseInfo database)
    throws IOException
  /*     */{
  ...
  /*     */{
    ...
    /* 144 */DatabaseInfoBuilder databaseBuilder = this.builderReg
      .getDatabaseBuilder();
  ...
  /*     */public final DimensionInfo[] getDimensions(DatabaseInfo database,
    int typeMask) throws IOException
  /*     */{
  ...
  /*     */{
    ...
    /* 194 */DatabaseInfoBuilder databaseBuilder = this.builderReg
      .getDatabaseBuilder();
  ...
  /*     */
  /*     */public final DatabaseInfo reload(DatabaseInfo database)
    throws IOException {
    ...
    /* 212 */DatabaseInfoBuilder databaseBuilder = this.builderReg
      .getDatabaseBuilder();
  ...
  /*     */{
    ...
    /* 226 */if (response[0].length == 6) {
      ...
      /*     */}
    /* 232 */DatabaseInfoBuilder databaseBuilder = this.builderReg
      .getDatabaseBuilder();
  ...
  /*     */
  /*     */private final DimensionInfo[] getDimensionsInternal(
    DatabaseInfo database, boolean getAll, int typeMask) throws IOException
  /*     */{
    /* 282 */if (database.getStatus() == 0) {
      /* 283 */System.err.println("WARNING: database '" + database.getName()
        + "' not loaded!!");
      /*     */}
    /*     */
  ...
  /*     */private final String getTypeString(int typeMask) {
    ...
    /*     */
    /* 312 */showTypes.append((hasType(8, typeMask)) ? "&show_attribute=1"
      : "&show_attribute=0");
    /* 313 */showTypes.append((hasType(16, typeMask)) ? "&show_info=1"
      : "&show_info=0");
    /* 314 */showTypes.append((hasType(2, typeMask)) ? "&show_normal=1"
      : "&show_normal=0");
    /* 315 */showTypes.append((hasType(4, typeMask)) ? "&show_system=1"
      : "&show_system=0");
 ...
 * Qualified Name: com.tensegrity.palojava.http.handlers.DatabaseHandler JD-Core
 * Version: 0.5.4
 */