 ...
 *
 * SVN Rev: $Id: AJAX.php 1979 2009-08-03 11:36:40Z predragm $
 *
 * @category  HTML
 * @package   AJAX
 ...
 */
require_once "html_ajax/AJAX/Serializer/JSON.php";
require_once "html_ajax/AJAX/Serializer/Null.php";
require_once "html_ajax/AJAX/Serializer/Error.php";
require_once "html_ajax/AJAX/Serializer/XML.php";
require_once "html_ajax/AJAX/Serializer/PHP.php";
require_once 'html_ajax/AJAX/Debug.php';
...
class HTML_AJAX
{
    ...
    function _getSerializer($type)
    {
        ...
        if ( (version_compare(phpversion(), 5, '>') && !class_exists($class, false)) 
            ...
            include_once "html_ajax/AJAX/Serializer/{$type}.php";
        }
