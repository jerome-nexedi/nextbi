...
public class Activator implements BundleActivator {
  ...
  static String[] nativeLibs = new String[] { "xerces-c_3_0", "icudt42", "icuuc42",
    "chinook.exe", "IEShims", "libeay32", "ssleay32", "ntwdblib", "libmysql",
    "php5ts", "libpalo_ng", "libconnectionpool", "palo_wss3", "php_macro_engine"/* , "ui_backend" */};
