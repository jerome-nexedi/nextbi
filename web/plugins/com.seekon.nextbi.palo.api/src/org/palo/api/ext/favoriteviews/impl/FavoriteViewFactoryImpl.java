...
public class FavoriteViewFactoryImpl extends FavoriteViewFactory {
   ...
   */
  public FavoriteView createFavoriteView(String name, CubeView view, int position) {
   ...
   */
  public FavoriteViewsFolder createFolder(String name, Connection con, int position) {
