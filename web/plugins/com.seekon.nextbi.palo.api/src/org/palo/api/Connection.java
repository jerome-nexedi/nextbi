...
* @author Stepan Rutz
*
* @version $Id: Connection.java,v 1.48 2010/07/13 09:21:05 PhilippBouillon Exp $
*
*/
...
public interface Connection extends Writable {
  ...
  * otherwise
  ...
  /**
   * Returns the license info for the currently used palo server. Note that
   * no login needs to be executed before calling this method.
   * 
   * @return the license information for this palo server or null if the server
