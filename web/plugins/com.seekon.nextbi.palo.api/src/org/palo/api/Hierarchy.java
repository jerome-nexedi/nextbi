...
*
* @version $Id: Hierarchy.java,v 1.18 2010/05/04 13:07:28 PhilippBouillon Exp $
*
*/
...
public interface Hierarchy extends PaloObject {
   ...
   * @param weights
   */
  void addElements(String[] names, int[] types, Element[][] children,
    double[][] weights);
  ...
  */
   ...
   */
  void setAttributeValues(Attribute[] attributes, Element[] elements, Object[] values);
  ...
  */
  ...
  public Element getVirtualElement(String id);

  public void addVirtualElement(Element element);
}
