...
* @author ArndHouben
*
* @version $Id: ElementPath.java,v 1.17 2010/05/04 13:07:27 PhilippBouillon Exp $
*
*/
...
public class ElementPath {
  ...
  private final void addPart(Hierarchy hierarchy, String[] elIDs)
    ...
    for (int i = 0; i < elIDs.length; ++i) {
      ...
      if (element == null) {
        PaloAPIException exception = new PaloAPIException(
          "Could not find element with id '" + elIDs[i] + "' in hierarchy '"
            + hierarchy.getName() + "'!!");
