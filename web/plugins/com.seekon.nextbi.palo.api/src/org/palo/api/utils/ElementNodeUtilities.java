...
/*     */{
  ...
  /*     */public static final void traverse(ElementNode[] roots,
    ...
    /* 104 */ElementNode[] arrayOfElementNode = roots;
    int j = roots.length;
    for (int i = 0; i < j; ++i) {
      ElementNode root = arrayOfElementNode[i];
      /* 105 */traverse(root, visitor);
    }
    /*     */}

  /*     */
  /*     */private static final void traverse(ElementNode node,
    ElementNodeVisitor visitor)
  /*     */{
 ...
 * Qualified Name: org.palo.api.utils.ElementNodeUtilities JD-Core Version:
 * 0.5.4
 */