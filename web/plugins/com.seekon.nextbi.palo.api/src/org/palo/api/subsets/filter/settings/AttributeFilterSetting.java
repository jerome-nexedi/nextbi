...
public class AttributeFilterSetting extends AbstractFilterSettings {
  ...
  public final boolean hasFilterConsraints() {
    AttributeConstraintsMatrix filterMatrix = (AttributeConstraintsMatrix) constraintsParam
      .getValue();
  ...
  public void adapt(FilterSetting from) {
    ...
    copyFilterConstraints((AttributeConstraintsMatrix) setting
  ...
  private final void copyFilterConstraints(
    ...
    for (AttributeConstraint constraint : newConstraintMatrix.getConstraints()) {
