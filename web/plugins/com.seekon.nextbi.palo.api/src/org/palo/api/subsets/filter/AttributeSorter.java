...
/*     */{
  ...
  /*     */public int compare(ElementNode o1, ElementNode o2) {
    ...
    /* 480 */if (attr.getType() == 0)
      /*     */try {
        /* 482 */Double db1 = (a1.length() > 0) ? Double.valueOf(a1) : new Double(
          0.0D);
        /* 483 */Double db2 = (a2.length() > 0) ? Double.valueOf(a2) : new Double(
          0.0D);
 ...
 * Qualified Name: org.palo.api.subsets.filter.AttributeSorter JD-Core Version:
 * 0.5.4
 */