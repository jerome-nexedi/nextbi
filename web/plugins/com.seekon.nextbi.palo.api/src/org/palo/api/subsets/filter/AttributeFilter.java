...
/*     */{
  ...
  /*     */{
    ...
    /* 124 */(AttributeConstraintsMatrix) this.setting.getFilterConstraints()
      .getValue();
  ...
  /*     */{
    /* 165 */int i = 0;
    for (int n = filterMatrix.getRowsCount(); i < n; ++i) {
 ...
 * Qualified Name: org.palo.api.subsets.filter.AttributeFilter JD-Core Version:
 * 0.5.4
 */