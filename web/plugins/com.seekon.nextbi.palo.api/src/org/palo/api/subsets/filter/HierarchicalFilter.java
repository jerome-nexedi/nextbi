...
/*     */{
  ...
  /*     */public final Element getReferenceElement() {
    /* 104 */return this.hierarchy.getElementById(this.setting.getRefElement()
      .getValue());
    /*     */}
  ...
  /*     */{
    ...
    /* 126 */final int revolveMode = this.setting.getRevolveMode().getValue()
      .intValue();
    /* 127 */final int revolveCount = this.setting.getRevolveCount().getValue()
      .intValue();
    /*     */
 ...
 * Qualified Name: org.palo.api.subsets.filter.HierarchicalFilter JD-Core
 * Version: 0.5.4
 */