...
public class HierarchicalFilter extends AbstractSubsetFilter implements
  ...
  public final void filter(List<ElementNode> hier, final Set<Element> elements) {
    ...
    final int revolveLevel = revolveElement != null ? revolveElement.getLevel() : 0;
  ...
  private final boolean isInLevelSelectionRegion(Element element,
    ...
    return (indentFilter.compare(element, startLevel) >= 0 && indentFilter.compare(
      element, endLevel) <= 0);
  }
