...
/*     */{
  ...
  /*     */{
    /* 272 */return "ElementNode ("
      + Integer.toHexString(System.identityHashCode(this)) + "/"
      + Integer.toHexString(hashCode()) + " " + this.element.toString() + ")";
    /*     */}
  ...
  /*     */{
    ...
    /*     */{
      /* 285 */eq &= this.parent.getElement()
        .equals(other.getParent().getElement());
      /*     */}
    /*     */else
    /*     */{
 ...
 * Qualified Name: org.palo.api.ElementNode JD-Core Version: 0.5.4
 */