...
/*     */{
  ...
  /*     */{
    ...
    /* 363 */if (index == this.size) {
      ...
      /*     */}
    /*     */else {
      /* 367 */System.arraycopy(this.data, index, this.data, index + 1, this.size
        - index);
  ...
  /*     */{
    ...
    /* 662 */int[] d = this.data;
    /* 663 */int i = 0;
    for (int j = this.size - 1; i < middle; --j) {
      /* 664 */int tmp = d[i];
      /* 665 */d[i] = d[j];
      /* 666 */d[j] = tmp;
      /*     */
  ...
  /*     */{
    ...
    /*     */{
      ...
      /* 843 */if (this.pos == ArrayListInt.this.size)
        return ArrayListInt.this.size;
 ...
 * Qualified Name: org.palo.api.impl.utils.ArrayListInt JD-Core Version: 0.5.4
 */