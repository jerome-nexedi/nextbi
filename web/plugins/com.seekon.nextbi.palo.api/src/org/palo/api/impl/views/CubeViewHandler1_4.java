    ...
    /* 70 */registerStartHandler(new IPaloStartHandler() {
      ...
      /*     */{
        ...
        /*     */{
          ...
          /* 86 */hierId = allIds[1];
          /*     */}
        /* 88 */Dimension dim = CubeViewHandler1_4.this.database
          .getDimensionById(dimId);
        /* 89 */if (dim == null) {
          /* 90 */CubeViewHandler1_4.this
          /* 93 */.addError("CubeViewReader: unknown dimension id '" + dimId +
          /* 91 */"'!!", CubeViewHandler1_4.this.cubeView.getId(),
            CubeViewHandler1_4.this.cubeView, CubeViewHandler1_4.this.database,
            /* 92 */dimId, 0,
        ...
        /* 96 */if ((hierId != null) && (dim != null)) {
          ...
          /* 98 */if (hier == null)
            ...
            /* 100 */"'!!", CubeViewHandler1_4.this.cubeView.getId(),
              CubeViewHandler1_4.this.cubeView, CubeViewHandler1_4.this.database,
              /* 101 */hierId, 0,
        ...
        /*     */ElementPath elPath;
        /* 108 */if (hier == null)
          /* 109 */elPath = ElementPath.restore(new Hierarchy[] { dim
            .getDefaultHierarchy() }, path);
        /*     */else {
 ...
 * Qualified Name: org.palo.api.impl.views.CubeViewHandler1_4 JD-Core Version:
 * 0.5.4
 */