  ...
  IPaloStartHandler[] getStartHandlers(final Database database) {
    return new IPaloStartHandler[] { new IPaloStartHandler() {
      ...
      public void startElement(String uri, String localName, String qName,
        ...
        String srcDimensionId = attributes.getValue("sourceDimensionId"); //$NON-NLS-1$
        ...
        try {
          ...
          if (!srcDim.getDatabase().getConnection().isLegacy())
            subsetBuilder.setAlias(getAttributeByName(srcHier, attributes
              .getValue("alias")));
        } catch (PaloException pe) {
          System.err.println("SubsetReader: cannot read attributes - "
            + pe.getMessage());
        }
      ...
      public void startElement(String uri, String localName, String qName,
        ...
        Attribute attr = getAttributeByName(subsetBuilder.getSourceHierarchy(),
