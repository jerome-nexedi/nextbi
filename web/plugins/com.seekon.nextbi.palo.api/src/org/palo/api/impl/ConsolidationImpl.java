...
class ConsolidationImpl implements Consolidation {
  ...
  final static ConsolidationImpl create(ConnectionImpl connection, Element parent,
    Element element, double weight) {
  ...
  private final CompoundKey createKey() {
    return new CompoundKey(new Object[] { ConsolidationImpl.class, this.parent,
      this.child, new Double(weight), });
  }
