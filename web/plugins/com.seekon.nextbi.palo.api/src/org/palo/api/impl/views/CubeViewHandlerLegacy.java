...
class CubeViewHandlerLegacy extends CubeViewHandler {
  ...
  private final void handleAxisProperties(Attributes attributes) {
    ...
    if (currDim == null) {
      addError("CubeViewHandlerLegacy: unknown dimension '" + currDimId + "'!!",
        ...
        PersistenceError.UNKNOWN_DIMENSION, null, PersistenceError.TARGET_UNKNOWN);
      return;
    }
  ...
  private final void handleHidden(Attributes attributes) {
    if (currDim == null) {
      addError("CubeViewHandlerLegacy: (hidden path) no dimension defined!!",
        cubeView.getId(), cubeView, database, currDimId,
    ...
    if (path == null) {
      addError("CubeViewHandlerLegacy: no hidden path defined!!", cubeView.getId(),
        cubeView, currAxis, path, PersistenceError.UNKNOWN_PATH, currAxis,
        PersistenceError.TARGET_HIDDEN_PATH);
      return;
  ...
  private final void handleExpanded(Attributes attributes) {
    if (currDim == null) {
      addError("CubeViewHandlerLegacy: (expanded path) no dimension defined!!",
        cubeView.getId(), cubeView, database, currDimId,
        PersistenceError.UNKNOWN_DIMENSION, currAxis,
    ...
    if (path == null) {
      addError("CubeViewHandlerLegacy: no expanded path defined!!",
        cubeView.getId(), cubeView, currAxis, path, PersistenceError.UNKNOWN_PATH,
