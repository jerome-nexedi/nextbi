...
class ServerInfoImpl implements ServerInfo {
  ...
  ServerInfoImpl(Connection connection, com.tensegrity.palojava.ServerInfo serverInfo) {
    this.connection = (ConnectionImpl) connection;
    this.properties = new HashMap<String, Property2>();
    this.serverInfo = serverInfo;

    addProperty(ServerInfo.MAJOR_VERSION_PROPERTY, Integer.toString(serverInfo
      .getMajor()));
    addProperty(ServerInfo.MINOR_VERSION_PROPERTY, Integer.toString(serverInfo
      .getMinor()));
    addProperty(ServerInfo.BUILD_NUMBER_PROPERTY, Integer.toString(serverInfo
      .getBuildNumber()));
